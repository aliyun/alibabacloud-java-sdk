...
public class DescribePhoneNumberStatusRequest extends TeaModel {
    @NameInMap("OwnerId")
    public Long ownerId;
    ...
    public DescribePhoneNumberStatusRequest setOwnerId(Long ownerId) {
    ...
    public DescribePhoneNumberStatusRequest setResourceOwnerId(Long resourceOwnerId) {
