...
public class DescribeDcdnDomainRealTimeBpsDataRequest extends TeaModel {
     ...
     * <p>If you do not set this parameter, all ISPs are queried. You can call <a href="~~DescribeDcdnRegionAndIsp~~">DescribeDcdnRegionAndIsp</a> to query ISP names.</p>
     * 
     * <strong>example:</strong>
     * <p>telecom</p>
     */
     ...
     * <p>If you do not set this parameter, all regions are queried. You can call <a href="~~DescribeDcdnRegionAndIsp~~">DescribeDcdnRegionAndIsp</a> to query regions.</p>
     * 
     * <strong>example:</strong>
     * <p>beijing</p>
     */
