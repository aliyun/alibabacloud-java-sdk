...
public class DescribeDcdnDomainLogExTtlResponseBody extends TeaModel {
    ...
    public DescribeDcdnDomainLogExTtlResponseBody setMaxResults(Integer maxResults) {
    ...
    public DescribeDcdnDomainLogExTtlResponseBody setNextToken(String nextToken) {
    ...
    public DescribeDcdnDomainLogExTtlResponseBody setTotalCount(Integer totalCount) {
