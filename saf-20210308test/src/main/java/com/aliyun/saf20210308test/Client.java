...
package com.aliyun.saf20210308test;

import com.aliyun.tea.*;
import com.aliyun.saf20210308test.models.*;
...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    public ExecuteRequestResponse executeRequestWithOptions(ExecuteRequestRequest request, RuntimeOptions runtime) throws Exception {
        ...
        return TeaModel.toModel(this.doRPCRequest("ExecuteRequest", "2021-03-08-test", "HTTPS", "POST", "AK", "json", req, runtime), new ExecuteRequestResponse());
    }
