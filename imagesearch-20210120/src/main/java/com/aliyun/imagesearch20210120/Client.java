...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    public CommodityTitleResponse commodityTitleWithOptions(CommodityTitleRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        Params params = Params.build(TeaConverter.buildMap(
            new TeaPair("action", "CommodityTitle"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new CommodityTitleResponse());
    }
    ...
    public GeneralRecognitionResponse generalRecognitionWithOptions(GeneralRecognitionRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        Params params = Params.build(TeaConverter.buildMap(
            new TeaPair("action", "GeneralRecognition"),
            new TeaPair("version", "2021-01-20"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new GeneralRecognitionResponse());
    }
    ...
    public ImageAmazonResponse imageAmazonWithOptions(ImageAmazonRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        OpenApiRequest req = OpenApiRequest.build(TeaConverter.buildMap(
            new TeaPair("body", com.aliyun.teautil.Common.toMap(request))
        ));
        Params params = Params.build(TeaConverter.buildMap(
            new TeaPair("action", "ImageAmazon"),
            new TeaPair("version", "2021-01-20"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new ImageAmazonResponse());
    }

    public ImageAmazonResponse imageAmazon(ImageAmazonRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
    ...
    public ImageCategoryResponse imageCategoryWithOptions(ImageCategoryRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        Params params = Params.build(TeaConverter.buildMap(
            new TeaPair("action", "ImageCategory"),
            new TeaPair("version", "2021-01-20"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new ImageCategoryResponse());
    }
    ...
    public ImageDuplicationResponse imageDuplicationWithOptions(ImageDuplicationRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        Params params = Params.build(TeaConverter.buildMap(
            new TeaPair("action", "ImageDuplication"),
            new TeaPair("version", "2021-01-20"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new ImageDuplicationResponse());
    }

    public ImageDuplicationResponse imageDuplication(ImageDuplicationRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
    ...
    public ImagePropertyResponse imagePropertyWithOptions(ImagePropertyRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        Params params = Params.build(TeaConverter.buildMap(
            new TeaPair("action", "ImageProperty"),
            new TeaPair("version", "2021-01-20"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new ImagePropertyResponse());
    }
    ...
    public ImageSegmentationResponse imageSegmentationWithOptions(ImageSegmentationRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        Params params = Params.build(TeaConverter.buildMap(
            new TeaPair("action", "ImageSegmentation"),
            new TeaPair("version", "2021-01-20"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new ImageSegmentationResponse());
    }
