...
public class QueryCompanyInfoResponseBody extends TeaModel {
    ...
    public QueryCompanyInfoResponseBody setCode(Integer code) {
        this.code = code;
        return this;
    }
    ...
    public QueryCompanyInfoResponseBody setData(java.util.List<String> data) {
        this.data = data;
        return this;
    }
    ...
    public QueryCompanyInfoResponseBody setTotal(Integer total) {
        this.total = total;
        return this;
    }
