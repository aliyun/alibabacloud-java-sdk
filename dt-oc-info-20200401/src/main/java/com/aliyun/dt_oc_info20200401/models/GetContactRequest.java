...
public class GetContactRequest extends TeaModel {
    ...
    public GetContactRequest setFetchFieldList(String fetchFieldList) {
    ...
    public GetContactRequest setPageNo(Integer pageNo) {
        this.pageNo = pageNo;
        return this;
    }
    ...
    public GetContactRequest setPageSize(Integer pageSize) {
    ...
    public GetContactRequest setSearchKey(String searchKey) {
