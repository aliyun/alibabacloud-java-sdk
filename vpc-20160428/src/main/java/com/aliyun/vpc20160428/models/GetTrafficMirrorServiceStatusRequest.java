...
public class GetTrafficMirrorServiceStatusRequest extends TeaModel {
    ...
    /**
     * <p>The region ID of the traffic mirroring instance.</p>
    ...
    public GetTrafficMirrorServiceStatusRequest setClientToken(String clientToken) {
    ...
    public GetTrafficMirrorServiceStatusRequest setOwnerAccount(String ownerAccount) {
    ...
    public GetTrafficMirrorServiceStatusRequest setRegionId(String regionId) {
    ...
    public GetTrafficMirrorServiceStatusRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public GetTrafficMirrorServiceStatusRequest setResourceOwnerId(Long resourceOwnerId) {
