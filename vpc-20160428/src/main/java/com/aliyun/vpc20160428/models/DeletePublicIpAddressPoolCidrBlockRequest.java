...
public class DeletePublicIpAddressPoolCidrBlockRequest extends TeaModel {
     ...
     * <ul>
     * <li><strong>true</strong>: performs only a dry run. The CIDR block is not deleted. The system checks the required parameters, request format, and service limits. If the request fails the dry run, an error message is returned. If the request passes the dry run, the <code>DryRunOperation</code> error code is returned.</li>
