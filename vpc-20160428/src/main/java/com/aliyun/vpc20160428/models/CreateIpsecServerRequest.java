...
public class CreateIpsecServerRequest extends TeaModel {
     ...
     * <br>
     * <p>If you do not specify a pre-shared key, the system randomly generates a 16-character string as the pre-shared key. You can call the [ListIpsecServers](https://help.aliyun.com/document_detail/2794120.html) operation to query the pre-shared keys that are generated by the system.</p>
     * <br>
