...
public class CreateVpnAttachmentRequest extends TeaModel {
     ...
     * <p>    **</p>
     * <br>
     * <p>    **Note** The pre-shared key of the IPsec-VPN connection must be the same as the authentication key of the data center. Otherwise, a connection cannot be established between the data center and the VPN gateway.</p>
     * <br>
     ...
     * <br>
     * <p>- If you do not specify a resource group, the IPsec-VPN connection will belong to the default resource group after being created.</p>
     */
