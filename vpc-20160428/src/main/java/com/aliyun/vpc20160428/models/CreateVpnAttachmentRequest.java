...
public class CreateVpnAttachmentRequest extends TeaModel {
     ...
     * <p>    *   If you do not specify a pre-shared key, the system generates a random 16-character string as the pre-shared key. You can call the [DescribeVpnConnection](https://help.aliyun.com/document_detail/448847.html) operation to query the pre-shared key that is generated by the system.</p>
     * <br>
