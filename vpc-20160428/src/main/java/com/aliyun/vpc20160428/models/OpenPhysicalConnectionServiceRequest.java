...
public class OpenPhysicalConnectionServiceRequest extends TeaModel {
    ...
    public static OpenPhysicalConnectionServiceRequest build(java.util.Map<String, ?> map) throws Exception {
        OpenPhysicalConnectionServiceRequest self = new OpenPhysicalConnectionServiceRequest();
