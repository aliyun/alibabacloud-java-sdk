...
public class DescribeIPv6TranslatorAclListAttributesRequest extends TeaModel {
    ...
    public DescribeIPv6TranslatorAclListAttributesRequest setOwnerAccount(String ownerAccount) {
    ...
    public DescribeIPv6TranslatorAclListAttributesRequest setOwnerId(Long ownerId) {
    ...
    public DescribeIPv6TranslatorAclListAttributesRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public DescribeIPv6TranslatorAclListAttributesRequest setResourceOwnerId(Long resourceOwnerId) {
