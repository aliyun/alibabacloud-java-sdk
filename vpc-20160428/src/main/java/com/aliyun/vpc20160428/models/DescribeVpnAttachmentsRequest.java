...
public class DescribeVpnAttachmentsRequest extends TeaModel {
    /**
     * <p>The type of resource to which the IPsec-VPN connection is associated. Default value: <strong>CEN</strong>.</p>
     * <p>The value can only be <strong>CEN</strong>, which indicates that the system queries IPsec-VPN connections associated with transit router instances.</p>
     * 
    ...
    /**
     * <p>The number of entries per page in paging queries. Default value: <strong>10</strong>. Valid values: <strong>1</strong> to <strong>50</strong>.</p>
     * 
     * <strong>example:</strong>
     * <p>10</p>
     */
     ...
     * <blockquote>
     * <p>If you do not specify an IPsec-VPN connection ID, the system queries all IPsec-VPN connections that are associated with transit router instances in the current region.</p>
     * </blockquote>
     * 
     * <strong>example:</strong>
