...
public class DescribeBandwidthPackagesResponse extends TeaModel {
    ...
    public static class DescribeBandwidthPackagesResponseBandwidthPackagesBandwidthPackagePublicIpAddressesPublicIpAddresse extends TeaModel {
        ...
        public DescribeBandwidthPackagesResponseBandwidthPackagesBandwidthPackagePublicIpAddressesPublicIpAddresse setUsingStatus(String usingStatus) {
        ...
        public DescribeBandwidthPackagesResponseBandwidthPackagesBandwidthPackagePublicIpAddressesPublicIpAddresse setApAccessEnabled(Boolean apAccessEnabled) {
