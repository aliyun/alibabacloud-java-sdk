...
public class DeleteTrafficMirrorFilterRequest extends TeaModel {
     ...
     * <li><strong>false</strong> (default): sends the request. If the request passes the check, the traffic mirror filter is deleted.</li>
     * </ul>
     * 
     * <strong>example:</strong>
     * <p>false</p>
    ...
    /**
     * <p>The region ID of the traffic mirror. You can call <a href="https://help.aliyun.com/document_detail/36063.html">DescribeRegions</a> to query the most recent region list. For more information about the regions that support traffic mirroring, see <a href="https://help.aliyun.com/document_detail/207513.html">Overview of traffic mirroring</a>.</p>
