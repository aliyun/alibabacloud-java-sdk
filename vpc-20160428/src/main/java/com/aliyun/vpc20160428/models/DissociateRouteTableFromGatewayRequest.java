...
public class DissociateRouteTableFromGatewayRequest extends TeaModel {
    ...
    public static DissociateRouteTableFromGatewayRequest build(java.util.Map<String, ?> map) throws Exception {
        DissociateRouteTableFromGatewayRequest self = new DissociateRouteTableFromGatewayRequest();
