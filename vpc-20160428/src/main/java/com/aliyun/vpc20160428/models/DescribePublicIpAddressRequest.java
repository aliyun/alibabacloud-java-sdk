...
public class DescribePublicIpAddressRequest extends TeaModel {
    ...
    public DescribePublicIpAddressRequest setOwnerId(Long ownerId) {
    ...
    public DescribePublicIpAddressRequest setPageNumber(Integer pageNumber) {
    ...
    public DescribePublicIpAddressRequest setPageSize(Integer pageSize) {
    ...
    public DescribePublicIpAddressRequest setRegionId(String regionId) {
    ...
    public DescribePublicIpAddressRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public DescribePublicIpAddressRequest setResourceOwnerId(Long resourceOwnerId) {
