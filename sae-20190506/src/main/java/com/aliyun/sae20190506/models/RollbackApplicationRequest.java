...
public class RollbackApplicationRequest extends TeaModel {
     ...
     * <ul>
     * <li><p><strong>true</strong>: turns on Logon-free Sharing</p>
     * </li>
     * <li><p><strong>false</strong>: turns off Logon-free Sharing</p>
     * </li>
     * </ul>
     * 
     * <strong>example:</strong>
     ...
     * </ul>
     * <blockquote>
     * <p>When both <strong>MinReadyInstance</strong> and <strong>MinReadyInstanceRatio</strong> are specified and <strong>MinReadyInstanceRatio</strong> is set to a number from 0 to 100, the value of <strong>MinReadyInstanceRatio</strong> takes precedence.\<em>\</em> For example, if <strong>MinReadyInstances</strong> is set to \*\*5, and <strong>MinReadyInstanceRatio</strong> is set to <strong>50</strong>, the minimum number of available instances is set to the nearest integer rounded up from the calculated result of the following formula: Current number of instances × <strong>50%</strong>.</p>
     * </blockquote>
     * 
     * <strong>example:</strong>
     * <p>-1</p>
     ...
     * </li>
     * <li><p><strong>releaseType</strong>: the processing method for the batches. Valid values: <strong>auto</strong> and <strong>manual</strong>.</p>
     * </li>
     * <li><p><strong>batchWaitTime</strong>: the interval between release batches. Unit: seconds.</p>
     * </li>
     * </ul>
     * </li>
