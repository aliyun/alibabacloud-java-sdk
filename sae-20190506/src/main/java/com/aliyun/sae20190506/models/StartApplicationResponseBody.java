...
public class StartApplicationResponseBody extends TeaModel {
     ...
     * <ul>
     * <li><p>If the call is successful, <strong>ErrorCode</strong> is not returned.</p>
     * </li>
     * <li><p>If the call fails, <strong>ErrorCode</strong> is returned. For more information, see the &quot;<strong>Error codes</strong>&quot; section in this topic.</p>
     * </li>
     * </ul>
     */
    @NameInMap("ErrorCode")
