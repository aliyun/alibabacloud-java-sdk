...
package com.aliyun.ddosdiversion20230701;

import com.aliyun.tea.*;
import com.aliyun.ddosdiversion20230701.models.*;
...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    public Client(com.aliyun.teaopenapi.models.Config config) throws Exception {
        ...
        this._endpoint = this.getEndpoint("ddosdiversion", _regionId, _endpointRule, _network, _suffix, _endpointMap, _endpoint);
    }
    ...
    public ConfigNetStatusResponse configNetStatusWithOptions(ConfigNetStatusRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.net)) {
            query.put("Net", request.net);
        }
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.subNets)) {
            query.put("SubNets", request.subNets);
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "ConfigNetStatus"),
    ...
    public QueryNetListResponse queryNetListWithOptions(QueryNetListRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.mainNet)) {
            query.put("MainNet", request.mainNet);
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "QueryNetList"),
            new TeaPair("version", "2023-07-01"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
