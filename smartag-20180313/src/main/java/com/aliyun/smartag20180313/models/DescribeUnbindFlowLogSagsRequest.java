...
public class DescribeUnbindFlowLogSagsRequest extends TeaModel {
    ...
    public DescribeUnbindFlowLogSagsRequest setOwnerAccount(String ownerAccount) {
    ...
    public DescribeUnbindFlowLogSagsRequest setOwnerId(Long ownerId) {
    ...
    public DescribeUnbindFlowLogSagsRequest setResourceOwnerId(Long resourceOwnerId) {
