...
public class DescribeSagRemoteAccessRequest extends TeaModel {
    ...
    public DescribeSagRemoteAccessRequest setOwnerAccount(String ownerAccount) {
    ...
    public DescribeSagRemoteAccessRequest setOwnerId(Long ownerId) {
    ...
    public DescribeSagRemoteAccessRequest setResourceOwnerId(Long resourceOwnerId) {
