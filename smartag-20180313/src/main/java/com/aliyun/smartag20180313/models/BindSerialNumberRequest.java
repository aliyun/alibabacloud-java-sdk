...
public class BindSerialNumberRequest extends TeaModel {
    ...
    public BindSerialNumberRequest setOwnerAccount(String ownerAccount) {
    ...
    public BindSerialNumberRequest setOwnerId(Long ownerId) {
    ...
    public BindSerialNumberRequest setResourceOwnerId(Long resourceOwnerId) {
