...
public class GetCloudConnectNetworkUseLimitRequest extends TeaModel {
    ...
    public GetCloudConnectNetworkUseLimitRequest setOwnerAccount(String ownerAccount) {
    ...
    public GetCloudConnectNetworkUseLimitRequest setOwnerId(Long ownerId) {
    ...
    public GetCloudConnectNetworkUseLimitRequest setResourceOwnerId(Long resourceOwnerId) {
