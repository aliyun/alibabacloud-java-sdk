...
public class DescribeGrantSagRulesRequest extends TeaModel {
    ...
    public DescribeGrantSagRulesRequest setOwnerAccount(String ownerAccount) {
    ...
    public DescribeGrantSagRulesRequest setOwnerId(Long ownerId) {
    ...
    public DescribeGrantSagRulesRequest setResourceOwnerId(Long resourceOwnerId) {
