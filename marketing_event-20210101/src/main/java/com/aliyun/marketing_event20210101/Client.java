...
public class Client extends com.aliyun.teaopenapi.Client {
     ...
     */
    public AddAgendaSumRecordFlowPopResponse addAgendaSumRecordFlowPopWithOptions(AddAgendaSumRecordFlowPopRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.activeNum)) {
            query.put("ActiveNum", request.activeNum);
        }
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.attendancePercent)) {
            query.put("AttendancePercent", request.attendancePercent);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.flowTime)) {
            query.put("FlowTime", request.flowTime);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.sessionName)) {
            query.put("SessionName", request.sessionName);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.totalPv)) {
            query.put("TotalPv", request.totalPv);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.totalUv)) {
            query.put("TotalUv", request.totalUv);
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "AddAgendaSumRecordFlowPop"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new AddAgendaSumRecordFlowPopResponse());
    }
     ...
     * @return AddAgendaSumRecordFlowPopResponse
     */
    public AddAgendaSumRecordFlowPopResponse addAgendaSumRecordFlowPop(AddAgendaSumRecordFlowPopRequest request) throws Exception {
