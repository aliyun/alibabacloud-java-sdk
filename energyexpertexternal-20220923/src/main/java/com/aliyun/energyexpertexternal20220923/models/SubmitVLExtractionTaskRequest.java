...
public class SubmitVLExtractionTaskRequest extends TeaModel {
    /**
    ...
    public static SubmitVLExtractionTaskRequest build(java.util.Map<String, ?> map) throws Exception {
        SubmitVLExtractionTaskRequest self = new SubmitVLExtractionTaskRequest();
        return TeaModel.build(map, self);
    }

    public SubmitVLExtractionTaskRequest setFileName(String fileName) {
    ...
    public SubmitVLExtractionTaskRequest setFileUrl(String fileUrl) {
    ...
    public SubmitVLExtractionTaskRequest setFolderId(String folderId) {
    ...
    public SubmitVLExtractionTaskRequest setTemplateId(String templateId) {
