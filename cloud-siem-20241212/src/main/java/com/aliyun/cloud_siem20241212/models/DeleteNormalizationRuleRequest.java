...
public class DeleteNormalizationRuleRequest extends TeaModel {
    ...
    /**
     * <p>The region of the threat analysis Management Hub. Select the region of the Management Hub based on the region where your assets are located. Valid values:</p>
     * <ul>
    ...
    /**
     * <p>The user ID of a member. An administrator can specify this parameter to operate on behalf of the member.</p>
     * 
     * <strong>example:</strong>
     * <p>173326*******</p>
     */
