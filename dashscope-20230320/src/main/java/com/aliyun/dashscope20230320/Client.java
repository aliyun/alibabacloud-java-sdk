...
import com.aliyun.dashscope20230320.models.*;
...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    public Client(com.aliyun.teaopenapi.models.Config config) throws Exception {
        ...
        this._endpoint = this.getEndpoint("dashscope", _regionId, _endpointRule, _network, _suffix, _endpointMap, _endpoint);
    }
    ...
    public CreateApiKeyResponse createApiKeyWithOptions(CreateApiKeyRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.expireHours)) {
            body.put("ExpireHours", request.expireHours);
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            ...
            new TeaPair("version", "2023-03-20"),
    ...
    public DeleteApiKeyResponse deleteApiKeyWithOptions(DeleteApiKeyRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.apiKeyId)) {
            body.put("ApiKeyId", request.apiKeyId);
        }
    ...
    public GetInvokeStatisticsResponse getInvokeStatisticsWithOptions(GetInvokeStatisticsRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "GetInvokeStatistics"),
            new TeaPair("version", "2023-03-20"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new GetInvokeStatisticsResponse());
    }

    public GetInvokeStatisticsResponse getInvokeStatistics(GetInvokeStatisticsRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        return this.getInvokeStatisticsWithOptions(request, runtime);
    }
    ...
    public ListApiKeysResponse listApiKeysWithOptions(ListApiKeysRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.validApiKey)) {
            body.put("ValidApiKey", request.validApiKey);
        }
    ...
    public ListModelNamesResponse listModelNamesWithOptions(com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teaopenapi.models.OpenApiRequest req = new com.aliyun.teaopenapi.models.OpenApiRequest();
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "ListModelNames"),
            new TeaPair("version", "2023-03-20"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new ListModelNamesResponse());
    }

    public ListModelNamesResponse listModelNames() throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        return this.listModelNamesWithOptions(runtime);
    }
