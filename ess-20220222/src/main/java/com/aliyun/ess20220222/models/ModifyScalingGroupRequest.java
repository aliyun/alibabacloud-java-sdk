...
public class ModifyScalingGroupRequest extends TeaModel {
     ...
     * <br>
     * <p>>  If you re-enable the Expected Number of Instances feature, you must specify a value for `DesiredCapacity` again.</p>
     */
     ...
     * <p>*   ECI: Auto Scaling checks the health status of elastic container instances in the scaling group.</p>
     ...
     * <br>
     * <p>>  HealthCheckType has the same effect as `HealthCheckTypes`. You can select one of them to specify based on your business requirements. If you specify `HealthCheckTypes`, `HealthCheckType` is ignored. HealthCheckType is optional.</p>
     */
     ...
     * <br>
     * <p>The value range of MaxSize is directly correlated with the degree of dependency your business has on Auto Scaling. You can go to [Quota Center](https://quotas.console.aliyun.com/products/ess/quotas) to check **the maximum number of instances that a single scaling group can contain.**</p>
     * <br>
     * <p>For example, if a scaling group can contain up to **2,000** instances, the value range of MaxSize is 0 to 2000.</p>
     */
    @NameInMap("MaxSize")
