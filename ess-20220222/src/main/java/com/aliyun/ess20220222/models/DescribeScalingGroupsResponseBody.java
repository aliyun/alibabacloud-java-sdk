...
public class DescribeScalingGroupsResponseBody extends TeaModel {
    ...
    public static class DescribeScalingGroupsResponseBodyScalingGroupsLoadBalancerConfigs extends TeaModel {
        /**
         * <p>The ID of the Classic Load Balancer (CLB, formerly known as Server Load Balancer or SLB) instance.</p>
         */
    ...
    public static class DescribeScalingGroupsResponseBodyScalingGroupsServerGroups extends TeaModel {
         ...
         * <br>
         * <p>*   ALB: ALB server group</p>
         * <p>*   NLB: NLB server group</p>
         */
        @NameInMap("Type")
        public String type;
    ...
    public static class DescribeScalingGroupsResponseBodyScalingGroups extends TeaModel {
        ...
        /**
         * <p>Indicates whether Auto Scaling can create pay-as-you-go instances to supplement preemptible instances in the case that preemptilble instances cannot be created due to price-related factors or insufficient inventory when MultiAZPolicy is set to COST_OPTIMIZED. Valid values:</p>
         * <br>
         * <p>*   true</p>
         * <p>*   false</p>
         */
        ...
        /**
         * <p>The number of instances that are in the Initialized state and ready to be scaled out in the scaling group.</p>
         */
        ...
        /**
         * <p>The lifecycle status of the scaling group. Valid values:</p>
         * <br>
        ...
        /**
         * <p>The IDs of the load balancers that are associated with the scaling group.</p>
         */
        @NameInMap("LoadBalancerIds")
        public java.util.List<String> loadBalancerIds;

        /**
         * <p>The maximum life span of an ECS instance in the scaling group. Unit: seconds.</p>
         * <br>
         * <p>Valid values: 0 or from 86400 to `Integer.maxValue`. A value of 0 indicates that the ECS instance has an unlimited life span in the scaling group.</p>
         * <br>
         ...
         * <br>
         * <p>*   BALANCE: ECS instances are evenly distributed across the zones that are specified for the scaling group. If ECS instance are unevenly distributed across the specified zones due to insufficient inventory of instance types, you can call the RebalanceInstance operation to rebalance the distribution of the ECS instances.</p>
         */
         ...
         * <br>
         * <p>For more information, see [RemoveInstances](~~25955~~).</p>
         */
        ...
        /**
         * <p>The allocation policy of preemptible instances. You can use this parameter to individually specify the allocation policy for preemptible instances. This parameter takes effect only if you set `MultiAZPolicy` to `COMPOSABLE`. Valid values:</p>
         * <br>
        ...
        /**
         * <p>The number of specified instance types. Auto Scaling evenly creates preemptible instances of multiple instance types that are provided at the lowest price across the zones of the scaling group. Valid values: 0 to 10.</p>
         */
