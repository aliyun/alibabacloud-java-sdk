...
public class UpdateKnowledgeResponseBody extends TeaModel {
    ...
    public UpdateKnowledgeResponseBody setCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public UpdateKnowledgeResponseBody setMessage(String message) {
    ...
    public UpdateKnowledgeResponseBody setSuccess(Boolean success) {
