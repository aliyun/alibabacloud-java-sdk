...
public class InitializeShrinkRequest extends TeaModel {
    ...
    public InitializeShrinkRequest setAutoDocPageConfig(String autoDocPageConfig) {
    ...
    public InitializeShrinkRequest setFaceAttributeCheck(String faceAttributeCheck) {
    ...
    public InitializeShrinkRequest setUpdateFaceIfUserExists(String updateFaceIfUserExists) {
