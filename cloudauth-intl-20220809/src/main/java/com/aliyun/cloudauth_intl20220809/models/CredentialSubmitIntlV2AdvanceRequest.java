...
public class CredentialSubmitIntlV2AdvanceRequest extends TeaModel {
    /**
    ...
    public static CredentialSubmitIntlV2AdvanceRequest build(java.util.Map<String, ?> map) throws Exception {
        CredentialSubmitIntlV2AdvanceRequest self = new CredentialSubmitIntlV2AdvanceRequest();
        return TeaModel.build(map, self);
    }

    public CredentialSubmitIntlV2AdvanceRequest setCheckRuleConfig(String checkRuleConfig) {
    ...
    public CredentialSubmitIntlV2AdvanceRequest setCredentialOcrPictureBase64(String credentialOcrPictureBase64) {
    ...
    public CredentialSubmitIntlV2AdvanceRequest setCredentialOcrPictureFileObject(java.io.InputStream credentialOcrPictureFileObject) {
    ...
    public CredentialSubmitIntlV2AdvanceRequest setCredentialOcrPictureUrl(String credentialOcrPictureUrl) {
    ...
    public CredentialSubmitIntlV2AdvanceRequest setDocType(String docType) {
    ...
    public CredentialSubmitIntlV2AdvanceRequest setFileInputType(String fileInputType) {
    ...
    public CredentialSubmitIntlV2AdvanceRequest setFraudCheck(String fraudCheck) {
    ...
    public CredentialSubmitIntlV2AdvanceRequest setIdQuality(String idQuality) {
    ...
    public CredentialSubmitIntlV2AdvanceRequest setMerchantBizId(String merchantBizId) {
    ...
    public CredentialSubmitIntlV2AdvanceRequest setOcrArea(String ocrArea) {
    ...
    public CredentialSubmitIntlV2AdvanceRequest setOcrTranslation(String ocrTranslation) {
    ...
    public CredentialSubmitIntlV2AdvanceRequest setOcrValueStandard(String ocrValueStandard) {
    ...
    public CredentialSubmitIntlV2AdvanceRequest setProductCode(String productCode) {
    ...
    public CredentialSubmitIntlV2AdvanceRequest setSceneCode(String sceneCode) {
