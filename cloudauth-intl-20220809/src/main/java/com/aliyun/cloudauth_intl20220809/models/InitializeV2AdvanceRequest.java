...
public class InitializeV2AdvanceRequest extends TeaModel {
    ...
    public static InitializeV2AdvanceRequest build(java.util.Map<String, ?> map) throws Exception {
        InitializeV2AdvanceRequest self = new InitializeV2AdvanceRequest();
        return TeaModel.build(map, self);
    }

    public InitializeV2AdvanceRequest setAppQualityCheck(String appQualityCheck) {
    ...
    public InitializeV2AdvanceRequest setAuthorize(String authorize) {
    ...
    public InitializeV2AdvanceRequest setCallbackToken(String callbackToken) {
    ...
    public InitializeV2AdvanceRequest setCallbackUrl(String callbackUrl) {
    ...
    public InitializeV2AdvanceRequest setChameleonFrameEnable(String chameleonFrameEnable) {
    ...
    public InitializeV2AdvanceRequest setCrop(String crop) {
        this.crop = crop;
        return this;
    }
    ...
    public InitializeV2AdvanceRequest setDateOfBirth(String dateOfBirth) {
    ...
    public InitializeV2AdvanceRequest setDateOfExpiry(String dateOfExpiry) {
    ...
    public InitializeV2AdvanceRequest setDocName(String docName) {
    ...
    public InitializeV2AdvanceRequest setDocNo(String docNo) {
        this.docNo = docNo;
        return this;
    }
    ...
    public InitializeV2AdvanceRequest setDocPageConfig(java.util.List<String> docPageConfig) {
    ...
    public InitializeV2AdvanceRequest setDocScanMode(String docScanMode) {
    ...
    public InitializeV2AdvanceRequest setDocType(String docType) {
    ...
    public InitializeV2AdvanceRequest setDocVideo(String docVideo) {
    ...
    public InitializeV2AdvanceRequest setDocumentNumber(String documentNumber) {
    ...
    public InitializeV2AdvanceRequest setEditOcrResult(String editOcrResult) {
    ...
    public InitializeV2AdvanceRequest setEmail(String email) {
        this.email = email;
        return this;
    }
    ...
    public InitializeV2AdvanceRequest setExperienceCode(String experienceCode) {
    ...
    public InitializeV2AdvanceRequest setFacePictureBase64(String facePictureBase64) {
    ...
    public InitializeV2AdvanceRequest setFacePictureFileObject(java.io.InputStream facePictureFileObject) {
    ...
    public InitializeV2AdvanceRequest setFacePictureUrl(String facePictureUrl) {
    ...
    public InitializeV2AdvanceRequest setFaceRegisterGroupCode(String faceRegisterGroupCode) {
    ...
    public InitializeV2AdvanceRequest setFaceVerifyThreshold(String faceVerifyThreshold) {
    ...
    public InitializeV2AdvanceRequest setIdFaceQuality(String idFaceQuality) {
    ...
    public InitializeV2AdvanceRequest setIdSpoof(String idSpoof) {
    ...
    public InitializeV2AdvanceRequest setIdThreshold(String idThreshold) {
    ...
    public InitializeV2AdvanceRequest setLanguageConfig(String languageConfig) {
    ...
    public InitializeV2AdvanceRequest setMRTDInput(String MRTDInput) {
    ...
    public InitializeV2AdvanceRequest setMerchantBizId(String merchantBizId) {
    ...
    public InitializeV2AdvanceRequest setMerchantUserId(String merchantUserId) {
    ...
    public InitializeV2AdvanceRequest setMetaInfo(String metaInfo) {
    ...
    public InitializeV2AdvanceRequest setMobile(String mobile) {
        this.mobile = mobile;
        return this;
    }
    ...
    public InitializeV2AdvanceRequest setModel(String model) {
        this.model = model;
        return this;
    }
    ...
    public InitializeV2AdvanceRequest setOcr(String ocr) {
        this.ocr = ocr;
        return this;
    }
    ...
    public InitializeV2AdvanceRequest setOcrValueStandard(String ocrValueStandard) {
    ...
    public InitializeV2AdvanceRequest setPages(String pages) {
        this.pages = pages;
        return this;
    }
    ...
    public InitializeV2AdvanceRequest setProcedurePriority(String procedurePriority) {
    ...
    public InitializeV2AdvanceRequest setProductCode(String productCode) {
    ...
    public InitializeV2AdvanceRequest setProductFlow(String productFlow) {
    ...
    public InitializeV2AdvanceRequest setReturnFaces(String returnFaces) {
    ...
    public InitializeV2AdvanceRequest setReturnUrl(String returnUrl) {
    ...
    public InitializeV2AdvanceRequest setSaveFacePicture(String saveFacePicture) {
    ...
    public InitializeV2AdvanceRequest setSceneCode(String sceneCode) {
    ...
    public InitializeV2AdvanceRequest setSecurityLevel(String securityLevel) {
    ...
    public InitializeV2AdvanceRequest setShowAlbumIcon(String showAlbumIcon) {
    ...
    public InitializeV2AdvanceRequest setShowGuidePage(String showGuidePage) {
    ...
    public InitializeV2AdvanceRequest setShowOcrResult(String showOcrResult) {
    ...
    public InitializeV2AdvanceRequest setStyleConfig(String styleConfig) {
    ...
    public InitializeV2AdvanceRequest setTargetFacePicture(String targetFacePicture) {
    ...
    public InitializeV2AdvanceRequest setTargetFacePictureFileObject(java.io.InputStream targetFacePictureFileObject) {
    ...
    public InitializeV2AdvanceRequest setTargetFacePictureUrl(String targetFacePictureUrl) {
    ...
    public InitializeV2AdvanceRequest setTemplateConfig(String templateConfig) {
    ...
    public InitializeV2AdvanceRequest setTemplateRanCount(String templateRanCount) {
    ...
    public InitializeV2AdvanceRequest setTemplateType(String templateType) {
    ...
    public InitializeV2AdvanceRequest setUpdateFaceIfUserExists(String updateFaceIfUserExists) {
    ...
    public InitializeV2AdvanceRequest setUseNFC(String useNFC) {
        this.useNFC = useNFC;
        return this;
    }
    ...
    public InitializeV2AdvanceRequest setVerifyModel(String verifyModel) {
