...
public class InitializeV2Request extends TeaModel {
    /**
    ...
    public static InitializeV2Request build(java.util.Map<String, ?> map) throws Exception {
        InitializeV2Request self = new InitializeV2Request();
        return TeaModel.build(map, self);
    }

    public InitializeV2Request setAppQualityCheck(String appQualityCheck) {
    ...
    public InitializeV2Request setAuthorize(String authorize) {
    ...
    public InitializeV2Request setAutoDocPageConfig(String autoDocPageConfig) {
    ...
    public InitializeV2Request setAutoRegistration(String autoRegistration) {
    ...
    public InitializeV2Request setCallbackToken(String callbackToken) {
    ...
    public InitializeV2Request setCallbackUrl(String callbackUrl) {
    ...
    public InitializeV2Request setChameleonFrameEnable(String chameleonFrameEnable) {
    ...
    public InitializeV2Request setCrop(String crop) {
        this.crop = crop;
        return this;
    }
    ...
    public InitializeV2Request setDateOfBirth(String dateOfBirth) {
    ...
    public InitializeV2Request setDateOfExpiry(String dateOfExpiry) {
    ...
    public InitializeV2Request setDocName(String docName) {
    ...
    public InitializeV2Request setDocNo(String docNo) {
        this.docNo = docNo;
        return this;
    }
    ...
    public InitializeV2Request setDocPageConfig(java.util.List<String> docPageConfig) {
    ...
    public InitializeV2Request setDocScanMode(String docScanMode) {
    ...
    public InitializeV2Request setDocType(String docType) {
    ...
    public InitializeV2Request setDocVideo(String docVideo) {
    ...
    public InitializeV2Request setDocumentNumber(String documentNumber) {
    ...
    public InitializeV2Request setEditOcrResult(String editOcrResult) {
    ...
    public InitializeV2Request setEmail(String email) {
        this.email = email;
        return this;
    }
    ...
    public InitializeV2Request setExperienceCode(String experienceCode) {
    ...
    public InitializeV2Request setFaceAttributeCheck(String faceAttributeCheck) {
    ...
    public InitializeV2Request setFaceGroupCodes(String faceGroupCodes) {
    ...
    public InitializeV2Request setFacePictureBase64(String facePictureBase64) {
    ...
    public InitializeV2Request setFacePictureFile(String facePictureFile) {
    ...
    public InitializeV2Request setFacePictureUrl(String facePictureUrl) {
    ...
    public InitializeV2Request setFaceRegisterGroupCode(String faceRegisterGroupCode) {
    ...
    public InitializeV2Request setFaceVerifyThreshold(String faceVerifyThreshold) {
    ...
    public InitializeV2Request setIdFaceQuality(String idFaceQuality) {
    ...
    public InitializeV2Request setIdSpoof(String idSpoof) {
    ...
    public InitializeV2Request setIdThreshold(String idThreshold) {
    ...
    public InitializeV2Request setLanguageConfig(String languageConfig) {
    ...
    public InitializeV2Request setMRTDInput(String MRTDInput) {
    ...
    public InitializeV2Request setMerchantBizId(String merchantBizId) {
    ...
    public InitializeV2Request setMerchantUserId(String merchantUserId) {
    ...
    public InitializeV2Request setMetaInfo(String metaInfo) {
    ...
    public InitializeV2Request setMobile(String mobile) {
        this.mobile = mobile;
        return this;
    }
    ...
    public InitializeV2Request setModel(String model) {
        this.model = model;
        return this;
    }
    ...
    public InitializeV2Request setOcr(String ocr) {
        this.ocr = ocr;
        return this;
    }
    ...
    public InitializeV2Request setOcrValueStandard(String ocrValueStandard) {
    ...
    public InitializeV2Request setPages(String pages) {
        this.pages = pages;
        return this;
    }
    ...
    public InitializeV2Request setProcedurePriority(String procedurePriority) {
    ...
    public InitializeV2Request setProductCode(String productCode) {
    ...
    public InitializeV2Request setProductFlow(String productFlow) {
    ...
    public InitializeV2Request setReturnFaces(String returnFaces) {
    ...
    public InitializeV2Request setReturnUrl(String returnUrl) {
    ...
    public InitializeV2Request setSaveFacePicture(String saveFacePicture) {
    ...
    public InitializeV2Request setSceneCode(String sceneCode) {
    ...
    public InitializeV2Request setSecurityLevel(String securityLevel) {
    ...
    public InitializeV2Request setShowAlbumIcon(String showAlbumIcon) {
    ...
    public InitializeV2Request setShowGuidePage(String showGuidePage) {
    ...
    public InitializeV2Request setShowOcrResult(String showOcrResult) {
    ...
    public InitializeV2Request setStyleConfig(String styleConfig) {
    ...
    public InitializeV2Request setTargetFacePicture(String targetFacePicture) {
    ...
    public InitializeV2Request setTargetFacePictureFile(String targetFacePictureFile) {
    ...
    public InitializeV2Request setTargetFacePictureUrl(String targetFacePictureUrl) {
    ...
    public InitializeV2Request setTemplateConfig(String templateConfig) {
    ...
    public InitializeV2Request setTemplateRanCount(String templateRanCount) {
    ...
    public InitializeV2Request setTemplateType(String templateType) {
    ...
    public InitializeV2Request setUpdateFaceIfUserExists(String updateFaceIfUserExists) {
    ...
    public InitializeV2Request setUseNFC(String useNFC) {
        this.useNFC = useNFC;
        return this;
    }
    ...
    public InitializeV2Request setVerifyModel(String verifyModel) {
