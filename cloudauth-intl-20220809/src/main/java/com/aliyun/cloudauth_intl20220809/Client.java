...
public class Client extends com.aliyun.teaopenapi.Client {
     ...
     */
    public AddFaceRecordResponse addFaceRecordWithOptions(AddFaceRecordRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.facePictureFile)) {
            body.put("FacePictureFile", request.facePictureFile);
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "AddFaceRecord"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new AddFaceRecordResponse());
    }
     ...
     * @return AddFaceRecordResponse
     */
    public AddFaceRecordResponse addFaceRecord(AddFaceRecordRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        return this.addFaceRecordWithOptions(request, runtime);
    }

    public AddFaceRecordResponse addFaceRecordAdvance(AddFaceRecordAdvanceRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        // Step 0: init client
        ...
        com.aliyun.openapiutil.Client.convert(request, addFaceRecordReq);
        ...
        AddFaceRecordResponse addFaceRecordResp = this.addFaceRecordWithOptions(addFaceRecordReq, runtime);
    ...
    /**
     * <b>summary</b> : 
     * <p>Recognizes identity documents worldwide through OCR.</p>
     * 
     ...
     */
    public DocOcrV2Response docOcrV2WithOptions(DocOcrV2Request request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.cardSide)) {
            query.put("CardSide", request.cardSide);
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new DocOcrV2Response());
    }
     ...
     * @return DocOcrV2Response
     */
    public DocOcrV2Response docOcrV2(DocOcrV2Request request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        return this.docOcrV2WithOptions(request, runtime);
    }

    public DocOcrV2Response docOcrV2Advance(DocOcrV2AdvanceRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        // Step 0: init client
        com.aliyun.credentials.models.CredentialModel credentialModel = null;
        if (com.aliyun.teautil.Common.isUnset(_credential)) {
            throw new TeaException(TeaConverter.buildMap(
        ...
        com.aliyun.openapiutil.Client.convert(request, docOcrV2Req);
        if (!com.aliyun.teautil.Common.isUnset(request.idOcrPictureFileObject)) {
            Object tmpResp0 = authClient.callApi(authParams, authReq, runtime);
            authResponse = com.aliyun.teautil.Common.assertAsMap(tmpResp0);
            tmpBody = com.aliyun.teautil.Common.assertAsMap(authResponse.get("body"));
        ...
        DocOcrV2Response docOcrV2Resp = this.docOcrV2WithOptions(docOcrV2Req, runtime);
        return docOcrV2Resp;
    }
     ...
     */
    public EkycVerifyV2Response ekycVerifyV2WithOptions(EkycVerifyV2Request request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.authorize)) {
            query.put("Authorize", request.authorize);
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "EkycVerifyV2"),
            new TeaPair("version", "2022-08-09"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new EkycVerifyV2Response());
    }
     ...
     * @return EkycVerifyV2Response
     */
    public EkycVerifyV2Response ekycVerifyV2(EkycVerifyV2Request request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        return this.ekycVerifyV2WithOptions(request, runtime);
    }

    public EkycVerifyV2Response ekycVerifyV2Advance(EkycVerifyV2AdvanceRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        // Step 0: init client
        com.aliyun.credentials.models.CredentialModel credentialModel = null;
        if (com.aliyun.teautil.Common.isUnset(_credential)) {
            throw new TeaException(TeaConverter.buildMap(
        ...
        com.aliyun.openapiutil.Client.convert(request, ekycVerifyV2Req);
        if (!com.aliyun.teautil.Common.isUnset(request.facePictureFileObject)) {
            Object tmpResp0 = authClient.callApi(authParams, authReq, runtime);
            authResponse = com.aliyun.teautil.Common.assertAsMap(tmpResp0);
            tmpBody = com.aliyun.teautil.Common.assertAsMap(authResponse.get("body"));
        ...
        EkycVerifyV2Response ekycVerifyV2Resp = this.ekycVerifyV2WithOptions(ekycVerifyV2Req, runtime);
        return ekycVerifyV2Resp;
    }

    /**
     * <b>summary</b> : 
     * <p>Uses facial recognition technology to compare and verify two input face images, returning the face comparison result and similarity score.</p>
     * 
     ...
     */
    public FaceCompareV2Response faceCompareV2WithOptions(FaceCompareV2Request request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.facePictureQualityCheck)) {
            query.put("FacePictureQualityCheck", request.facePictureQualityCheck);
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.sourceFacePictureFile)) {
            body.put("SourceFacePictureFile", request.sourceFacePictureFile);
        }
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.targetFacePictureFile)) {
            body.put("TargetFacePictureFile", request.targetFacePictureFile);
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "FaceCompareV2"),
            new TeaPair("version", "2022-08-09"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new FaceCompareV2Response());
    }
     ...
     * @return FaceCompareV2Response
     */
    public FaceCompareV2Response faceCompareV2(FaceCompareV2Request request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        return this.faceCompareV2WithOptions(request, runtime);
    }

    public FaceCompareV2Response faceCompareV2Advance(FaceCompareV2AdvanceRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        // Step 0: init client
        com.aliyun.credentials.models.CredentialModel credentialModel = null;
        if (com.aliyun.teautil.Common.isUnset(_credential)) {
            throw new TeaException(TeaConverter.buildMap(
        ...
        com.aliyun.openapiutil.Client.convert(request, faceCompareV2Req);
        if (!com.aliyun.teautil.Common.isUnset(request.sourceFacePictureFileObject)) {
            Object tmpResp0 = authClient.callApi(authParams, authReq, runtime);
            authResponse = com.aliyun.teautil.Common.assertAsMap(tmpResp0);
            tmpBody = com.aliyun.teautil.Common.assertAsMap(authResponse.get("body"));
            useAccelerate = com.aliyun.teautil.Common.assertAsBoolean(tmpBody.get("UseAccelerate"));
            ...
            fileObj = com.aliyun.fileform.models.FileField.build(TeaConverter.buildMap(
                new TeaPair("filename", authResponseBody.get("ObjectKey")),
                new TeaPair("content", request.sourceFacePictureFileObject),
                new TeaPair("contentType", "")
            ));
            ossHeader = TeaConverter.buildMap(
                new TeaPair("host", com.aliyun.openapiutil.Client.getEndpoint(authResponseBody.get("Endpoint"), useAccelerate, _endpointType)),
        ...
        FaceCompareV2Response faceCompareV2Resp = this.faceCompareV2WithOptions(faceCompareV2Req, runtime);
    ...
    public FaceLivenessV2Response faceLivenessV2WithOptions(FaceLivenessV2Request request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "FaceLivenessV2"),
            new TeaPair("version", "2022-08-09"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new FaceLivenessV2Response());
    }
     ...
     * @return FaceLivenessV2Response
     */
    public FaceLivenessV2Response faceLivenessV2(FaceLivenessV2Request request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        return this.faceLivenessV2WithOptions(request, runtime);
    }

    public FaceLivenessV2Response faceLivenessV2Advance(FaceLivenessV2AdvanceRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        // Step 0: init client
        com.aliyun.credentials.models.CredentialModel credentialModel = null;
        if (com.aliyun.teautil.Common.isUnset(_credential)) {
            throw new TeaException(TeaConverter.buildMap(
        ...
        com.aliyun.openapiutil.Client.convert(request, faceLivenessV2Req);
        if (!com.aliyun.teautil.Common.isUnset(request.facePictureFileObject)) {
            Object tmpResp0 = authClient.callApi(authParams, authReq, runtime);
            authResponse = com.aliyun.teautil.Common.assertAsMap(tmpResp0);
            tmpBody = com.aliyun.teautil.Common.assertAsMap(authResponse.get("body"));
        ...
        FaceLivenessV2Response faceLivenessV2Resp = this.faceLivenessV2WithOptions(faceLivenessV2Req, runtime);
     ...
     */
    public FaceVerifyIntlResponse faceVerifyIntlWithOptions(FaceVerifyIntlRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.autoRegistration)) {
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.sourceFacePictureFile)) {
            query.put("SourceFacePictureFile", request.sourceFacePictureFile);
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "FaceVerifyIntl"),
            new TeaPair("version", "2022-08-09"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new FaceVerifyIntlResponse());
    }
     ...
     * @return FaceVerifyIntlResponse
     */
    public FaceVerifyIntlResponse faceVerifyIntl(FaceVerifyIntlRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        return this.faceVerifyIntlWithOptions(request, runtime);
    }

    public FaceVerifyIntlResponse faceVerifyIntlAdvance(FaceVerifyIntlAdvanceRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        // Step 0: init client
        com.aliyun.credentials.models.CredentialModel credentialModel = null;
        if (com.aliyun.teautil.Common.isUnset(_credential)) {
            throw new TeaException(TeaConverter.buildMap(
        ...
        com.aliyun.openapiutil.Client.convert(request, faceVerifyIntlReq);
        if (!com.aliyun.teautil.Common.isUnset(request.sourceFacePictureFileObject)) {
            Object tmpResp0 = authClient.callApi(authParams, authReq, runtime);
            authResponse = com.aliyun.teautil.Common.assertAsMap(tmpResp0);
            tmpBody = com.aliyun.teautil.Common.assertAsMap(authResponse.get("body"));
        ...
        FaceVerifyIntlResponse faceVerifyIntlResp = this.faceVerifyIntlWithOptions(faceVerifyIntlReq, runtime);
    ...
    /**
     * <b>summary</b> : 
     * <p>Verifies the identity of an Indonesian user by calling the authoritative source API in a standalone business scenario.</p>
     * 
     * @param request IdnAuthorityVerifyIntlRequest
     * @param runtime runtime options for this request RuntimeOptions
     * @return IdnAuthorityVerifyIntlResponse
     */
    public IdnAuthorityVerifyIntlResponse idnAuthorityVerifyIntlWithOptions(IdnAuthorityVerifyIntlRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.birthDate)) {
            query.put("BirthDate", request.birthDate);
        }
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.idNumber)) {
            query.put("IdNumber", request.idNumber);
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "IdnAuthorityVerifyIntl"),
            new TeaPair("version", "2022-08-09"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new IdnAuthorityVerifyIntlResponse());
    }
     ...
     * @return IdnAuthorityVerifyIntlResponse
     */
    public IdnAuthorityVerifyIntlResponse idnAuthorityVerifyIntl(IdnAuthorityVerifyIntlRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        return this.idnAuthorityVerifyIntlWithOptions(request, runtime);
    }

    public IdnAuthorityVerifyIntlResponse idnAuthorityVerifyIntlAdvance(IdnAuthorityVerifyIntlAdvanceRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        // Step 0: init client
        com.aliyun.credentials.models.CredentialModel credentialModel = null;
        if (com.aliyun.teautil.Common.isUnset(_credential)) {
            throw new TeaException(TeaConverter.buildMap(
        ...
        com.aliyun.openapiutil.Client.convert(request, idnAuthorityVerifyIntlReq);
        if (!com.aliyun.teautil.Common.isUnset(request.sourceFacePictureFileObject)) {
            Object tmpResp0 = authClient.callApi(authParams, authReq, runtime);
            authResponse = com.aliyun.teautil.Common.assertAsMap(tmpResp0);
            tmpBody = com.aliyun.teautil.Common.assertAsMap(authResponse.get("body"));
        ...
        IdnAuthorityVerifyIntlResponse idnAuthorityVerifyIntlResp = this.idnAuthorityVerifyIntlWithOptions(idnAuthorityVerifyIntlReq, runtime);
