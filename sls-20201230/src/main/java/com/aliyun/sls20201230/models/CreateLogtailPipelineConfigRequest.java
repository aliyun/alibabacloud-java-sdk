...
public class CreateLogtailPipelineConfigRequest extends TeaModel {
    /**
     * <p>The list of aggregation plugins. &gt;Notice: This parameter is valid only when you use extension processing plugins. You can use a maximum of one aggregation plugin.</p>
     */
    ...
    /**
     * <p>The list of output plugins. &gt;Notice: Currently, you can add only one flusher_sls plugin.</p>
     * <p>This parameter is required.</p>
     */
    @NameInMap("flushers")
    ...
    /**
     * <p>The list of input plugins. &gt;Notice: Currently, you can configure only one input plugin.</p>
     * <p>This parameter is required.</p>
     */
    @NameInMap("inputs")
