...
public class DescribeExposedCheckWarningResponseBody extends TeaModel {
    ...
    /**
     * <p>The list of baseline risks for exposed assets.</p>
     */
    ...
    public static class DescribeExposedCheckWarningResponseBodyWarningList extends TeaModel {
        ...
        /**
         * <p>The display name of the subcategory to which the baseline belongs.</p>
         * 
         * <strong>example:</strong>
        ...
        /**
         * <p>The display name of the category to which the baseline belongs.</p>
         * 
         * <strong>example:</strong>
         * <p>Weak password</p>
         */
