...
public class DescribeCheckWarningsResponseBody extends TeaModel {
    ...
    /**
     * <p>The number of check items displayed on each page in a paged query. Default value: <strong>20</strong>, which indicates that 20 check items are displayed on each page.</p>
     * 
     * <strong>example:</strong>
     * <p>20</p>
     */
    ...
    /**
     * <p>The total number of check items returned.</p>
     * 
     * <strong>example:</strong>
     * <p>100</p>
     */
    ...
    public static class DescribeCheckWarningsResponseBodyCheckWarnings extends TeaModel {
        ...
        /**
         * <p>The alert data ID of the baseline check.</p>
         * 
         * <strong>example:</strong>
         * <p>212251441</p>
         */
        ...
        /**
         * <p>The error message during the alert data check.</p>
         * 
         * <strong>example:</strong>
        ...
        /**
         * <p>The timestamp of the most recent handling of the check item risk on the server. Unit: milliseconds.</p>
         * 
         * <strong>example:</strong>
         * <p>1704937755000</p>
         */
        ...
        /**
         * <p>The risk level of the baseline check risk item. Valid values:</p>
         * <ul>
         ...
         * <ul>
         * <li><p><strong>1</strong>: The baseline check failed.</p>
         * </li>
         * <li><p><strong>2</strong>: The baseline fix is being verified.</p>
         * </li>
         * <li><p><strong>3</strong>: The baseline check passed.</p>
         * </li>
         * <li><p><strong>5</strong>: The baseline check status has expired.</p>
         * </li>
         * <li><p><strong>6</strong>: The baseline check item has been ignored.</p>
         * </li>
         * </ul>
         * 
         * <strong>example:</strong>
