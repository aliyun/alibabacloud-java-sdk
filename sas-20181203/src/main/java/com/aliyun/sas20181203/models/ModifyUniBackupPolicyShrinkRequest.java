...
public class ModifyUniBackupPolicyShrinkRequest extends TeaModel {
    ...
    public ModifyUniBackupPolicyShrinkRequest setResourceOwnerId(Long resourceOwnerId) {
    ...
    public ModifyUniBackupPolicyShrinkRequest setSourceIp(String sourceIp) {
