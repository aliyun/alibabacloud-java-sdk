...
public class ModifySecurityEventMarkMissIndividuallyResponseBody extends TeaModel {
    /**
     * <p>The return code for processing the security alert event.</p>
     * <ul>
     * <li><strong>200</strong>: The request was processed successfully.</li>
     * <li>Other values: The request failed to be processed.</li>
     * </ul>
     * 
