...
public class GetCheckStructureResponseBody extends TeaModel {
    /**
     * <p>The structure information of cloud platform configuration check items.</p>
     */
    ...
    public static class GetCheckStructureResponseBodyCheckStructureResponseStandardsRequirementsSections extends TeaModel {
        /**
         * <p>The ID of the check item section.</p>
         * 
         * <strong>example:</strong>
         * <p>177</p>
         */
        ...
        /**
         * <p>The name of the check item section.</p>
         * 
         * <strong>example:</strong>
         * <p>Access Control</p>
         */
    ...
    public static class GetCheckStructureResponseBodyCheckStructureResponseStandardsRequirements extends TeaModel {
        /**
         * <p>The ID of the cloud platform configuration check item requirement.</p>
         * 
         * <strong>example:</strong>
         * <p>46</p>
         */
        ...
        /**
         * <p>The total number of check items under the requirement.</p>
         * 
         * <strong>example:</strong>
         * <p>36</p>
         */
    ...
    public static class GetCheckStructureResponseBodyCheckStructureResponseStandards extends TeaModel {
        /**
         * <p>The ID of the cloud platform configuration check item standard.</p>
         * 
         * <strong>example:</strong>
         * <p>8</p>
         */
        ...
        /**
         * <p>The standards of the cloud platform configuration check items.</p>
         */
        ...
        /**
         * <p>The name of the cloud platform configuration check item standard.</p>
         * 
         * <strong>example:</strong>
        ...
        /**
         * <p>The business type corresponding to the cloud platform configuration check item standard. Valid values:</p>
         * <ul>
         * <li><p>RISK: security risk</p>
         * </li>
         * <li><p>IDENTITY_PERMISSION: permission management CIEM</p>
         * </li>
         * <li><p>COMPLIANCE: security compliance.</p>
         * </li>
         * </ul>
         * 
         * <strong>example:</strong>
    ...
    public static class GetCheckStructureResponseBodyCheckStructureResponse extends TeaModel {
        /**
         * <p>The business type of the cloud platform configuration check item. Valid values:</p>
         * <ul>
         * <li><p>RISK: security risk</p>
         * </li>
         * <li><p>IDENTITY_PERMISSION: permission management CIEM</p>
        ...
        /**
         * <p>The structure information of check items under the business type.</p>
         */
        @NameInMap("Standards")
