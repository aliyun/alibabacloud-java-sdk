...
public class DescribeImageSensitiveFileListShrinkRequest extends TeaModel {
    /**
     * <p>The value that corresponds to the search type.</p>
     * 
    ...
    /**
     * <p>The search type for sensitive files. Valid values:</p>
     * <ul>
     * <li><p><strong>SensitiveFileKey</strong>: the sensitive file alerting categorization. Valid values:</p>
     * <ul>
     ...
     * </ul>
     * </li>
     * <li><p><strong>SensitiveFileName</strong>: the sensitive file alerting type.</p>
     * </li>
     * </ul>
     * 
     * <strong>example:</strong>
     ...
     * <blockquote>
     * <p>Call the <a href="~~DescribeGroupedContainerInstances~~">DescribeGroupedContainerInstances</a> operation of Container Registry. You can obtain the unique identifier of the container image from the <strong>ImageUuid</strong> response parameter.</p>
     * </blockquote>
     * 
     * <strong>example:</strong>
     * <p>850613a48999900f48417c7e6e9d****</p>
     */
    @NameInMap("ImageUuid")
    ...
    /**
     * <p>The maximum number of entries to return on each page in a paging query. Default value: 20.</p>
     * 
     * <strong>example:</strong>
     * <p>20</p>
     */
    ...
    /**
     * <p>The list of sensitive file keys.</p>
     */
