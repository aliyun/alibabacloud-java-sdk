...
public class SetImageSensitiveFileStatusShrinkRequest extends TeaModel {
    ...
    public static SetImageSensitiveFileStatusShrinkRequest build(java.util.Map<String, ?> map) throws Exception {
        SetImageSensitiveFileStatusShrinkRequest self = new SetImageSensitiveFileStatusShrinkRequest();
        return TeaModel.build(map, self);
    }

    public SetImageSensitiveFileStatusShrinkRequest setIdList(java.util.List<Long> idList) {
        this.idList = idList;
        return this;
    }
    ...
    public SetImageSensitiveFileStatusShrinkRequest setImageUuids(String imageUuids) {
    ...
    public SetImageSensitiveFileStatusShrinkRequest setScanRangeShrink(String scanRangeShrink) {
    ...
    public SetImageSensitiveFileStatusShrinkRequest setSensitiveFileKey(String sensitiveFileKey) {
    ...
    public SetImageSensitiveFileStatusShrinkRequest setStatus(Integer status) {
        this.status = status;
        return this;
    }
