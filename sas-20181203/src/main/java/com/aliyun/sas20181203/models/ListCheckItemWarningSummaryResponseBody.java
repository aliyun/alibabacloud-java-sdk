...
public class ListCheckItemWarningSummaryResponseBody extends TeaModel {
    /**
     * <p>The list of check item risk statistics information.</p>
     */
    @NameInMap("List")
    ...
    public static class ListCheckItemWarningSummaryResponseBodyList extends TeaModel {
        /**
         * <p>The suggestion for the check item.</p>
         * 
         * <strong>example:</strong>
        ...
        /**
         * <p>The list of affiliated baseline categories.</p>
         */
        @NameInMap("AffiliatedRiskTypes")
        public java.util.List<String> affiliatedRiskTypes;

        /**
         * <p>The list of affiliated baselines.</p>
         */
        ...
        /**
         * <p>The check item description.</p>
         * 
         * <strong>example:</strong>
        ...
        /**
         * <p>Indicates whether the check item belongs to the container runtime category. Valid values:</p>
         * <ul>
        ...
        /**
         * <p>The list of baselines enabled for the check item.</p>
         */
        ...
        /**
         * <p>The number of machines affected by the check item risk.</p>
         * 
         * <strong>example:</strong>
         * <p>20</p>
         */
