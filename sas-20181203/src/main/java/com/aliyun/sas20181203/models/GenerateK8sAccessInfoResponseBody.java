...
public class GenerateK8sAccessInfoResponseBody extends TeaModel {
    ...
    public static class GenerateK8sAccessInfoResponseBodyData extends TeaModel {
        ...
        /**
         * <p>The SLS project for audit logs.</p>
         * 
         * <strong>example:</strong>
        ...
        /**
         * <p>The CPU architecture, which can be ARM architecture or x86 architecture. Examples:</p>
         * <ul>
         * <li><p>arm64</p>
         * </li>
         * <li><p>x86</p>
        ...
        /**
         * <p>The installation key for the server.</p>
         * 
         * <strong>example:</strong>
         * <p>BC66185***</p>
         */
