...
public class GetFileDetectReportResponseBody extends TeaModel {
    ...
    public static class GetFileDetectReportResponseBodyData extends TeaModel {
         ...
         * </li>
         * <li><p><strong>1</strong>: suspicious</p>
         * </li>
         * <li><p><strong>2</strong>: high</p>
         * </li>
         * </ul>
         * 
         * <strong>example:</strong>
         ...
         * <ul>
         * <li><p><strong>threat_type_desc</strong>: the threat type.</p>
         * </li>
         * <li><p><strong>last_find_time</strong>: the last time the threat was detected.</p>
         * </li>
         * <li><p><strong>risk_type</strong>: indicates whether the tag is malicious. The value 0 indicates that the tag is not malicious. The value 1 indicates that the tag is malicious. The value -1 indicates that whether the tag type is malicious is unknown.</p>
         * </li>
         * <li><p><strong>threat_type</strong>: the threat type. The value is an array. The elements in the array can be network layer intrusion, network service scanning, network sharing and discovery, mining pool, exploits, darknet, malicious logon, malicious download source, central control, web shell, and web attack.</p>
         * </li>
         * </ul>
         * 
         * <strong>example:</strong>
         * <p>[{&quot;threat_type_desc&quot;: &quot;挖矿程序&quot;,&quot;risk_type&quot;: 1,&quot;threat_type&quot;: &quot;&quot;}]</p>
         */
