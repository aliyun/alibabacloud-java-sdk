...
public class GetAttackPathWhitelistRequest extends TeaModel {
    ...
    public static GetAttackPathWhitelistRequest build(java.util.Map<String, ?> map) throws Exception {
        GetAttackPathWhitelistRequest self = new GetAttackPathWhitelistRequest();
        return TeaModel.build(map, self);
    }

    public GetAttackPathWhitelistRequest setAttackPathWhitelistId(String attackPathWhitelistId) {
