...
public class DescribeFrontVulPatchListResponseBody extends TeaModel {
    /**
     * <p>The information about the prerequisite patches for the Windows vulnerability.</p>
     */
    ...
    public static class DescribeFrontVulPatchListResponseBodyFrontPatchListPatchList extends TeaModel {
        ...
        /**
         * <p>The patch number of the prerequisite patch for the Windows vulnerability.</p>
         * 
         * <strong>example:</strong>
         * <p>4523204</p>
         */
    ...
    public static class DescribeFrontVulPatchListResponseBodyFrontPatchList extends TeaModel {
        /**
         * <p>The list of prerequisite patches for the Windows vulnerability on the server.</p>
         */
        @NameInMap("PatchList")
