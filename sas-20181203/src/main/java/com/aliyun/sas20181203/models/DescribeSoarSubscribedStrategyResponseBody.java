...
public class DescribeSoarSubscribedStrategyResponseBody extends TeaModel {
    ...
    public static class DescribeSoarSubscribedStrategyResponseBodySoarStrategies extends TeaModel {
        ...
        /**
         * <p>The total number of times the policy has been executed.</p>
         * 
         * <strong>example:</strong>
         * <p>10</p>
         */
        ...
        /**
         * <p>The timestamp when the policy was created, in milliseconds.</p>
         * 
         * <strong>example:</strong>
         * <p>1716344106000</p>
         */
        ...
        /**
         * <p>The timestamp when the policy was last modified, in milliseconds.</p>
         * 
         * <strong>example:</strong>
         * <p>1652672104000</p>
         */
         ...
         * <ul>
         * <li>runmode_TRIGGER_BY_USER: manual execution.</li>
         * </ul>
         * 
         * <strong>example:</strong>
         ...
         * <ul>
         * <li>type_vulfix: vulnerability management.</li>
         * </ul>
         * 
         * <strong>example:</strong>
         * <p>type_vulfix</p>
