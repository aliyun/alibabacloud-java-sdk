...
public class ListCloudAssetInstancesResponseBody extends TeaModel {
    /**
     * <p>The list of detailed cloud asset information.</p>
     */
    @NameInMap("Instances")
    ...
    public static class ListCloudAssetInstancesResponseBodyInstances extends TeaModel {
        /**
         * <p>Indicates whether the cloud asset has security alerts. Valid values:</p>
         * <ul>
         ...
         * <ul>
         * <li><strong>0</strong>: Server Load Balancer</li>
         ...
         * </ul>
         * </li>
         * <li><p><strong>5</strong>: ApsaraDB for Tair (compatible with Redis)</p>
         * <ul>
         * <li><strong>0</strong>: Instance</li>
         * </ul>
         * </li>
         ...
         * </ul>
         * </li>
         * <li><p><strong>25</strong>: Identity as a Service - EIAM</p>
         * <ul>
         * <li><strong>0</strong>: Instance</li>
         * </ul>
         * </li>
        ...
        /**
         * <p>The ID of the region to which the asset instance belongs.</p>
         * 
         * <strong>example:</strong>
         * <p>cn-hanghzou</p>
         */
        ...
        /**
         * <p>Indicates whether the cloud asset has security risks. Valid values:</p>
         * <ul>
         * <li><strong>YES</strong>: Exists.</li>
         * <li><strong>NO</strong>: Does not exist.</li>
         * </ul>
         * 
         * <strong>example:</strong>
         * <p>NO</p>
    ...
    public static class ListCloudAssetInstancesResponseBodyPageInfo extends TeaModel {
        ...
        /**
         * <p>The page number of the current page in paginated queries.</p>
         * 
         * <strong>example:</strong>
         * <p>2</p>
         */
