...
public class DescribeClientConfStrategyResponseBody extends TeaModel {
    /**
     * <p>The request ID. China Chinese Cloud generates a unique request ID for each API request. You can use the request ID to troubleshoot issues.</p>
     * 
    ...
    public static class DescribeClientConfStrategyResponseBodyTargetList extends TeaModel {
        /**
         * <p>The UUID generated by the Security Center client.</p>
         * 
         * <strong>example:</strong>
