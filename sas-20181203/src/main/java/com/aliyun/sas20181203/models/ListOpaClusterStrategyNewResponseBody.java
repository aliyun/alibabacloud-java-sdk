...
public class ListOpaClusterStrategyNewResponseBody extends TeaModel {
    ...
    /**
     * <p>The result message. Fixed value: <strong>success</strong>. This indicates that the export was successful.</p>
     * 
     * <strong>example:</strong>
     * <p>success</p>
     */
    ...
    public static class ListOpaClusterStrategyNewResponseBodyList extends TeaModel {
        /**
         * <p>The action performed by the policy. Valid values:</p>
         * <ul>
        ...
        /**
         * <p>The number of clusters to which the policy applies.</p>
         * 
         * <strong>example:</strong>
         * <p>1</p>
         */
        ...
        /**
         * <p>The list of clusters to which the policy applies.</p>
         */
        ...
        /**
         * <p>The container label.</p>
         */
        @NameInMap("Label")
        public java.util.List<String> label;

        /**
         * <p>Specifies whether the rule supports Internet malicious images. Valid values:</p>
         * <ul>
