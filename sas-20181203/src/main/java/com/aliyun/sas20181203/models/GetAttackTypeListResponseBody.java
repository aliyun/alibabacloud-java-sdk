...
public class GetAttackTypeListResponseBody extends TeaModel {
    ...
    /**
     * <p>The ID of the request. The ID is generated by Alibaba Cloud and is a unique identifier used for troubleshooting and locating issues.</p>
     * 
    ...
    public static class GetAttackTypeListResponseBodyAttackTypeList extends TeaModel {
        /**
         * <p>The attack type description.</p>
         * 
         * <strong>example:</strong>
