...
public class GetOssScanConfigResponseBody extends TeaModel {
    ...
    /**
     * <p>The request ID. It is a unique identifier generated by Alibaba Cloud for this request and can be used to troubleshoot issues.</p>
     * 
    ...
    public static class GetOssScanConfigResponseBodyData extends TeaModel {
        ...
        /**
         * <p>The maximum number of files to decompress. The minimum value is 1 and the maximum value is 1000. When the maximum number of decompressed files is exceeded, the decompression operation ends immediately. The scanning of files that have already been decompressed is not affected.</p>
         * 
         * <strong>example:</strong>
         * <p>100</p>
         */
        ...
        /**
         * <p>The maximum number of decompression layers when nested compressed files exist. The minimum value is 1 and the maximum value is 5. When the maximum decompression layer is exceeded, the decompression operation ends immediately. The scanning of files that have already been decompressed is not affected.</p>
         * 
         * <strong>example:</strong>
         * <p>1</p>
         */
        ...
        /**
         * <p>Scans files whose last modification time is after the specified timestamp, in milliseconds.</p>
         * 
         * <strong>example:</strong>
         * <p>1724301769834</p>
         */
        ...
        /**
         * <p>Specifies whether to enable real-time incremental scanning. When this parameter is set to true, the parameters ScanDayList, StartTime, and EndTime do not take effect.</p>
         * 
         * <strong>example:</strong>
         * <p>true</p>
         */
        ...
        /**
         * <p>The scan days. The numbers represent the day of the week.</p>
         */
        ...
        public GetOssScanConfigResponseBodyData setAutoAdd(Integer autoAdd) {
        ...
        public GetOssScanConfigResponseBodyData setAutoAddConfigName(String autoAddConfigName) {
        ...
        public GetOssScanConfigResponseBodyData setSource(String source) {
            this.source = source;
            return this;
        }
