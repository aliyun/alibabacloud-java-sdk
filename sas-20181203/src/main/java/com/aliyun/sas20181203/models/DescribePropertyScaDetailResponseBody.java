...
public class DescribePropertyScaDetailResponseBody extends TeaModel {
    ...
    public static class DescribePropertyScaDetailResponseBodyPageInfo extends TeaModel {
        ...
        /**
         * <p>The number of Asset Fingerprints entries per page in a paged query. Default value: <strong>10</strong>, which indicates that 10 Asset Fingerprints entries are displayed per page.</p>
         * 
         * <strong>example:</strong>
         * <p>20</p>
         */
    ...
    public static class DescribePropertyScaDetailResponseBodyPropertys extends TeaModel {
        ...
        /**
         * <p>The display name of the middleware, database, or web service type. Valid values:
         * &lt;props=&quot;china&quot;&gt;</p>
         * <ul>
         * <li>系统服务</li>
         * <li>软件库</li>
        ...
        /**
         * <p>The timestamp of the latest scan, which is the most recent time when Security Center collected middleware, database, or web service information. Unit: milliseconds.</p>
         * 
         * <strong>example:</strong>
         * <p>1597987834000</p>
         */
