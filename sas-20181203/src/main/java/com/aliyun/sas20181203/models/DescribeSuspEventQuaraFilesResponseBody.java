...
public class DescribeSuspEventQuaraFilesResponseBody extends TeaModel {
    /**
     * <p>The number of quarantined files on the current page.</p>
     * 
    ...
    /**
     * <p>The current page number of the returned file list.</p>
     * 
     * <strong>example:</strong>
     * <p>1</p>
     */
    ...
    /**
     * <p>The maximum number of quarantined files displayed per page.</p>
     * 
     * <strong>example:</strong>
     * <p>20</p>
     */
    ...
    /**
     * <p>The list of quarantined files.</p>
     */
    ...
    public static class DescribeSuspEventQuaraFilesResponseBodyQuaraFiles extends TeaModel {
        ...
        /**
         * <p>The name of the server where the quarantined file is located.</p>
         * 
         * <strong>example:</strong>
        ...
        /**
         * <p>The public IP address of the server where the quarantined file is located.</p>
         * 
         * <strong>example:</strong>
         * <p>47.XX.XX.131</p>
         */
        ...
        /**
         * <p>The private IP address of the server where the quarantined file is located.</p>
         * 
         * <strong>example:</strong>
         * <p>192.168.XX.XX</p>
         */
        ...
        /**
         * <p>The update time. The value is in the YYYY-MM-DD HH:mm:ss format.</p>
         * 
         * <strong>example:</strong>
        ...
        /**
         * <p>The storage path of the quarantined file on the server.</p>
         * 
         * <strong>example:</strong>
        ...
        /**
         * <p>The quarantine status. Valid values:  </p>
         * <ul>
