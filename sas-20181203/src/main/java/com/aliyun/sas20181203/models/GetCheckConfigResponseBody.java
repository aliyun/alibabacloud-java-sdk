...
public class GetCheckConfigResponseBody extends TeaModel {
    ...
    /**
     * <p>The end hour of the check time window, indicating the hour of the day when the check ends. The start time and end time must be within one of the following time ranges:</p>
     * <ul>
    ...
    /**
     * <p>The start hour of the check time window, indicating the hour of the day when the check starts.</p>
     * 
     * <strong>example:</strong>
     * <p>0</p>
     */
