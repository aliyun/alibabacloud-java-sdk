...
public class GetCheckConfigResponseBody extends TeaModel {
     ...
     * <li><strong>18~24</strong>: If the start time is 18, the end time must be set to 24. Unit: hours (h).</li>
     * </ul>
     * 
     * <strong>example:</strong>
     * <p>6</p>
    ...
    /**
     * <p>The start time of the check period, indicating the hour of the day. Unit: hours (h).</p>
     * 
     * <strong>example:</strong>
     * <p>0</p>
     */
    ...
    public static class GetCheckConfigResponseBodyStandards extends TeaModel {
         ...
         * 
         * <strong>example:</strong>
         * <p>Cloud Product Configuration Management</p>
         */
        @NameInMap("ShowName")
         ...
         * <ul>
         * <li><strong>RISK:</strong> Cloud product configuration management.</li>
