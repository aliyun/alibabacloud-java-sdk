...
public class DescribeHoneyPotSuspStatisticsResponseBody extends TeaModel {
    ...
    /**
     * <p>The list of top 5 VPCs or assets ranked by the number of security alerts.</p>
     */
    ...
    public static class DescribeHoneyPotSuspStatisticsResponseBodySuspHoneyPotStatisticsResponse extends TeaModel {
        /**
         * <p>The total number of security alerts on the asset.</p>
         * 
         * <strong>example:</strong>
         * <p>8793</p>
         */
        ...
        /**
         * <p>The server instance ID.</p>
         * <blockquote>
         * <p>This parameter is returned only when the request parameter <strong>StatisticsKeyType</strong> is set to <strong>uuid</strong>.</p>
         * </blockquote>
         * 
         * <strong>example:</strong>
        ...
        /**
         * <p>The Asset Type queried. Valid values:</p>
         * <ul>
         ...
         * <blockquote>
         * <p>This parameter is returned only when the request parameter <strong>StatisticsKeyType</strong> is set to <strong>vpcInstanceId</strong>.</p>
         * </blockquote>
         * 
         * <strong>example:</strong>
        ...
        /**
         * <p>The VPC-connected instance name.</p>
         * <blockquote>
         * <p>This parameter is returned only when the request parameter <strong>StatisticsKeyType</strong> is set to <strong>vpcInstanceId</strong>.</p>
         * </blockquote>
         * 
