...
public class DescribeImageListWithBaselineNameResponseBody extends TeaModel {
    ...
    /**
     * <p>The paging information for the paged query results.</p>
     */
    @NameInMap("PageInfo")
    ...
    public static class DescribeImageListWithBaselineNameResponseBodyImageInfos extends TeaModel {
        ...
        /**
         * <p>The timestamp when the image was created, in milliseconds.</p>
         * 
         * <strong>example:</strong>
         * <p>1636962328000</p>
         */
        ...
        /**
         * <p>The timestamp when the image was updated, in milliseconds.</p>
         * 
         * <strong>example:</strong>
         * <p>1636974116000</p>
         */
        ...
        /**
         * <p>The number of images that do not have baseline risk issues.</p>
         * 
         * <strong>example:</strong>
         * <p>0</p>
         */
         ...
         * <ul>
         * <li><strong>YES</strong>: The image has risks.</li>
         * <li><strong>NO</strong>: The image does not have risks.</li>
         * </ul>
         * 
         * <strong>example:</strong>
         * <p>YES</p>
         ...
         * <ul>
         * <li>** ECS_IMAGE**: image.</li>
         * <li>** ECS_SNAPSHOT**: snapshot.</li>
         * </ul>
         * 
         * <strong>example:</strong>
         * <p>ECS_IMAGE</p>
        ...
        /**
         * <p>The total number of baseline risk items in the image.</p>
         * 
         * <strong>example:</strong>
         * <p>3</p>
         */
    ...
    public static class DescribeImageListWithBaselineNameResponseBodyPageInfo extends TeaModel {
        /**
         * <p>The number of images that have baseline risks on the current page.</p>
         * 
         * <strong>example:</strong>
         * <p>1</p>
         */
        ...
        /**
         * <p>Settings for paging in a paged query. The number of image baseline check results to display per page. Default value: <strong>10</strong>, which indicates that 10 image baseline check results are displayed per page.</p>
         * 
         * <strong>example:</strong>
         * <p>10</p>
         */
        ...
        /**
         * <p>The total number of images that have baseline risks in the image baseline check.</p>
         * 
         * <strong>example:</strong>
         * <p>1</p>
         */
