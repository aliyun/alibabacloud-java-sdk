...
public class DescribeAssetsSecurityEventSummaryResponseBody extends TeaModel {
    /**
     * <p>The container asset risk statistics information list.</p>
     */
    @NameInMap("Assets")
    ...
    public static class DescribeAssetsSecurityEventSummaryResponseBodyAssets extends TeaModel {
         ...
         * <li><strong>clusters</strong>: cluster</li>
         * <li><strong>applications</strong>: application</li>
         * <li><strong>pods</strong>: pod</li>
         * <li><strong>containers</strong>: container</li>
         * <li><strong>images</strong>: image</li>
         * <li><strong>hosts</strong>: node.</li>
         * </ul>
         * 
         * <strong>example:</strong>
         * <p>namespace</p>
        ...
        /**
         * <p>The number of assets that have risks.</p>
         * 
         * <strong>example:</strong>
         * <p>16</p>
         */
