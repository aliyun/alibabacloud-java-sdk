...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    public CreateJenkinsImageRegistryResponse createJenkinsImageRegistryWithOptions(CreateJenkinsImageRegistryRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.sourceIp)) {
            query.put("SourceIp", request.sourceIp);
    ...
    public CreateJenkinsImageScanTaskResponse createJenkinsImageScanTaskWithOptions(CreateJenkinsImageScanTaskRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
    ...
    public ListImageAnalysisRuleProjectResponse listImageAnalysisRuleProjectWithOptions(ListImageAnalysisRuleProjectRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.sourceIp)) {
            query.put("SourceIp", request.sourceIp);
        ...
        Params params = Params.build(TeaConverter.buildMap(
            new TeaPair("action", "ListImageAnalysisRuleProject"),
            new TeaPair("version", "2018-12-03"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new ListImageAnalysisRuleProjectResponse());
    }

    public ListImageAnalysisRuleProjectResponse listImageAnalysisRuleProject(ListImageAnalysisRuleProjectRequest request) throws Exception {
        RuntimeOptions runtime = new RuntimeOptions();
    ...
    public PageImageRegistryResponse pageImageRegistryWithOptions(PageImageRegistryRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.sourceIp)) {
            query.put("SourceIp", request.sourceIp);
    ...
    public QueryJenkinsImageRegistryPersistenceDayResponse queryJenkinsImageRegistryPersistenceDayWithOptions(QueryJenkinsImageRegistryPersistenceDayRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.sourceIp)) {
            query.put("SourceIp", request.sourceIp);
    ...
    public SubmitImageAnalysisOutputResponse submitImageAnalysisOutputWithOptions(SubmitImageAnalysisOutputRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.sourceIp)) {
            query.put("SourceIp", request.sourceIp);
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.isCompress)) {
            body.put("IsCompress", request.isCompress);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.isEncrypt)) {
            body.put("IsEncrypt", request.isEncrypt);
        }
        ...
        Params params = Params.build(TeaConverter.buildMap(
            new TeaPair("action", "SubmitImageAnalysisOutput"),
            new TeaPair("version", "2018-12-03"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new SubmitImageAnalysisOutputResponse());
    }

    public SubmitImageAnalysisOutputResponse submitImageAnalysisOutput(SubmitImageAnalysisOutputRequest request) throws Exception {
        RuntimeOptions runtime = new RuntimeOptions();
    ...
    public UpdateJenkinsImageRegistryNameResponse updateJenkinsImageRegistryNameWithOptions(UpdateJenkinsImageRegistryNameRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.sourceIp)) {
            query.put("SourceIp", request.sourceIp);
    ...
    public UpdateJenkinsImageRegistryPersistenceDayResponse updateJenkinsImageRegistryPersistenceDayWithOptions(UpdateJenkinsImageRegistryPersistenceDayRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.sourceIp)) {
            query.put("SourceIp", request.sourceIp);
    ...
    public UpdateJenkinsImageScanTaskStatusResponse updateJenkinsImageScanTaskStatusWithOptions(UpdateJenkinsImageScanTaskStatusRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.sourceIp)) {
            query.put("SourceIp", request.sourceIp);
        ...
        Params params = Params.build(TeaConverter.buildMap(
            new TeaPair("action", "UpdateJenkinsImageScanTaskStatus"),
            new TeaPair("version", "2018-12-03"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new UpdateJenkinsImageScanTaskStatusResponse());
    }

    public UpdateJenkinsImageScanTaskStatusResponse updateJenkinsImageScanTaskStatus(UpdateJenkinsImageScanTaskStatusRequest request) throws Exception {
        RuntimeOptions runtime = new RuntimeOptions();
        return this.updateJenkinsImageScanTaskStatusWithOptions(request, runtime);
    }

    public UploadAnalyzerRuntimeLogResponse uploadAnalyzerRuntimeLogWithOptions(UploadAnalyzerRuntimeLogRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.sourceIp)) {
            query.put("SourceIp", request.sourceIp);
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.extendedContent)) {
            bodyFlat.put("ExtendedContent", request.extendedContent);
        }
        ...
        Params params = Params.build(TeaConverter.buildMap(
            new TeaPair("action", "UploadAnalyzerRuntimeLog"),
            new TeaPair("version", "2018-12-03"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new UploadAnalyzerRuntimeLogResponse());
    }

    public UploadAnalyzerRuntimeLogResponse uploadAnalyzerRuntimeLog(UploadAnalyzerRuntimeLogRequest request) throws Exception {
        RuntimeOptions runtime = new RuntimeOptions();
