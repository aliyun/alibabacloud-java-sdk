...
public class UpdateMemberResponseBody extends TeaModel {
    ...
    public UpdateMemberResponseBody setCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public UpdateMemberResponseBody setHttpStatusCode(Integer httpStatusCode) {
    ...
    public UpdateMemberResponseBody setMessage(String message) {
