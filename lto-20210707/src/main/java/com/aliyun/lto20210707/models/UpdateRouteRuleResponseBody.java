...
public class UpdateRouteRuleResponseBody extends TeaModel {
    ...
    public UpdateRouteRuleResponseBody setCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public UpdateRouteRuleResponseBody setHttpStatusCode(Integer httpStatusCode) {
    ...
    public UpdateRouteRuleResponseBody setMessage(String message) {
    ...
    public UpdateRouteRuleResponseBody setSuccess(Boolean success) {
