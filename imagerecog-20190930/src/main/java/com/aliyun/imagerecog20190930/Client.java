...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    public RecognizeLogoResponse recognizeLogoWithOptions(RecognizeLogoRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "RecognizeLogo"),
            new TeaPair("version", "2019-09-30"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new RecognizeLogoResponse());
    }
    ...
    public RecognizeLogoResponse recognizeLogoAdvance(RecognizeLogoAdvanceRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        // Step 0: init client
        String accessKeyId = _credential.getAccessKeyId();
        String accessKeySecret = _credential.getAccessKeySecret();
        String securityToken = _credential.getSecurityToken();
        ...
        RecognizeLogoResponse recognizeLogoResp = this.recognizeLogoWithOptions(recognizeLogoReq, runtime);
