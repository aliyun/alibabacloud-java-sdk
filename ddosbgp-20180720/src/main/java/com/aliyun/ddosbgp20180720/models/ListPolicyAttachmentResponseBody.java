...
public class ListPolicyAttachmentResponseBody extends TeaModel {
    /**
     * <p>The list of mitigation policy associations.</p>
     */
    ...
    /**
     * <p>The total number of mitigation policy associations.</p>
     * 
     * <strong>example:</strong>
     * <p>28</p>
     */
    ...
    public static class ListPolicyAttachmentResponseBodyAttachmentList extends TeaModel {
        ...
        /**
         * <p>The UID of the member accounts to which the IP address of the protected object belongs.</p>
         * 
         * <strong>example:</strong>
         * <p>177699790631****</p>
         */
        ...
        /**
         * <p>The current status of the policy. Valid values:</p>
         * <ul>
         * <li><strong>enabled</strong>: Normal and available.</li>
         * <li><strong>disabled</strong>: Abnormal and unavailable.</li>
         * </ul>
         * 
         * <strong>example:</strong>
         * <p>enabled</p>
        ...
        public ListPolicyAttachmentResponseBodyAttachmentList setStatus(String status) {
            this.status = status;
            return this;
        }
