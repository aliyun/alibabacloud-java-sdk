...
public class DeleteBlackholeRequest extends TeaModel {
     ...
     * <br>
     * <p>>  You can call the [DescribePackIpList](https://help.aliyun.com/document_detail/118701.html) operation to query all the IP addresses that are protected by the Anti-DDoS Origin instance and the protection status of the IP addresses. For example, you can query whether blackhole filtering is triggered for an IP address.</p>
     * <br>
     * <p>This parameter is required.</p>
     */
    @NameInMap("Ip")
