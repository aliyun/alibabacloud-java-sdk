...
public class DescribeInstanceSpecsResponse extends TeaModel {
    ...
    public static class DescribeInstanceSpecsResponseInstanceSpecsPackConfig extends TeaModel {
        ...
        public DescribeInstanceSpecsResponseInstanceSpecsPackConfig setNormalBandwidth(Integer normalBandwidth) {
    ...
    public static class DescribeInstanceSpecsResponseInstanceSpecs extends TeaModel {
        ...
        public DescribeInstanceSpecsResponseInstanceSpecs setAvailableDefenseTimes(Integer availableDefenseTimes) {
        ...
        public DescribeInstanceSpecsResponseInstanceSpecs setTotalDefenseTimes(Integer totalDefenseTimes) {
        ...
        public DescribeInstanceSpecsResponseInstanceSpecs setIsFullDefenseMode(Integer isFullDefenseMode) {
