...
public class DescribeInstanceAttributeResponseBody extends TeaModel {
    ...
    public static class DescribeInstanceAttributeResponseBodyInstanceAttribute extends TeaModel {
        ...
        @NameInMap("Ipv6WhiteList")
        public java.util.List<String> ipv6WhiteList;
        ...
        public DescribeInstanceAttributeResponseBodyInstanceAttribute setIpv6WhiteList(java.util.List<String> ipv6WhiteList) {
            this.ipv6WhiteList = ipv6WhiteList;
            return this;
        }
        public java.util.List<String> getIpv6WhiteList() {
