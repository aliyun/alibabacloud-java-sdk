...
public class VisionFlowRequest extends TeaModel {
    ...
    public static VisionFlowRequest build(java.util.Map<String, ?> map) throws Exception {
        VisionFlowRequest self = new VisionFlowRequest();
        return TeaModel.build(map, self);
    }

    public VisionFlowRequest setAbility(java.util.List<Integer> ability) {
    ...
    public VisionFlowRequest setBackGroundType(String backGroundType) {
    ...
    public VisionFlowRequest setGlossary(String glossary) {
    ...
    public VisionFlowRequest setImageUrl(String imageUrl) {
    ...
    public VisionFlowRequest setIncludingProductArea(Boolean includingProductArea) {
    ...
    public VisionFlowRequest setIsFilter(Boolean isFilter) {
    ...
    public VisionFlowRequest setMask(String mask) {
        this.mask = mask;
        return this;
    }
    ...
    public VisionFlowRequest setNonobjectDetectElements(java.util.List<Integer> nonobjectDetectElements) {
    ...
    public VisionFlowRequest setNonobjectRemoveElements(java.util.List<Integer> nonobjectRemoveElements) {
    ...
    public VisionFlowRequest setObjectDetectElements(java.util.List<Integer> objectDetectElements) {
    ...
    public VisionFlowRequest setObjectRemoveElements(java.util.List<Integer> objectRemoveElements) {
    ...
    public VisionFlowRequest setSourceLanguage(String sourceLanguage) {
    ...
    public VisionFlowRequest setTargetHeight(Integer targetHeight) {
    ...
    public VisionFlowRequest setTargetLanguage(String targetLanguage) {
    ...
    public VisionFlowRequest setTargetWidth(Integer targetWidth) {
    ...
    public VisionFlowRequest setTranslatingBrandInTheProduct(Boolean translatingBrandInTheProduct) {
    ...
    public VisionFlowRequest setUpscaleFactor(Integer upscaleFactor) {
