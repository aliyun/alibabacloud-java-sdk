...
public class GetDatasetResponseBody extends TeaModel {
    ...
    public static class GetDatasetResponseBodyData extends TeaModel {
        ...
        public GetDatasetResponseBodyData setDescription(String description) {
        ...
        public GetDatasetResponseBodyData setGmtCreate(Long gmtCreate) {
        ...
        public GetDatasetResponseBodyData setId(Long id) {
            this.id = id;
            return this;
        }
        public Long getId() {
        ...
        public GetDatasetResponseBodyData setName(String name) {
            this.name = name;
            return this;
        }
        ...
        public GetDatasetResponseBodyData setOssUrl(String ossUrl) {
            this.ossUrl = ossUrl;
            return this;
        }
        ...
        public GetDatasetResponseBodyData setOwnerType(String ownerType) {
        ...
        public GetDatasetResponseBodyData setTotal(Long total) {
            this.total = total;
            return this;
        }
