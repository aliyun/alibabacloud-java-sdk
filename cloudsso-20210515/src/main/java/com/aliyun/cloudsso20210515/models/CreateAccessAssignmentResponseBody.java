...
public class CreateAccessAssignmentResponseBody extends TeaModel {
    ...
    public static class CreateAccessAssignmentResponseBodyTask extends TeaModel {
        ...
        /**
         * <p>The type of the task. The value is fixed as CreateAccessAssignment, which indicates that access permissions on an account in your resource directory are assigned.</p>
         */
        @NameInMap("TaskType")
