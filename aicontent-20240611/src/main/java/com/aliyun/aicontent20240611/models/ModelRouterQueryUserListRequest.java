...
public class ModelRouterQueryUserListRequest extends TeaModel {
    /**
    ...
    public ModelRouterQueryUserListRequest setKeyword(String keyword) {
    ...
    public ModelRouterQueryUserListRequest setPageIndex(Integer pageIndex) {
    ...
    public ModelRouterQueryUserListRequest setPageSize(Integer pageSize) {
