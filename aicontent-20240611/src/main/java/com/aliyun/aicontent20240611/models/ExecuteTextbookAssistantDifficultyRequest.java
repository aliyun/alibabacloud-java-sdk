...
public class ExecuteTextbookAssistantDifficultyRequest extends TeaModel {
    /**
     * <p>The type of difficulty adjustment.</p>
    ...
    /**
     * <p>The ID of the message generated by the AI assistant.</p>
     * <p>This parameter is required.</p>
     * 
     * <strong>example:</strong>
    ...
    /**
     * <p>The authorization token for the API call. Obtain this token by calling the relevant authorization API.</p>
     * <p>This parameter is required.</p>
     * 
     * <strong>example:</strong>
    ...
    /**
     * <p>The ID of the current dialogue.</p>
     * <p>This parameter is required.</p>
     * 
     * <strong>example:</strong>
    ...
    /**
     * <p>The interaction scenario. Specify <code>SYNC</code> for a Sync exercise or <code>EXPAND</code> for an Expansion exercise.</p>
     * <p>This parameter is required.</p>
     * 
     * <strong>example:</strong>
     * <p>SYNC</p>
