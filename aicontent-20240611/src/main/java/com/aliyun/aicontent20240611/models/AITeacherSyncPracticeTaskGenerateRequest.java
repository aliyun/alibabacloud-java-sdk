...
public class AITeacherSyncPracticeTaskGenerateRequest extends TeaModel {
    ...
    public static AITeacherSyncPracticeTaskGenerateRequest build(java.util.Map<String, ?> map) throws Exception {
        AITeacherSyncPracticeTaskGenerateRequest self = new AITeacherSyncPracticeTaskGenerateRequest();
        return TeaModel.build(map, self);
    }

    public AITeacherSyncPracticeTaskGenerateRequest setGrade(String grade) {
        this.grade = grade;
        return this;
    }
    ...
    public AITeacherSyncPracticeTaskGenerateRequest setKeySentences(java.util.List<String> keySentences) {
    ...
    public AITeacherSyncPracticeTaskGenerateRequest setKeyWords(java.util.List<String> keyWords) {
    ...
    public AITeacherSyncPracticeTaskGenerateRequest setLearningObject(String learningObject) {
    ...
    public AITeacherSyncPracticeTaskGenerateRequest setTextContent(String textContent) {
    ...
    public AITeacherSyncPracticeTaskGenerateRequest setTextbook(String textbook) {
    ...
    public AITeacherSyncPracticeTaskGenerateRequest setTopic(String topic) {
        this.topic = topic;
        return this;
    }
    ...
    public AITeacherSyncPracticeTaskGenerateRequest setUserId(String userId) {
        this.userId = userId;
        return this;
    }
