...
public class QueryJobsWithResultResponseBody extends TeaModel {
     ...
     * <blockquote>
     * <p>Displays all label information with enumerated values in the job group.</p>
     * </blockquote>
     */
    @NameInMap("Labels")
    ...
    public static class QueryJobsWithResultResponseBodyJobsListLatestTaskContact extends TeaModel {
        /**
         * <p>The honorific for the contact. If not specified, it defaults to the same value as the name.</p>
         * <blockquote>
         * <p>Custom-defined by the customer. Passed in JSON format when calling the API to execute an outbound call task.</p>
         * </blockquote>
         * 
         * <strong>example:</strong>
         * <p>张先生</p>
        ...
        /**
         * <p>The contact ID. A unique identifier generated by the system when the outbound call list is uploaded.</p>
         * 
         * <strong>example:</strong>
        ...
        /**
         * <p>The phone number specified by the callee during the conversation. If provided, this number is actually dialed.</p>
         * <blockquote>
         * <p>Custom-defined by the customer. Passed in JSON format when calling the API to execute an outbound call task.</p>
         * </blockquote>
         * 
        ...
        /**
         * <p>The contact ID uploaded by the customer. This must be provided by the business side to avoid duplicate name issues.</p>
         * 
         * <strong>example:</strong>
         * <p>C01</p>
         */
        ...
        /**
         * <p>The role of the contact in this outbound call scenario. If not specified, no role distinction is made. For example, in a debt collection scenario, contact roles can include borrower, co-borrower, and guarantor.</p>
         * <blockquote>
         * <p>Custom-defined by the customer. Passed in JSON format when calling the API.</p>
         * </blockquote>
         * 
         * <strong>example:</strong>
         * <p>借款人</p>
        ...
        /**
         * <p>The status of the contact, such as Available, WrongNumber, or DoesNotExist.</p>
         * <blockquote>
         * <p>Custom-defined by the customer. Passed in JSON format when calling the API to execute an outbound call task.</p>
         * </blockquote>
         * 
    ...
    public static class QueryJobsWithResultResponseBodyJobsList extends TeaModel {
         ...
         * <li>Succeeded(2, &quot;Ended - Reached&quot;)</li>
         * <li>Paused(3, &quot;Paused&quot;)</li>
         * <li>Failed(4, &quot;Ended - Not reached&quot;)</li>
