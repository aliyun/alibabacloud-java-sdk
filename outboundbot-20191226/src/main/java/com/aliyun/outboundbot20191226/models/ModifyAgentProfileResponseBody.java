...
public class ModifyAgentProfileResponseBody extends TeaModel {
    ...
    public static class ModifyAgentProfileResponseBodyData extends TeaModel {
        ...
        /**
         * <p>NLU configuration, parameter settings:</p>
         * <ul>
         * <li><p>chatbotInstanceId Xiaomi Large Language Model (LLM) robot instance ID</p>
         * </li>
         * <li><p>faqCategoryIds bound FAQ category ID</p>
         * </li>
         * <li><p>llmAgentId Xiaomi Large Language Model (LLM) workspace ID</p>
         * </li>
         * <li><p>llmAgentKey Xiaomi Large Language Model (LLM) workspace key</p>
         * </li>
         * <li><p>llmAgentInstanceId Xiaomi Large Language Model (LLM) workspace instance ID</p>
         * </li>
         * </ul>
         * 
         * <strong>example:</strong>
