...
public class RefreshNodeGroupNodesRequest extends TeaModel {
    /**
    ...
    public static RefreshNodeGroupNodesRequest build(java.util.Map<String, ?> map) throws Exception {
        RefreshNodeGroupNodesRequest self = new RefreshNodeGroupNodesRequest();
        return TeaModel.build(map, self);
    }

    public RefreshNodeGroupNodesRequest setMaxDisruptiveAction(String maxDisruptiveAction) {
    ...
    public RefreshNodeGroupNodesRequest setNodeGroupId(String nodeGroupId) {
    ...
    public RefreshNodeGroupNodesRequest setNodeIds(java.util.List<String> nodeIds) {
