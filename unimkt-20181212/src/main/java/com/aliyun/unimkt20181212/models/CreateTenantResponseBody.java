...
public class CreateTenantResponseBody extends TeaModel {
    ...
    public static class CreateTenantResponseBodyModel extends TeaModel {
        ...
        public CreateTenantResponseBodyModel setBusiness(String business) {
        ...
        public CreateTenantResponseBodyModel setCreateTime(Long createTime) {
        ...
        public CreateTenantResponseBodyModel setExtInfo(String extInfo) {
        ...
        public CreateTenantResponseBodyModel setModifyTime(Long modifyTime) {
        ...
        public CreateTenantResponseBodyModel setSettleInfo(String settleInfo) {
        ...
        public CreateTenantResponseBodyModel setStatus(String status) {
            this.status = status;
            return this;
        }
        ...
        public CreateTenantResponseBodyModel setTenantDescription(String tenantDescription) {
        ...
        public CreateTenantResponseBodyModel setTenantName(String tenantName) {
        ...
        public CreateTenantResponseBodyModel setUserName(String userName) {
