...
public class ListAgentStatesResponseBody extends TeaModel {
    ...
    public static class ListAgentStatesResponseBodyDataListRealTimeAgentState extends TeaModel {
        ...
        public ListAgentStatesResponseBodyDataListRealTimeAgentState setAgentName(String agentName) {
    ...
    public static class ListAgentStatesResponseBodyDataList extends TeaModel {
        ...
        public java.util.List<ListAgentStatesResponseBodyDataListRealTimeAgentState> realTimeAgentState;
        ...
        public ListAgentStatesResponseBodyDataList setRealTimeAgentState(java.util.List<ListAgentStatesResponseBodyDataListRealTimeAgentState> realTimeAgentState) {
            this.realTimeAgentState = realTimeAgentState;
            return this;
        }
        public java.util.List<ListAgentStatesResponseBodyDataListRealTimeAgentState> getRealTimeAgentState() {
    ...
    public static class ListAgentStatesResponseBodyData extends TeaModel {
        @NameInMap("List")
        public ListAgentStatesResponseBodyDataList list;
        ...
        public ListAgentStatesResponseBodyData setList(ListAgentStatesResponseBodyDataList list) {
            this.list = list;
            return this;
        }
        public ListAgentStatesResponseBodyDataList getList() {
            return this.list;
        }
