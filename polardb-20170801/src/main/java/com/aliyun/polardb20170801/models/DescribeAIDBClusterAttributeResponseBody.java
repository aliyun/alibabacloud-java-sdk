...
public class DescribeAIDBClusterAttributeResponseBody extends TeaModel {
    ...
    public DescribeAIDBClusterAttributeResponseBody setDedicatedHostModel(Boolean dedicatedHostModel) {
    ...
    public DescribeAIDBClusterAttributeResponseBody setInferenceEngine(String inferenceEngine) {
