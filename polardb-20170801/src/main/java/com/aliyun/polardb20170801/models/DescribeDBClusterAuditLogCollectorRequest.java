...
public class DescribeDBClusterAuditLogCollectorRequest extends TeaModel {
    ...
    public DescribeDBClusterAuditLogCollectorRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public DescribeDBClusterAuditLogCollectorRequest setResourceOwnerId(Long resourceOwnerId) {
