...
public class DescribeDBClusterPriceShrinkRequest extends TeaModel {
    /**
    ...
    public static DescribeDBClusterPriceShrinkRequest build(java.util.Map<String, ?> map) throws Exception {
        DescribeDBClusterPriceShrinkRequest self = new DescribeDBClusterPriceShrinkRequest();
        return TeaModel.build(map, self);
    }

    public DescribeDBClusterPriceShrinkRequest setCreationCategory(String creationCategory) {
    ...
    public DescribeDBClusterPriceShrinkRequest setDBClusterId(String DBClusterId) {
    ...
    public DescribeDBClusterPriceShrinkRequest setDBNodeClass(String DBNodeClass) {
    ...
    public DescribeDBClusterPriceShrinkRequest setDBNodeIds(java.util.List<String> DBNodeIds) {
    ...
    public DescribeDBClusterPriceShrinkRequest setDBNodeNum(Integer DBNodeNum) {
    ...
    public DescribeDBClusterPriceShrinkRequest setDBNodesShrink(String DBNodesShrink) {
    ...
    public DescribeDBClusterPriceShrinkRequest setDBType(String DBType) {
        this.DBType = DBType;
        return this;
    }
    ...
    public DescribeDBClusterPriceShrinkRequest setDBVersion(String DBVersion) {
    ...
    public DescribeDBClusterPriceShrinkRequest setHotStandbyCluster(String hotStandbyCluster) {
    ...
    public DescribeDBClusterPriceShrinkRequest setModifyType(String modifyType) {
    ...
    public DescribeDBClusterPriceShrinkRequest setOrderType(String orderType) {
    ...
    public DescribeDBClusterPriceShrinkRequest setPayType(String payType) {
    ...
    public DescribeDBClusterPriceShrinkRequest setPeriod(String period) {
        this.period = period;
        return this;
    }
    ...
    public DescribeDBClusterPriceShrinkRequest setProvisionedIops(String provisionedIops) {
    ...
    public DescribeDBClusterPriceShrinkRequest setRegionId(String regionId) {
    ...
    public DescribeDBClusterPriceShrinkRequest setServerlessType(String serverlessType) {
    ...
    public DescribeDBClusterPriceShrinkRequest setStorageChargeType(String storageChargeType) {
    ...
    public DescribeDBClusterPriceShrinkRequest setStorageSpace(String storageSpace) {
    ...
    public DescribeDBClusterPriceShrinkRequest setStorageType(String storageType) {
    ...
    public DescribeDBClusterPriceShrinkRequest setUsedTime(String usedTime) {
    ...
    public DescribeDBClusterPriceShrinkRequest setZoneId(String zoneId) {
        this.zoneId = zoneId;
        return this;
    }
