...
public class ListComponentVersionsResponseBody extends TeaModel {
    ...
    public ListComponentVersionsResponseBody setErrCode(String errCode) {
    ...
    public ListComponentVersionsResponseBody setErrMsg(String errMsg) {
        this.errMsg = errMsg;
        return this;
    }
    ...
    public ListComponentVersionsResponseBody setSuccess(Boolean success) {
    ...
    public static class ListComponentVersionsResponseBodyDataList extends TeaModel {
        ...
        public ListComponentVersionsResponseBodyDataList setProvider(String provider) {
