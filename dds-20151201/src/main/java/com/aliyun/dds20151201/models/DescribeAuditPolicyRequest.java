...
public class DescribeAuditPolicyRequest extends TeaModel {
    ...
    public DescribeAuditPolicyRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public DescribeAuditPolicyRequest setResourceOwnerId(Long resourceOwnerId) {
