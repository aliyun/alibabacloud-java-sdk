...
public class CreateDBInstanceRequest extends TeaModel {
    ...
    /**
     * <p>Template for global IP whitelist of the instance, multiple IP whitelist templates should be separated by a comma (,) in English and cannot be repeated. (In function gray scale).</p>
     */
