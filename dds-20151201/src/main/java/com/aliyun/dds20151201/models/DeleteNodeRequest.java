...
public class DeleteNodeRequest extends TeaModel {
    ...
    /**
     * <p>The ID of the shard or mongos node that you want to delete. You can call the <a href="https://help.aliyun.com/document_detail/61923.html">DescribeDBInstanceAttribute</a> operation to query node IDs.</p>
     * <p>This parameter is required.</p>
     * 
     * <strong>example:</strong>
     * <p>s-bpxxxxxxxx</p>
    ...
    public DeleteNodeRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public DeleteNodeRequest setResourceOwnerId(Long resourceOwnerId) {
