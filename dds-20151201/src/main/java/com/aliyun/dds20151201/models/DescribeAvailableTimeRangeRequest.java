...
public class DescribeAvailableTimeRangeRequest extends TeaModel {
    ...
    public DescribeAvailableTimeRangeRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public DescribeAvailableTimeRangeRequest setResourceOwnerId(Long resourceOwnerId) {
