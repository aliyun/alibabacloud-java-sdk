...
public class ListSessionClustersResponseBody extends TeaModel {
    /**
     * <p>The list of session clusters. This parameter is empty if the request fails.</p>
     */
    @NameInMap("data")
    ...
    /**
     * <p>The HTTP status code. A value of 200 is always returned. Use the \<code>success\\</code> parameter to determine if the request was successful.</p>
     * 
     * <strong>example:</strong>
     * <p>200</p>
     */
