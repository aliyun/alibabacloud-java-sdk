...
public class CreateDeploymentTargetResponseBody extends TeaModel {
    /**
     * <p>The data structure that represents the created deployment target.</p>
     */
    @NameInMap("data")
    public DeploymentTarget data;

    /**
     * <p>The error code. This parameter is returned only when the request fails. If the request is successful, this parameter is empty.</p>
     * 
    ...
    /**
     * <p>The error message. This parameter is returned only when the request fails. If the request is successful, this parameter is empty.</p>
     * 
     * <strong>example:</strong>
     * <p>&quot;&quot;</p>
     */
    ...
    /**
     * <p>The business status code. A value of 200 is always returned. Use the success parameter to determine whether the request was successful.</p>
     * 
     * <strong>example:</strong>
     * <p>200</p>
     */
