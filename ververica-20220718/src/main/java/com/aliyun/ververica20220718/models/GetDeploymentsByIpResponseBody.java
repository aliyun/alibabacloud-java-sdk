...
public class GetDeploymentsByIpResponseBody extends TeaModel {
    ...
    /**
     * <p>The error code. This parameter is returned only when success is false. If success is true, this parameter is empty.</p>
     * 
    ...
    /**
     * <p>The error message. This parameter is returned only when success is false. If success is true, this parameter is empty.</p>
     * 
     * <strong>example:</strong>
     * <p>&quot;&quot;</p>
     */
    ...
    /**
     * <p>The HTTP status code. A value of 200 indicates that the request was successful. Use the success parameter to determine whether the business request was successful.</p>
     * 
     * <strong>example:</strong>
     * <p>200</p>
     */
