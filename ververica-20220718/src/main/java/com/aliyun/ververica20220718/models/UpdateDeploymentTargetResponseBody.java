...
public class UpdateDeploymentTargetResponseBody extends TeaModel {
    /**
     * <p>The updated deployment target.</p>
     */
    @NameInMap("data")
    ...
    /**
     * <p>The HTTP status code. A value of 200 is always returned. Use the \<code>success\\</code> parameter to determine whether the request was successful.</p>
     * 
     * <strong>example:</strong>
     * <p>200</p>
     */
