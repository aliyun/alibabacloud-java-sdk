...
public class GetAppliedScheduledPlanResponseBody extends TeaModel {
    /**
     * <p>The scheduled plan for the application.</p>
     */
    @NameInMap("data")
    public ScheduledPlanAppliedInfo data;

    /**
     * <p>The error code. This parameter is returned if the request fails. If the request is successful, this parameter is empty.</p>
     * 
    ...
    /**
     * <p>The error message. This parameter is returned if the request fails. If the request is successful, this parameter is empty.</p>
     * 
     * <strong>example:</strong>
     * <p>&quot;&quot;</p>
     */
