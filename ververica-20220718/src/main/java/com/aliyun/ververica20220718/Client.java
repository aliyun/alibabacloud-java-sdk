...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    /**
     * <b>summary</b> : 
     * <p>This operation applies a scheduled plan.</p>
     * 
     ...
     */
    public CancelSqlPreviewResponse cancelSqlPreviewWithOptions(String namespace, CancelSqlPreviewRequest request, CancelSqlPreviewHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.sessionClusterName)) {
            query.put("sessionClusterName", request.sessionClusterName);
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "CancelSqlPreview"),
            new TeaPair("version", "2022-07-18"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/api/v2/namespaces/" + com.aliyun.openapiutil.Client.getEncodeParam(namespace) + "/sql-preview/cancel"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new CancelSqlPreviewResponse());
    }
     ...
     * @return CancelSqlPreviewResponse
     */
    public CancelSqlPreviewResponse cancelSqlPreview(String namespace, CancelSqlPreviewRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        CancelSqlPreviewHeaders headers = new CancelSqlPreviewHeaders();
        return this.cancelSqlPreviewWithOptions(namespace, request, headers, runtime);
    }
    ...
    /**
     * <b>summary</b> : 
     * <p>Creates a draft for an SQL or data ingestion job.</p>
     * 
    ...
    /**
     * <b>description</b> :
     * <p>The previous API for creating deployment targets supported only fixed or elastic resources. This new API supports fixed resources, elastic resources, and mixed mode.</p>
     * 
     * <b>summary</b> : 
     * <p>Creates a deployment target.</p>
     * 
     ...
     */
    public CreateDeploymentTargetV2Response createDeploymentTargetV2WithOptions(String namespace, CreateDeploymentTargetV2Request request, CreateDeploymentTargetV2Headers headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.deploymentTargetName)) {
            query.put("deploymentTargetName", request.deploymentTargetName);
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "CreateDeploymentTargetV2"),
            new TeaPair("version", "2022-07-18"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/api/v2/namespaces/" + com.aliyun.openapiutil.Client.getEncodeParam(namespace) + "/deployment-targets/support-elastic"),
            new TeaPair("method", "POST"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "json"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new CreateDeploymentTargetV2Response());
    }
     ...
     * @return CreateDeploymentTargetV2Response
     */
    public CreateDeploymentTargetV2Response createDeploymentTargetV2(String namespace, CreateDeploymentTargetV2Request request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        CreateDeploymentTargetV2Headers headers = new CreateDeploymentTargetV2Headers();
        return this.createDeploymentTargetV2WithOptions(namespace, request, headers, runtime);
    }
    ...
    /**
     * <b>description</b> :
     * <p>The original interface for creating deployment targets only supports creating deployment targets with fixed resources or elastic resources. The new interface supports creating deployment targets with fixed resources, elastic resources, or mixed pattern.</p>
     * 
     * <b>summary</b> : 
     * <p>Creates a SQL query script job file.</p>
     * 
     ...
     */
    public CreateSqlFileResponse createSqlFileWithOptions(String namespace, CreateSqlFileRequest request, CreateSqlFileHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, String> realHeaders = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(headers.commonHeaders)) {
            realHeaders = headers.commonHeaders;
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "CreateSqlFile"),
            new TeaPair("version", "2022-07-18"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/api/v2/namespaces/" + com.aliyun.openapiutil.Client.getEncodeParam(namespace) + "/sql-file"),
            new TeaPair("method", "POST"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "json"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new CreateSqlFileResponse());
    }
     ...
     * @return CreateSqlFileResponse
     */
    public CreateSqlFileResponse createSqlFile(String namespace, CreateSqlFileRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        CreateSqlFileHeaders headers = new CreateSqlFileHeaders();
        return this.createSqlFileWithOptions(namespace, request, headers, runtime);
    }
    ...
    /**
     * <b>description</b> :
     * <p>Deletes the deployment instance information of a job in a specified workspace and namespace based on the deployed job name. This operation is applicable to scenarios where you want to quickly locate job details by deployment identifier.</p>
     * 
     * <b>summary</b> : 
     * <p>Deletes the deployment instance information of a job in a specified workspace and namespace based on the deployed job name.</p>
     * 
     ...
     */
    public DeleteDeploymentByNameResponse deleteDeploymentByNameWithOptions(String namespace, DeleteDeploymentByNameRequest request, DeleteDeploymentByNameHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "DeleteDeploymentByName"),
            new TeaPair("version", "2022-07-18"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/api/v2/namespaces/" + com.aliyun.openapiutil.Client.getEncodeParam(namespace) + "/deployments/deleteDeployment/byName"),
            new TeaPair("method", "DELETE"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "json"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new DeleteDeploymentByNameResponse());
    }
     ...
     * @return DeleteDeploymentByNameResponse
     */
    public DeleteDeploymentByNameResponse deleteDeploymentByName(String namespace, DeleteDeploymentByNameRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        DeleteDeploymentByNameHeaders headers = new DeleteDeploymentByNameHeaders();
        return this.deleteDeploymentByNameWithOptions(namespace, request, headers, runtime);
    }

    /**
     * <b>summary</b> : 
     * <p>Deletes a draft of an SQL or data ingestion job. The draft cannot be deleted if it has any published or running deployment.</p>
     * 
    ...
    /**
     * <b>description</b> :
     * <p>Queries the list of deployed jobs that are associated with a specified job label and their details. Exact matching by labelKey and labelValue is supported.</p>
     * 
     * <b>summary</b> : 
     * <p>Deletes a created SQL query script file.</p>
     * 
     ...
     */
    public DeleteSqlFileResponse deleteSqlFileWithOptions(String namespace, String sqlFileId, DeleteSqlFileRequest request, DeleteSqlFileHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, String> realHeaders = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(headers.commonHeaders)) {
            realHeaders = headers.commonHeaders;
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "DeleteSqlFile"),
            new TeaPair("version", "2022-07-18"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/api/v2/namespaces/" + com.aliyun.openapiutil.Client.getEncodeParam(namespace) + "/sql-file/" + com.aliyun.openapiutil.Client.getEncodeParam(sqlFileId) + ""),
            new TeaPair("method", "DELETE"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "json"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new DeleteSqlFileResponse());
    }
     ...
     * @return DeleteSqlFileResponse
     */
    public DeleteSqlFileResponse deleteSqlFile(String namespace, String sqlFileId, DeleteSqlFileRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        DeleteSqlFileHeaders headers = new DeleteSqlFileHeaders();
        return this.deleteSqlFileWithOptions(namespace, sqlFileId, request, headers, runtime);
    }

    /**
     * <b>summary</b> : 
     * <p>Deletes a user-defined function (UDF) resource. You must delete all UDFs registered with the resource before you can delete the resource.</p>
     * 
    ...
    /**
     * <b>summary</b> : 
     * <p>Deploys a draft of an SQL job.</p>
     * 
    ...
    /**
     * <b>summary</b> : 
     * <p>Retrieves the execution result of an SQL data query submitted through the platform.</p>
     * 
     ...
     */
    public FetchSqlExecutionResultResponse fetchSqlExecutionResultWithOptions(String namespace, String sqlExecutionId, FetchSqlExecutionResultRequest request, FetchSqlExecutionResultHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, String> realHeaders = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(headers.commonHeaders)) {
            realHeaders = headers.commonHeaders;
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "FetchSqlExecutionResult"),
            new TeaPair("version", "2022-07-18"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/api/v2/namespaces/" + com.aliyun.openapiutil.Client.getEncodeParam(namespace) + "/sql-execution/" + com.aliyun.openapiutil.Client.getEncodeParam(sqlExecutionId) + "%3AfetchSqlExecutionResult"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new FetchSqlExecutionResultResponse());
    }
     ...
     * @return FetchSqlExecutionResultResponse
     */
    public FetchSqlExecutionResultResponse fetchSqlExecutionResult(String namespace, String sqlExecutionId, FetchSqlExecutionResultRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        FetchSqlExecutionResultHeaders headers = new FetchSqlExecutionResultHeaders();
        return this.fetchSqlExecutionResultWithOptions(namespace, sqlExecutionId, request, headers, runtime);
    }
     ...
     */
    public FetchSqlPreviewResultsResponse fetchSqlPreviewResultsWithOptions(String namespace, FetchSqlPreviewResultsRequest request, FetchSqlPreviewResultsHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.queryId)) {
            query.put("queryId", request.queryId);
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "FetchSqlPreviewResults"),
            new TeaPair("version", "2022-07-18"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/api/v2/namespaces/" + com.aliyun.openapiutil.Client.getEncodeParam(namespace) + "/sql-preview/fetchResults"),
            new TeaPair("method", "GET"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "json"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new FetchSqlPreviewResultsResponse());
    }
     ...
     * @return FetchSqlPreviewResultsResponse
     */
    public FetchSqlPreviewResultsResponse fetchSqlPreviewResults(String namespace, FetchSqlPreviewResultsRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        FetchSqlPreviewResultsHeaders headers = new FetchSqlPreviewResultsHeaders();
        return this.fetchSqlPreviewResultsWithOptions(namespace, request, headers, runtime);
    }
    ...
    /**
     * <b>summary</b> : 
     * <p>Retrieves the execution plan for an application.</p>
     * 
    ...
    /**
     * <b>summary</b> : 
     * <p>Checks the deployment result of a job draft.</p>
     * 
    ...
    /**
     * <b>summary</b> : 
     * <p>Retrieves the details of an SQL or data ingestion job draft.</p>
     * 
    ...
    /**
     * <b>summary</b> : 
     * <p>Before using an API to edit, validate, or deploy a job draft, you must acquire an edit lock to prevent conflicts between user interface (UI) and API operations. Acquiring this lock requires either the &quot;Develop SQL/YAML Job (Create, Edit)&quot; or &quot;Unlock SQL/YAML Job Draft&quot; permission.</p>
     * 
    ...
    /**
     * <b>description</b> :
     * <p>Use this operation to query for associated Flink deployments based on the source or destination IP address and port of a network connection.</p>
     * 
     * <b>summary</b> : 
     * <p>Gets a list of deployed jobs and their information on a node by a specified IP address.</p>
     * 
     ...
     */
    public GetDeploymentsByIpResponse getDeploymentsByIpWithOptions(String namespace, GetDeploymentsByIpRequest request, GetDeploymentsByIpHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.ignoreJobSummary)) {
            query.put("ignoreJobSummary", request.ignoreJobSummary);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.ignoreResourceSetting)) {
            query.put("ignoreResourceSetting", request.ignoreResourceSetting);
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "GetDeploymentsByIp"),
            new TeaPair("version", "2022-07-18"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/api/v2/namespaces/" + com.aliyun.openapiutil.Client.getEncodeParam(namespace) + "/deployments/getDeployments/byIp"),
            new TeaPair("method", "GET"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "json"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new GetDeploymentsByIpResponse());
    }
     ...
     * @return GetDeploymentsByIpResponse
     */
    public GetDeploymentsByIpResponse getDeploymentsByIp(String namespace, GetDeploymentsByIpRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        GetDeploymentsByIpHeaders headers = new GetDeploymentsByIpHeaders();
        return this.getDeploymentsByIpWithOptions(namespace, request, headers, runtime);
    }

    /**
     * <b>description</b> :
     * <p>Queries a list of deployed jobs and their details by a specified job label. The query performs an exact match on the <code>labelKey</code> and <code>labelValue</code>.</p>
     * 
     * <b>summary</b> : 
     * <p>Queries a list of deployed jobs and their information by a specified label.</p>
     * 
     ...
     */
    public GetDeploymentsByLabelResponse getDeploymentsByLabelWithOptions(String namespace, GetDeploymentsByLabelRequest request, GetDeploymentsByLabelHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.ignoreJobSummary)) {
            query.put("ignoreJobSummary", request.ignoreJobSummary);
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "GetDeploymentsByLabel"),
            new TeaPair("version", "2022-07-18"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/api/v2/namespaces/" + com.aliyun.openapiutil.Client.getEncodeParam(namespace) + "/deployments/getDeployments/byLabel"),
            new TeaPair("method", "GET"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "json"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new GetDeploymentsByLabelResponse());
    }
     ...
     * @return GetDeploymentsByLabelResponse
     */
    public GetDeploymentsByLabelResponse getDeploymentsByLabel(String namespace, GetDeploymentsByLabelRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        GetDeploymentsByLabelHeaders headers = new GetDeploymentsByLabelHeaders();
        return this.getDeploymentsByLabelWithOptions(namespace, request, headers, runtime);
    }

    /**
     * <b>summary</b> : 
     * <p>Retrieves deployed job instances by name from a specified workspace and namespace.</p>
     * 
     ...
     */
    public GetDeploymentsByNameResponse getDeploymentsByNameWithOptions(String namespace, String deploymentName, GetDeploymentsByNameRequest request, GetDeploymentsByNameHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.ignoreJobSummary)) {
            query.put("ignoreJobSummary", request.ignoreJobSummary);
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "GetDeploymentsByName"),
            new TeaPair("version", "2022-07-18"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/api/v2/namespaces/" + com.aliyun.openapiutil.Client.getEncodeParam(namespace) + "/deployments/name/" + com.aliyun.openapiutil.Client.getEncodeParam(deploymentName) + ""),
            new TeaPair("method", "GET"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "json"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new GetDeploymentsByNameResponse());
    }
     ...
     * @return GetDeploymentsByNameResponse
     */
    public GetDeploymentsByNameResponse getDeploymentsByName(String namespace, String deploymentName, GetDeploymentsByNameRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        GetDeploymentsByNameHeaders headers = new GetDeploymentsByNameHeaders();
        return this.getDeploymentsByNameWithOptions(namespace, deploymentName, request, headers, runtime);
    }

    /**
     * <b>summary</b> : 
     * <p>Retrieves runtime events.</p>
     * 
    ...
    /**
     * <b>summary</b> : 
     * <p>Retrieves the result of a hot update for a job.</p>
     * 
    ...
    /**
     * <b>summary</b> : 
     * <p>Retrieves detailed information about a job instance.</p>
     * 
    ...
    /**
     * <b>summary</b> : 
     * <p>Performs intelligent diagnostics on a job and retrieves information about abnormal diagnostic items.</p>
     * 
    ...
    /**
     * <b>summary</b> : 
     * <p>Retrieves a session cluster.</p>
     * 
    ...
    /**
     * <b>summary</b> : 
     * <p>Retrieves the details of a created SQL query script.</p>
     * 
     ...
     */
    public GetSqlFileResponse getSqlFileWithOptions(String namespace, String sqlFileId, GetSqlFileRequest request, GetSqlFileHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, String> realHeaders = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(headers.commonHeaders)) {
            realHeaders = headers.commonHeaders;
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new GetSqlFileResponse());
    }
     ...
     * @return GetSqlFileResponse
     */
    public GetSqlFileResponse getSqlFile(String namespace, String sqlFileId, GetSqlFileRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        GetSqlFileHeaders headers = new GetSqlFileHeaders();
        return this.getSqlFileWithOptions(namespace, sqlFileId, request, headers, runtime);
    }
    ...
    /**
     * <b>summary</b> : 
     * <p>Queries the depth validation result of a job draft by ticket ID.</p>
     * 
     * @param headers GetValidateDeploymentDraftResultHeaders
     * @param runtime runtime options for this request RuntimeOptions
     * @return GetValidateDeploymentDraftResultResponse
     */
    public GetValidateDeploymentDraftResultResponse getValidateDeploymentDraftResultWithOptions(String namespace, String ticketId, GetValidateDeploymentDraftResultHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        java.util.Map<String, String> realHeaders = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(headers.commonHeaders)) {
            realHeaders = headers.commonHeaders;
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "GetValidateDeploymentDraftResult"),
            new TeaPair("version", "2022-07-18"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/api/v2/namespaces/" + com.aliyun.openapiutil.Client.getEncodeParam(namespace) + "/deployment-drafts/tickets/" + com.aliyun.openapiutil.Client.getEncodeParam(ticketId) + "/async-validate"),
            new TeaPair("method", "GET"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "json"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new GetValidateDeploymentDraftResultResponse());
    }
     ...
     * @return GetValidateDeploymentDraftResultResponse
     */
    public GetValidateDeploymentDraftResultResponse getValidateDeploymentDraftResult(String namespace, String ticketId) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        GetValidateDeploymentDraftResultHeaders headers = new GetValidateDeploymentDraftResultHeaders();
        return this.getValidateDeploymentDraftResultWithOptions(namespace, ticketId, headers, runtime);
    }
    ...
    /**
     * <b>summary</b> : 
     * <p>Retrieves a list of SQL or data ingestion job drafts.</p>
     * 
    ...
    /**
     * <b>summary</b> : 
     * <p>Retrieve information about all deployed jobs.</p>
     * 
    ...
    /**
     * <b>summary</b> : 
     * <p>Retrieves information about all job instances for a specified deployment.</p>
     * 
    ...
    /**
     * <b>summary</b> : 
     * <p>Retrieves the execution history of a scheduled plan.</p>
     * 
    ...
    /**
     * <b>summary</b> : 
     * <p>This operation lists session clusters.</p>
     * 
    ...
    /**
     * <b>summary</b> : 
     * <p>Create and start a job instance.</p>
     * 
     ...
     */
    public StopSqlExecutionResponse stopSqlExecutionWithOptions(String namespace, String sqlExecutionId, StopSqlExecutionRequest request, StopSqlExecutionHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, String> realHeaders = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(headers.commonHeaders)) {
            realHeaders = headers.commonHeaders;
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "StopSqlExecution"),
            new TeaPair("version", "2022-07-18"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/api/v2/namespaces/" + com.aliyun.openapiutil.Client.getEncodeParam(namespace) + "/sql-execution/" + com.aliyun.openapiutil.Client.getEncodeParam(sqlExecutionId) + "%3Astop"),
            new TeaPair("method", "POST"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "json"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new StopSqlExecutionResponse());
    }
     ...
     * @return StopSqlExecutionResponse
     */
    public StopSqlExecutionResponse stopSqlExecution(String namespace, String sqlExecutionId, StopSqlExecutionRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        StopSqlExecutionHeaders headers = new StopSqlExecutionHeaders();
        return this.stopSqlExecutionWithOptions(namespace, sqlExecutionId, request, headers, runtime);
    }
     ...
     */
    public SubmitSqlPreviewResponse submitSqlPreviewWithOptions(String namespace, SubmitSqlPreviewRequest request, SubmitSqlPreviewHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.sessionClusterName)) {
            query.put("sessionClusterName", request.sessionClusterName);
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "SubmitSqlPreview"),
            new TeaPair("version", "2022-07-18"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/api/v2/namespaces/" + com.aliyun.openapiutil.Client.getEncodeParam(namespace) + "/sql-preview/submit"),
            new TeaPair("method", "POST"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "json"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new SubmitSqlPreviewResponse());
    }
     ...
     * @return SubmitSqlPreviewResponse
     */
    public SubmitSqlPreviewResponse submitSqlPreview(String namespace, SubmitSqlPreviewRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
    ...
    /**
     * <b>summary</b> : 
     * <p>Updates the details and configuration parameters of a deployment job by its name.</p>
     * 
     ...
     */
    public UpdateDeploymentByNameResponse updateDeploymentByNameWithOptions(String namespace, UpdateDeploymentByNameRequest request, UpdateDeploymentByNameHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.deploymentName)) {
            query.put("deploymentName", request.deploymentName);
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "UpdateDeploymentByName"),
            new TeaPair("version", "2022-07-18"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/api/v2/namespaces/" + com.aliyun.openapiutil.Client.getEncodeParam(namespace) + "/deployments/updateDeployment/byName"),
            new TeaPair("method", "PUT"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "json"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new UpdateDeploymentByNameResponse());
    }
     ...
     * @return UpdateDeploymentByNameResponse
     */
    public UpdateDeploymentByNameResponse updateDeploymentByName(String namespace, UpdateDeploymentByNameRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        UpdateDeploymentByNameHeaders headers = new UpdateDeploymentByNameHeaders();
        return this.updateDeploymentByNameWithOptions(namespace, request, headers, runtime);
    }

    /**
     * <b>summary</b> : 
     * <p>Updates the draft of an SQL or data ingestion job.</p>
     * 
    ...
    /**
     * <b>summary</b> : 
     * <p>Updates a deployment target.</p>
     * 
    ...
    /**
     * <b>description</b> :
     * <p>This new API operation updates deployment targets that use fixed resources, elastic resources, or mixed mode. The previous operation supported only fixed and elastic resources.</p>
     * 
     * <b>summary</b> : 
     * <p>Updates a deployment target.</p>
     * 
     ...
     */
    public UpdateDeploymentTargetV2Response updateDeploymentTargetV2WithOptions(String namespace, String deploymentTargetName, UpdateDeploymentTargetV2Request request, UpdateDeploymentTargetV2Headers headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, String> realHeaders = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(headers.commonHeaders)) {
            realHeaders = headers.commonHeaders;
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "UpdateDeploymentTargetV2"),
            new TeaPair("version", "2022-07-18"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/api/v2/namespaces/" + com.aliyun.openapiutil.Client.getEncodeParam(namespace) + "/deployment-targets/support-elastic/" + com.aliyun.openapiutil.Client.getEncodeParam(deploymentTargetName) + ""),
            new TeaPair("method", "PUT"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "json"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new UpdateDeploymentTargetV2Response());
    }
     ...
     * @return UpdateDeploymentTargetV2Response
     */
    public UpdateDeploymentTargetV2Response updateDeploymentTargetV2(String namespace, String deploymentTargetName, UpdateDeploymentTargetV2Request request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        UpdateDeploymentTargetV2Headers headers = new UpdateDeploymentTargetV2Headers();
        return this.updateDeploymentTargetV2WithOptions(namespace, deploymentTargetName, request, headers, runtime);
    }
    ...
    /**
     * <b>summary</b> : 
     * <p>Updates a created SQL query script.</p>
     * 
     ...
     */
    public UpdateSqlFileResponse updateSqlFileWithOptions(String namespace, String sqlFileId, UpdateSqlFileRequest request, UpdateSqlFileHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, String> realHeaders = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(headers.commonHeaders)) {
            realHeaders = headers.commonHeaders;
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "UpdateSqlFile"),
            new TeaPair("version", "2022-07-18"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/api/v2/namespaces/" + com.aliyun.openapiutil.Client.getEncodeParam(namespace) + "/sql-file/" + com.aliyun.openapiutil.Client.getEncodeParam(sqlFileId) + ""),
            new TeaPair("method", "PATCH"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new UpdateSqlFileResponse());
    }
     ...
     * @return UpdateSqlFileResponse
     */
    public UpdateSqlFileResponse updateSqlFile(String namespace, String sqlFileId, UpdateSqlFileRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        UpdateSqlFileHeaders headers = new UpdateSqlFileHeaders();
        return this.updateSqlFileWithOptions(namespace, sqlFileId, request, headers, runtime);
    }
    ...
    /**
     * <b>description</b> :
     * <p>This API asynchronously validates a job draft. It conducts end-to-end compliance and compatibility checks on the draft\&quot;s configuration before it is submitted for deployment.</p>
     * 
     * <b>summary</b> : 
     * <p>Asynchronously performs an in-depth check of a Flink job draft to validate its syntax and resource configuration.</p>
     * 
     ...
     */
    public ValidateDeploymentDraftAsyncResponse validateDeploymentDraftAsyncWithOptions(String namespace, ValidateDeploymentDraftAsyncRequest request, ValidateDeploymentDraftAsyncHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, String> realHeaders = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(headers.commonHeaders)) {
            realHeaders = headers.commonHeaders;
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "ValidateDeploymentDraftAsync"),
            new TeaPair("version", "2022-07-18"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/api/v2/namespaces/" + com.aliyun.openapiutil.Client.getEncodeParam(namespace) + "/deployment-drafts/async-validate"),
            new TeaPair("method", "POST"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "json"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new ValidateDeploymentDraftAsyncResponse());
    }
     ...
     * @return ValidateDeploymentDraftAsyncResponse
     */
    public ValidateDeploymentDraftAsyncResponse validateDeploymentDraftAsync(String namespace, ValidateDeploymentDraftAsyncRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        ValidateDeploymentDraftAsyncHeaders headers = new ValidateDeploymentDraftAsyncHeaders();
        return this.validateDeploymentDraftAsyncWithOptions(namespace, request, headers, runtime);
    }
