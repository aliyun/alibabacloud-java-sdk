...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    public AcceptDemandResponse acceptDemandWithOptions(AcceptDemandRequest request, RuntimeOptions runtime) throws Exception {
    ...
    public BidDomainResponse bidDomainWithOptions(BidDomainRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
    ...
    public ChangeAuctionResponse changeAuctionWithOptions(ChangeAuctionRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> body = new java.util.HashMap<>();
    ...
    public CheckDomainStatusResponse checkDomainStatusWithOptions(CheckDomainStatusRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
    ...
    public CreateFixedPriceDemandOrderResponse createFixedPriceDemandOrderWithOptions(CreateFixedPriceDemandOrderRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
    ...
    public FailDemandResponse failDemandWithOptions(FailDemandRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.bizId)) {
            query.put("BizId", request.bizId);
    ...
    public FinishDemandResponse finishDemandWithOptions(FinishDemandRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.bizId)) {
            query.put("BizId", request.bizId);
    ...
    public GetReserveDomainUrlResponse getReserveDomainUrlWithOptions(RuntimeOptions runtime) throws Exception {
    ...
    public QueryAuctionDetailResponse queryAuctionDetailWithOptions(QueryAuctionDetailRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> body = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.auctionId)) {
            body.put("AuctionId", request.auctionId);
    ...
    public QueryAuctionsResponse queryAuctionsWithOptions(QueryAuctionsRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> body = new java.util.HashMap<>();
    ...
    public QueryBidRecordsResponse queryBidRecordsWithOptions(QueryBidRecordsRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> body = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.auctionId)) {
            body.put("AuctionId", request.auctionId);
    ...
    public QueryBookingDomainInfoResponse queryBookingDomainInfoWithOptions(QueryBookingDomainInfoRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> body = new java.util.HashMap<>();
    ...
    public QueryBrokerDemandResponse queryBrokerDemandWithOptions(QueryBrokerDemandRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.bizId)) {
            query.put("BizId", request.bizId);
    ...
    public QueryBrokerDemandRecordResponse queryBrokerDemandRecordWithOptions(QueryBrokerDemandRecordRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.bizId)) {
            query.put("BizId", request.bizId);
    ...
    public QueryDomainTransferStatusResponse queryDomainTransferStatusWithOptions(QueryDomainTransferStatusRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> body = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.domainName)) {
            body.put("DomainName", request.domainName);
    ...
    public RecordDemandResponse recordDemandWithOptions(RecordDemandRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.bizId)) {
            query.put("BizId", request.bizId);
    ...
    public RefuseDemandResponse refuseDemandWithOptions(RefuseDemandRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.bizId)) {
            query.put("BizId", request.bizId);
    ...
    public RequestPayDemandResponse requestPayDemandWithOptions(RequestPayDemandRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.bizId)) {
            query.put("BizId", request.bizId);
    ...
    public ReserveDomainResponse reserveDomainWithOptions(ReserveDomainRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> body = new java.util.HashMap<>();
