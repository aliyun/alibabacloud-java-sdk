...
public class DescribeAlertHistoryListResponseBody extends TeaModel {
    ...
    public static class DescribeAlertHistoryListResponseBodyAlarmHistoryListAlarmHistory extends TeaModel {
        ...
        public DescribeAlertHistoryListResponseBodyAlarmHistoryListAlarmHistory setAlertName(String alertName) {
        ...
        public DescribeAlertHistoryListResponseBodyAlarmHistoryListAlarmHistory setId(String id) {
            this.id = id;
            return this;
        }
        public String getId() {
        ...
        public DescribeAlertHistoryListResponseBodyAlarmHistoryListAlarmHistory setPreLevel(String preLevel) {
        ...
        public DescribeAlertHistoryListResponseBodyAlarmHistoryListAlarmHistory setUserId(String userId) {
            this.userId = userId;
            return this;
        }
