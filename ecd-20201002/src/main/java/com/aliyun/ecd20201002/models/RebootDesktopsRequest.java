...
public class RebootDesktopsRequest extends TeaModel {
    ...
    /**
     * <p>Operating system of the device running the client.</p>
     * 
     * <strong>example:</strong>
    ...
    /**
     * <p>Ensures idempotence. Generate a unique value on your client for each request. ClientToken supports only ASCII characters and must be no longer than 64 characters. For more information, see <a href="https://help.aliyun.com/document_detail/25693.html">How to ensure idempotence</a>.</p>
     * 
     * <strong>example:</strong>
    ...
    /**
     * <p>Client version. If you use the WUYING Workspace client, find this value in the <strong>About</strong> dialog box on the client login screen.</p>
     * 
     * <strong>example:</strong>
    ...
    /**
     * <p>A list of 1 to 20 cloud computer IDs.</p>
     * <p>This parameter is required.</p>
     * 
     * <strong>example:</strong>
    ...
    /**
     * <p>Specifies the logon credentials.</p>
     * 
     * <strong>example:</strong>
