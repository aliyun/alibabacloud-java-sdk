...
public class GetConnectionTicketRequest extends TeaModel {
    ...
    /**
     * <p>This parameter lets you configure a custom user-mode application. After a ticket is obtained, the application is automatically run.</p>
     * <ul>
     * <li><p>appPath: A string that specifies the path of the application startup file. For example, <code>&quot;C:\\Program Files (x86)\\000\\000.exe&quot;</code>. Note: Use double backslashes (\) as separators.</p>
     * </li>
     * <li><p>appParameter: A string that specifies the startup parameters of the application. For example, <code>&quot;meetingid 000 meetingname aaa&quot;</code>. Note: Use spaces to separate parameters.</p>
     * </li>
     * </ul>
     * 
     * <strong>example:</strong>
    ...
    /**
     * <p>The logon credential. Call GetLoginToken to obtain this credential.</p>
     * <p>This parameter is required.</p>
     * 
     * <strong>example:</strong>
    ...
    /**
     * <p>The region ID. Call <a href="t2223508.xdita#"></a>to get a list of regions that Elastic Desktop Service (EDS) supports.</p>
     * <p>This parameter is required.</p>
     * 
     * <strong>example:</strong>
     * <p>cn-hangzhou</p>
    ...
    /**
     * <p>The session ID. Call GetLoginToken to obtain this ID.</p>
     * 
     * <strong>example:</strong>
    ...
    /**
     * <p>A list of tags. You can include 1 to 20 tags.</p>
     */
    @NameInMap("Tag")
    public java.util.List<GetConnectionTicketRequestTag> tag;

    /**
     * <p>The ID of the cloud computer connection task.<br>Do not specify this parameter in your first call. For subsequent calls, set this parameter to the <code>TaskId</code> returned from the previous call.<br></p>
     * 
     * <strong>example:</strong>
    ...
    /**
     * <p>The unique identifier of the client. If you use a Alibaba Cloud Workspace client, find this parameter in the <strong>About</strong> dialog box on the logon screen.</p>
     * 
     * <strong>example:</strong>
    ...
    public static class GetConnectionTicketRequestTag extends TeaModel {
        /**
         * <p>The tag key. If you specify <code>Tag</code>, <code>Key</code> is required. The key cannot exceed 128 characters in length. It cannot start with <code>aliyun</code> or <code>acs:</code>, contain <code>http://</code> or <code>https://</code>, or consist of only spaces.</p>
         * 
         * <strong>example:</strong>
         * <p>TestKey</p>
         */
        ...
        /**
         * <p>The tag value. The value can be an empty string. It can be up to 128 characters in length. It cannot start with <code>acs:</code> or contain <code>http://</code> or <code>https://</code>.</p>
         * 
         * <strong>example:</strong>
         * <p>TestValue</p>
         */
