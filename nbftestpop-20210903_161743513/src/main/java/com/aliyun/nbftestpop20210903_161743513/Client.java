...
package com.aliyun.nbftestpop20210903_161743513;

import com.aliyun.tea.*;
import com.aliyun.nbftestpop20210903_161743513.models.*;
...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    public AddResponse addWithOptions(AddRequest request, java.util.Map<String, String> headers, RuntimeOptions runtime) throws Exception {
        ...
        return TeaModel.toModel(this.doROARequest("Add", "2021-09-03_16-17-43-513", "HTTPS", "GET", "AK", "/kxNineThreeNineSeven/kxaddTest", "json", req, runtime), new AddResponse());
    }
}
