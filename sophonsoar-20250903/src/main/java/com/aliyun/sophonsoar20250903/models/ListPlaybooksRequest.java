...
public class ListPlaybooksRequest extends TeaModel {
    /**
    ...
    public java.util.List<String> playbookParamTypes;
    ...
    public java.util.List<String> playbookUuids;
    ...
    public static ListPlaybooksRequest build(java.util.Map<String, ?> map) throws Exception {
        ListPlaybooksRequest self = new ListPlaybooksRequest();
        return TeaModel.build(map, self);
    }

    public ListPlaybooksRequest setLang(String lang) {
        this.lang = lang;
        return this;
    }
    ...
    public ListPlaybooksRequest setMaxResults(Integer maxResults) {
    ...
    public ListPlaybooksRequest setNextToken(String nextToken) {
    ...
    public ListPlaybooksRequest setOrder(String order) {
        this.order = order;
        return this;
    }
    ...
    public ListPlaybooksRequest setOrderField(String orderField) {
    ...
    public ListPlaybooksRequest setPageNumber(Integer pageNumber) {
    ...
    public ListPlaybooksRequest setPageSize(Integer pageSize) {
    ...
    public ListPlaybooksRequest setPlaybookExecutionEndTime(Long playbookExecutionEndTime) {
    ...
    public ListPlaybooksRequest setPlaybookExecutionStartTime(Long playbookExecutionStartTime) {
    ...
    public ListPlaybooksRequest setPlaybookName(String playbookName) {
    ...
    public ListPlaybooksRequest setPlaybookParamTypes(java.util.List<String> playbookParamTypes) {
    ...
    public ListPlaybooksRequest setPlaybookStatus(Integer playbookStatus) {
    ...
    public ListPlaybooksRequest setPlaybookType(String playbookType) {
    ...
    public ListPlaybooksRequest setPlaybookUuids(java.util.List<String> playbookUuids) {
    ...
    public ListPlaybooksRequest setRoleFor(Long roleFor) {
