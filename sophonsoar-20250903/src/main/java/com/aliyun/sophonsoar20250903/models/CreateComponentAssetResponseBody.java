...
public class CreateComponentAssetResponseBody extends TeaModel {
    ...
    public static CreateComponentAssetResponseBody build(java.util.Map<String, ?> map) throws Exception {
        CreateComponentAssetResponseBody self = new CreateComponentAssetResponseBody();
        return TeaModel.build(map, self);
    }

    public CreateComponentAssetResponseBody setComponentAssetUuid(String componentAssetUuid) {
    ...
    public CreateComponentAssetResponseBody setRequestId(String requestId) {
