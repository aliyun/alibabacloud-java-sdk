...
public class UpdatePlaybookRequest extends TeaModel {
    /**
    ...
    public static UpdatePlaybookRequest build(java.util.Map<String, ?> map) throws Exception {
        UpdatePlaybookRequest self = new UpdatePlaybookRequest();
        return TeaModel.build(map, self);
    }

    public UpdatePlaybookRequest setLang(String lang) {
        this.lang = lang;
        return this;
    }
    ...
    public UpdatePlaybookRequest setPlaybookDescription(String playbookDescription) {
    ...
    public UpdatePlaybookRequest setPlaybookInputConfigs(java.util.List<FieldInputConfig> playbookInputConfigs) {
    ...
    public UpdatePlaybookRequest setPlaybookName(String playbookName) {
    ...
    public UpdatePlaybookRequest setPlaybookOutputConfigs(java.util.List<FieldOutputConfig> playbookOutputConfigs) {
    ...
    public UpdatePlaybookRequest setPlaybookParamType(String playbookParamType) {
    ...
    public UpdatePlaybookRequest setPlaybookTaskFlow(String playbookTaskFlow) {
    ...
    public UpdatePlaybookRequest setPlaybookUuid(String playbookUuid) {
    ...
    public UpdatePlaybookRequest setRoleFor(Long roleFor) {
