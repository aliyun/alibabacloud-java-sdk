...
public class CreateCustomCertificateResponseBody extends TeaModel {
    /**
     * <p>The content of the certificate. This is returned when Immediately is set to 1 or 2.</p>
     * 
    ...
    /**
     * <p>The CA certificate chain. This is returned when Immediately is set to 2.</p>
     * 
     * <strong>example:</strong>
     * <p>-----BEGIN CERTIFICATE-----
    ...
    /**
     * <p>The ID of the request. This is a unique identifier generated by Alibaba Cloud for the request. Use this ID to troubleshoot issues.</p>
     * 
     * <strong>example:</strong>
    ...
    /**
     * <p>The serial number of the certificate. This is returned when Immediately is set to 1 or 2.</p>
     * 
     * <strong>example:</strong>
