...
public class GetCAInstanceStatusResponseBody extends TeaModel {
    /**
     * <p>An array that consists of the status information about the private CA instance.</p>
     */
    ...
    public static class GetCAInstanceStatusResponseBodyInstanceStatusList extends TeaModel {
         ...
         * <br>
         * <p>For a private root CA instance whose **Type** is **ROOT**, this parameter indicates the number of intermediate CA certificates that can be issued. For a private intermediate CA instance whose **Type** is **SUB_ROOT**, this parameter indicates the total number of client certificates and server certificates that can be issued</p>
         */
         ...
         * <p>*   **REFUND**: The payment of the private CA instance is refunded.</p>
