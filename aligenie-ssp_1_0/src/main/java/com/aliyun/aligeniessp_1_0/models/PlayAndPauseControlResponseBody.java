...
public class PlayAndPauseControlResponseBody extends TeaModel {
    ...
    /**
     * <p>Additional information. In typical scenarios, this provides a brief description of a failed invocation to help the caller troubleshoot the issue.</p>
     * 
     * <strong>example:</strong>
     * <p>success</p>
     */
    ...
    /**
     * <p>Indicates whether the invocation succeeded. The value true means success, and false means failure. If the invocation fails, check the Message field for details.</p>
     * 
     * <strong>example:</strong>
     * <p>true</p>
     */
