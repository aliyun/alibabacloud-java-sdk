...
public class PreviousAndNextControlResponseBody extends TeaModel {
    ...
    /**
     * <p>Indicates whether the invocation succeeded. A value of true means success, and false means failure. When the value is false, check the Message field for details.</p>
     * 
     * <strong>example:</strong>
     * <p>true</p>
     */
