...
public class IndexControlPlayingListResponseBody extends TeaModel {
    ...
    /**
     * <p>Indicates whether the invocation succeeded. true indicates success, and false indicates failure. If the invocation fails, check the Message field for details.</p>
     * 
     * <strong>example:</strong>
     * <p>true</p>
     */
