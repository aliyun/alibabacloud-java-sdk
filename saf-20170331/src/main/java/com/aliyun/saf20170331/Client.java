...
package com.aliyun.saf20170331;

import com.aliyun.tea.*;
import com.aliyun.saf20170331.models.*;
...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    public ExecuteRequestResponse executeRequestWithOptions(ExecuteRequestRequest request, RuntimeOptions runtime) throws Exception {
        ...
        return TeaModel.toModel(this.doRPCRequest("ExecuteRequest", "2017-03-31", "HTTPS", "POST", "AK", "json", req, runtime), new ExecuteRequestResponse());
    }
