...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    public AlivisionImgdupResponse alivisionImgdupWithOptions(AlivisionImgdupRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.picNumList)) {
            body.put("PicNumList", request.picNumList);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.picUrlList)) {
            body.put("PicUrlList", request.picUrlList);
        }
    ...
    public CreateRemoveWorkTaskResponse createRemoveWorkTaskWithOptions(CreateRemoveWorkTaskRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.itemIdentity)) {
            query.put("ItemIdentity", request.itemIdentity);
        }
        ...
        Params params = Params.build(TeaConverter.buildMap(
            new TeaPair("action", "CreateRemoveWorkTask"),
            new TeaPair("version", "2020-12-16"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new CreateRemoveWorkTaskResponse());
    }

    public CreateRemoveWorkTaskResponse createRemoveWorkTask(CreateRemoveWorkTaskRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        return this.createRemoveWorkTaskWithOptions(request, runtime);
    }

    public CreateRemoveWorkTaskResponse createRemoveWorkTaskAdvance(CreateRemoveWorkTaskAdvanceRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        // Step 0: init client
        String accessKeyId = _credential.getAccessKeyId();
        String accessKeySecret = _credential.getAccessKeySecret();
        String securityToken = _credential.getSecurityToken();
        ...
        com.aliyun.openapiutil.Client.convert(request, createRemoveWorkTaskReq);
        if (!com.aliyun.teautil.Common.isUnset(request.picUrlObject)) {
            authResponse = authClient.authorizeFileUploadWithOptions(authRequest, runtime);
            ossConfig.accessKeyId = authResponse.accessKeyId;
            ossConfig.endpoint = com.aliyun.openapiutil.Client.getEndpoint(authResponse.endpoint, authResponse.useAccelerate, _endpointType);
        ...
        CreateRemoveWorkTaskResponse createRemoveWorkTaskResp = this.createRemoveWorkTaskWithOptions(createRemoveWorkTaskReq, runtime);
    ...
    public SeleteCommodityResponse seleteCommodityWithOptions(SeleteCommodityRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.num)) {
            query.put("Num", request.num);
        ...
        Params params = Params.build(TeaConverter.buildMap(
            new TeaPair("action", "SeleteCommodity"),
            new TeaPair("version", "2020-12-16"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new SeleteCommodityResponse());
    }

    public SeleteCommodityResponse seleteCommodity(SeleteCommodityRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        return this.seleteCommodityWithOptions(request, runtime);
    }

    public SeleteCommodityByBToBResponse seleteCommodityByBToBWithOptions(SeleteCommodityByBToBRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.num)) {
            query.put("Num", request.num);
        ...
        Params params = Params.build(TeaConverter.buildMap(
            new TeaPair("action", "SeleteCommodityByBToB"),
            new TeaPair("version", "2020-12-16"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new SeleteCommodityByBToBResponse());
    }

    public SeleteCommodityByBToBResponse seleteCommodityByBToB(SeleteCommodityByBToBRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        return this.seleteCommodityByBToBWithOptions(request, runtime);
    }

    public TbPredictCategoryResponse tbPredictCategoryWithOptions(TbPredictCategoryRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> body = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.picUrl)) {
            body.put("PicUrl", request.picUrl);
        ...
        Params params = Params.build(TeaConverter.buildMap(
            new TeaPair("action", "TbPredictCategory"),
            new TeaPair("version", "2020-12-16"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new TbPredictCategoryResponse());
    }

    public TbPredictCategoryResponse tbPredictCategory(TbPredictCategoryRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        return this.tbPredictCategoryWithOptions(request, runtime);
    }

    public TbPredictCategoryResponse tbPredictCategoryAdvance(TbPredictCategoryAdvanceRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        // Step 0: init client
        String accessKeyId = _credential.getAccessKeyId();
        String accessKeySecret = _credential.getAccessKeySecret();
        String securityToken = _credential.getSecurityToken();
        ...
        com.aliyun.openapiutil.Client.convert(request, tbPredictCategoryReq);
        if (!com.aliyun.teautil.Common.isUnset(request.picUrlObject)) {
            authResponse = authClient.authorizeFileUploadWithOptions(authRequest, runtime);
            ossConfig.accessKeyId = authResponse.accessKeyId;
            ossConfig.endpoint = com.aliyun.openapiutil.Client.getEndpoint(authResponse.endpoint, authResponse.useAccelerate, _endpointType);
        ...
        TbPredictCategoryResponse tbPredictCategoryResp = this.tbPredictCategoryWithOptions(tbPredictCategoryReq, runtime);
        return tbPredictCategoryResp;
    }

    public TbPropRecResponse tbPropRecWithOptions(TbPropRecRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> body = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.picUrl)) {
            body.put("PicUrl", request.picUrl);
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new TbPropRecResponse());
    }

    public TbPropRecResponse tbPropRec(TbPropRecRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        return this.tbPropRecWithOptions(request, runtime);
    }

    public TbPropRecResponse tbPropRecAdvance(TbPropRecAdvanceRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        // Step 0: init client
        String accessKeyId = _credential.getAccessKeyId();
        String accessKeySecret = _credential.getAccessKeySecret();
        String securityToken = _credential.getSecurityToken();
        ...
        com.aliyun.openapiutil.Client.convert(request, tbPropRecReq);
        if (!com.aliyun.teautil.Common.isUnset(request.picUrlObject)) {
            authResponse = authClient.authorizeFileUploadWithOptions(authRequest, runtime);
            ossConfig.accessKeyId = authResponse.accessKeyId;
            ossConfig.endpoint = com.aliyun.openapiutil.Client.getEndpoint(authResponse.endpoint, authResponse.useAccelerate, _endpointType);
        ...
        TbPropRecResponse tbPropRecResp = this.tbPropRecWithOptions(tbPropRecReq, runtime);
        return tbPropRecResp;
    }

    public TransferUrlByBtoBResponse transferUrlByBtoBWithOptions(TransferUrlByBtoBRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.offerId)) {
            query.put("OfferId", request.offerId);
        }
        ...
        Params params = Params.build(TeaConverter.buildMap(
            new TeaPair("action", "TransferUrlByBtoB"),
            new TeaPair("version", "2020-12-16"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new TransferUrlByBtoBResponse());
    }

    public TransferUrlByBtoBResponse transferUrlByBtoB(TransferUrlByBtoBRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
