...
public class UpdateZoneRemarkRequest extends TeaModel {
    /**
     * <p>A client-generated token that is used to ensure the idempotence of the request. Make sure that the token is unique for each request. The token can contain only ASCII characters and cannot exceed 64 characters in length.</p>
     * 
    ...
    /**
     * <p>The new remark. To clear the remark, set this parameter to an empty string.</p>
     * 
     * <strong>example:</strong>
     * <p>test</p>
     */
