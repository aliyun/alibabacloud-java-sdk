...
public class DescribeDedicatedBlockStorageClustersRequest extends TeaModel {
    ...
    /**
     * <p>A string generated by the server as an identifier for clients to send requests.</p>
     * 
     * <strong>example:</strong>
    ...
    /**
     * <p>The IDs of the dedicated block storage clusters. You can specify the IDs of multiple dedicated block storage clusters in a request.</p>
     */
    @NameInMap("DedicatedBlockStorageClusterId")
    public java.util.List<String> dedicatedBlockStorageClusterId;

    /**
     * <p>The maximum number of entries to return in each request that uses a token to perform a query.</p>
     * 
     * <strong>example:</strong>
     * <p>10</p>
     */
    ...
    /**
     * <p>The query token. Set the value to the NextToken value that is returned in the last call.</p>
     * 
     * <strong>example:</strong>
     * <p>AAAAAdDWBF2</p>
     */
