...
public class ReadOutboundTaskCallListShrinkRequest extends TeaModel {
    ...
    public ReadOutboundTaskCallListShrinkRequest setCallEndTimeBegin(Long callEndTimeBegin) {
    ...
    public ReadOutboundTaskCallListShrinkRequest setCallEndTimeEnd(Long callEndTimeEnd) {
    ...
    public ReadOutboundTaskCallListShrinkRequest setCallStartTimeBegin(Long callStartTimeBegin) {
    ...
    public ReadOutboundTaskCallListShrinkRequest setCallStartTimeEnd(Long callStartTimeEnd) {
