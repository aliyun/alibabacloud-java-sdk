...
public class DescribeVisitTopIpRequest extends TeaModel {
    /**
     * <p>The end of the time range to query. The value is a UNIX timestamp. Unit: seconds. If you do not specify this parameter, the end time is the current time.</p>
     * 
