...
public class DescribeSensitiveApiStatisticRequest extends TeaModel {
     ...
     * <blockquote>
     * <p>This parameter is available only in hybrid cloud scenarios. You can call the <a href="https://help.aliyun.com/document_detail/2849376.html">DescribeHybridCloudClusters</a> operation to query information about hybrid cloud clusters.</p>
     * </blockquote>
     * 
     ...
     * <blockquote>
     * <p>Compliance assessment supports queries for data from the past 1, 3, 6, and 12 months, or from January 1 of the previous year to the current time. Make sure that the specified time range is valid.</p>
     * </blockquote>
     * 
     * <strong>example:</strong>
     * <p>1725966000</p>
     ...
     * </li>
     * <li><p><strong>apiFormat</strong>: statistics by API</p>
     * </li>
     * </ul>
     * <blockquote>
     * <p>Notice: </p>
     * </blockquote>
     * <p>To collect statistics by API, you must specify the <strong>MatchedHost</strong> parameter.</p>
     * 
     * <strong>example:</strong>
     * <p>matchedHost</p>
     */
