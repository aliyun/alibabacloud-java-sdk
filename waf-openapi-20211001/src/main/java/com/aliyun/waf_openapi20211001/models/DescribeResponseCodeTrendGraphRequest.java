...
public class DescribeResponseCodeTrendGraphRequest extends TeaModel {
    ...
    /**
     * <p>The type of response code. Valid values:</p>
     * <ul>
     * <li><p><strong>waf</strong>: a response code that WAF returns to a client.</p>
     * </li>
     * <li><p><strong>upstream</strong>: a response code that an origin server returns to WAF.</p>
     * </li>
     * </ul>
     * <p>This parameter is required.</p>
     * 
