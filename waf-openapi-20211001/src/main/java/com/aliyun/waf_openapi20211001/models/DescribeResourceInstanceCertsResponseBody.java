...
public class DescribeResourceInstanceCertsResponseBody extends TeaModel {
    /**
     * <p>The details of the certificates.</p>
     */
    @NameInMap("Certs")
    ...
    public static class DescribeResourceInstanceCertsResponseBodyCerts extends TeaModel {
        /**
         * <p>The time when the certificate expires. This is a UNIX timestamp. Unit: milliseconds.</p>
         * 
         * <strong>example:</strong>
         * <p>1708415521211</p>
         */
        ...
        /**
         * <p>The time when the certificate was issued. This is a UNIX timestamp. Unit: milliseconds.</p>
         * 
         * <strong>example:</strong>
         * <p>1708415521211</p>
         */
        ...
        /**
         * <p>The global ID of the certificate. The ID is generated by appending -cn-hangzhou to the certificate ID. For example, if the certificate ID is 123, the value of CertIdentifier is 123-cn-hangzhou.</p>
         * 
         * <strong>example:</strong>
         * <p>123-cn-hangzhou</p>
         */
