...
public class DescribeFlowTopResourceRequest extends TeaModel {
    ...
    public DescribeFlowTopResourceRequest setRegionId(String regionId) {
    ...
    public DescribeFlowTopResourceRequest setResourceManagerResourceGroupId(String resourceManagerResourceGroupId) {
