...
public class DescribeDefenseResourceOwnerUidRequest extends TeaModel {
    ...
    /**
     * <p>The protected objects to query. Separate multiple protected objects with commas (,). A maximum of 100 protected objects can be queried in a single request.</p>
     * <p>This parameter is required.</p>
     * 
     * <strong>example:</strong>
