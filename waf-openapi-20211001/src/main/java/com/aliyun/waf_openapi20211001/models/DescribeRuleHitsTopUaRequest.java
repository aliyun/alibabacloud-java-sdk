...
public class DescribeRuleHitsTopUaRequest extends TeaModel {
    /**
     * <p>The end of the time range to query. This is a UNIX timestamp in seconds. If you do not specify this parameter, the current time is used as the end time.</p>
     * 
    ...
    /**
     * <p>The beginning of the time range to query. This is a UNIX timestamp in seconds.</p>
     * <p>This parameter is required.</p>
     * 
     * <strong>example:</strong>
     * <p>1665331200</p>
