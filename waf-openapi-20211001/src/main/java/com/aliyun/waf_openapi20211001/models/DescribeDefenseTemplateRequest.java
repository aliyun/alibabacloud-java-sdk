...
public class DescribeDefenseTemplateRequest extends TeaModel {
    ...
    /**
     * <p>The ID of the protection template that you want to query.</p>
     * <p>This parameter is required.</p>
     * 
     * <strong>example:</strong>
     * <p>1333</p>
    ...
    public DescribeDefenseTemplateRequest setRegionId(String regionId) {
    ...
    public DescribeDefenseTemplateRequest setResourceManagerResourceGroupId(String resourceManagerResourceGroupId) {
