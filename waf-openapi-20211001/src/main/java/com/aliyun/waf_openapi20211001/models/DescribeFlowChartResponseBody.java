...
public class DescribeFlowChartResponseBody extends TeaModel {
    /**
     * <p>The array of the traffic statistics.</p>
     */
    @NameInMap("FlowChart")
    ...
    public static class DescribeFlowChartResponseBodyFlowChart extends TeaModel {
        /**
         * <p>The number of requests that are blocked by custom access control rules.</p>
         */
        @NameInMap("AclCustomBlockSum")
        public Long aclCustomBlockSum;

        /**
         * <p>The number of requests that are monitored by custom access control rules.</p>
         */
        ...
        /**
         * <p>The number of requests that are blocked by IP address blacklist rules.</p>
         */
        @NameInMap("BlacklistBlockSum")
        public String blacklistBlockSum;

        /**
         * <p>The number of requests that are monitored by the IP address blacklist module.</p>
         */
        @NameInMap("BlacklistReportsSum")
        public Long blacklistReportsSum;

        /**
         * <p>The number of requests that are blocked by HTTP flood protection rules created by the user.</p>
         */
        @NameInMap("CcCustomBlockSum")
        public Long ccCustomBlockSum;

        /**
         * <p>The number of requests that are monitored by HTTP flood protection rules created by the user.</p>
         */
        @NameInMap("CcCustomReportsSum")
        public Long ccCustomReportsSum;

        /**
         * <p>The number of requests that are blocked by HTTP flood protection rules generated by the system.</p>
         */
        @NameInMap("CcSystemBlocksSum")
        public Long ccSystemBlocksSum;

        /**
         * <p>The number of requests that are monitored by HTTP flood protection rules generated by the system.</p>
         */
        ...
        /**
         * <p>The total number of requests that are forwarded to WAF.</p>
         */
        @NameInMap("InBytes")
        public Long inBytes;
        ...
        /**
         * <p>The total number of requests that are sent from WAF.</p>
         */
        @NameInMap("OutBytes")
        ...
        /**
         * <p>The number of request that are monitored by basic protection rules.</p>
         */
