...
public class ListDoctorHBaseRegionServersResponseBody extends TeaModel {
    ...
    public static ListDoctorHBaseRegionServersResponseBody build(java.util.Map<String, ?> map) throws Exception {
        ListDoctorHBaseRegionServersResponseBody self = new ListDoctorHBaseRegionServersResponseBody();
        return TeaModel.build(map, self);
    }

    public ListDoctorHBaseRegionServersResponseBody setData(java.util.List<Data> data) {
        this.data = data;
        return this;
    }
    ...
    public ListDoctorHBaseRegionServersResponseBody setMaxResults(Integer maxResults) {
    ...
    public ListDoctorHBaseRegionServersResponseBody setNextToken(String nextToken) {
    ...
    public ListDoctorHBaseRegionServersResponseBody setRequestId(String requestId) {
    ...
    public ListDoctorHBaseRegionServersResponseBody setTotalCount(Integer totalCount) {
