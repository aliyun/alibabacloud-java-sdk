...
public class GetDoctorHDFSClusterResponseBody extends TeaModel {
    ...
    public static GetDoctorHDFSClusterResponseBody build(java.util.Map<String, ?> map) throws Exception {
        GetDoctorHDFSClusterResponseBody self = new GetDoctorHDFSClusterResponseBody();
        return TeaModel.build(map, self);
    }

    public GetDoctorHDFSClusterResponseBody setData(Data data) {
        this.data = data;
        return this;
    }
    public Data getData() {
    ...
    public GetDoctorHDFSClusterResponseBody setRequestId(String requestId) {
    ...
    public static class Analysis extends TeaModel {
        ...
        public Analysis setHdfsScore(Integer hdfsScore) {
