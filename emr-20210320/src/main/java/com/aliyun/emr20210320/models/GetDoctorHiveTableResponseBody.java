...
public class GetDoctorHiveTableResponseBody extends TeaModel {
    ...
    public static GetDoctorHiveTableResponseBody build(java.util.Map<String, ?> map) throws Exception {
        GetDoctorHiveTableResponseBody self = new GetDoctorHiveTableResponseBody();
        return TeaModel.build(map, self);
    }

    public GetDoctorHiveTableResponseBody setData(Data data) {
        this.data = data;
        return this;
    }
    public Data getData() {
    ...
    public GetDoctorHiveTableResponseBody setRequestId(String requestId) {
