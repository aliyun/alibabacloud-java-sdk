...
public class ListDoctorHiveTablesResponseBody extends TeaModel {
    ...
    public static ListDoctorHiveTablesResponseBody build(java.util.Map<String, ?> map) throws Exception {
        ListDoctorHiveTablesResponseBody self = new ListDoctorHiveTablesResponseBody();
        return TeaModel.build(map, self);
    }

    public ListDoctorHiveTablesResponseBody setData(java.util.List<Data> data) {
        this.data = data;
        return this;
    }
    ...
    public ListDoctorHiveTablesResponseBody setMaxResults(Integer maxResults) {
    ...
    public ListDoctorHiveTablesResponseBody setNextToken(String nextToken) {
    ...
    public ListDoctorHiveTablesResponseBody setRequestId(String requestId) {
    ...
    public ListDoctorHiveTablesResponseBody setTotalCount(Integer totalCount) {
    ...
    public static class Data extends TeaModel {
        ...
        public Data setOwner(String owner) {
            this.owner = owner;
            return this;
        }
