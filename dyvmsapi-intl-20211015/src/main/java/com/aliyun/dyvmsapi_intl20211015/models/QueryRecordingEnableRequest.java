...
public class QueryRecordingEnableRequest extends TeaModel {
    @NameInMap("OwnerId")
    public Long ownerId;
    ...
    public QueryRecordingEnableRequest setOwnerId(Long ownerId) {
    ...
    public QueryRecordingEnableRequest setResourceOwnerAccount(String resourceOwnerAccount) {
