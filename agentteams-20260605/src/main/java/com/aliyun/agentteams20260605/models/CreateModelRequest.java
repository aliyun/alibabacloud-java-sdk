...
public class CreateModelRequest extends TeaModel {
    ...
    public CreateModelRequest setInstanceId(String instanceId) {
    ...
    public CreateModelRequest setProtocols(java.util.List<String> protocols) {
    ...
    public CreateModelRequest setProvider(String provider) {
    ...
    public CreateModelRequest setProviderId(String providerId) {
    ...
    public CreateModelRequest setProviderName(String providerName) {
