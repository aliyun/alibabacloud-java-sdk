...
public class SearchCondition extends TeaModel {
    ...
    @NameInMap("excludeAuthorIdx")
    public String excludeAuthorIdx;
    ...
    public SearchCondition setAuthorIdx(String authorIdx) {
        this.authorIdx = authorIdx;
        return this;
    }
    public String getAuthorIdx() {
    ...
    public SearchCondition setExcludeAuthorIdx(String excludeAuthorIdx) {
        this.excludeAuthorIdx = excludeAuthorIdx;
        return this;
    }
    public String getExcludeAuthorIdx() {
        return this.excludeAuthorIdx;
    }
