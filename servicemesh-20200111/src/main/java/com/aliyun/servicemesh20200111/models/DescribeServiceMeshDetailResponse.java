...
public class DescribeServiceMeshDetailResponse extends TeaModel {
    ...
    public static class DescribeServiceMeshDetailResponseServiceMeshSpecMeshConfigKiali extends TeaModel {
        @NameInMap("Enabled")
        @Validation(required = true)
        public Boolean enabled;
        ...
        public DescribeServiceMeshDetailResponseServiceMeshSpecMeshConfigKiali setEnabled(Boolean enabled) {
            this.enabled = enabled;
            return this;
        }
        public Boolean getEnabled() {
    ...
    public static class DescribeServiceMeshDetailResponseServiceMeshSpecMeshConfigPrometheus extends TeaModel {
        ...
        public static DescribeServiceMeshDetailResponseServiceMeshSpecMeshConfigPrometheus build(java.util.Map<String, ?> map) throws Exception {
            DescribeServiceMeshDetailResponseServiceMeshSpecMeshConfigPrometheus self = new DescribeServiceMeshDetailResponseServiceMeshSpecMeshConfigPrometheus();
            return TeaModel.build(map, self);
        }

        public DescribeServiceMeshDetailResponseServiceMeshSpecMeshConfigPrometheus setUseExternal(Boolean useExternal) {
        ...
        public DescribeServiceMeshDetailResponseServiceMeshSpecMeshConfigPrometheus setExternalUrl(String externalUrl) {
    ...
    public static class DescribeServiceMeshDetailResponseServiceMeshSpecMeshConfigAccessLog extends TeaModel {
        @NameInMap("Enabled")
        @Validation(required = true)
        public Boolean enabled;

        public static DescribeServiceMeshDetailResponseServiceMeshSpecMeshConfigAccessLog build(java.util.Map<String, ?> map) throws Exception {
            DescribeServiceMeshDetailResponseServiceMeshSpecMeshConfigAccessLog self = new DescribeServiceMeshDetailResponseServiceMeshSpecMeshConfigAccessLog();
            return TeaModel.build(map, self);
        }

        public DescribeServiceMeshDetailResponseServiceMeshSpecMeshConfigAccessLog setEnabled(Boolean enabled) {
            this.enabled = enabled;
            return this;
        }
        public Boolean getEnabled() {
    ...
    public static class DescribeServiceMeshDetailResponseServiceMeshSpecMeshConfig extends TeaModel {
        ...
        @NameInMap("Kiali")
        @Validation(required = true)
        public DescribeServiceMeshDetailResponseServiceMeshSpecMeshConfigKiali kiali;

        @NameInMap("Prometheus")
        @Validation(required = true)
        public DescribeServiceMeshDetailResponseServiceMeshSpecMeshConfigPrometheus prometheus;

        @NameInMap("AccessLog")
        @Validation(required = true)
        public DescribeServiceMeshDetailResponseServiceMeshSpecMeshConfigAccessLog accessLog;
        ...
        public DescribeServiceMeshDetailResponseServiceMeshSpecMeshConfig setEdition(String edition) {
        ...
        public DescribeServiceMeshDetailResponseServiceMeshSpecMeshConfig setKiali(DescribeServiceMeshDetailResponseServiceMeshSpecMeshConfigKiali kiali) {
            this.kiali = kiali;
            return this;
        }
        public DescribeServiceMeshDetailResponseServiceMeshSpecMeshConfigKiali getKiali() {
            return this.kiali;
        }

        public DescribeServiceMeshDetailResponseServiceMeshSpecMeshConfig setPrometheus(DescribeServiceMeshDetailResponseServiceMeshSpecMeshConfigPrometheus prometheus) {
            this.prometheus = prometheus;
            return this;
        }
        public DescribeServiceMeshDetailResponseServiceMeshSpecMeshConfigPrometheus getPrometheus() {
            return this.prometheus;
        }

        public DescribeServiceMeshDetailResponseServiceMeshSpecMeshConfig setAccessLog(DescribeServiceMeshDetailResponseServiceMeshSpecMeshConfigAccessLog accessLog) {
            this.accessLog = accessLog;
            return this;
        }
        public DescribeServiceMeshDetailResponseServiceMeshSpecMeshConfigAccessLog getAccessLog() {
