...
public class UpdateNamespaceScopeSidecarConfigRequest extends TeaModel {
    ...
    public UpdateNamespaceScopeSidecarConfigRequestScaledSidecarResource scaledSidecarResource;
    ...
    public UpdateNamespaceScopeSidecarConfigRequest setRuntimeValues(String runtimeValues) {
    ...
    public UpdateNamespaceScopeSidecarConfigRequest setSMCEnabled(Boolean SMCEnabled) {
    ...
    public UpdateNamespaceScopeSidecarConfigRequest setScaledSidecarResource(UpdateNamespaceScopeSidecarConfigRequestScaledSidecarResource scaledSidecarResource) {
        this.scaledSidecarResource = scaledSidecarResource;
        return this;
    }
    public UpdateNamespaceScopeSidecarConfigRequestScaledSidecarResource getScaledSidecarResource() {
    ...
    public static class UpdateNamespaceScopeSidecarConfigRequestScaledSidecarResource extends TeaModel {
        ...
        public static UpdateNamespaceScopeSidecarConfigRequestScaledSidecarResource build(java.util.Map<String, ?> map) throws Exception {
            UpdateNamespaceScopeSidecarConfigRequestScaledSidecarResource self = new UpdateNamespaceScopeSidecarConfigRequestScaledSidecarResource();
            return TeaModel.build(map, self);
        }

        public UpdateNamespaceScopeSidecarConfigRequestScaledSidecarResource setContainerRef(String containerRef) {
        ...
        public UpdateNamespaceScopeSidecarConfigRequestScaledSidecarResource setResourceCalculationStrategy(String resourceCalculationStrategy) {
        ...
        public UpdateNamespaceScopeSidecarConfigRequestScaledSidecarResource setResourcePercentage(Integer resourcePercentage) {
