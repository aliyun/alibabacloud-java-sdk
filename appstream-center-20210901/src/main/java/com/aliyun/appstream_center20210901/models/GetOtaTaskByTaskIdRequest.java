...
public class GetOtaTaskByTaskIdRequest extends TeaModel {
    /**
     * <p>The ID of the over-the-air update task. You can call <a href="https://help.aliyun.com/document_detail/428506.html">ListAppInstanceGroup</a> to obtain the ID.</p>
