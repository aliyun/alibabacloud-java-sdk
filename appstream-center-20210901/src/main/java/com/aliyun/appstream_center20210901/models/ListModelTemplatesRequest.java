...
public class ListModelTemplatesRequest extends TeaModel {
    ...
    public ListModelTemplatesRequest setAgentPlatformList(java.util.List<String> agentPlatformList) {
    ...
    public ListModelTemplatesRequest setAgentProviderList(java.util.List<String> agentProviderList) {
    ...
    public ListModelTemplatesRequest setName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ListModelTemplatesRequest setRefScope(String refScope) {
    ...
    public ListModelTemplatesRequest setSource(String source) {
        this.source = source;
        return this;
    }
