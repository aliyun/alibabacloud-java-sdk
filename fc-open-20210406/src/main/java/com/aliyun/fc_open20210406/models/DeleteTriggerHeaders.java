...
public class DeleteTriggerHeaders extends TeaModel {
    ...
    public DeleteTriggerHeaders setXFcCodeChecksum(String xFcCodeChecksum) {
    ...
    public DeleteTriggerHeaders setXFcInvocationType(String xFcInvocationType) {
    ...
    public DeleteTriggerHeaders setXFcLogType(String xFcLogType) {
