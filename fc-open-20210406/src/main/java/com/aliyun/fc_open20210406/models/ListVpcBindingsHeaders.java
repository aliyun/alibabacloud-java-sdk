...
public class ListVpcBindingsHeaders extends TeaModel {
    ...
    public ListVpcBindingsHeaders setXFcCodeChecksum(String xFcCodeChecksum) {
    ...
    public ListVpcBindingsHeaders setXFcInvocationType(String xFcInvocationType) {
    ...
    public ListVpcBindingsHeaders setXFcLogType(String xFcLogType) {
