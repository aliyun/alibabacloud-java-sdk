...
public class PutFunctionAsyncInvokeConfigHeaders extends TeaModel {
    ...
    public PutFunctionAsyncInvokeConfigHeaders setXFcCodeChecksum(String xFcCodeChecksum) {
    ...
    public PutFunctionAsyncInvokeConfigHeaders setXFcInvocationType(String xFcInvocationType) {
    ...
    public PutFunctionAsyncInvokeConfigHeaders setXFcLogType(String xFcLogType) {
