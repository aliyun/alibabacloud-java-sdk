...
public class DeleteVpcBindingHeaders extends TeaModel {
    ...
    public DeleteVpcBindingHeaders setXFcCodeChecksum(String xFcCodeChecksum) {
    ...
    public DeleteVpcBindingHeaders setXFcInvocationType(String xFcInvocationType) {
    ...
    public DeleteVpcBindingHeaders setXFcLogType(String xFcLogType) {
