...
public class DeleteServiceVersionHeaders extends TeaModel {
    ...
    public DeleteServiceVersionHeaders setXFcCodeChecksum(String xFcCodeChecksum) {
    ...
    public DeleteServiceVersionHeaders setXFcInvocationType(String xFcInvocationType) {
    ...
    public DeleteServiceVersionHeaders setXFcLogType(String xFcLogType) {
