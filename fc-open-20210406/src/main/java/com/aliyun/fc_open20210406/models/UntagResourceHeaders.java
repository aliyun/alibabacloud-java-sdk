...
public class UntagResourceHeaders extends TeaModel {
    ...
    public UntagResourceHeaders setXFcCodeChecksum(String xFcCodeChecksum) {
    ...
    public UntagResourceHeaders setXFcInvocationType(String xFcInvocationType) {
    ...
    public UntagResourceHeaders setXFcLogType(String xFcLogType) {
