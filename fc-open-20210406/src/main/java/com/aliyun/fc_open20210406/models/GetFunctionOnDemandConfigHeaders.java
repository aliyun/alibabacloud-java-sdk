...
public class GetFunctionOnDemandConfigHeaders extends TeaModel {
    ...
    public GetFunctionOnDemandConfigHeaders setXFcCodeChecksum(String xFcCodeChecksum) {
    ...
    public GetFunctionOnDemandConfigHeaders setXFcInvocationType(String xFcInvocationType) {
    ...
    public GetFunctionOnDemandConfigHeaders setXFcLogType(String xFcLogType) {
