...
public class CreateTriggerHeaders extends TeaModel {
    ...
    public CreateTriggerHeaders setXFcCodeChecksum(String xFcCodeChecksum) {
    ...
    public CreateTriggerHeaders setXFcInvocationType(String xFcInvocationType) {
    ...
    public CreateTriggerHeaders setXFcLogType(String xFcLogType) {
