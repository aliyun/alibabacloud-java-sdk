...
public class UpdateServiceHeaders extends TeaModel {
    ...
    public UpdateServiceHeaders setXFcCodeChecksum(String xFcCodeChecksum) {
    ...
    public UpdateServiceHeaders setXFcInvocationType(String xFcInvocationType) {
    ...
    public UpdateServiceHeaders setXFcLogType(String xFcLogType) {
