...
public class ListTaggedResourcesHeaders extends TeaModel {
    ...
    public ListTaggedResourcesHeaders setXFcCodeChecksum(String xFcCodeChecksum) {
    ...
    public ListTaggedResourcesHeaders setXFcInvocationType(String xFcInvocationType) {
    ...
    public ListTaggedResourcesHeaders setXFcLogType(String xFcLogType) {
