...
public class UpdateTriggerHeaders extends TeaModel {
    ...
    public UpdateTriggerHeaders setXFcCodeChecksum(String xFcCodeChecksum) {
    ...
    public UpdateTriggerHeaders setXFcInvocationType(String xFcInvocationType) {
    ...
    public UpdateTriggerHeaders setXFcLogType(String xFcLogType) {
