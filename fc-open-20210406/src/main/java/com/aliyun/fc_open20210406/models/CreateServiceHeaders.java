...
public class CreateServiceHeaders extends TeaModel {
    ...
    public CreateServiceHeaders setXFcCodeChecksum(String xFcCodeChecksum) {
    ...
    public CreateServiceHeaders setXFcInvocationType(String xFcInvocationType) {
    ...
    public CreateServiceHeaders setXFcLogType(String xFcLogType) {
