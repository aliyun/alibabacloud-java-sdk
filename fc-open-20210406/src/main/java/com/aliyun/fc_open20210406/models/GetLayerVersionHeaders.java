...
public class GetLayerVersionHeaders extends TeaModel {
    ...
    public GetLayerVersionHeaders setXFcCodeChecksum(String xFcCodeChecksum) {
    ...
    public GetLayerVersionHeaders setXFcInvocationType(String xFcInvocationType) {
    ...
    public GetLayerVersionHeaders setXFcLogType(String xFcLogType) {
