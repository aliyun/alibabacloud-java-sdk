...
public class ListEventSourcesHeaders extends TeaModel {
    ...
    public ListEventSourcesHeaders setXFcCodeChecksum(String xFcCodeChecksum) {
    ...
    public ListEventSourcesHeaders setXFcInvocationType(String xFcInvocationType) {
    ...
    public ListEventSourcesHeaders setXFcLogType(String xFcLogType) {
