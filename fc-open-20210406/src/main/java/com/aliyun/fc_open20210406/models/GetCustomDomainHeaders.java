...
public class GetCustomDomainHeaders extends TeaModel {
    ...
    public GetCustomDomainHeaders setXFcCodeChecksum(String xFcCodeChecksum) {
    ...
    public GetCustomDomainHeaders setXFcInvocationType(String xFcInvocationType) {
    ...
    public GetCustomDomainHeaders setXFcLogType(String xFcLogType) {
