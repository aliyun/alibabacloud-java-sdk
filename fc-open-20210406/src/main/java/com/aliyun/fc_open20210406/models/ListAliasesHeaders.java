...
public class ListAliasesHeaders extends TeaModel {
    ...
    public ListAliasesHeaders setXFcCodeChecksum(String xFcCodeChecksum) {
    ...
    public ListAliasesHeaders setXFcInvocationType(String xFcInvocationType) {
    ...
    public ListAliasesHeaders setXFcLogType(String xFcLogType) {
