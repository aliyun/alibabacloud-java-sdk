...
public class ListOnDemandConfigsHeaders extends TeaModel {
    ...
    public ListOnDemandConfigsHeaders setXFcCodeChecksum(String xFcCodeChecksum) {
    ...
    public ListOnDemandConfigsHeaders setXFcInvocationType(String xFcInvocationType) {
    ...
    public ListOnDemandConfigsHeaders setXFcLogType(String xFcLogType) {
