...
public class ListProvisionConfigsHeaders extends TeaModel {
    ...
    public ListProvisionConfigsHeaders setXFcCodeChecksum(String xFcCodeChecksum) {
    ...
    public ListProvisionConfigsHeaders setXFcInvocationType(String xFcInvocationType) {
    ...
    public ListProvisionConfigsHeaders setXFcLogType(String xFcLogType) {
