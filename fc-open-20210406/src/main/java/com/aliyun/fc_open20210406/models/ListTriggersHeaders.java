...
public class ListTriggersHeaders extends TeaModel {
    ...
    public ListTriggersHeaders setXFcCodeChecksum(String xFcCodeChecksum) {
    ...
    public ListTriggersHeaders setXFcInvocationType(String xFcInvocationType) {
    ...
    public ListTriggersHeaders setXFcLogType(String xFcLogType) {
