...
public class GetProvisionConfigHeaders extends TeaModel {
    ...
    public GetProvisionConfigHeaders setXFcCodeChecksum(String xFcCodeChecksum) {
    ...
    public GetProvisionConfigHeaders setXFcInvocationType(String xFcInvocationType) {
    ...
    public GetProvisionConfigHeaders setXFcLogType(String xFcLogType) {
