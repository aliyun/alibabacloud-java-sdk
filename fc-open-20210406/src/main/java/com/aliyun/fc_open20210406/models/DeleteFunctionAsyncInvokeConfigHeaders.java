...
public class DeleteFunctionAsyncInvokeConfigHeaders extends TeaModel {
    ...
    public DeleteFunctionAsyncInvokeConfigHeaders setXFcCodeChecksum(String xFcCodeChecksum) {
    ...
    public DeleteFunctionAsyncInvokeConfigHeaders setXFcInvocationType(String xFcInvocationType) {
    ...
    public DeleteFunctionAsyncInvokeConfigHeaders setXFcLogType(String xFcLogType) {
