...
public class RegisterEventSourceHeaders extends TeaModel {
    ...
    public RegisterEventSourceHeaders setXFcCodeChecksum(String xFcCodeChecksum) {
    ...
    public RegisterEventSourceHeaders setXFcInvocationType(String xFcInvocationType) {
    ...
    public RegisterEventSourceHeaders setXFcLogType(String xFcLogType) {
