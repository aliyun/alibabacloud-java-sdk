...
public class CreateLayerVersionHeaders extends TeaModel {
    ...
    public CreateLayerVersionHeaders setXFcCodeChecksum(String xFcCodeChecksum) {
    ...
    public CreateLayerVersionHeaders setXFcInvocationType(String xFcInvocationType) {
    ...
    public CreateLayerVersionHeaders setXFcLogType(String xFcLogType) {
