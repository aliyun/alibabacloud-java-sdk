...
public class GetProjectResponseBody extends TeaModel {
     ...
     * </li>
     * <li><p>4xx: Client error. The request contains invalid request parameters or syntax, or specific request conditions cannot be met.</p>
     * </li>
    ...
    public static class GetProjectResponseBodyDataIpWhiteList extends TeaModel {
        /**
         * <p>The IP address whitelist for access over the Internet or a network that is used to interconnect with other Alibaba Cloud services.</p>
         * <blockquote>
         * <p>If you configure only this IP address whitelist, access over the Internet or the network that is used to interconnect with other Alibaba Cloud services is restricted based on the configuration, and access over a VPC is prohibited.</p>
         * </blockquote>
         * 
         * <strong>example:</strong>
         * <p>10.88.111.3</p>
         ...
         * <blockquote>
         * <p>If you configure only this IP address whitelist, access over a VPC is restricted based on the configuration, and access over the Internet or a network that is used to interconnect with other Alibaba Cloud services is prohibited.</p>
         * </blockquote>
         * 
         * <strong>example:</strong>
         * <p>10.88.111.3</p>
    ...
    public static class GetProjectResponseBodyDataPropertiesEncryption extends TeaModel {
        ...
        /**
         * <p>Specifies whether to enable data encryption for the project. For more information, see &lt;props=&quot;intl&quot;&gt;<a href="https://www.alibabacloud.com/help/en/maxcompute/security-and-compliance/storage-encryption">Storage encryption</a>.</p>
         * 
         * <strong>example:</strong>
         * <p>true</p>
         */
        ...
        /**
         * <p>The type of key used for data encryption. Valid values include MaxCompute Default Key and Bring-Your-Own-Key (BYOK). MaxCompute Default Key is a default key created within MaxCompute.</p>
         * 
         * <strong>example:</strong>
         * <p>dafault</p>
         */
    ...
    public static class GetProjectResponseBodyDataPropertiesExternalProjectProperties extends TeaModel {
        ...
        /**
         * <p>Specifies whether the project is an external project of &lt;props=&quot;intl&quot;&gt;<a href="https://www.alibabacloud.com/help/en/maxcompute/user-guide/lake-warehouse-integrated-2-0-use-guide">data lakehouse 2.0</a>.</p>
         * 
         * <strong>example:</strong>
         * <p>true</p>
         */
    ...
    public static class GetProjectResponseBodyDataPropertiesStorageTierInfo extends TeaModel {
        ...
        /**
         * <p>The &lt;props=&quot;intl&quot;&gt;<a href="https://www.alibabacloud.com/help/en/maxcompute/user-guide/tiered-storage">tiered storage</a> information.</p>
         */
    ...
    public static class GetProjectResponseBodyDataPropertiesTableLifecycle extends TeaModel {
         ...
         * </li>
         * <li><p><strong>optional</strong>: The Lifecycle clause is optional when you create a table. If you do not set a lifecycle for the table, the table is permanently valid.</p>
         * </li>
         * <li><p><strong>inherit</strong>: If you do not set a lifecycle for a table when you create it, the lifecycle of the table is the value of odps.table.lifecycle.value.</p>
         * </li>
         * </ul>
         * 
         * <strong>example:</strong>
        ...
        /**
         * <p>The lifecycle of the table. Unit: days. The value can be an integer from 1 to 37231. The default value is 37231.</p>
         * 
         * <strong>example:</strong>
         * <p>37231</p>
         */
    ...
    public static class GetProjectResponseBodyDataPropertiesTableLifecycleConfigTierToLongterm extends TeaModel {
        /**
         * <p>The number of days after the data was last accessed. After this period, the storage class is automatically changed. This corresponds to the <code>LastAccessTime</code> of the table or partition.</p>
         * <blockquote>
         * <p>If the LastAccessTime of the table or partition is empty:</p>
         * <ul>
         * <li><p>For tables or partitions that were created before October 1, 2023, the last access time is considered 00:00:00 on October 1, 2023 (UTC+0).</p>
         * </li>
         * <li><p>For tables or partitions that were created on or after October 1, 2023, if the data has not been accessed, the creation time of the table or partition is considered the last access time.</p>
         * </li>
         * </ul>
         * </blockquote>
         * 
        ...
        /**
         * <p>The number of days after the data was last modified. After this period, the storage class is automatically changed. This corresponds to the <code>LastModifiedTime</code> of the table or partition.</p>
         * 
         * <strong>example:</strong>
         * <p>180</p>
         */
        ...
        /**
         * <p>The number of days after the storage class was last changed.</p>
         * 
         * <strong>example:</strong>
         * <p>1</p>
         */
    ...
    public static class GetProjectResponseBodyDataProperties extends TeaModel {
        /**
         * <p>Specifies whether to allow a full table scan in the project. A full table scan consumes a large amount of resources and reduces processing efficiency. By default, this feature is disabled.</p>
         * 
         * <strong>example:</strong>
         * <p>false</p>
         */
        ...
        /**
         * <p>The parent resource group of the Data Transmission Service resource group that is bound to the project. This parameter is for internal use.</p>
         * 
         * <strong>example:</strong>
         * <p>Default_p</p>
         */
        ...
        /**
         * <p>Specifies whether to forcefully enable external table caching.</p>
         * 
         * <strong>example:</strong>
         * <p>true</p>
         */
        ...
        /**
         * <p>Specifies whether to enable &lt;props=&quot;intl&quot;&gt;<a href="https://www.alibabacloud.com/help/en/maxcompute/user-guide/tiered-storage">tiered storage</a>.</p>
         * 
         * <strong>example:</strong>
         * <p>true</p>
         */
         ...
         * <ul>
         * <li><p>true: The data transmission tasks that are submitted by default in the project use the Data Transmission Service resource group that is bound to the project.</p>
         * </li>
         * <li><p>false: The data transmission tasks that are submitted by default in the project use the shared Data Transmission Service resource group.</p>
         * </li>
         * </ul>
         * 
         * <strong>example:</strong>
        ...
        /**
         * <p>The retention period of backup data. Unit: days. During this period, you can restore the current data version to any backup version. The value can be an integer from 0 to 30. The default value is 1. A value of 0 indicates that the backup feature is disabled.</p>
         * 
         * <strong>example:</strong>
         * <p>1</p>
         */
        ...
        /**
         * <p>The properties of the &lt;props=&quot;intl&quot;&gt;<a href="https://www.alibabacloud.com/help/en/maxcompute/user-guide/tiered-storage#f61fc9db76nna">tiered storage lifecycle rule</a>. After you set these properties, the system automatically triggers the conversion of storage classes based on the rule.</p>
         */
        ...
        /**
         * <p>The &lt;props=&quot;intl&quot;&gt;<a href="https://www.alibabacloud.com/help/en/maxcompute/user-guide/overview-of-dts">Data Transmission Service</a> resource group that is bound to the project.</p>
         * <ul>
         * <li><p>Default (shared Data Transmission Service resource group): The project cannot use a subscription Data Transmission Service resource group. Regardless of the value of the default Data Transmission Service resource group, the Data Transmission Service automatically uses the Default resource group for data transmission tasks that are submitted by default in the project.</p>
         * </li>
         ...
         * <ul>
         * <li><p><strong>1</strong>: V1.0</p>
         * </li>
         * <li><p><strong>2</strong>: V2.0</p>
         * </li>
         * <li><p><strong>hive</strong>: Hive-compatible</p>
         * </li>
         * </ul>
         * <p>For more information, see &lt;props=&quot;intl&quot;&gt;<a href="https://www.alibabacloud.com/help/en/maxcompute/user-guide/data-type-editions">Data type editions</a>.</p>
         * 
         * <strong>example:</strong>
         * <p>2.0</p>
         */
    ...
    public static class GetProjectResponseBodyDataSecurityPropertiesProjectProtection extends TeaModel {
        /**
         * <p>If data protection is enabled for a project, you can configure an exception policy to specify exception or trusted projects. This policy allows specified users to transfer data from a specified object to a specified project. The data protection mechanism does not apply to the scenarios described in the exception policy.</p>
         * 
         * <strong>example:</strong>
         * <p>{
         *       &quot;Version&quot;: &quot;1&quot;,
        ...
        /**
         * <p>Specifies whether to enable the &lt;props=&quot;intl&quot;&gt;<a href="https://www.alibabacloud.com/help/en/maxcompute/security-and-compliance/project-data-protection">data protection mechanism</a> for the project to prohibit or allow data to flow out of the project. By default, this mechanism is disabled.</p>
         * 
         * <strong>example:</strong>
         * <p>true</p>
         */
    ...
    public static class GetProjectResponseBodyDataSecurityProperties extends TeaModel {
        /**
         * <p>Specifies whether to use the &lt;props=&quot;intl&quot;&gt;<a href="https://www.alibabacloud.com/help/en/maxcompute/user-guide/download-control">download control</a> feature. By default, this feature is disabled.</p>
         * 
         * <strong>example:</strong>
         * <p>false</p>
         */
        ...
        /**
         * <p>Specifies whether to use the &lt;props=&quot;intl&quot;&gt;<a href="https://www.alibabacloud.com/help/en/maxcompute/user-guide/label-based-access-control">label-based access control</a> feature. By default, this feature is disabled.</p>
         * 
         * <strong>example:</strong>
         * <p>false</p>
         */
        ...
        /**
         * <p>Specifies whether the creator of an object has access permissions on the object. Default value: true.</p>
         * 
         * <strong>example:</strong>
         * <p>true</p>
         */
        ...
        /**
         * <p>Specifies whether the creator of an object has grant permissions on the object. Default value: true.</p>
         * 
         * <strong>example:</strong>
         * <p>true</p>
         */
        ...
        /**
         * <p>The properties of the &lt;props=&quot;intl&quot;&gt;<a href="https://www.alibabacloud.com/help/en/maxcompute/security-and-compliance/project-data-protection">data protection mechanism</a>.</p>
         */
        @NameInMap("projectProtection")
        public GetProjectResponseBodyDataSecurityPropertiesProjectProtection projectProtection;

        /**
         * <p>Specifies whether to use the &lt;props=&quot;intl&quot;&gt;<a href="https://www.alibabacloud.com/help/en/maxcompute/user-guide/acl-based-access-control">ACL-based access control</a> feature. By default, this feature is enabled.</p>
         * 
         * <strong>example:</strong>
         * <p>true</p>
         */
        ...
        /**
         * <p>Specifies whether to use the &lt;props=&quot;intl&quot;&gt;<a href="https://www.alibabacloud.com/help/en/maxcompute/user-guide/policy-based-access-control-1">policy-based access control</a> feature. By default, this feature is enabled.</p>
         * 
         * <strong>example:</strong>
         * <p>true</p>
         */
    ...
    public static class GetProjectResponseBodyData extends TeaModel {
        ...
        /**
         * <p>The total storage usage. This value indicates the logical storage size after data is collected and compressed for the project. The storage usage is the same as the usage for billing.</p>
         * 
         * <strong>example:</strong>
         * <p>16489027</p>
         */
         ...
         * <ul>
         * <li><p><strong>AVAILABLE</strong>: Normal</p>
         * </li>
         * <li><p><strong>READONLY</strong>: read-only</p>
         * </li>
         * <li><p><strong>FROZEN</strong>: frozen</p>
         * </li>
        ...
        /**
         * <p>The list of members that are assigned the <code>Super_Administrator</code> role in the project.</p>
         */
        @NameInMap("superAdmins")
        public java.util.List<String> superAdmins;

        /**
         * <p>Specifies whether data storage by schema is supported. MaxCompute supports schemas. A schema is an object in a project. It is used to classify objects such as tables, resources, and user-defined functions (UDFs). You can create multiple schemas in a project. For more information, see &lt;props=&quot;intl&quot;&gt;<a href="https://www.alibabacloud.com/help/en/maxcompute/user-guide/schema-related-operations">Schema operations</a>.</p>
         * 
         * <strong>example:</strong>
         * <p>true</p>
         */
