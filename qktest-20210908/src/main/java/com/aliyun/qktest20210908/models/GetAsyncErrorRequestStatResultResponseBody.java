...
public class GetAsyncErrorRequestStatResultResponseBody extends TeaModel {
    ...
    public static class GetAsyncErrorRequestStatResultResponseBodyDataResult extends TeaModel {
        @NameInMap("stat")
        public java.util.List<java.util.Map<String, DataResultValue>> stat;

        public static GetAsyncErrorRequestStatResultResponseBodyDataResult build(java.util.Map<String, ?> map) throws Exception {
            GetAsyncErrorRequestStatResultResponseBodyDataResult self = new GetAsyncErrorRequestStatResultResponseBodyDataResult();
            return TeaModel.build(map, self);
        }

        public GetAsyncErrorRequestStatResultResponseBodyDataResult setStat(java.util.List<java.util.Map<String, DataResultValue>> stat) {
            this.stat = stat;
            return this;
        }
        public java.util.List<java.util.Map<String, DataResultValue>> getStat() {
            return this.stat;
        }
    ...
    public static class GetAsyncErrorRequestStatResultResponseBodyData extends TeaModel {
        ...
        @NameInMap("result")
        public GetAsyncErrorRequestStatResultResponseBodyDataResult result;
        ...
        public GetAsyncErrorRequestStatResultResponseBodyData setResult(GetAsyncErrorRequestStatResultResponseBodyDataResult result) {
            this.result = result;
            return this;
        }
        public GetAsyncErrorRequestStatResultResponseBodyDataResult getResult() {
            return this.result;
        }
