...
public class UpdateProjectMemberResponseBody extends TeaModel {
    ...
    public UpdateProjectMemberResponseBody setCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public UpdateProjectMemberResponseBody setHttpStatusCode(Integer httpStatusCode) {
    ...
    public UpdateProjectMemberResponseBody setMessage(String message) {
