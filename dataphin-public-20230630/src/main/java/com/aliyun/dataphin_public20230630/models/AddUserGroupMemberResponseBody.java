...
public class AddUserGroupMemberResponseBody extends TeaModel {
    ...
    public AddUserGroupMemberResponseBody setCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public AddUserGroupMemberResponseBody setData(Boolean data) {
        this.data = data;
        return this;
    }
    ...
    public AddUserGroupMemberResponseBody setHttpStatusCode(Integer httpStatusCode) {
    ...
    public AddUserGroupMemberResponseBody setMessage(String message) {
