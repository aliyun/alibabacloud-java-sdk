...
public class UpdateUserGroupResponseBody extends TeaModel {
    ...
    /**
     * <p>The result of the edit operation.</p>
     * 
     * <strong>example:</strong>
     * <p>true</p>
     */
    ...
    public UpdateUserGroupResponseBody setData(Boolean data) {
        this.data = data;
        return this;
    }
    ...
    public UpdateUserGroupResponseBody setHttpStatusCode(Integer httpStatusCode) {
