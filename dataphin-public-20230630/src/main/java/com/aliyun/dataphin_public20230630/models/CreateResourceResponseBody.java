...
public class CreateResourceResponseBody extends TeaModel {
    ...
    /**
     * <p>The ID of the resource file.</p>
     * 
     * <strong>example:</strong>
     * <p>10112101</p>
     */
    ...
    public CreateResourceResponseBody setCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public CreateResourceResponseBody setHttpStatusCode(Integer httpStatusCode) {
    ...
    public CreateResourceResponseBody setMessage(String message) {
    ...
    public CreateResourceResponseBody setSuccess(Boolean success) {
