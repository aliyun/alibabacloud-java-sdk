...
public class UpdateResourceResponseBody extends TeaModel {
    ...
    public UpdateResourceResponseBody setCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public UpdateResourceResponseBody setHttpStatusCode(Integer httpStatusCode) {
    ...
    public UpdateResourceResponseBody setMessage(String message) {
