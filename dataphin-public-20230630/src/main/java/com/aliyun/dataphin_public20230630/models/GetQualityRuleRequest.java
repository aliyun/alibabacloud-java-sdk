...
public class GetQualityRuleRequest extends TeaModel {
    ...
    public GetQualityRuleRequest setId(Long id) {
        this.id = id;
        return this;
    }
    public Long getId() {
    ...
    public GetQualityRuleRequest setOpTenantId(Long opTenantId) {
    ...
    public GetQualityRuleRequest setOpUserId(String opUserId) {
