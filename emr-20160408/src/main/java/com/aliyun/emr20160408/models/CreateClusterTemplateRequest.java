...
public class CreateClusterTemplateRequest extends TeaModel {
    ...
    public CreateClusterTemplateRequest setAutoRenew(Boolean autoRenew) {
    ...
    public CreateClusterTemplateRequest setHighAvailabilityEnable(Boolean highAvailabilityEnable) {
    ...
    public CreateClusterTemplateRequest setIoOptimized(Boolean ioOptimized) {
    ...
    public CreateClusterTemplateRequest setSshEnable(Boolean sshEnable) {
    ...
    public CreateClusterTemplateRequest setEasEnable(Boolean easEnable) {
    ...
    public static class CreateClusterTemplateRequestBootstrapAction extends TeaModel {
        ...
        public CreateClusterTemplateRequestBootstrapAction setExecutionFailStrategy(String executionFailStrategy) {
        ...
        public CreateClusterTemplateRequestBootstrapAction setExecutionTarget(String executionTarget) {
        ...
        public CreateClusterTemplateRequestBootstrapAction setExecutionMoment(String executionMoment) {
