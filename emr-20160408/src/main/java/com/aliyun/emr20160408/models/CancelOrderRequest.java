...
public class CancelOrderRequest extends TeaModel {
    ...
    public CancelOrderRequest setResourceOwnerId(Long resourceOwnerId) {
    ...
    public CancelOrderRequest setRegionId(String regionId) {
    ...
    public CancelOrderRequest setClusterId(String clusterId) {
