...
public class ModifyFlowRequest extends TeaModel {
    ...
    public ModifyFlowRequest setNamespace(String namespace) {
    ...
    public ModifyFlowRequest setLogArchiveLocation(String logArchiveLocation) {
    ...
    public ModifyFlowRequest setLifecycle(String lifecycle) {
