...
public class CreateClusterV2Request extends TeaModel {
    ...
    public CreateClusterV2Request setAutoRenew(Boolean autoRenew) {
    ...
    public CreateClusterV2Request setHighAvailabilityEnable(Boolean highAvailabilityEnable) {
    ...
    public CreateClusterV2Request setIoOptimized(Boolean ioOptimized) {
    ...
    public CreateClusterV2Request setSshEnable(Boolean sshEnable) {
    ...
    public CreateClusterV2Request setEasEnable(Boolean easEnable) {
    ...
    public CreateClusterV2Request setOptionSoftWareList(java.util.List<String> optionSoftWareList) {
    ...
    public static class CreateClusterV2RequestBootstrapAction extends TeaModel {
        ...
        public CreateClusterV2RequestBootstrapAction setExecutionFailStrategy(String executionFailStrategy) {
        ...
        public CreateClusterV2RequestBootstrapAction setExecutionTarget(String executionTarget) {
        ...
        public CreateClusterV2RequestBootstrapAction setExecutionMoment(String executionMoment) {
