...
public class CreateFlowJobRequest extends TeaModel {
    ...
    public CreateFlowJobRequest setMaxRetry(Integer maxRetry) {
    ...
    public CreateFlowJobRequest setMaxRunningTimeSec(Long maxRunningTimeSec) {
    ...
    public CreateFlowJobRequest setRetryInterval(Long retryInterval) {
