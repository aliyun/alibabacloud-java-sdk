...
public class Id3MetaVerifyPROAdvanceRequest extends TeaModel {
    /**
    ...
    public static Id3MetaVerifyPROAdvanceRequest build(java.util.Map<String, ?> map) throws Exception {
        Id3MetaVerifyPROAdvanceRequest self = new Id3MetaVerifyPROAdvanceRequest();
        return TeaModel.build(map, self);
    }

    public Id3MetaVerifyPROAdvanceRequest setCrop(String crop) {
        this.crop = crop;
        return this;
    }
    ...
    public Id3MetaVerifyPROAdvanceRequest setEnableFallback(String enableFallback) {
    ...
    public Id3MetaVerifyPROAdvanceRequest setFaceFileObject(java.io.InputStream faceFileObject) {
    ...
    public Id3MetaVerifyPROAdvanceRequest setFacePicture(String facePicture) {
    ...
    public Id3MetaVerifyPROAdvanceRequest setFaceUrl(String faceUrl) {
    ...
    public Id3MetaVerifyPROAdvanceRequest setIdentifyNum(String identifyNum) {
    ...
    public Id3MetaVerifyPROAdvanceRequest setLivenessCheck(String livenessCheck) {
    ...
    public Id3MetaVerifyPROAdvanceRequest setParamType(String paramType) {
    ...
    public Id3MetaVerifyPROAdvanceRequest setUserName(String userName) {
