...
public class Id3MetaVerifyAdvanceRequest extends TeaModel {
    /**
    ...
    public static Id3MetaVerifyAdvanceRequest build(java.util.Map<String, ?> map) throws Exception {
        Id3MetaVerifyAdvanceRequest self = new Id3MetaVerifyAdvanceRequest();
        return TeaModel.build(map, self);
    }

    public Id3MetaVerifyAdvanceRequest setCrop(String crop) {
        this.crop = crop;
        return this;
    }
    ...
    public Id3MetaVerifyAdvanceRequest setFaceFileObject(java.io.InputStream faceFileObject) {
    ...
    public Id3MetaVerifyAdvanceRequest setFacePicture(String facePicture) {
    ...
    public Id3MetaVerifyAdvanceRequest setFaceUrl(String faceUrl) {
    ...
    public Id3MetaVerifyAdvanceRequest setIdentifyNum(String identifyNum) {
    ...
    public Id3MetaVerifyAdvanceRequest setParamType(String paramType) {
    ...
    public Id3MetaVerifyAdvanceRequest setUserName(String userName) {
