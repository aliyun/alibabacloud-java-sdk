...
public class DetectFaceAttributesResponse extends TeaModel {
    ...
    public static class DetectFaceAttributesResponseDataFaceInfosFaceAttributesDetectInfoFaceAttributesGender extends TeaModel {
        @NameInMap("Score")
        @Validation(required = true)
        public Float score;
        ...
        public static DetectFaceAttributesResponseDataFaceInfosFaceAttributesDetectInfoFaceAttributesGender build(java.util.Map<String, ?> map) throws Exception {
            DetectFaceAttributesResponseDataFaceInfosFaceAttributesDetectInfoFaceAttributesGender self = new DetectFaceAttributesResponseDataFaceInfosFaceAttributesDetectInfoFaceAttributesGender();
            return TeaModel.build(map, self);
        }

        public DetectFaceAttributesResponseDataFaceInfosFaceAttributesDetectInfoFaceAttributesGender setScore(Float score) {
            this.score = score;
            return this;
        }
        ...
        public DetectFaceAttributesResponseDataFaceInfosFaceAttributesDetectInfoFaceAttributesGender setValue(String value) {
            this.value = value;
            return this;
        }
    ...
    public static class DetectFaceAttributesResponseDataFaceInfosFaceAttributesDetectInfoFaceAttributes extends TeaModel {
        ...
        @NameInMap("Gender")
        @Validation(required = true)
        public DetectFaceAttributesResponseDataFaceInfosFaceAttributesDetectInfoFaceAttributesGender gender;
        ...
        public DetectFaceAttributesResponseDataFaceInfosFaceAttributesDetectInfoFaceAttributes setAge(Integer age) {
            this.age = age;
            return this;
        }
        ...
        public DetectFaceAttributesResponseDataFaceInfosFaceAttributesDetectInfoFaceAttributes setEthnicity(String ethnicity) {
        ...
        public DetectFaceAttributesResponseDataFaceInfosFaceAttributesDetectInfoFaceAttributes setGender(DetectFaceAttributesResponseDataFaceInfosFaceAttributesDetectInfoFaceAttributesGender gender) {
            this.gender = gender;
            return this;
        }
        public DetectFaceAttributesResponseDataFaceInfosFaceAttributesDetectInfoFaceAttributesGender getGender() {
            return this.gender;
        }
