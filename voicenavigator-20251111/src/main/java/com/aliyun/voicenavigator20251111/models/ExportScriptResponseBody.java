...
public class ExportScriptResponseBody extends TeaModel {
    ...
    /**
     * <strong>example:</strong>
     * <p>83C6DA11-798F-5524-AB1D-555263E7A400</p>
     */
    @NameInMap("RequestId")
    ...
    public ExportScriptResponseBody setData(String data) {
        this.data = data;
        return this;
    }
    ...
    public ExportScriptResponseBody setParams(java.util.List<String> params) {
        this.params = params;
        return this;
    }
