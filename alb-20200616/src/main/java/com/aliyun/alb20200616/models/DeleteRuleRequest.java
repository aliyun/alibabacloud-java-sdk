...
public class DeleteRuleRequest extends TeaModel {
     ...
     * <li><strong>false</strong>: performs a dry run and sends the request. If the request passes the dry run, the <code>HTTP_2xx</code> status code is returned and the operation is performed. This is the default value.</li>
     * </ul>
     * 
     * <strong>example:</strong>
     * <p>true</p>
