...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    public CreateResourceResponse createResourceWithOptions(String provider, String productCode, String resourceTypeCode, CreateResourceRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            ...
            new TeaPair("version", "2022-06-06"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/api/v1/providers/" + com.aliyun.openapiutil.Client.getEncodeParam(provider) + "/products/" + com.aliyun.openapiutil.Client.getEncodeParam(productCode) + "/resourceTypes/" + com.aliyun.openapiutil.Client.getEncodeParam(resourceTypeCode) + "/resources"),
    ...
    public DeleteResourceResponse deleteResourceWithOptions(String provider, String productCode, String resourceTypeCode, String resourceId, DeleteResourceRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.clientToken)) {
            query.put("clientToken", request.clientToken);
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            ...
            new TeaPair("version", "2022-06-06"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/api/v1/providers/" + com.aliyun.openapiutil.Client.getEncodeParam(provider) + "/products/" + com.aliyun.openapiutil.Client.getEncodeParam(productCode) + "/resourceTypes/" + com.aliyun.openapiutil.Client.getEncodeParam(resourceTypeCode) + "/resources/" + com.aliyun.openapiutil.Client.getEncodeParam(resourceId) + ""),
    ...
    public GetResourceResponse getResourceWithOptions(String provider, String productCode, String resourceTypeCode, String resourceId, GetResourceRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.regionId)) {
            query.put("regionId", request.regionId);
    ...
    public GetResourceTypeResponse getResourceTypeWithOptions(String provider, String productCode, String resourceTypeCode, GetResourceTypeRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.resourceTypeVersion)) {
            query.put("resourceTypeVersion", request.resourceTypeVersion);
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            ...
            new TeaPair("version", "2022-06-06"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/api/v1/providers/" + com.aliyun.openapiutil.Client.getEncodeParam(provider) + "/products/" + com.aliyun.openapiutil.Client.getEncodeParam(productCode) + "/resourceTypes/" + com.aliyun.openapiutil.Client.getEncodeParam(resourceTypeCode) + ""),
            new TeaPair("method", "GET"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "json"),
    ...
    public ListDataSourcesResponse listDataSourcesWithOptions(String provider, String productCode, String resourceTypeCode, String attributeName, ListDataSourcesRequest tmpReq, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            ...
            new TeaPair("version", "2022-06-06"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/api/v1/providers/" + com.aliyun.openapiutil.Client.getEncodeParam(provider) + "/products/" + com.aliyun.openapiutil.Client.getEncodeParam(productCode) + "/resourceTypes/" + com.aliyun.openapiutil.Client.getEncodeParam(resourceTypeCode) + "/dataSources/" + com.aliyun.openapiutil.Client.getEncodeParam(attributeName) + ""),
            new TeaPair("method", "GET"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "json"),
    ...
    public ListProductsResponse listProductsWithOptions(String provider, ListProductsRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
    ...
    public ListResourceTypesResponse listResourceTypesWithOptions(String provider, String productCode, ListResourceTypesRequest tmpReq, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(tmpReq);
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            ...
            new TeaPair("version", "2022-06-06"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/api/v1/providers/" + com.aliyun.openapiutil.Client.getEncodeParam(provider) + "/products/" + com.aliyun.openapiutil.Client.getEncodeParam(productCode) + "/resourceTypes"),
            new TeaPair("method", "GET"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "json"),
    ...
    public ListResourcesResponse listResourcesWithOptions(String provider, String productCode, String resourceTypeCode, ListResourcesRequest tmpReq, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(tmpReq);
    ...
    public UpdateResourceResponse updateResourceWithOptions(String provider, String productCode, String resourceTypeCode, String resourceId, UpdateResourceRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.clientToken)) {
            query.put("clientToken", request.clientToken);
