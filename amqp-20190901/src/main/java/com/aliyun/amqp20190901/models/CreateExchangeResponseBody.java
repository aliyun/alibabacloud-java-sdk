...
public class CreateExchangeResponseBody extends TeaModel {
    ...
    public CreateExchangeResponseBody setCode(Integer code) {
        this.code = code;
        return this;
    }
    ...
    public CreateExchangeResponseBody setData(Boolean data) {
        this.data = data;
        return this;
    }
    ...
    public CreateExchangeResponseBody setMessage(String message) {
    ...
    public CreateExchangeResponseBody setSuccess(Boolean success) {
