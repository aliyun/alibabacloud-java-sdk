...
public class ListExchangeUpstreamBindingsRequest extends TeaModel {
    ...
    public ListExchangeUpstreamBindingsRequest setConsoleSessionId(String consoleSessionId) {
    ...
    public ListExchangeUpstreamBindingsRequest setCurrentPage(Integer currentPage) {
    ...
    public ListExchangeUpstreamBindingsRequest setPageSize(Integer pageSize) {
    ...
    public ListExchangeUpstreamBindingsRequest setVhostName(String vhostName) {
