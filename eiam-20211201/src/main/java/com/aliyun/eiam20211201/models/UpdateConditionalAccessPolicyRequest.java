...
public class UpdateConditionalAccessPolicyRequest extends TeaModel {
    /**
     * <p>The client token that is used to ensure the idempotence of the request. The value of this parameter is generated by the client and must be unique across different requests.</p>
     * 
    ...
    public static class UpdateConditionalAccessPolicyRequestDecisionConfig extends TeaModel {
        ...
        /**
         * <p>The interval in seconds for repeated MFA authentication of the conditional access policy.</p>
         * 
         * <strong>example:</strong>
         * <p>300</p>
         */
