...
public class Credential extends TeaModel {
    ...
    public Credential setCreatedAt(String createdAt) {
    ...
    public Credential setCredentialAuthType(String credentialAuthType) {
    ...
    public Credential setCredentialId(String credentialId) {
    ...
    public Credential setCredentialName(String credentialName) {
    ...
    public Credential setCredentialSecret(String credentialSecret) {
    ...
    public Credential setCredentialSourceType(String credentialSourceType) {
    ...
    public Credential setEnabled(Boolean enabled) {
    ...
    public Credential setRelatedResources(java.util.List<RelatedResource> relatedResources) {
    ...
    public Credential setUpdatedAt(String updatedAt) {
