...
package com.aliyun.vcs20190430;

import com.aliyun.tea.*;
import com.aliyun.vcs20190430.models.*;
...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    public CreateComputeTaskResponse createComputeTaskWithOptions(CreateComputeTaskRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.algorithmCodeList)) {
            query.put("AlgorithmCodeList", request.algorithmCodeList);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.deviceCodeList)) {
            query.put("DeviceCodeList", request.deviceCodeList);
        }
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.vcsId)) {
            query.put("VcsId", request.vcsId);
        }
    ...
    public CreateProjectResponse createProjectWithOptions(CreateProjectRequest request, RuntimeOptions runtime) throws Exception {
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.timeZoneCode)) {
            query.put("TimeZoneCode", request.timeZoneCode);
        }
    ...
    public DescribeComputeTasksResponse describeComputeTasksWithOptions(DescribeComputeTasksRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        ...
        Params params = Params.build(TeaConverter.buildMap(
            new TeaPair("action", "DescribeComputeTasks"),
            new TeaPair("version", "2019-04-30"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new DescribeComputeTasksResponse());
    }

    public DescribeComputeTasksResponse describeComputeTasks(DescribeComputeTasksRequest request) throws Exception {
        RuntimeOptions runtime = new RuntimeOptions();
    ...
    public DescribeProjectsResponse describeProjectsWithOptions(DescribeProjectsRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.pageNum)) {
            query.put("PageNum", request.pageNum);
    ...
    public GetPictureSearchResultsResponse getPictureSearchResultsWithOptions(GetPictureSearchResultsRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.pictureContents)) {
            query.put("PictureContents", request.pictureContents);
        }
        ...
        Params params = Params.build(TeaConverter.buildMap(
            new TeaPair("action", "GetPictureSearchResults"),
            new TeaPair("version", "2019-04-30"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new GetPictureSearchResultsResponse());
    }

    public GetPictureSearchResultsResponse getPictureSearchResults(GetPictureSearchResultsRequest request) throws Exception {
        RuntimeOptions runtime = new RuntimeOptions();
        return this.getPictureSearchResultsWithOptions(request, runtime);
    }

    public ImportDevicesResponse importDevicesWithOptions(ImportDevicesRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.deviceList)) {
            query.put("DeviceList", request.deviceList);
        ...
        Params params = Params.build(TeaConverter.buildMap(
            new TeaPair("action", "ImportDevices"),
            new TeaPair("version", "2019-04-30"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new ImportDevicesResponse());
    }

    public ImportDevicesResponse importDevices(ImportDevicesRequest request) throws Exception {
        RuntimeOptions runtime = new RuntimeOptions();
