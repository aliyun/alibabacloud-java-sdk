...
public class GenerateCopilotResponseResponseBody extends TeaModel {
    ...
    /**
     * <p>Data returned by the LLM service, in string format. If it is a dict, you must perform conversion and parsing yourself.</p>
     * 
     * <strong>example:</strong>
    ...
    /**
     * <p>Description of the error code. This field is empty if there is no error.</p>
     * 
     * <strong>example:</strong>
