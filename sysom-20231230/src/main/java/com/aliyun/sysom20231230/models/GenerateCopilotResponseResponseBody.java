...
public class GenerateCopilotResponseResponseBody extends TeaModel {
    ...
    /**
     * <p>Data returned by the LLM service, in string type. If it is a dict, you need to convert and parse it yourself</p>
     * 
     * <strong>example:</strong>
    ...
    /**
     * <p>Error code description, empty if no error occurs</p>
     * 
     * <strong>example:</strong>
