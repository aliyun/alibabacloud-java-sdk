...
public class GenerateCopilotStreamResponseResponseBody extends TeaModel {
    ...
    /**
     * <p>The data returned by the LLM service. The value is of the string type. Convert and parse it yourself if the value is a dictionary.</p>
     * 
     * <strong>example:</strong>
    ...
    /**
     * <p>The description of the error code. This value is empty if no error occurs.</p>
     * 
     * <strong>example:</strong>
