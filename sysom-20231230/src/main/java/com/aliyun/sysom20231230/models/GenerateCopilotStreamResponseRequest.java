...
public class GenerateCopilotStreamResponseRequest extends TeaModel {
    /**
     * <p>Input parameter for integrating with the Copilot LLM service. Refer to the standard LLM API input parameter dictionary, convert it into a string, and pass it in llmParamString.</p>
     * 
