...
public class ListLiveFilesResponseBody extends TeaModel {
    ...
    public ListLiveFilesResponseBody setFileName(String fileName) {
    ...
    public ListLiveFilesResponseBody setMaxResults(Integer maxResults) {
    ...
    public ListLiveFilesResponseBody setNextToken(String nextToken) {
    ...
    public ListLiveFilesResponseBody setTotalCount(Integer totalCount) {
