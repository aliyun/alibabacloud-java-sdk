...
public class ListDeviceResponseBody extends TeaModel {
    ...
    public ListDeviceResponseBody setCode(Integer code) {
        this.code = code;
        return this;
    }
    ...
    public static class ListDeviceResponseBodyDataPageData extends TeaModel {
        ...
        public ListDeviceResponseBodyDataPageData setIotId(String iotId) {
            this.iotId = iotId;
            return this;
        }
        ...
        public ListDeviceResponseBodyDataPageData setLastSaveTime(Long lastSaveTime) {
