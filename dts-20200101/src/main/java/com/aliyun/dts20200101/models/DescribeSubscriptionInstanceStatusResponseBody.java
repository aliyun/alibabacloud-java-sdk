...
public class DescribeSubscriptionInstanceStatusResponseBody extends TeaModel {
     ...
     * <br>
     * <p>>  This parameter is returned only if your change tracking instance is of the new version and you have called the [CreateConsumerGroup](~~122863~~) operation to create a consumer group.</p>
     */
