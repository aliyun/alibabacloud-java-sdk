...
public class SuspendDtsJobResponseBody extends TeaModel {
     ...
     * <blockquote>
     * <p>For example, if the <strong>ErrMessage</strong> parameter returns <strong>The Value of Input Parameter %s is not valid</strong> and the <strong>DynamicMessage</strong> parameter returns <strong>DtsJobId</strong>, the request parameter <strong>DtsJobId</strong> is invalid.</p>
     * </blockquote>
     * 
     * <strong>example:</strong>
     * <p>DtsJobId</p>
    ...
    public static SuspendDtsJobResponseBody build(java.util.Map<String, ?> map) throws Exception {
