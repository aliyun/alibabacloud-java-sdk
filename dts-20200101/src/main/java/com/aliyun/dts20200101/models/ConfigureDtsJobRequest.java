...
public class ConfigureDtsJobRequest extends TeaModel {
    ...
    public ConfigureDtsJobRequest setDestPrimaryVswId(String destPrimaryVswId) {
    ...
    public ConfigureDtsJobRequest setDestSecondaryVswId(String destSecondaryVswId) {
    ...
    public ConfigureDtsJobRequest setSrcPrimaryVswId(String srcPrimaryVswId) {
    ...
    public ConfigureDtsJobRequest setSrcSecondaryVswId(String srcSecondaryVswId) {
