...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    /**
     * <b>summary</b> : 
     * <p>Retrieves a list of user labels.</p>
     * 
     * @param tmpReq ListSaseUserTagsRequest
     * @param runtime runtime options for this request RuntimeOptions
     * @return ListSaseUserTagsResponse
     */
    public ListSaseUserTagsResponse listSaseUserTagsWithOptions(ListSaseUserTagsRequest tmpReq, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(tmpReq);
        ListSaseUserTagsShrinkRequest request = new ListSaseUserTagsShrinkRequest();
        com.aliyun.openapiutil.Client.convert(tmpReq, request);
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "ListSaseUserTags"),
            new TeaPair("version", "2023-01-20"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new ListSaseUserTagsResponse());
    }
     ...
     * @return ListSaseUserTagsResponse
     */
    public ListSaseUserTagsResponse listSaseUserTags(ListSaseUserTagsRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
