...
public class DescribeLiveMessageAppRequest extends TeaModel {
    /**
    ...
    public static DescribeLiveMessageAppRequest build(java.util.Map<String, ?> map) throws Exception {
        DescribeLiveMessageAppRequest self = new DescribeLiveMessageAppRequest();
        return TeaModel.build(map, self);
    }

    public DescribeLiveMessageAppRequest setAppId(String appId) {
        this.appId = appId;
        return this;
    }
    ...
    public DescribeLiveMessageAppRequest setDataCenter(String dataCenter) {
