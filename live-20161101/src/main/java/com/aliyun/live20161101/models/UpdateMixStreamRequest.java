...
public class UpdateMixStreamRequest extends TeaModel {
     ...
     * <p>Notice: </p>
     * </blockquote>
     * <p>Only domain names in the China (Shanghai) and China (Beijing) regions are supported.</p>
    ...
    /**
     * <p>The list of input streams for the mix. This is a JSON array.</p>
    ...
    /**
     * <p>The layout ID. The following values are supported:</p>
     * <ul>
     * <li><p><strong>MixStreamLayout-1-1</strong></p>
     * </li>
     * <li><p><strong>MixStreamLayout-2-1</strong></p>
     * </li>
     * <li><p><strong>MixStreamLayout-2-2</strong></p>
     * </li>
     * <li><p><strong>MixStreamLayout-2-3</strong></p>
     * </li>
     * <li><p><strong>MixStreamLayout-3-1</strong></p>
     * </li>
     * <li><p><strong>MixStreamLayout-3-2</strong></p>
     * </li>
     * <li><p><strong>MixStreamLayout-4-1</strong></p>
     * </li>
     * <li><p><strong>USERDEFINED</strong> (If you use a custom layout instead of a preset layout, set this parameter to this value.)</p>
     * </li>
     * </ul>
     * 
     * <strong>example:</strong>
    ...
    /**
     * <p>The ID of the stream mix task. If you created the task by calling the <a href="https://help.aliyun.com/document_detail/2848087.html">CreateMixStream</a> operation, use the MixStreamId value returned in the response.</p>
     * <p>This parameter is required.</p>
     * 
     * <strong>example:</strong>
