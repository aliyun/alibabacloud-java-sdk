...
public class AddLivePullStreamInfoConfigRequest extends TeaModel {
    /**
     * <p>The custom name of the application.</p>
    ...
    /**
     * <p>The streaming domain where the ingested stream will be hosted and distributed from.</p>
     * <p>This parameter is required.</p>
     * 
     * <strong>example:</strong>
     * <p>example.com</p>
     ...
     * <p>The time range specified by the StartTime and EndTime parameters cannot exceed seven days. The time must be later than the current time. Specify the value in the ISO 8601 standard in the <em>yyyy-MM-dd</em>T<em>HH:mm:ss</em>Z format. The time must be in UTC.</p>
     * <p>This parameter is required.</p>
     * 
     * <strong>example:</strong>
     ...
     * <blockquote>
     * <p>You can pull only live streams in the RTMP, FLV, HLS, and SRT formats.</p>
     * </blockquote>
     * <p>This parameter is required.</p>
     */
    @NameInMap("SourceUrl")
    ...
    /**
     * <p>The time when stream pulling starts. Specify the time in the ISO 8601 standard in the <em>yyyy-MM-dd</em>T<em>HH:mm:ss</em>Z format. The time must be in UTC.</p>
     * <p>This parameter is required.</p>
     * 
     * <strong>example:</strong>
    ...
    /**
     * <p>The custom name of the live stream.</p>
     * <p>This parameter is required.</p>
     * 
     * <strong>example:</strong>
     * <p>liveStream****</p>
