...
public class UpdateLivePullToPushRequest extends TeaModel {
    ...
    public UpdateLivePullToPushRequest setAuthKey(String authKey) {
    ...
    public UpdateLivePullToPushRequest setNotifyItemSwitch(String notifyItemSwitch) {
    ...
    public UpdateLivePullToPushRequest setReqAuth(String reqAuth) {
