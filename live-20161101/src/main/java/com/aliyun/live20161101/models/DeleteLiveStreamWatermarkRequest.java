...
public class DeleteLiveStreamWatermarkRequest extends TeaModel {
     ...
     * <blockquote>
     * <p>The template ID is returned in the response of the <a href="https://help.aliyun.com/document_detail/2848096.html">AddLiveStreamWatermark</a> operation.</p>
     * </blockquote>
    ...
    public DeleteLiveStreamWatermarkRequest setRegionId(String regionId) {
