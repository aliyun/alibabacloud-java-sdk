...
import com.aliyun.resellertrade20220920.models.*;
...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    public GetResellerBillResponse getResellerBillWithOptions(GetResellerBillRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "GetResellerBill"),
            new TeaPair("version", "2022-09-20"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new GetResellerBillResponse());
    }

    public GetResellerBillResponse getResellerBill(GetResellerBillRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        return this.getResellerBillWithOptions(request, runtime);
    }
}
