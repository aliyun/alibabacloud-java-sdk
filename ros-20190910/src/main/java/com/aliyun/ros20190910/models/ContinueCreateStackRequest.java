...
public class ContinueCreateStackRequest extends TeaModel {
     ...
     * <ul>
     * <li><p>true: only validates the stack.</p>
     * </li>
     * <li><p>false (default): validates and continues to create the stack.</p>
     * </li>
     * </ul>
     * 
     ...
     * <ul>
     * <li><p>Resources that fail to be created</p>
     * </li>
     * <li><p>Resources that you specify for RecreatingResources.N</p>
     * </li>
     * <li><p>Dependencies of the resources that you specify for RecreatingResources.N</p>
     * </li>
     * <li><p>Resources that you have not created</p>
     * </li>
     * </ul>
     * </li>
     * </ul>
     ...
     * <li><p>Ignore</p>
     * <ul>
     * <li><p>ROS ignores and discards resources that fail to be created and you have not created, and considers that the stack is successfully created.</p>
     * </li>
     * <li><p>The body of the template that you use to create the stack is changed.</p>
     * </li>
     * </ul>
     * </li>
     * </ul>
     ...
     * </li>
     * <li><p>If you set this parameter to 0, no limit is imposed on ROS stacks. However, the default value in Terraform is used for Terraform stacks. In most cases, the default value in Terraform is 10.</p>
     * </li>
     * <li><p>If you leave this parameter empty, the value that you specified for this parameter in the previous request is used. If you left this parameter empty in the previous request, no limit is imposed on ROS stacks. However, the default value in Terraform is used for Terraform stacks. In most cases, the default value in Terraform is 10.</p>
     * </li>
     * <li><p>If you set this parameter to a specific value, ROS associates the value with the stack. The value affects subsequent operations on the stack.</p>
     * </li>
     * </ul>
     * </blockquote>
     * 
    ...
    /**
     * <p>The name of the RAM role. Resource Orchestration Service (ROS) assumes the RAM role to create the stack and uses the credentials of the role to call the APIs of Alibaba Cloud services.<br>
     ...
     * <ul>
     * <li><p>You cannot delete the resources or change the template body for the resources that you do not want to continue to create.</p>
     * </li>
     * <li><p>You can delete the resources or change the template body for the resources that you want to continue to create.</p>
     * </li>
     * <li><p>You can add resources to this section.</p>
     * </li>
     * </ul>
     * </li>
     * </ul>
     * <blockquote>
     * <ul>
     * <li><p>This parameter takes effect only when Mode is set to Recreate.</p>
     * </li>
     * <li><p>You can specify only one of the following parameters: TemplateBody, TemplateURL, and TemplateId. If you do not specify the parameters, the existing template is used.</p>
     * </li>
     * </ul>
     * </blockquote>
     * 
     ...
     * <blockquote>
     * <ul>
     * <li><p>This parameter takes effect when <code>Mode</code> is set to <code>Recreate</code>. When you specify TemplateId of a template, the template is subject to the limits that are described for <code>TemplateBody</code> in this topic.</p>
     * </li>
     * <li><p>You can specify only one of the following parameters: <code>TemplateBody</code>, <code>TemplateURL</code>, and <code>TemplateId</code>. If you do not specify the parameters, the existing template is used.</p>
     * </li>
     * </ul>
     * </blockquote>
     * 
     ...
     * <blockquote>
     * <ul>
     * <li><p>This parameter takes effect only when Mode is set to Recreate. When you specify TemplateURL of a template, the template is subject to the limits that are described for TemplateBody in this topic.</p>
     * </li>
     * <li><p>You can specify only one of the following parameters: TemplateBody, TemplateURL, and TemplateId. If you do not specify the parameters, the existing template is used.</p>
     * </li>
     * </ul>
    ...
    public static class ContinueCreateStackRequestParameters extends TeaModel {
         ...
         * <ul>
         * <li><p>You cannot change the condition values in the Conditions section of a template from true to false or from false to true.</p>
         * </li>
         * <li><p>The template parameters can be referenced only by resources that ROS continues to create.</p>
         * </li>
         * </ul>
         * <blockquote>
         * <p>This parameter takes effect only when Mode is set to Recreate.</p>
