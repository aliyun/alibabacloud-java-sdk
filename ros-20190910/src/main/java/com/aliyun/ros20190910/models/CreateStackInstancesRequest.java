...
public class CreateStackInstancesRequest extends TeaModel {
    ...
    public static class CreateStackInstancesRequestDeploymentTargets extends TeaModel {
         ...
         * <br>
         * <p>> To view the folder IDs, go to the **Overview** page in the **Resource Management** console. For more information, see [View the basic information about a folder](https://help.aliyun.com/document_detail/111223.html).</p>
         */
