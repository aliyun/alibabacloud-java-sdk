...
public class UpdateStackGroupRequest extends TeaModel {
    ...
    public static class UpdateStackGroupRequestAutoDeployment extends TeaModel {
         ...
         * <br>
         * <p>>  To view the member IDs, go to the **Overview** page in the **Resource Management** console. For more information, see [View the detailed information of a member](https://help.aliyun.com/document_detail/111624.html).</p>
         */
        @NameInMap("Enabled")
