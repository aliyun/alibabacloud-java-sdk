...
public class GetStackResponse extends TeaModel {
    ...
    @NameInMap("Tags")
    @Validation(required = true)
    public java.util.List<GetStackResponseTags> tags;
    ...
    public GetStackResponse setTags(java.util.List<GetStackResponseTags> tags) {
        this.tags = tags;
        return this;
    }
    public java.util.List<GetStackResponseTags> getTags() {
        return this.tags;
    }
    ...
    public static class GetStackResponseTags extends TeaModel {
        @NameInMap("Key")
        @Validation(required = true)
        public String key;
        ...
        public static GetStackResponseTags build(java.util.Map<String, ?> map) throws Exception {
            GetStackResponseTags self = new GetStackResponseTags();
            return TeaModel.build(map, self);
        }

        public GetStackResponseTags setKey(String key) {
            this.key = key;
            return this;
        }
        ...
        public GetStackResponseTags setValue(String value) {
            this.value = value;
            return this;
        }
