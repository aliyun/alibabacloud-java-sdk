...
public class QueryMaterialResponseBody extends TeaModel {
    ...
    public static class QueryMaterialResponseBodyReviewAdditionalFiles extends TeaModel {
        ...
        public static QueryMaterialResponseBodyReviewAdditionalFiles build(java.util.Map<String, ?> map) throws Exception {
            QueryMaterialResponseBodyReviewAdditionalFiles self = new QueryMaterialResponseBodyReviewAdditionalFiles();
            return TeaModel.build(map, self);
        }

        public QueryMaterialResponseBodyReviewAdditionalFiles setReviewAdditionalFile(java.util.List<String> reviewAdditionalFile) {
