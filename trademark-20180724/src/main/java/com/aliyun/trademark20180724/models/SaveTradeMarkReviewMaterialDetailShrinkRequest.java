...
public class SaveTradeMarkReviewMaterialDetailShrinkRequest extends TeaModel {
    ...
    public SaveTradeMarkReviewMaterialDetailShrinkRequest setContactNumber(String contactNumber) {
    ...
    public SaveTradeMarkReviewMaterialDetailShrinkRequest setName(String name) {
        this.name = name;
        return this;
    }
