...
public class DescribeAllDataSourceRequest extends TeaModel {
    ...
    public DescribeAllDataSourceRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public DescribeAllDataSourceRequest setResourceOwnerId(Long resourceOwnerId) {
