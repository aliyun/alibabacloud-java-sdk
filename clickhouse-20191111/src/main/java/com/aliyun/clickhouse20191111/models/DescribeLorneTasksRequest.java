...
public class DescribeLorneTasksRequest extends TeaModel {
    ...
    public DescribeLorneTasksRequest setOwnerId(Long ownerId) {
    ...
    public DescribeLorneTasksRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public DescribeLorneTasksRequest setResourceOwnerId(Long resourceOwnerId) {
    ...
    public DescribeLorneTasksRequest setOwnerAccount(String ownerAccount) {
