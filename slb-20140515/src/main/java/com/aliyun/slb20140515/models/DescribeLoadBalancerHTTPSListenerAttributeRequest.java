...
public class DescribeLoadBalancerHTTPSListenerAttributeRequest extends TeaModel {
    ...
    public DescribeLoadBalancerHTTPSListenerAttributeRequest setAccessKeyId(String accessKeyId) {
    ...
    public DescribeLoadBalancerHTTPSListenerAttributeRequest setTags(String tags) {
        this.tags = tags;
        return this;
    }
