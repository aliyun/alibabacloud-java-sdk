...
public class TagResourcesRequest extends TeaModel {
     ...
     * <blockquote>
     * <p> Set <strong>ResourceId</strong> of the <strong>listener</strong> to <strong>LoadBalancerId_Listener protocol_Port</strong>. Set LoadBalancerId to the ID of the SLB instance, and Port to the listener port. Example: lb-bp1snb10sbml4\<em>\</em>\<em>\</em>_http_80.</p>
     * </blockquote>
     * <p>This parameter is required.</p>
     * 
     * <strong>example:</strong>
     ...
     * <ul>
     * <li><strong>instance</strong>: a Server Load Balancer (SLB) instance</li>
    ...
    public static class TagResourcesRequestTag extends TeaModel {
         ...
         * <p>The tag key must be 1 to 64 characters in length and cannot start with <code>aliyun</code> or <code>acs:</code>. The tag key cannot contain <code>http://</code> or <code>https://</code>.</p>
         * 
         * <strong>example:</strong>
         * <p>FinanceDept</p>
         */
