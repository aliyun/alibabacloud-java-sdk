...
public class CreateSchedulerxCalendarRequest extends TeaModel {
    /**
    ...
    public static CreateSchedulerxCalendarRequest build(java.util.Map<String, ?> map) throws Exception {
        CreateSchedulerxCalendarRequest self = new CreateSchedulerxCalendarRequest();
        return TeaModel.build(map, self);
    }

    public CreateSchedulerxCalendarRequest setCalendarName(String calendarName) {
    ...
    public CreateSchedulerxCalendarRequest setMonthDaysContent(String monthDaysContent) {
    ...
    public CreateSchedulerxCalendarRequest setRegionId(String regionId) {
    ...
    public CreateSchedulerxCalendarRequest setYear(Integer year) {
        this.year = year;
        return this;
    }
