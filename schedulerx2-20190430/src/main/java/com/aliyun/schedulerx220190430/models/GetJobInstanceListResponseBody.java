...
public class GetJobInstanceListResponseBody extends TeaModel {
    ...
    public GetJobInstanceListResponseBodyAccessDeniedDetail accessDeniedDetail;
    ...
    public GetJobInstanceListResponseBody setAccessDeniedDetail(GetJobInstanceListResponseBodyAccessDeniedDetail accessDeniedDetail) {
        this.accessDeniedDetail = accessDeniedDetail;
        return this;
    }
    public GetJobInstanceListResponseBodyAccessDeniedDetail getAccessDeniedDetail() {
    ...
    public static class GetJobInstanceListResponseBodyAccessDeniedDetail extends TeaModel {
        ...
        public static GetJobInstanceListResponseBodyAccessDeniedDetail build(java.util.Map<String, ?> map) throws Exception {
            GetJobInstanceListResponseBodyAccessDeniedDetail self = new GetJobInstanceListResponseBodyAccessDeniedDetail();
            return TeaModel.build(map, self);
        }

        public GetJobInstanceListResponseBodyAccessDeniedDetail setAuthAction(String authAction) {
        ...
        public GetJobInstanceListResponseBodyAccessDeniedDetail setAuthPrincipalDisplayName(String authPrincipalDisplayName) {
        ...
        public GetJobInstanceListResponseBodyAccessDeniedDetail setAuthPrincipalOwnerId(String authPrincipalOwnerId) {
        ...
        public GetJobInstanceListResponseBodyAccessDeniedDetail setAuthPrincipalType(String authPrincipalType) {
        ...
        public GetJobInstanceListResponseBodyAccessDeniedDetail setEncodedDiagnosticMessage(String encodedDiagnosticMessage) {
        ...
        public GetJobInstanceListResponseBodyAccessDeniedDetail setNoPermissionType(String noPermissionType) {
        ...
        public GetJobInstanceListResponseBodyAccessDeniedDetail setPolicyType(String policyType) {
