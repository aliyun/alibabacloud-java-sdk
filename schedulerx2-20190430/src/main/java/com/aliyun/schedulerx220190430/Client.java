...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    /**
     * <b>summary</b> : 
     * <p>Deletes multiple Route Strategies in a batch.</p>
     * 
     ...
     * 
     * <b>summary</b> : 
     * <p>Disables multiple jobs in a batch.</p>
     * 
    ...
    /**
     * <b>summary</b> : 
     * <p>Creates an app group and returns an AppKey.</p>
     * 
    ...
    /**
     * <b>summary</b> : 
     * <p>Creates a node and returns the node ID.</p>
     * 
    ...
    /**
     * <b>summary</b> : 
     * <p>Returns a list of available regions.</p>
     * 
    ...
    /**
     * <b>summary</b> : 
     * <p>Executes a workflow immediately.</p>
     * 
    ...
    /**
     * <b>summary</b> : 
     * <p>Retrieves the details of an App Group.</p>
     * 
    ...
    /**
     * <b>summary</b> : 
     * <p>Returns the information of a job instance, allowing you to view its status and progress.</p>
     * 
    ...
    /**
     * <b>summary</b> : 
     * <p>Retrieves the overview data of task scheduling for a professional edition application.</p>
     * 
    ...
    /**
     * <b>summary</b> : 
     * <p>Retrieves workflow information.</p>
     * 
     ...
     * 
     * <b>summary</b> : 
     * <p>Gets the list of applications.</p>
     * 
     ...
     */
    public ReadSchedulerxDesignateDetailResponse readSchedulerxDesignateDetailWithOptions(ReadSchedulerxDesignateDetailRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.designateType)) {
            query.put("DesignateType", request.designateType);
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "ReadSchedulerxDesignateDetail"),
            new TeaPair("version", "2019-04-30"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new ReadSchedulerxDesignateDetailResponse());
    }
     ...
     * @return ReadSchedulerxDesignateDetailResponse
     */
    public ReadSchedulerxDesignateDetailResponse readSchedulerxDesignateDetail(ReadSchedulerxDesignateDetailRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
    ...
    /**
     * <b>summary</b> : 
     * <p>Retrieves basic information for the specified instance.</p>
     * 
    ...
    /**
     * <b>summary</b> : 
     * <p>Reruns a node instance in the failed or successful state. Only the professional edition supports this operation.</p>
     * 
    ...
    /**
     * <b>summary</b> : 
     * <p>Forcibly sets the instance status of a node to successful. Only the professional edition supports this operation.</p>
     * 
    ...
    /**
     * <b>summary</b> : 
     * <p>Update the application group.</p>
     * 
    ...
    public UpdateAppGroupResponse updateAppGroupWithOptions(UpdateAppGroupRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.monitorConfigJson)) {
            query.put("MonitorConfigJson", request.monitorConfigJson);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.monitorContactsJson)) {
            query.put("MonitorContactsJson", request.monitorContactsJson);
        }
    ...
    /**
     * <b>summary</b> : 
     * <p>Updates the nodes and dependencies of a workflow. This operation is available only in the Enterprise Edition.</p>
     * 
