...
public class QueryThingModelExtendConfigRequest extends TeaModel {
    ...
    public QueryThingModelExtendConfigRequest setApiProduct(String apiProduct) {
    ...
    public QueryThingModelExtendConfigRequest setApiRevision(String apiRevision) {
    ...
    public QueryThingModelExtendConfigRequest setRealTenantId(String realTenantId) {
    ...
    public QueryThingModelExtendConfigRequest setRealTripartiteKey(String realTripartiteKey) {
