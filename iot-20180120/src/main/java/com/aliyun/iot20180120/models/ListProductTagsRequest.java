...
public class ListProductTagsRequest extends TeaModel {
    ...
    public ListProductTagsRequest setApiProduct(String apiProduct) {
    ...
    public ListProductTagsRequest setApiRevision(String apiRevision) {
    ...
    public ListProductTagsRequest setRealTenantId(String realTenantId) {
    ...
    public ListProductTagsRequest setRealTripartiteKey(String realTripartiteKey) {
