...
public class BatchRegisterDeviceWithApplyIdRequest extends TeaModel {
    ...
    public BatchRegisterDeviceWithApplyIdRequest setApiProduct(String apiProduct) {
    ...
    public BatchRegisterDeviceWithApplyIdRequest setApiRevision(String apiRevision) {
    ...
    public BatchRegisterDeviceWithApplyIdRequest setRealTenantId(String realTenantId) {
    ...
    public BatchRegisterDeviceWithApplyIdRequest setRealTripartiteKey(String realTripartiteKey) {
