...
public class DeleteDeviceGroupRequest extends TeaModel {
    ...
    public DeleteDeviceGroupRequest setApiProduct(String apiProduct) {
    ...
    public DeleteDeviceGroupRequest setApiRevision(String apiRevision) {
    ...
    public DeleteDeviceGroupRequest setRealTenantId(String realTenantId) {
    ...
    public DeleteDeviceGroupRequest setRealTripartiteKey(String realTripartiteKey) {
