...
public class QueryDevicePropRequest extends TeaModel {
    ...
    public QueryDevicePropRequest setApiProduct(String apiProduct) {
    ...
    public QueryDevicePropRequest setApiRevision(String apiRevision) {
    ...
    public QueryDevicePropRequest setRealTenantId(String realTenantId) {
    ...
    public QueryDevicePropRequest setRealTripartiteKey(String realTripartiteKey) {
