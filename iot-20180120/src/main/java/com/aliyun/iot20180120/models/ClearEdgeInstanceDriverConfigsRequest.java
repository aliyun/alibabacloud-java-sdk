...
public class ClearEdgeInstanceDriverConfigsRequest extends TeaModel {
    ...
    public ClearEdgeInstanceDriverConfigsRequest setApiProduct(String apiProduct) {
    ...
    public ClearEdgeInstanceDriverConfigsRequest setApiRevision(String apiRevision) {
