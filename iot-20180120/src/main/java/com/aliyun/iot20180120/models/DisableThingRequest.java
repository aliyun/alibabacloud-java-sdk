...
public class DisableThingRequest extends TeaModel {
    ...
    public DisableThingRequest setApiProduct(String apiProduct) {
    ...
    public DisableThingRequest setApiRevision(String apiRevision) {
    ...
    public DisableThingRequest setRealTenantId(String realTenantId) {
    ...
    public DisableThingRequest setRealTripartiteKey(String realTripartiteKey) {
