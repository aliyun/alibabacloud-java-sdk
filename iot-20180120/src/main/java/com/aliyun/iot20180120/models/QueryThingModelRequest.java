...
public class QueryThingModelRequest extends TeaModel {
    ...
    public QueryThingModelRequest setApiProduct(String apiProduct) {
    ...
    public QueryThingModelRequest setApiRevision(String apiRevision) {
    ...
    public QueryThingModelRequest setRealTenantId(String realTenantId) {
    ...
    public QueryThingModelRequest setRealTripartiteKey(String realTripartiteKey) {
