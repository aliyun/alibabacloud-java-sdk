...
public class BindApplicationToEdgeInstanceRequest extends TeaModel {
    ...
    public BindApplicationToEdgeInstanceRequest setApiProduct(String apiProduct) {
    ...
    public BindApplicationToEdgeInstanceRequest setApiRevision(String apiRevision) {
