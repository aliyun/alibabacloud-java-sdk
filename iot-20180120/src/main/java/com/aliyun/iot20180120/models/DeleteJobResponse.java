...
public class DeleteJobResponse extends TeaModel {
    ...
    public DeleteJobResponse setSuccess(Boolean success) {
    ...
    public DeleteJobResponse setCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public DeleteJobResponse setErrorMessage(String errorMessage) {
