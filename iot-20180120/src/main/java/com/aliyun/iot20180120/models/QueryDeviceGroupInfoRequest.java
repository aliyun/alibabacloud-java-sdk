...
public class QueryDeviceGroupInfoRequest extends TeaModel {
    ...
    public QueryDeviceGroupInfoRequest setApiProduct(String apiProduct) {
    ...
    public QueryDeviceGroupInfoRequest setApiRevision(String apiRevision) {
    ...
    public QueryDeviceGroupInfoRequest setRealTenantId(String realTenantId) {
    ...
    public QueryDeviceGroupInfoRequest setRealTripartiteKey(String realTripartiteKey) {
