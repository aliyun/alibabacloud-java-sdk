...
public class QueryOTAFirmwareResponse extends TeaModel {
    ...
    public static class QueryOTAFirmwareResponseFirmwareInfoMultiFiles extends TeaModel {
        @NameInMap("Name")
        @Validation(required = true)
        public String name;
        ...
        public static QueryOTAFirmwareResponseFirmwareInfoMultiFiles build(java.util.Map<String, ?> map) throws Exception {
            QueryOTAFirmwareResponseFirmwareInfoMultiFiles self = new QueryOTAFirmwareResponseFirmwareInfoMultiFiles();
            return TeaModel.build(map, self);
        }

        public QueryOTAFirmwareResponseFirmwareInfoMultiFiles setName(String name) {
            this.name = name;
            return this;
        }
        ...
        public QueryOTAFirmwareResponseFirmwareInfoMultiFiles setSize(Integer size) {
            this.size = size;
            return this;
        }
        ...
        public QueryOTAFirmwareResponseFirmwareInfoMultiFiles setUrl(String url) {
            this.url = url;
            return this;
        }
        ...
        public QueryOTAFirmwareResponseFirmwareInfoMultiFiles setSignValue(String signValue) {
        ...
        public QueryOTAFirmwareResponseFirmwareInfoMultiFiles setFileMd5(String fileMd5) {
    ...
    public static class QueryOTAFirmwareResponseFirmwareInfo extends TeaModel {
        ...
        @Validation(required = true)
        public java.util.List<QueryOTAFirmwareResponseFirmwareInfoMultiFiles> multiFiles;
        ...
        public QueryOTAFirmwareResponseFirmwareInfo setUdi(String udi) {
            this.udi = udi;
            return this;
        }
        ...
        public QueryOTAFirmwareResponseFirmwareInfo setMultiFiles(java.util.List<QueryOTAFirmwareResponseFirmwareInfoMultiFiles> multiFiles) {
            this.multiFiles = multiFiles;
            return this;
        }
        public java.util.List<QueryOTAFirmwareResponseFirmwareInfoMultiFiles> getMultiFiles() {
