...
public class QueryThingModelExtendConfigPublishedRequest extends TeaModel {
    ...
    public QueryThingModelExtendConfigPublishedRequest setApiProduct(String apiProduct) {
    ...
    public QueryThingModelExtendConfigPublishedRequest setApiRevision(String apiRevision) {
    ...
    public QueryThingModelExtendConfigPublishedRequest setRealTenantId(String realTenantId) {
    ...
    public QueryThingModelExtendConfigPublishedRequest setRealTripartiteKey(String realTripartiteKey) {
