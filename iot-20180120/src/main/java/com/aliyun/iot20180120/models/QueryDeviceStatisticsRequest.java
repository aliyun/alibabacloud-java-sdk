...
public class QueryDeviceStatisticsRequest extends TeaModel {
    ...
    public QueryDeviceStatisticsRequest setApiProduct(String apiProduct) {
    ...
    public QueryDeviceStatisticsRequest setApiRevision(String apiRevision) {
    ...
    public QueryDeviceStatisticsRequest setRealTenantId(String realTenantId) {
    ...
    public QueryDeviceStatisticsRequest setRealTripartiteKey(String realTripartiteKey) {
