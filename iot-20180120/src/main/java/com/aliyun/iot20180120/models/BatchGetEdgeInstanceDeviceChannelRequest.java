...
public class BatchGetEdgeInstanceDeviceChannelRequest extends TeaModel {
    ...
    public BatchGetEdgeInstanceDeviceChannelRequest setApiProduct(String apiProduct) {
    ...
    public BatchGetEdgeInstanceDeviceChannelRequest setApiRevision(String apiRevision) {
