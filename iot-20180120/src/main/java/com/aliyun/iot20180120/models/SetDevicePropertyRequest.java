...
public class SetDevicePropertyRequest extends TeaModel {
    ...
    public SetDevicePropertyRequest setApiProduct(String apiProduct) {
    ...
    public SetDevicePropertyRequest setApiRevision(String apiRevision) {
    ...
    public SetDevicePropertyRequest setRealTenantId(String realTenantId) {
    ...
    public SetDevicePropertyRequest setRealTripartiteKey(String realTripartiteKey) {
