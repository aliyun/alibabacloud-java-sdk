...
public class QueryDevicePropertyStatusRequest extends TeaModel {
    ...
    public QueryDevicePropertyStatusRequest setApiProduct(String apiProduct) {
    ...
    public QueryDevicePropertyStatusRequest setApiRevision(String apiRevision) {
    ...
    public QueryDevicePropertyStatusRequest setRealTenantId(String realTenantId) {
    ...
    public QueryDevicePropertyStatusRequest setRealTripartiteKey(String realTripartiteKey) {
