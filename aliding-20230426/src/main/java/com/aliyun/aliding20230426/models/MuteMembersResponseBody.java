...
public class MuteMembersResponseBody extends TeaModel {
    ...
    public MuteMembersResponseBody setRequestId(String requestId) {
    ...
    public MuteMembersResponseBody setVendorRequestId(String vendorRequestId) {
    ...
    public MuteMembersResponseBody setVendorType(String vendorType) {
