...
public class AddPermissionResponseBody extends TeaModel {
    ...
    public AddPermissionResponseBody setRequestId(String requestId) {
    ...
    public AddPermissionResponseBody setVendorRequestId(String vendorRequestId) {
    ...
    public AddPermissionResponseBody setVendorType(String vendorType) {
