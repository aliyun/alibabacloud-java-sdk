...
public class AddRecordPermissionResponseBody extends TeaModel {
    ...
    public AddRecordPermissionResponseBody setRequestId(String requestId) {
    ...
    public AddRecordPermissionResponseBody setVendorRequestId(String vendorRequestId) {
    ...
    public AddRecordPermissionResponseBody setVendorType(String vendorType) {
