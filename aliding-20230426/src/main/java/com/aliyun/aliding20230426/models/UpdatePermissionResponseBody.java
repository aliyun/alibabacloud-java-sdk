...
public class UpdatePermissionResponseBody extends TeaModel {
    ...
    public UpdatePermissionResponseBody setRequestId(String requestId) {
    ...
    public UpdatePermissionResponseBody setVendorRequestId(String vendorRequestId) {
    ...
    public UpdatePermissionResponseBody setVendorType(String vendorType) {
