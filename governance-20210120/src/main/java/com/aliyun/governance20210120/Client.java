...
public class Client extends com.aliyun.teaopenapi.Client {
     ...
     */
    public GenerateEvaluationReportResponse generateEvaluationReportWithOptions(GenerateEvaluationReportRequest tmpReq, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(tmpReq);
        GenerateEvaluationReportShrinkRequest request = new GenerateEvaluationReportShrinkRequest();
        com.aliyun.openapiutil.Client.convert(tmpReq, request);
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "GenerateEvaluationReport"),
            new TeaPair("version", "2021-01-20"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new GenerateEvaluationReportResponse());
    }
     ...
     * @return GenerateEvaluationReportResponse
     */
    public GenerateEvaluationReportResponse generateEvaluationReport(GenerateEvaluationReportRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
    ...
    public ListEvaluationMetadataResponse listEvaluationMetadataWithOptions(ListEvaluationMetadataRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.lensCode)) {
            query.put("LensCode", request.lensCode);
        }
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.topicCode)) {
            query.put("TopicCode", request.topicCode);
        }
