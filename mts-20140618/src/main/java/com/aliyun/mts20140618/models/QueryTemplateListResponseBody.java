...
public class QueryTemplateListResponseBody extends TeaModel {
    /**
     * <p>The template IDs that do not exist. This parameter is not returned if all specified custom transcoding templates are found.</p>
     */
    ...
    public static class QueryTemplateListResponseBodyTemplateListTemplateContainer extends TeaModel {
        /**
         * <p>The container format. Valid values: flv, mp4, ts, m3u8, gif, mp3, ogg, and flac.</p>
         */
        @NameInMap("Format")
    ...
    public static class QueryTemplateListResponseBodyTemplateListTemplateVideo extends TeaModel {
        ...
        /**
         * <p>The black borders to be added to the video. Format: width:height:left:top. Example: 1280:800:0:140.</p>
         */
        @NameInMap("Pad")
        public String pad;
