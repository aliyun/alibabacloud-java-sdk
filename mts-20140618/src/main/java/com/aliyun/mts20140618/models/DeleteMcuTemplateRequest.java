...
public class DeleteMcuTemplateRequest extends TeaModel {
    ...
    public DeleteMcuTemplateRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public DeleteMcuTemplateRequest setResourceOwnerId(Long resourceOwnerId) {
