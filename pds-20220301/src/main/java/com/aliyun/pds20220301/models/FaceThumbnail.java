...
public class FaceThumbnail extends TeaModel {
    /**
     * <p>The ID of the group to which the face belongs.</p>
     * <p>The following specific IDs are included:</p>
     * <ul>
     * <li>figure-cluster-id-independent: The face does not belong to a group. When you perform face clustering after an image is added to the dataset, this face may be grouped.</li>
     * <li>figure-cluster-id-unavailable: No clustering has been performed on this face. In other words, no face clustering is performed after an image is added to the dataset.</li>
     * </ul>
     * 
