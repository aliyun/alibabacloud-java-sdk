...
package com.aliyun.educloud20220202;

import com.aliyun.tea.*;
import com.aliyun.educloud20220202.models.*;
...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    public Client(Config config) throws Exception {
        ...
        this._endpoint = this.getEndpoint("educloud", _regionId, _endpointRule, _network, _suffix, _endpointMap, _endpoint);
    }
    ...
    public DescribeCourseLessonResponse describeCourseLessonWithOptions(DescribeCourseLessonRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, String> query = com.aliyun.openapiutil.Client.query(com.aliyun.teautil.Common.toMap(request));
        OpenApiRequest req = OpenApiRequest.build(TeaConverter.buildMap(
            new TeaPair("query", com.aliyun.openapiutil.Client.query(query))
    ...
    public DescribeLabResponse describeLabWithOptions(DescribeLabRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, String> query = com.aliyun.openapiutil.Client.query(com.aliyun.teautil.Common.toMap(request));
        OpenApiRequest req = OpenApiRequest.build(TeaConverter.buildMap(
            new TeaPair("query", com.aliyun.openapiutil.Client.query(query))
    ...
    public GetLabTokenResponse getLabTokenWithOptions(GetLabTokenRequest request, RuntimeOptions runtime) throws Exception {
        ...
        Params params = Params.build(TeaConverter.buildMap(
            new TeaPair("action", "GetLabToken"),
            new TeaPair("version", "2022-02-02"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "GET"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new GetLabTokenResponse());
    }

    public GetLabTokenResponse getLabToken(GetLabTokenRequest request) throws Exception {
        RuntimeOptions runtime = new RuntimeOptions();
        return this.getLabTokenWithOptions(request, runtime);
    }

    public ListCoursesResponse listCoursesWithOptions(ListCoursesRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, String> query = com.aliyun.openapiutil.Client.query(com.aliyun.teautil.Common.toMap(request));
        OpenApiRequest req = OpenApiRequest.build(TeaConverter.buildMap(
            new TeaPair("query", com.aliyun.openapiutil.Client.query(query))
    ...
    public ListLabsResponse listLabsWithOptions(ListLabsRequest request, RuntimeOptions runtime) throws Exception {
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new ListLabsResponse());
    }

    public ListLabsResponse listLabs(ListLabsRequest request) throws Exception {
        RuntimeOptions runtime = new RuntimeOptions();
