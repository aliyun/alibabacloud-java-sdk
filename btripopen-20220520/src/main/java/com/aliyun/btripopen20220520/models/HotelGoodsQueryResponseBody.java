...
public class HotelGoodsQueryResponseBody extends TeaModel {
    ...
    public static class HotelGoodsQueryResponseBodyModuleRoomsRatesHotelOnsitePriceDetailAvgOnsitePrice extends TeaModel {
        /**
         * <strong>example:</strong>
         * <p>CNY</p>
         */
        ...
        public static HotelGoodsQueryResponseBodyModuleRoomsRatesHotelOnsitePriceDetailAvgOnsitePrice build(java.util.Map<String, ?> map) throws Exception {
            HotelGoodsQueryResponseBodyModuleRoomsRatesHotelOnsitePriceDetailAvgOnsitePrice self = new HotelGoodsQueryResponseBodyModuleRoomsRatesHotelOnsitePriceDetailAvgOnsitePrice();
            return TeaModel.build(map, self);
        }

        public HotelGoodsQueryResponseBodyModuleRoomsRatesHotelOnsitePriceDetailAvgOnsitePrice setCurrency(String currency) {
        ...
        public HotelGoodsQueryResponseBodyModuleRoomsRatesHotelOnsitePriceDetailAvgOnsitePrice setForeignCurrency(String foreignCurrency) {
        ...
        public HotelGoodsQueryResponseBodyModuleRoomsRatesHotelOnsitePriceDetailAvgOnsitePrice setForeignPriceCent(Long foreignPriceCent) {
        ...
        public HotelGoodsQueryResponseBodyModuleRoomsRatesHotelOnsitePriceDetailAvgOnsitePrice setPriceCent(Long priceCent) {
    ...
    public static class HotelGoodsQueryResponseBodyModuleRoomsRatesHotelOnsitePriceDetailDailyOnsitePrice extends TeaModel {
        /**
         * <strong>example:</strong>
         * <p>CNY</p>
         */
        ...
        public static HotelGoodsQueryResponseBodyModuleRoomsRatesHotelOnsitePriceDetailDailyOnsitePrice build(java.util.Map<String, ?> map) throws Exception {
            HotelGoodsQueryResponseBodyModuleRoomsRatesHotelOnsitePriceDetailDailyOnsitePrice self = new HotelGoodsQueryResponseBodyModuleRoomsRatesHotelOnsitePriceDetailDailyOnsitePrice();
            return TeaModel.build(map, self);
        }

        public HotelGoodsQueryResponseBodyModuleRoomsRatesHotelOnsitePriceDetailDailyOnsitePrice setCurrency(String currency) {
            this.currency = currency;
            return this;
        }
        public String getCurrency() {
        ...
        public HotelGoodsQueryResponseBodyModuleRoomsRatesHotelOnsitePriceDetailDailyOnsitePrice setDay(String day) {
            this.day = day;
            return this;
        }
        ...
        public HotelGoodsQueryResponseBodyModuleRoomsRatesHotelOnsitePriceDetailDailyOnsitePrice setForeignCurrency(String foreignCurrency) {
            this.foreignCurrency = foreignCurrency;
            return this;
        }
        public String getForeignCurrency() {
        ...
        public HotelGoodsQueryResponseBodyModuleRoomsRatesHotelOnsitePriceDetailDailyOnsitePrice setForeignPriceCent(Long foreignPriceCent) {
            this.foreignPriceCent = foreignPriceCent;
            return this;
        }
        public Long getForeignPriceCent() {
        ...
        public HotelGoodsQueryResponseBodyModuleRoomsRatesHotelOnsitePriceDetailDailyOnsitePrice setPriceCent(Long priceCent) {
            this.priceCent = priceCent;
            return this;
        }
        public Long getPriceCent() {
    ...
    public static class HotelGoodsQueryResponseBodyModuleRoomsRatesHotelOnsitePriceDetail extends TeaModel {
        @NameInMap("avg_onsite_price")
        public HotelGoodsQueryResponseBodyModuleRoomsRatesHotelOnsitePriceDetailAvgOnsitePrice avgOnsitePrice;

        @NameInMap("daily_onsite_price")
        public java.util.List<HotelGoodsQueryResponseBodyModuleRoomsRatesHotelOnsitePriceDetailDailyOnsitePrice> dailyOnsitePrice;

        public static HotelGoodsQueryResponseBodyModuleRoomsRatesHotelOnsitePriceDetail build(java.util.Map<String, ?> map) throws Exception {
            HotelGoodsQueryResponseBodyModuleRoomsRatesHotelOnsitePriceDetail self = new HotelGoodsQueryResponseBodyModuleRoomsRatesHotelOnsitePriceDetail();
            return TeaModel.build(map, self);
        }

        public HotelGoodsQueryResponseBodyModuleRoomsRatesHotelOnsitePriceDetail setAvgOnsitePrice(HotelGoodsQueryResponseBodyModuleRoomsRatesHotelOnsitePriceDetailAvgOnsitePrice avgOnsitePrice) {
            this.avgOnsitePrice = avgOnsitePrice;
            return this;
        }
        public HotelGoodsQueryResponseBodyModuleRoomsRatesHotelOnsitePriceDetailAvgOnsitePrice getAvgOnsitePrice() {
            return this.avgOnsitePrice;
        }

        public HotelGoodsQueryResponseBodyModuleRoomsRatesHotelOnsitePriceDetail setDailyOnsitePrice(java.util.List<HotelGoodsQueryResponseBodyModuleRoomsRatesHotelOnsitePriceDetailDailyOnsitePrice> dailyOnsitePrice) {
            this.dailyOnsitePrice = dailyOnsitePrice;
            return this;
        }
        public java.util.List<HotelGoodsQueryResponseBodyModuleRoomsRatesHotelOnsitePriceDetailDailyOnsitePrice> getDailyOnsitePrice() {
    ...
    public static class HotelGoodsQueryResponseBodyModuleRoomsRates extends TeaModel {
        ...
        public HotelGoodsQueryResponseBodyModuleRoomsRatesHotelOnsitePriceDetail hotelOnsitePriceDetail;
        ...
        public HotelGoodsQueryResponseBodyModuleRoomsRates setHotelOnsitePriceDetail(HotelGoodsQueryResponseBodyModuleRoomsRatesHotelOnsitePriceDetail hotelOnsitePriceDetail) {
            this.hotelOnsitePriceDetail = hotelOnsitePriceDetail;
            return this;
        }
        public HotelGoodsQueryResponseBodyModuleRoomsRatesHotelOnsitePriceDetail getHotelOnsitePriceDetail() {
        ...
        public HotelGoodsQueryResponseBodyModuleRoomsRates setTaxFeeDesc(String taxFeeDesc) {
    ...
    public static class HotelGoodsQueryResponseBodyModuleRoomsRoomService extends TeaModel {
        ...
        /**
         * <strong>example:</strong>
         * <p><span>免费</span>有线上网 <span>免费</span>wifi</p>
         */
        @NameInMap("desc")
        public String desc;
    ...
    public static class HotelGoodsQueryResponseBodyModuleRooms extends TeaModel {
        ...
        /**
         * <strong>example:</strong>
         * <p><a href="https://img.alicdn.com/imgextra/i4/6000000007171/O1CN01NHHdOw22qMoYHweI9_!!6000000007171-0-hotel.jpg">https://img.alicdn.com/imgextra/i4/6000000007171/O1CN01NHHdOw22qMoYHweI9_!!6000000007171-0-hotel.jpg</a></p>
         */
        @NameInMap("pics")
        public String pics;
    ...
    public static class HotelGoodsQueryResponseBodyModule extends TeaModel {
        /**
         * <strong>example:</strong>
         * <p>贵州省贵阳市贵阳国家高新技术产业开发区沙文园区科学城智谷13-2栋三、四层</p>
         */
        @NameInMap("address")
