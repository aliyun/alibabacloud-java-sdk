...
public class CooperatorHotelBillSettlementQueryRequest extends TeaModel {
    ...
    public CooperatorHotelBillSettlementQueryRequest setApplyId(String applyId) {
    ...
    public CooperatorHotelBillSettlementQueryRequest setBillRecordTimeEnd(String billRecordTimeEnd) {
    ...
    public CooperatorHotelBillSettlementQueryRequest setBillRecordTimeStart(String billRecordTimeStart) {
