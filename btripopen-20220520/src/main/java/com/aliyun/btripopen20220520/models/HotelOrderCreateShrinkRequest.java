...
public class HotelOrderCreateShrinkRequest extends TeaModel {
    ...
    public HotelOrderCreateShrinkRequest setArrivalTime(String arrivalTime) {
    ...
    public HotelOrderCreateShrinkRequest setLeaveTime(String leaveTime) {
    ...
    public HotelOrderCreateShrinkRequest setRpType(Integer rpType) {
        this.rpType = rpType;
        return this;
    }
