...
public class FlightBillSettlementQueryRequest extends TeaModel {
    ...
    public FlightBillSettlementQueryRequest setApplyId(String applyId) {
    ...
    public FlightBillSettlementQueryRequest setBillRecordTimeEnd(String billRecordTimeEnd) {
    ...
    public FlightBillSettlementQueryRequest setBillRecordTimeStart(String billRecordTimeStart) {
    ...
    public FlightBillSettlementQueryRequest setOrderId(Long orderId) {
