...
public class UpdateVpcEndpointConnectionAttributeRequest extends TeaModel {
     ...
     * <blockquote>
     * <p>The valid values vary based on the type of service resource:</p>
     * <ul>
     ...
     * <p>You can use the client to generate the value, but you must make sure that it is unique among different requests. The <strong>ClientToken</strong> value can contain only ASCII characters.</p>
     * 
     * <strong>example:</strong>
    ...
    /**
     * <p>The region ID of the endpoint connection bandwidth that you want to modify.
     * You can call the <a href="https://help.aliyun.com/document_detail/120468.html">DescribeRegions</a> operation to query the most recent region list.</p>
     * <p>This parameter is required.</p>
     * 
     * <strong>example:</strong>
     * <p>eu-west-1</p>
    ...
    /**
     * <ul>
     * <li><p>Scalability: auto scaling. In this mode, the bandwidth configured for the endpoint connection does not take effect.</p>
     * </li>
     ...
     * <blockquote>
     * <ul>
     * <li>When the service resource is NLB, TrafficControlMode is set to Scalability by default. You can set it to BandwidthLimit and modify the Bandwidth value to provide a bandwidth upper limit.</li>
     * <li>When the service resource is CLB, TrafficControlMode can only be set to BandwidthLimit, which indicates that the service consumer provides a default rate limit for each endpoint.</li>
