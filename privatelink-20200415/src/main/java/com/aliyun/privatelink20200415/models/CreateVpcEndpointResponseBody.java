...
public class CreateVpcEndpointResponseBody extends TeaModel {
    ...
    public CreateVpcEndpointResponseBody setCrossRegionBandwidth(Integer crossRegionBandwidth) {
    ...
    public CreateVpcEndpointResponseBody setServiceRegionId(String serviceRegionId) {
