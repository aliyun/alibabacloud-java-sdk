...
public class CreateOrderRequest extends TeaModel {
    ...
    public CreateOrderRequest setOwnerAccount(String ownerAccount) {
    ...
    public CreateOrderRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public CreateOrderRequest setResourceOwnerId(String resourceOwnerId) {
