...
public class DescribeDomainFlowDataRequest extends TeaModel {
    ...
    public DescribeDomainFlowDataRequest setOwnerId(String ownerId) {
    ...
    public DescribeDomainFlowDataRequest setResourceOwnerId(String resourceOwnerId) {
    ...
    public DescribeDomainFlowDataRequest setResourceRealOwnerId(String resourceRealOwnerId) {
