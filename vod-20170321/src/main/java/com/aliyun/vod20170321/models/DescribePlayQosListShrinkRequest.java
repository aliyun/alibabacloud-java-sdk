...
public class DescribePlayQosListShrinkRequest extends TeaModel {
    ...
    public DescribePlayQosListShrinkRequest setBeginTs(Long beginTs) {
    ...
    public DescribePlayQosListShrinkRequest setEndTs(Long endTs) {
        this.endTs = endTs;
        return this;
    }
    ...
    public DescribePlayQosListShrinkRequest setPageNo(Long pageNo) {
        this.pageNo = pageNo;
        return this;
    }
    ...
    public DescribePlayQosListShrinkRequest setPageSize(Long pageSize) {
