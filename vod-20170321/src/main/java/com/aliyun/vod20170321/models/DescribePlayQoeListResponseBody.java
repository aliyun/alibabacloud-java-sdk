...
public class DescribePlayQoeListResponseBody extends TeaModel {
    ...
    public static class DescribePlayQoeListResponseBodyQoeInfoList extends TeaModel {
        ...
        public DescribePlayQoeListResponseBodyQoeInfoList setQoeJumpRate5s(Float qoeJumpRate5s) {
        ...
        public DescribePlayQoeListResponseBodyQoeInfoList setTraceId(String traceId) {
