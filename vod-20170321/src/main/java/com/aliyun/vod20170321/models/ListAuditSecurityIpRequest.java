...
public class ListAuditSecurityIpRequest extends TeaModel {
    /**
     * <p>The name of the review security group where you want to query IP addresses. If you do not set this parameter, IP addresses in all review security groups are queried.</p>
     */
