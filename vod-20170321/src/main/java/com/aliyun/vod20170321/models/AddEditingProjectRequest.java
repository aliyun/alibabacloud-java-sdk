...
public class AddEditingProjectRequest extends TeaModel {
    /**
     * <p>The thumbnail of the online editing project. If this parameter is left empty and the video track on the timeline already contains materials, the thumbnail of the first material on the timeline is used by default.</p>
     * 
    ...
    /**
     * <p>The timeline of the online editing project. JSON format. For the specific structure definition, see <a href="https://help.aliyun.com/document_detail/52839.html">Timeline</a>.</p>
     * <p>If this parameter is left empty, an empty timeline is created and the total duration of the online editing project is 0.</p>
     * 
     * <strong>example:</strong>
