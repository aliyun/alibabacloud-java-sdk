...
public class DescribeVodRangeDataByLocateAndIspServiceResponseBody extends TeaModel {
    /**
     * <p>The result in JSON format. From left to right, the fields are: UNIX timestamp, region, ISP, HTTP status code distribution, response duration, bandwidth (unit: bit/s), average response rate, page views, cache hit ratio, and request hit ratio.</p>
     * 
