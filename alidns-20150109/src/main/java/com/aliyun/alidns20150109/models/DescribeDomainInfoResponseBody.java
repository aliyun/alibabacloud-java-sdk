...
public class DescribeDomainInfoResponseBody extends TeaModel {
    ...
    public java.util.List<DescribeDomainInfoResponseBodyRecordLines> recordLines;

    @NameInMap("DomainId")
    public String domainId;

    @NameInMap("AvailableTtls")
    public java.util.List<String> availableTtls;
    ...
    public DescribeDomainInfoResponseBody setDnsServers(java.util.List<String> dnsServers) {
    ...
    public DescribeDomainInfoResponseBody setRecordLines(java.util.List<DescribeDomainInfoResponseBodyRecordLines> recordLines) {
        this.recordLines = recordLines;
        return this;
    }
    public java.util.List<DescribeDomainInfoResponseBodyRecordLines> getRecordLines() {
    ...
    public DescribeDomainInfoResponseBody setAvailableTtls(java.util.List<String> availableTtls) {
        this.availableTtls = availableTtls;
        return this;
    }
    public java.util.List<String> getAvailableTtls() {
    ...
    public static class DescribeDomainInfoResponseBodyRecordLines extends TeaModel {
        ...
        public DescribeDomainInfoResponseBodyRecordLines setFatherCode(String fatherCode) {
        ...
        public DescribeDomainInfoResponseBodyRecordLines setLineDisplayName(String lineDisplayName) {
        ...
        public DescribeDomainInfoResponseBodyRecordLines setLineCode(String lineCode) {
        ...
        public DescribeDomainInfoResponseBodyRecordLines setLineName(String lineName) {
