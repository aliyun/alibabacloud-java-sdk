...
public class DeleteCloudGtmMonitorTemplateRequest extends TeaModel {
    ...
    /**
     * <p>A client-generated token that is used to ensure the idempotence of the request. This token must be unique for each request and can contain a maximum of 64 ASCII characters.</p>
     * 
     * <strong>example:</strong>
