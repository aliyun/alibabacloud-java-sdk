...
public class DescribeDnsGtmInstanceAddressPoolResponseBody extends TeaModel {
    @NameInMap("Addrs")
    public java.util.List<DescribeDnsGtmInstanceAddressPoolResponseBodyAddrs> addrs;
    ...
    public DescribeDnsGtmInstanceAddressPoolResponseBody setAddrs(java.util.List<DescribeDnsGtmInstanceAddressPoolResponseBodyAddrs> addrs) {
        this.addrs = addrs;
        return this;
    }
    public java.util.List<DescribeDnsGtmInstanceAddressPoolResponseBodyAddrs> getAddrs() {
        return this.addrs;
    }
    ...
    public static class DescribeDnsGtmInstanceAddressPoolResponseBodyAddrs extends TeaModel {
        ...
        public DescribeDnsGtmInstanceAddressPoolResponseBodyAddrs setUpdateTimestamp(Long updateTimestamp) {
            this.updateTimestamp = updateTimestamp;
            return this;
        }
        public Long getUpdateTimestamp() {
        ...
        public DescribeDnsGtmInstanceAddressPoolResponseBodyAddrs setAttributeInfo(String attributeInfo) {
        ...
        public DescribeDnsGtmInstanceAddressPoolResponseBodyAddrs setUpdateTime(String updateTime) {
            this.updateTime = updateTime;
            return this;
        }
        public String getUpdateTime() {
        ...
        public DescribeDnsGtmInstanceAddressPoolResponseBodyAddrs setAlertStatus(String alertStatus) {
        ...
        public DescribeDnsGtmInstanceAddressPoolResponseBodyAddrs setRemark(String remark) {
            this.remark = remark;
            return this;
        }
        ...
        public DescribeDnsGtmInstanceAddressPoolResponseBodyAddrs setLbaWeight(Integer lbaWeight) {
        ...
        public DescribeDnsGtmInstanceAddressPoolResponseBodyAddrs setAddr(String addr) {
            this.addr = addr;
            return this;
        }
        ...
        public DescribeDnsGtmInstanceAddressPoolResponseBodyAddrs setCreateTime(String createTime) {
            this.createTime = createTime;
            return this;
        }
        public String getCreateTime() {
        ...
        public DescribeDnsGtmInstanceAddressPoolResponseBodyAddrs setMode(String mode) {
            this.mode = mode;
            return this;
        }
        ...
        public DescribeDnsGtmInstanceAddressPoolResponseBodyAddrs setCreateTimestamp(Long createTimestamp) {
            this.createTimestamp = createTimestamp;
            return this;
        }
        public Long getCreateTimestamp() {
