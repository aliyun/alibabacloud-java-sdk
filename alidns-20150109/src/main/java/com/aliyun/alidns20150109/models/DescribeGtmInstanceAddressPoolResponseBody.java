...
public class DescribeGtmInstanceAddressPoolResponseBody extends TeaModel {
    ...
    @NameInMap("Addrs")
    public java.util.List<DescribeGtmInstanceAddressPoolResponseBodyAddrs> addrs;
    ...
    public DescribeGtmInstanceAddressPoolResponseBody setAddrs(java.util.List<DescribeGtmInstanceAddressPoolResponseBodyAddrs> addrs) {
        this.addrs = addrs;
        return this;
    }
    public java.util.List<DescribeGtmInstanceAddressPoolResponseBodyAddrs> getAddrs() {
        return this.addrs;
    }
    ...
    public static class DescribeGtmInstanceAddressPoolResponseBodyAddrs extends TeaModel {
        ...
        public DescribeGtmInstanceAddressPoolResponseBodyAddrs setValue(String value) {
            this.value = value;
            return this;
        }
        ...
        public DescribeGtmInstanceAddressPoolResponseBodyAddrs setUpdateTimestamp(Long updateTimestamp) {
            this.updateTimestamp = updateTimestamp;
            return this;
        }
        public Long getUpdateTimestamp() {
        ...
        public DescribeGtmInstanceAddressPoolResponseBodyAddrs setUpdateTime(String updateTime) {
            this.updateTime = updateTime;
            return this;
        }
        public String getUpdateTime() {
        ...
        public DescribeGtmInstanceAddressPoolResponseBodyAddrs setAlertStatus(String alertStatus) {
        ...
        public DescribeGtmInstanceAddressPoolResponseBodyAddrs setLbaWeight(Integer lbaWeight) {
        ...
        public DescribeGtmInstanceAddressPoolResponseBodyAddrs setCreateTime(String createTime) {
            this.createTime = createTime;
            return this;
        }
        public String getCreateTime() {
        ...
        public DescribeGtmInstanceAddressPoolResponseBodyAddrs setAddrId(Long addrId) {
            this.addrId = addrId;
            return this;
        }
        ...
        public DescribeGtmInstanceAddressPoolResponseBodyAddrs setMode(String mode) {
            this.mode = mode;
            return this;
        }
        ...
        public DescribeGtmInstanceAddressPoolResponseBodyAddrs setCreateTimestamp(Long createTimestamp) {
            this.createTimestamp = createTimestamp;
            return this;
        }
        public Long getCreateTimestamp() {
