...
public class DescribeGtmMonitorConfigResponseBody extends TeaModel {
    ...
    public java.util.List<DescribeGtmMonitorConfigResponseBodyIspCityNodes> ispCityNodes;
    ...
    public DescribeGtmMonitorConfigResponseBody setIspCityNodes(java.util.List<DescribeGtmMonitorConfigResponseBodyIspCityNodes> ispCityNodes) {
        this.ispCityNodes = ispCityNodes;
        return this;
    }
    public java.util.List<DescribeGtmMonitorConfigResponseBodyIspCityNodes> getIspCityNodes() {
    ...
    public static class DescribeGtmMonitorConfigResponseBodyIspCityNodes extends TeaModel {
        ...
        public DescribeGtmMonitorConfigResponseBodyIspCityNodes setCityCode(String cityCode) {
        ...
        public DescribeGtmMonitorConfigResponseBodyIspCityNodes setCountryName(String countryName) {
        ...
        public DescribeGtmMonitorConfigResponseBodyIspCityNodes setIspCode(String ispCode) {
        ...
        public DescribeGtmMonitorConfigResponseBodyIspCityNodes setCityName(String cityName) {
        ...
        public DescribeGtmMonitorConfigResponseBodyIspCityNodes setCountryCode(String countryCode) {
        ...
        public DescribeGtmMonitorConfigResponseBodyIspCityNodes setIspName(String ispName) {
