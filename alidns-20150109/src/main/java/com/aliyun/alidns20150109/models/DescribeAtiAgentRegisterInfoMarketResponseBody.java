...
public class DescribeAtiAgentRegisterInfoMarketResponseBody extends TeaModel {
    ...
    /**
     * <p>The agent ID, which is uniformly assigned by CNNIC after real-name verification. The AgentID serves as the unique identifier that binds the agent to the real-name authenticated registrant.</p>
     * 
     * <strong>example:</strong>
     ...
     * <ul>
     * <li>Enable: DNS resolution is enabled.</li>
     * <li>Disable: DNS resolution is paused.</li>
     * </ul>
     * 
     * <strong>example:</strong>
     * <p>Disable</p>
    ...
    /**
     * <p>The trust level. Valid values:</p>
     * <ul>
