...
public class DescribeDohSubDomainStatisticsSummaryRequest extends TeaModel {
    ...
    /**
     * <p>The current page number. The value starts from 1. Default value: 1.</p>
     * 
     * <strong>example:</strong>
     * <p>1</p>
     */
    ...
    /**
     * <p>The number of entries to return on each page for a paged query. Maximum value: 100. Default value: 20.</p>
     * 
     * <strong>example:</strong>
     * <p>20</p>
     */
     ...
     * <p>You can query data only from the last 90 days. StartDate must be greater than or equal to <code>Now - 90</code>.</p>
     * 
     * <strong>example:</strong>
     * <p>2019-07-04</p>
     */
