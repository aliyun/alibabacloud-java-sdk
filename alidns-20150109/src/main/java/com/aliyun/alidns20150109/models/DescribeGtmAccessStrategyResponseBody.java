...
public class DescribeGtmAccessStrategyResponseBody extends TeaModel {
    ...
    @NameInMap("Lines")
    public java.util.List<DescribeGtmAccessStrategyResponseBodyLines> lines;
    ...
    public DescribeGtmAccessStrategyResponseBody setLines(java.util.List<DescribeGtmAccessStrategyResponseBodyLines> lines) {
        this.lines = lines;
        return this;
    }
    public java.util.List<DescribeGtmAccessStrategyResponseBodyLines> getLines() {
        return this.lines;
    }
    ...
    public static class DescribeGtmAccessStrategyResponseBodyLines extends TeaModel {
        ...
        public DescribeGtmAccessStrategyResponseBodyLines setGroupName(String groupName) {
        ...
        public DescribeGtmAccessStrategyResponseBodyLines setLineCode(String lineCode) {
        ...
        public DescribeGtmAccessStrategyResponseBodyLines setLineName(String lineName) {
        ...
        public DescribeGtmAccessStrategyResponseBodyLines setGroupCode(String groupCode) {
