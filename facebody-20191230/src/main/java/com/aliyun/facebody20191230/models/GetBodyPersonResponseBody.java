...
public class GetBodyPersonResponseBody extends TeaModel {
    ...
    public GetBodyPersonResponseBody setCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public GetBodyPersonResponseBody setMessage(String message) {
    ...
    public static class GetBodyPersonResponseBodyData extends TeaModel {
        ...
        public GetBodyPersonResponseBodyData setInstanceId(Long instanceId) {
