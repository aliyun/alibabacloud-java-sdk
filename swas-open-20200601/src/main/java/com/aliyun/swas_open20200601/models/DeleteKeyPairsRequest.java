...
public class DeleteKeyPairsRequest extends TeaModel {
    ...
    public java.util.List<String> keyPairNames;
    ...
    public DeleteKeyPairsRequest setClientToken(String clientToken) {
    ...
    public DeleteKeyPairsRequest setKeyPairNames(java.util.List<String> keyPairNames) {
