...
public class ResetSystemRequest extends TeaModel {
    ...
    /**
     * <p>The ID of the image that is used to replace the image of the simple application server. If you do not specify this parameter, the current image of the simple application server is replaced by default.</p>
     */
    @NameInMap("ImageId")
