...
public class ResetSystemRequest extends TeaModel {
    ...
    /**
     * <p>The ID of the image that is used to replace the image on the simple application server. If you do not specify this parameter, the operating system of the simple application server is reset by default.</p>
     */
    @NameInMap("ImageId")
