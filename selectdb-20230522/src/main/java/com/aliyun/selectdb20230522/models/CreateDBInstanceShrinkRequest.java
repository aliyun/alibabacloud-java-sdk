...
public class CreateDBInstanceShrinkRequest extends TeaModel {
    /**
     * <p>Specifies whether to add the VPC CIDR block to the whitelist. Description of valid values:</p>
     * 
    ...
    /**
     * <p>The client token that is used to ensure the idempotency of the request and prevent repeated request submissions. The token is generated by the client and must be unique across different requests. The token can be up to 64 ASCII characters in length and cannot contain non-ASCII characters.</p>
     * 
     * <strong>example:</strong>
     * <p>AB</p>
     */
    ...
    /**
     * <p>The instance specifications. You can call the <a href="https://help.aliyun.com/document_detail/2853363.html">DescribeAllDBInstanceClass</a> operation to query instance specifications.</p>
     * <p>This parameter is required.</p>
     * 
     * <strong>example:</strong>
     * <p>selectdb.xlarge</p>
    ...
    /**
     * <p>The database engine version. Default value: <strong>4.1</strong>. Description of valid values:</p>
     * <p>This parameter is required.</p>
     * 
     * <strong>example:</strong>
     * <p>4.1</p>
    ...
    /**
     * <p>The node specifications of a single FE cluster node. This parameter takes effect only when you create a pay-as-you-go or subscription instance. Default value: selectdb_fe.xlarge16.</p>
     */
    @NameInMap("FEClassCode")
    public String FEClassCode;

    /**
     * <p>The number of FE cluster nodes. This parameter takes effect only when you create a pay-as-you-go or subscription instance. Default value: 3. Valid values: 1 to 11 (odd numbers only).</p>
     */
    @NameInMap("FENodeCount")
    public String FENodeCount;
    ...
    /**
     * <p>Specifies whether the upfront cluster is billed on a yearly or monthly basis. Description of valid values:</p>
     * 
     * <strong>example:</strong>
     * <p>Month</p>
     */
    ...
    /**
     * <p>The IP whitelist of the instance. Separate multiple IP addresses with commas (,).</p>
     * 
     * <strong>example:</strong>
     * <p>192.168.1.1</p>
     */
    ...
    /**
     * <p>The subscription duration of the instance. Description of valid values:</p>
     * 
     * <strong>example:</strong>
     * <p>1</p>
     */
    ...
    public CreateDBInstanceShrinkRequest setFEClassCode(String FEClassCode) {
    ...
    public CreateDBInstanceShrinkRequest setFENodeCount(String FENodeCount) {
