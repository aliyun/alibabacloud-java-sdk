...
public class GetEventRuleResponseBody extends TeaModel {
    ...
    /**
     * <p>The unique ID generated by Alibaba Cloud for the request. You can use this ID to troubleshoot issues.</p>
     * 
     * <strong>example:</strong>
    ...
    public static class GetEventRuleResponseBodyDataEndpoint extends TeaModel {
         ...
         * <ul>
         * <li><p><strong>queue</strong>: A queue.</p>
         * </li>
         * <li><p><strong>topic</strong>: A topic.</p>
         * </li>
         * </ul>
         * 
         * <strong>example:</strong>
