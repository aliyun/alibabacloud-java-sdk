...
public class QueryOrderInfoHeaders extends TeaModel {
    ...
    public static QueryOrderInfoHeaders build(java.util.Map<String, ?> map) throws Exception {
        QueryOrderInfoHeaders self = new QueryOrderInfoHeaders();
        return TeaModel.build(map, self);
    }

    public QueryOrderInfoHeaders setCommonHeaders(java.util.Map<String, String> commonHeaders) {
    ...
    public QueryOrderInfoHeaders setXAcsAirticketAccessToken(String xAcsAirticketAccessToken) {
    ...
    public QueryOrderInfoHeaders setXAcsAirticketLanguage(String xAcsAirticketLanguage) {
