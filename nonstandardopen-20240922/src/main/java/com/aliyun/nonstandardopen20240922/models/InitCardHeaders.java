...
public class InitCardHeaders extends TeaModel {
    ...
    public static InitCardHeaders build(java.util.Map<String, ?> map) throws Exception {
        InitCardHeaders self = new InitCardHeaders();
        return TeaModel.build(map, self);
    }

    public InitCardHeaders setCommonHeaders(java.util.Map<String, String> commonHeaders) {
    ...
    public InitCardHeaders setXAcsAirticketAccessToken(String xAcsAirticketAccessToken) {
    ...
    public InitCardHeaders setXAcsAirticketLanguage(String xAcsAirticketLanguage) {
