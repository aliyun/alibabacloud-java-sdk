...
public class RefundConfirmHeaders extends TeaModel {
    ...
    public static RefundConfirmHeaders build(java.util.Map<String, ?> map) throws Exception {
        RefundConfirmHeaders self = new RefundConfirmHeaders();
        return TeaModel.build(map, self);
    }

    public RefundConfirmHeaders setCommonHeaders(java.util.Map<String, String> commonHeaders) {
    ...
    public RefundConfirmHeaders setXAcsAirticketAccessToken(String xAcsAirticketAccessToken) {
    ...
    public RefundConfirmHeaders setXAcsAirticketLanguage(String xAcsAirticketLanguage) {
