...
public class ListClusterServiceConfigHistoryRequest extends TeaModel {
    ...
    public ListClusterServiceConfigHistoryRequest setOwnerId(Long ownerId) {
    ...
    public ListClusterServiceConfigHistoryRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public ListClusterServiceConfigHistoryRequest setZoneId(String zoneId) {
        this.zoneId = zoneId;
        return this;
    }
