...
public class DeleteGlobalResourceRequest extends TeaModel {
    ...
    public DeleteGlobalResourceRequest setOwnerId(Long ownerId) {
    ...
    public DeleteGlobalResourceRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public DeleteGlobalResourceRequest setResourceOwnerId(Long resourceOwnerId) {
    ...
    public DeleteGlobalResourceRequest setZoneId(String zoneId) {
        this.zoneId = zoneId;
        return this;
    }
