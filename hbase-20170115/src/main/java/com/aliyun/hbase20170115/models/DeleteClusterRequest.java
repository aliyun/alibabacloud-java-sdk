...
public class DeleteClusterRequest extends TeaModel {
    ...
    public DeleteClusterRequest setClientToken(String clientToken) {
    ...
    public DeleteClusterRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public DeleteClusterRequest setResourceOwnerId(Long resourceOwnerId) {
    ...
    public DeleteClusterRequest setZoneId(String zoneId) {
        this.zoneId = zoneId;
        return this;
    }
