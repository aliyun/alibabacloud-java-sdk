...
public class GetMultimodeCmsUrlRequest extends TeaModel {
    ...
    public GetMultimodeCmsUrlRequest setOwnerId(Long ownerId) {
    ...
    public GetMultimodeCmsUrlRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public GetMultimodeCmsUrlRequest setResourceOwnerId(Long resourceOwnerId) {
    ...
    public GetMultimodeCmsUrlRequest setZoneId(String zoneId) {
        this.zoneId = zoneId;
        return this;
    }
