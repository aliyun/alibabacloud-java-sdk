...
public class ModifyClusterNameRequest extends TeaModel {
    ...
    public ModifyClusterNameRequest setClusterId(String clusterId) {
    ...
    public ModifyClusterNameRequest setClusterName(String clusterName) {
    ...
    public ModifyClusterNameRequest setOwnerId(Long ownerId) {
    ...
    public ModifyClusterNameRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public ModifyClusterNameRequest setZoneId(String zoneId) {
        this.zoneId = zoneId;
        return this;
    }
