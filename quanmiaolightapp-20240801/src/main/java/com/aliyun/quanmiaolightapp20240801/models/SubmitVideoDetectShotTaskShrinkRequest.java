...
public class SubmitVideoDetectShotTaskShrinkRequest extends TeaModel {
    /**
    ...
    public static SubmitVideoDetectShotTaskShrinkRequest build(java.util.Map<String, ?> map) throws Exception {
        SubmitVideoDetectShotTaskShrinkRequest self = new SubmitVideoDetectShotTaskShrinkRequest();
        return TeaModel.build(map, self);
    }

    public SubmitVideoDetectShotTaskShrinkRequest setDeduplicationId(String deduplicationId) {
    ...
    public SubmitVideoDetectShotTaskShrinkRequest setIntelliSimpPrompt(String intelliSimpPrompt) {
    ...
    public SubmitVideoDetectShotTaskShrinkRequest setIntelliSimpPromptTemplateId(String intelliSimpPromptTemplateId) {
    ...
    public SubmitVideoDetectShotTaskShrinkRequest setLanguage(String language) {
    ...
    public SubmitVideoDetectShotTaskShrinkRequest setModelCustomPromptTemplateId(String modelCustomPromptTemplateId) {
    ...
    public SubmitVideoDetectShotTaskShrinkRequest setModelId(String modelId) {
    ...
    public SubmitVideoDetectShotTaskShrinkRequest setModelVlCustomPromptTemplateId(String modelVlCustomPromptTemplateId) {
    ...
    public SubmitVideoDetectShotTaskShrinkRequest setOptionsShrink(String optionsShrink) {
    ...
    public SubmitVideoDetectShotTaskShrinkRequest setOriginalSessionId(String originalSessionId) {
    ...
    public SubmitVideoDetectShotTaskShrinkRequest setPreModelId(String preModelId) {
    ...
    public SubmitVideoDetectShotTaskShrinkRequest setPrompt(String prompt) {
        this.prompt = prompt;
        return this;
    }
    ...
    public SubmitVideoDetectShotTaskShrinkRequest setRecognitionOptionsShrink(String recognitionOptionsShrink) {
    ...
    public SubmitVideoDetectShotTaskShrinkRequest setTaskId(String taskId) {
        this.taskId = taskId;
        return this;
    }
    ...
    public SubmitVideoDetectShotTaskShrinkRequest setVideoUrl(String videoUrl) {
    ...
    public SubmitVideoDetectShotTaskShrinkRequest setVlPrompt(String vlPrompt) {
