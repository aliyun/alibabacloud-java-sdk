...
public class UnlockSecretNoResponse extends TeaModel {
    ...
    public UnlockSecretNoResponse setRequestId(String requestId) {
    ...
    public UnlockSecretNoResponse setCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public UnlockSecretNoResponse setMessage(String message) {
