...
public class GetSecretAsrDetailRequest extends TeaModel {
    ...
    public GetSecretAsrDetailRequest setOwnerId(Long ownerId) {
    ...
    public GetSecretAsrDetailRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public GetSecretAsrDetailRequest setResourceOwnerId(Long resourceOwnerId) {
