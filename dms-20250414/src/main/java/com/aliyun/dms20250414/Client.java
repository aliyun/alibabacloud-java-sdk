...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    public CreateAgentResponse createAgentWithOptions(CreateAgentRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.expireAfterSeconds)) {
            query.put("ExpireAfterSeconds", request.expireAfterSeconds);
        }
    ...
    /**
     * <b>summary</b> : 
     * <p>Creates a DataAgent session.</p>
     * 
    ...
    /**
     * <b>summary</b> : 
     * <p>Invokes the DescribeDataAgentTheme operation to query the details of a specific DataAgent theme, including the theme name, stage, source, common scenarios, description, and creation and modification time.</p>
     * 
    ...
    /**
     * <b>summary</b> : 
     * <p>Calls the ListDataAgentTheme operation to query the DataAgent theme list by paging. You can filter results by theme stage, source, and common scenario.</p>
     * 
    ...
    /**
     * <b>summary</b> : 
     * <p>Resets the Access Token of a specified data gateway. The associated Agent and name are retained, and only the plaintext Access Token is regenerated. The old Access Token becomes invalid immediately. The new plaintext Access Token is returned only once in this response. Store it securely right away. Only the creator of the Access Token can reset it, and only Access Tokens issued by the console (source=console) can be reset.</p>
     * 
     * @param request ResetAgenticApiKeyRequest
     * @param runtime runtime options for this request RuntimeOptions
     * @return ResetAgenticApiKeyResponse
     */
    public ResetAgenticApiKeyResponse resetAgenticApiKeyWithOptions(ResetAgenticApiKeyRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.expireAfterSeconds)) {
            query.put("ExpireAfterSeconds", request.expireAfterSeconds);
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "ResetAgenticApiKey"),
            new TeaPair("version", "2025-04-14"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new ResetAgenticApiKeyResponse());
    }
     ...
     * @return ResetAgenticApiKeyResponse
     */
    public ResetAgenticApiKeyResponse resetAgenticApiKey(ResetAgenticApiKeyRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        return this.resetAgenticApiKeyWithOptions(request, runtime);
    }
