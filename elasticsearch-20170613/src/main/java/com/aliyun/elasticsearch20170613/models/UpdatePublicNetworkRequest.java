...
public class UpdatePublicNetworkRequest extends TeaModel {
    ...
    /**
     * <p>A unique token used to ensure idempotence of the request. This parameter value is generated by the client and must be unique across different requests. The value cannot exceed 64 ASCII characters in length.</p>
     * 
