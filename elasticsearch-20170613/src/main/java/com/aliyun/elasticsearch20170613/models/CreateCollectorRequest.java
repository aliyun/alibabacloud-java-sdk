...
public class CreateCollectorRequest extends TeaModel {
    /**
     * <p>The collection paths of fileBeat. This parameter is required only when the collector is installed on ECS instances.</p>
     */
    ...
    /**
     * <p>Specifies whether to perform only a dry run without creating the collector. This parameter is used only when you create or update a collector. Valid values:</p>
     * <ul>
    ...
    /**
     * <p>The collector name. The name must be 1 to 30 characters in length and must start with an uppercase or lowercase letter. The name can contain letters, digits, underscores (_), or hyphens (-).</p>
     * <p>This parameter is required.</p>
     * 
     * <strong>example:</strong>
     * <p>ct-test</p>
