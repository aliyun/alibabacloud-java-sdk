...
public class InitializeOperationRoleRequest extends TeaModel {
    /**
     * <p>A unique token generated by the client to ensure the idempotence of the request. The value of this parameter must be unique across different requests and can contain up to 64 ASCII characters.</p>
     * 
