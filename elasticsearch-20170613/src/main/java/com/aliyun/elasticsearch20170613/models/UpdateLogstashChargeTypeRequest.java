...
public class UpdateLogstashChargeTypeRequest extends TeaModel {
    ...
    /**
     * <p>A unique token used to ensure idempotence. Generated by the client. The value must be unique across requests and cannot exceed 64 ASCII characters in length.</p>
     * 
