...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    public StartApmResponse startApmWithOptions(String instanceId, java.util.Map<String, String> headers, RuntimeOptions runtime) throws Exception {
        ...
        return TeaModel.toModel(this.doROARequest("StartApm", "2017-06-13", "HTTPS", "POST", "AK", "/openapi/apm/" + instanceId + "/start", "json", req, runtime), new StartApmResponse());
    }
    ...
    public StopApmResponse stopApmWithOptions(String instanceId, java.util.Map<String, String> headers, RuntimeOptions runtime) throws Exception {
        ...
        return TeaModel.toModel(this.doROARequest("StopApm", "2017-06-13", "HTTPS", "POST", "AK", "/openapi/apm/" + instanceId + "/stop", "json", req, runtime), new StopApmResponse());
    }
    ...
    public ListApmResponse listApmWithOptions(ListApmRequest request, java.util.Map<String, String> headers, RuntimeOptions runtime) throws Exception {
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.esInstanceId)) {
            query.put("esInstanceId", request.esInstanceId);
        }
    ...
    public RpcListInstanceResponse rpcListInstance(RpcListInstanceRequest request) throws Exception {
        RuntimeOptions runtime = new RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
        return this.rpcListInstanceWithOptions(request, headers, runtime);
    }

    public RpcListInstanceResponse rpcListInstanceWithOptions(RpcListInstanceRequest request, java.util.Map<String, String> headers, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.esVersion)) {
            query.put("esVersion", request.esVersion);
        ...
        return TeaModel.toModel(this.doROARequest("RpcListInstance", "2017-06-13", "HTTPS", "POST", "AK", "/openapi/instances/rpc", "json", req, runtime), new RpcListInstanceResponse());
    }
