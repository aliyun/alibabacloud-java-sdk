...
public class KillSemanticJobRequest extends TeaModel {
    ...
    /**
     * <p>The number of retries when sending the stop request to the executor. This parameter is optional. If specified, use a non-negative integer. After the call, confirm the final status by calling GetSemanticJobDetail.</p>
     * 
     * <strong>example:</strong>
     * <p>1</p>
     */
