...
public class KillSemanticJobRequest extends TeaModel {
    /**
     * <p>The executor job ID of the run to stop. Use the Data.ExecutorJobId value from the RunSemanticJob response or the ExecutorJobId from a ListSemanticJobRuns record.</p>
    ...
    /**
     * <p>The number of retries when sending the stop request to the executor. This parameter is optional. Specify a non-negative integer. After the call, confirm the final status by calling GetSemanticJobDetail.</p>
     * 
     * <strong>example:</strong>
     * <p>1</p>
     */
