...
public class UpdateSkillRequest extends TeaModel {
    ...
    public UpdateSkillRequestVisibilityScope visibilityScope;
    ...
    public UpdateSkillRequest setBundleUrl(String bundleUrl) {
    ...
    public UpdateSkillRequest setExpectedVersion(Integer expectedVersion) {
    ...
    public UpdateSkillRequest setExtra(java.util.Map<String, ?> extra) {
        this.extra = extra;
        return this;
    }
    ...
    public UpdateSkillRequest setSkillMdOverride(String skillMdOverride) {
    ...
    public UpdateSkillRequest setVersionNote(String versionNote) {
    ...
    public UpdateSkillRequest setVisibilityScope(UpdateSkillRequestVisibilityScope visibilityScope) {
        this.visibilityScope = visibilityScope;
        return this;
    }
    public UpdateSkillRequestVisibilityScope getVisibilityScope() {
    ...
    public static class UpdateSkillRequestVisibilityScope extends TeaModel {
        ...
        public static UpdateSkillRequestVisibilityScope build(java.util.Map<String, ?> map) throws Exception {
            UpdateSkillRequestVisibilityScope self = new UpdateSkillRequestVisibilityScope();
            return TeaModel.build(map, self);
        }

        public UpdateSkillRequestVisibilityScope setProjectIds(java.util.List<String> projectIds) {
        ...
        public UpdateSkillRequestVisibilityScope setUserIds(java.util.List<String> userIds) {
