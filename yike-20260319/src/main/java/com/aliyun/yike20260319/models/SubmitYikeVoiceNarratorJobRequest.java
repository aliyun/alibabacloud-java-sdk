...
public class SubmitYikeVoiceNarratorJobRequest extends TeaModel {
    /**
     * <p>The node request content. JSON string. Contains the following parameters:</p>
     * <ul>
     * <li>SceneType: string. The common scenarios type. Valid values: <code>briefing-voiceover</code>: news broadcast or financial education industry.</li>
     * <li>TextType: int. The text type. Valid values: <code>1</code>: raw text (product or news information, which the system automatically converts into a voiceover script). <code>2</code>: voiceover script.</li>
     ...
     * <li>VoiceDuration: int. The expected voiceover duration. Set this parameter when <code>TextType==1</code>. Unit: seconds. Default value: 60. The final video duration is slightly shorter than the expected duration.</li>
     ...
     * </ul>
     * <p>-- The following parameters are for the portrait-mode packaging template and are valid only for the briefing-voiceover type. --</p>
     * <ul>
     * <li>TargetAspectRatio: string. The aspect ratio adapted for portrait mode. Valid values: <code>16:9</code>, <code>9:16</code>, <code>4:3</code>, <code>3:4</code>.</li>
