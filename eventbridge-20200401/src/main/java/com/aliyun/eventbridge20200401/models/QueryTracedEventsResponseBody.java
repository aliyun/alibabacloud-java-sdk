...
public class QueryTracedEventsResponseBody extends TeaModel {
     ...
     * <ul>
     * <li><p><code>Success</code>: The request succeeded.</p>
     * </li>
     * <li><p>Other values indicate an error. For more information, see error codes.</p>
     * </li>
     * </ul>
     * 
    ...
    /**
     * <p>The request ID generated by Alibaba Cloud.</p>
     * 
     * <strong>example:</strong>
    ...
    /**
     * <p><code>true</code> indicates that the request succeeded.</p>
     * 
     * <strong>example:</strong>
     * <p>true</p>
     */
    ...
    public static class QueryTracedEventsResponseBodyDataEvents extends TeaModel {
        ...
        /**
         * <p>The UNIX timestamp (in milliseconds) when the event was delivered to the event bus.</p>
         * 
         * <strong>example:</strong>
         * <p>1661773573100</p>
         */
    ...
    public static class QueryTracedEventsResponseBodyData extends TeaModel {
        /**
         * <p>An array of event objects.</p>
         */
        @NameInMap("Events")
        public java.util.List<QueryTracedEventsResponseBodyDataEvents> events;

        /**
         * <p>The token to retrieve the next page of results. This parameter is returned only if more results are available.</p>
         * 
         * <strong>example:</strong>
         * <p>1000</p>
         */
