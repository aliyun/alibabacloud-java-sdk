...
public class GetNamespaceRequest extends TeaModel {
    ...
    public GetNamespaceRequest setCatalog(String catalog) {
    ...
    public GetNamespaceRequest setClientToken(String clientToken) {
    ...
    public GetNamespaceRequest setName(String name) {
        this.name = name;
        return this;
    }
