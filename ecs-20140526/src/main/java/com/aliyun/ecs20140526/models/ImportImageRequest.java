...
public class ImportImageRequest extends TeaModel {
     ...
     * <br>
     * <p>>  You must be aware of the boot modes supported by the specified image. When you use this parameter to change the boot mode of the image, specify a boot mode supported by the image to ensure that instances that use this image can start normally.</p>
     */
    @NameInMap("BootMode")
    public String bootMode;

    /**
     * <p>The description of the custom image. The description must be 2 to 256 characters in length and cannot start with `http://` or `https://`.</p>
     */
     ...
     * <p>*   Grub: whether GRUB configurations are correct.</p>
    ...
    /**
     * <p>The mappings of the disk devices.</p>
     */
    ...
    /**
     * <p>The name of the RAM role to use to import the source image.</p>
     */
    @NameInMap("RoleName")
    public String roleName;

    /**
     * <p>The tags of the imported custom image.</p>
     */
    @NameInMap("Tag")
    ...
    public static class ImportImageRequestDiskDeviceMapping extends TeaModel {
         ...
         * <br>
         * <p>>  This parameter will be removed in the future. To ensure future compatibility, we recommend that you use the `DiskDeviceMapping.N.DiskImageSize` parameter.</p>
         */
         ...
         * <br>
         * <p>You can use this parameter to specify the sizes of the system disk and data disks in the custom image. When you specify the size of the system disk, make sure that the specified size is greater than or equal to the size of the custom image file. Unit: GiB. Valid values:</p>
         * <br>
        ...
        /**
         * <p>The format of the custom image. Valid values:</p>
         * <br>
         * <p>*   RAW</p>
         * <p>*   VHD</p>
         * <p>*   QCOW2</p>
         * <br>
         * <p>This parameter is empty by default, which indicates that the system checks the format of the custom image and uses the check result as the value of this parameter.</p>
         */
        @NameInMap("Format")
         ...
         * <br>
         * <p>>  Before you import images for the first time, you must use RAM to authorize ECS to access your OSS buckets. If ECS is not authorized to access your OSS buckets, the **NoSetRoletoECSServiceAcount** error code is returned when you call the ImportImage operation. For more information, see the `Description` section of this topic.</p>
         */
        @NameInMap("OSSBucket")
        public String OSSBucket;

        /**
         * <p>The name (key) of the object that the uploaded source image is stored as in the OSS bucket.</p>
         */
        @NameInMap("OSSObject")
    ...
    public static class ImportImageRequestTag extends TeaModel {
        /**
         * <p>The key of tag N to add to the custom image. Valid values of N: 1 to 20. The tag key cannot be an empty string. It can be up to 128 characters in length and cannot contain `http://` or `https://`. It cannot start with `aliyun` or `acs:`.</p>
         */
        @NameInMap("Key")
        public String key;

        /**
         * <p>The value of tag N to add to the custom image. Valid values of N: 1 to 20. The tag value can be an empty string. It can be up to 128 characters in length and cannot start with `acs:`. It cannot contain `http://` or `https://`.</p>
         */
        @NameInMap("Value")
        public String value;
