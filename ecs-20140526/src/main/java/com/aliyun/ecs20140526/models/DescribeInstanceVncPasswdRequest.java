...
public class DescribeInstanceVncPasswdRequest extends TeaModel {
    ...
    public DescribeInstanceVncPasswdRequest setOwnerId(Long ownerId) {
    ...
    public DescribeInstanceVncPasswdRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public DescribeInstanceVncPasswdRequest setResourceOwnerId(Long resourceOwnerId) {
    ...
    public DescribeInstanceVncPasswdRequest setOwnerAccount(String ownerAccount) {
