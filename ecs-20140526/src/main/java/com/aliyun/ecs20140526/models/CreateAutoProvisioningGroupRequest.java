...
public class CreateAutoProvisioningGroupRequest extends TeaModel {
    ...
    public static class CreateAutoProvisioningGroupRequestResourcePoolOptions extends TeaModel {
        ...
        /**
         * <p>Resource pools include private pools generated by Elastic Guaranteed or Capacity Reservation services, and public pools. Instances select from these pools at startup. Valid values:</p>
         * <ul>
         * <li><p>PrivatePoolFirst: Private pools first. With this strategy,
         * if ResourcePoolOptions.PrivatePoolIds is specified, the specified private pools are prioritized. If no private pool is specified or the specified private pools lack capacity, open private pools are automatically matched. If no eligible private pools exist, instances are created from the public pool.</p>
         * </li>
         * <li><p>PrivatePoolOnly: Private pools only. With this strategy, you must specify ResourcePoolOptions.PrivatePoolIds. If the specified private pools lack capacity, instance startup fails.</p>
         * </li>
         * <li><p>PublicPoolOnly: Use the public pool to create instances.</p>
         * </li>
         * </ul>
