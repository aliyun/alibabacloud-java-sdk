...
public class DescribeInstanceVncUrlRequest extends TeaModel {
    ...
    public DescribeInstanceVncUrlRequest setOwnerAccount(String ownerAccount) {
    ...
    public DescribeInstanceVncUrlRequest setOwnerId(Long ownerId) {
    ...
    public DescribeInstanceVncUrlRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public DescribeInstanceVncUrlRequest setResourceOwnerId(Long resourceOwnerId) {
