...
public class CreateActivationResponseBody extends TeaModel {
    /**
     * <p>The value of the activation code. The value is returned only once after the CreateActivation operation is called and cannot be subsequently queried. Properly save the return value.</p>
     */
