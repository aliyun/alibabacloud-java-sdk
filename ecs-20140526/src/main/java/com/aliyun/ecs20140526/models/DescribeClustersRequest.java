...
public class DescribeClustersRequest extends TeaModel {
    ...
    public DescribeClustersRequest setOwnerAccount(String ownerAccount) {
    ...
    public DescribeClustersRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public DescribeClustersRequest setResourceOwnerId(Long resourceOwnerId) {
