...
public class CreateSnapshotGroupRequest extends TeaModel {
    ...
    /**
     * <p>The ID of a disk for which you want to create a snapshot-consistent group. You can specify disk IDs across instances within the same zone. Valid values of N: 1 to 128. A snapshot-consistent group can contain up to 128 disks with a total capacity of up to 256 TiB.</p>
     * <p>Take note of the following items:</p>
     * <ul>
     * <li>This parameter cannot be specified together with <code>ExcludeDiskId.N</code>.</li>
     * <li>If you specify <code>InstanceId</code>, this parameter can only be set to disks that are attached to the specified instance. Specifying disk IDs across multiple instances is not supported in this case.</li>
     * </ul>
     */
    @NameInMap("DiskId")
    ...
    /**
     * <p>The ID of a disk in the instance for which you do not want to create a snapshot. After you specify the disk ID, the snapshot-consistent group does not contain the snapshot of the specified disk. Valid values of N: 1 to 128.</p>
     ...
     * <p>This parameter takes effect only when <code>InstantAccess=true</code>. The snapshot instant access feature is automatically disabled when the specified period expires.</p>
     * <p>Default value: null, which indicates that the snapshot instant access feature is active until the snapshot is released.</p>
     * <blockquote>
     * <p>This parameter is deprecated. Standard snapshots of enterprise SSDs have been upgraded to <a href="https://help.aliyun.com/document_detail/193667.html">instant access by default</a>. No additional configuration or fees are required.</p>
     * </blockquote>
     * 
