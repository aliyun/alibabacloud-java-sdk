...
public class ModifyDedicatedHostAutoReleaseTimeRequest extends TeaModel {
     ...
     * <p>*   The scheduled release time can be at most 3 years from the current time.</p>
     * <p>*   If the value of the seconds (ss) is not 00, it is automatically set to 00.</p>
     * <p>*   If you do not specify the `AutoReleaseTime` parameter, automatic release is disabled. The dedicated host will not be released at the scheduled time.</p>
     */
