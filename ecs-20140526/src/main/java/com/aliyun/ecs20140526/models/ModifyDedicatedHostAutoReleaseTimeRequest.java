...
public class ModifyDedicatedHostAutoReleaseTimeRequest extends TeaModel {
     ...
     * <br>
     * <p>*   The scheduled automatic release time must be at least 30 minutes from the current time.</p>
     * <p>*   The specified release time can be up to 3 years from the current time.</p>
     * <p>*   If the value of the seconds (ss) is not 00, it is automatically set to 00.</p>
     * <p>*   If `AutoReleaseTime` is not specified, the automatic release feature is disabled and the dedicated host will not be automatically released.</p>
     */
    @NameInMap("AutoReleaseTime")
    public String autoReleaseTime;

    /**
     * <p>The ID of the dedicated host to configure automatic release.</p>
     */
