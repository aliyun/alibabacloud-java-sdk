...
public class DeleteCommandRequest extends TeaModel {
    ...
    public DeleteCommandRequest setOwnerAccount(String ownerAccount) {
    ...
    public DeleteCommandRequest setOwnerId(Long ownerId) {
    ...
    public DeleteCommandRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public DeleteCommandRequest setResourceOwnerId(Long resourceOwnerId) {
