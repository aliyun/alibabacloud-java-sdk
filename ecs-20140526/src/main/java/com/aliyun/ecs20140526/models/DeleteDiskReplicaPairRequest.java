...
public class DeleteDiskReplicaPairRequest extends TeaModel {
    ...
    public DeleteDiskReplicaPairRequest setOwnerId(Long ownerId) {
    ...
    public DeleteDiskReplicaPairRequest setOwnerAccount(String ownerAccount) {
    ...
    public DeleteDiskReplicaPairRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public DeleteDiskReplicaPairRequest setResourceOwnerId(Long resourceOwnerId) {
