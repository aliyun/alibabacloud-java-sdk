...
public class GetInstanceConsoleOutputResponseBody extends TeaModel {
    /**
     * <p>The Base64-encoded system command-line output of the instance.</p>
     * 
    ...
    /**
     * <p>The record of the time when the last line of the Linux kernel logs was printed, in UTC+8. Format: yyyy-MM-dd HH:mm:ss.</p>
     * 
     * <strong>example:</strong>
