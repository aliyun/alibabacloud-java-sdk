...
public class GetInstanceConsoleOutputResponseBody extends TeaModel {
    /**
     * <p>The system command line output of the instance, encoded in Base64.</p>
     * 
    ...
    /**
     * <p>The UTC+8 time recorded when the last entry of the Linux kernel logs was printed. Format: yyyy-MM-dd HH:mm:ss.</p>
     * 
     * <strong>example:</strong>
