...
public class DescribeBandwidthPackagesRequest extends TeaModel {
    ...
    public DescribeBandwidthPackagesRequest setOwnerAccount(String ownerAccount) {
    ...
    public DescribeBandwidthPackagesRequest setOwnerId(Long ownerId) {
    ...
    public DescribeBandwidthPackagesRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public DescribeBandwidthPackagesRequest setResourceOwnerId(Long resourceOwnerId) {
