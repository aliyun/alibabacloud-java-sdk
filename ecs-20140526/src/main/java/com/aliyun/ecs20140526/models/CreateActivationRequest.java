...
public class CreateActivationRequest extends TeaModel {
    ...
    /**
     * <p>The validity period of the activation code. The activation code cannot be used to register new instances after the validity period ends. Unit: hours. Valid values: 1 to 24.</p>
     * <br>
     * <p>Default value: 4.</p>
     */
    ...
    /**
     * <p>The description of the activation code. The description must be 1 to 100 characters in length and cannot start with `http://` or `https://`.</p>
     */
    ...
    /**
     * <p>The tag to add to the activation code.</p>
     */
    @NameInMap("Tag")
