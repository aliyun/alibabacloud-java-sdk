...
public class DeleteBandwidthPackageRequest extends TeaModel {
    ...
    public DeleteBandwidthPackageRequest setOwnerAccount(String ownerAccount) {
    ...
    public DeleteBandwidthPackageRequest setOwnerId(Long ownerId) {
    ...
    public DeleteBandwidthPackageRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public DeleteBandwidthPackageRequest setResourceOwnerId(Long resourceOwnerId) {
