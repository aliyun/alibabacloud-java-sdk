...
public class DescribeCommandsResponse extends TeaModel {
    ...
    public static class DescribeCommandsResponseCommandsCommand extends TeaModel {
        ...
        public DescribeCommandsResponseCommandsCommand setVersion(Integer version) {
        ...
        public DescribeCommandsResponseCommandsCommand setLatest(Boolean latest) {
            this.latest = latest;
            return this;
        }
        ...
        public DescribeCommandsResponseCommandsCommand setProvider(String provider) {
        ...
        public DescribeCommandsResponseCommandsCommand setCategory(String category) {
