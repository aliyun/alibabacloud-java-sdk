...
public class ModifyPrepayInstanceSpecRequest extends TeaModel {
    ...
    /**
     * <p>Specifies whether automatic payment is enabled when you upgrade the instance type. Valid values:</p>
     * 
    ...
    /**
     * <p>The end time of the temporary specification change. Specify the time in the <a href="https://help.aliyun.com/document_detail/25696.html">ISO 8601</a> standard in the yyyy-MM-ddTHH:mmZ format. The time must be in UTC.</p>
     * 
     * <strong>example:</strong>
