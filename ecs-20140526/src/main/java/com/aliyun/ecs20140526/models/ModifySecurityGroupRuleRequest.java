...
public class ModifySecurityGroupRuleRequest extends TeaModel {
     ...
     * <br>
     * <p>>  Only the IP addresses of instances in VPCs are supported. You cannot specify both the Ipv6DestCidrIp parameter and the `DestCidrIp` parameter.</p>
     * <br>
     * <p>This parameter is empty by default.</p>
     */
     ...
     * <br>
     * <p>>  Only the IP addresses of instances in virtual private clouds (VPCs) are supported. You cannot specify both the Ipv6SourceCidrIp parameter and the `SourceCidrIp` parameter.</p>
     * <br>
     * <p>This parameter is empty by default.</p>
     */
    ...
    /**
     * <p>The region ID of the destination security group. You can call the [DescribeRegions](~~25609~~) operation to query the most recent region list.</p>
     */
    @NameInMap("RegionId")
