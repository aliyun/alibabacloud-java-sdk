...
public class DescribeInstancesResponse extends TeaModel {
    ...
    public DescribeInstancesResponse setNextToken(String nextToken) {
    ...
    public static class DescribeInstancesResponseInstancesInstanceHibernationOptions extends TeaModel {
        @NameInMap("Configured")
        @Validation(required = true)
        public Boolean configured;

        public static DescribeInstancesResponseInstancesInstanceHibernationOptions build(java.util.Map<String, ?> map) throws Exception {
            DescribeInstancesResponseInstancesInstanceHibernationOptions self = new DescribeInstancesResponseInstancesInstanceHibernationOptions();
            return TeaModel.build(map, self);
        }

        public DescribeInstancesResponseInstancesInstanceHibernationOptions setConfigured(Boolean configured) {
    ...
    public static class DescribeInstancesResponseInstancesInstance extends TeaModel {
        ...
        @Validation(required = true)
        public DescribeInstancesResponseInstancesInstanceHibernationOptions hibernationOptions;
        ...
        public DescribeInstancesResponseInstancesInstance setHibernationOptions(DescribeInstancesResponseInstancesInstanceHibernationOptions hibernationOptions) {
            this.hibernationOptions = hibernationOptions;
            return this;
        }
        public DescribeInstancesResponseInstancesInstanceHibernationOptions getHibernationOptions() {
