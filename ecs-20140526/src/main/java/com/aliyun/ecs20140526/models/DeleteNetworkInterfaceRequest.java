...
public class DeleteNetworkInterfaceRequest extends TeaModel {
    ...
    public DeleteNetworkInterfaceRequest setOwnerAccount(String ownerAccount) {
    ...
    public DeleteNetworkInterfaceRequest setOwnerId(Long ownerId) {
    ...
    public DeleteNetworkInterfaceRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public DeleteNetworkInterfaceRequest setResourceOwnerId(Long resourceOwnerId) {
