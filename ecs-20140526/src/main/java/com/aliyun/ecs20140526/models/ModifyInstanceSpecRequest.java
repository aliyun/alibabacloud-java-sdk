...
public class ModifyInstanceSpecRequest extends TeaModel {
    ...
    /**
     * <p>Specifies whether to allow cross-cluster instance type upgrades.</p>
     * <br>
     ...
     * <br>
     * <p>Instances in the classic network:</p>
     * <br>
     * <p>*   For retired instance types, when the configurations of a non-I/O optimized instance is upgraded to those of an I/O optimized instance, the private IP address, disk device names, and software license code of the instance are changed. For information about retired instance types, see [Retired instance types](~~55263~~). For Linux instances, basic disks (`cloud`) are identified as xvd\*, such as **xvda** and **xvdb**. Ultra disks (`cloud_efficiency`) and standard SSDs (`cloud_ssd`) are identified as vd\*, such as **vda** and **vdb**.</p>
     * <p>*   For instance families available for purchase, when the instance type of an instance is changed, the private IP address of the instance is also changed. For information about instance families available for purchase, see [Instance families](~~25378~~).</p>
     * <br>
     * <p>Instances in VPCs: For retired instance types, when the configurations of a non-I/O optimized instance is upgraded to those of an I/O optimized instance, the disk device names and software license code of the instance are changed. For information about retired instance types, see [Retired instance types](~~55263~~). For Linux instances, basic disks (`cloud`) are identified as xvd\*, such as **xvda** and **xvdb**. Ultra disks (`cloud_efficiency`) and standard SSDs (`cloud_ssd`) are identified as vd\*, such as **vda** and **vdb**.</p>
     */
    ...
    /**
     * <p>The new instance type. For more information, see [Instance families](~~25378~~) or call the [DescribeInstanceTypes](~~25620~~) operation to query the most recent instance type list.</p>
     */
    ...
    public static class ModifyInstanceSpecRequestSystemDisk extends TeaModel {
        /**
         * <p>The category of the system disk. This parameter is valid only when you upgrade the configurations of an instance from a retired instance type to an available instance type or from a non-I/O optimized instance to an I/O optimized instance. For more information, see [Retired instance types](~~55263~~) and [Instance families](~~25378~~). Valid values:</p>
         * <br>
