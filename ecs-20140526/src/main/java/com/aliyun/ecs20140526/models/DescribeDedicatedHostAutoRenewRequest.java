...
public class DescribeDedicatedHostAutoRenewRequest extends TeaModel {
    ...
    public DescribeDedicatedHostAutoRenewRequest setOwnerAccount(String ownerAccount) {
    ...
    public DescribeDedicatedHostAutoRenewRequest setOwnerId(Long ownerId) {
    ...
    public DescribeDedicatedHostAutoRenewRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public DescribeDedicatedHostAutoRenewRequest setResourceOwnerId(Long resourceOwnerId) {
