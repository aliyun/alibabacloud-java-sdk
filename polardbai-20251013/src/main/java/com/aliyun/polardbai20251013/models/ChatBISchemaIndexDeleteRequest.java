...
public class ChatBISchemaIndexDeleteRequest extends TeaModel {
    ...
    public ChatBISchemaIndexDeleteRequest setInstanceName(String instanceName) {
    ...
    public ChatBISchemaIndexDeleteRequest setSourceRegionId(String sourceRegionId) {
    ...
    public ChatBISchemaIndexDeleteRequest setTableName(String tableName) {
