...
public class ChatBIConfigQueryEntriesRequest extends TeaModel {
    ...
    public ChatBIConfigQueryEntriesRequest setAuthMessage(String authMessage) {
    ...
    public ChatBIConfigQueryEntriesRequest setAuthType(String authType) {
    ...
    public ChatBIConfigQueryEntriesRequest setSourceRegionId(String sourceRegionId) {
