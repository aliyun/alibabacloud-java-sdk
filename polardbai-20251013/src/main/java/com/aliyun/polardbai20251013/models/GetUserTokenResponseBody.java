...
public class GetUserTokenResponseBody extends TeaModel {
    ...
    public GetUserTokenResponseBody setData(Object data) {
        this.data = data;
        return this;
    }
    ...
    public GetUserTokenResponseBody setErrCode(String errCode) {
    ...
    public GetUserTokenResponseBody setErrMessage(String errMessage) {
