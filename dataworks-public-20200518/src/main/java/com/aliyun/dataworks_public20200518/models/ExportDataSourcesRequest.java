...
public class ExportDataSourcesRequest extends TeaModel {
    ...
    /**
     * <p>The ID of the DataWorks workspace to which the data sources belong. You can call the [ListProjects](~~178393~~) operation to query the ID of the workspace.</p>
     */
    @NameInMap("ProjectId")
