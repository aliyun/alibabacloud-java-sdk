...
public class QueryDISyncTaskConfigProcessResultResponseBody extends TeaModel {
    ...
    public static class QueryDISyncTaskConfigProcessResultResponseBodyData extends TeaModel {
         ...
         * <ul>
         * <li><p>success: The parameters are obtained.</p>
         * </li>
         * <li><p>fail: The parameters fail to be obtained. You can view the reason for the failure and troubleshoot the issue based on the reason.</p>
         * </li>
         * </ul>
         * 
         * <strong>example:</strong>
