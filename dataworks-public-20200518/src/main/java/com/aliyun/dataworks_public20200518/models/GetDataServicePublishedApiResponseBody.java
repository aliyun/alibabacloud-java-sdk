...
public class GetDataServicePublishedApiResponseBody extends TeaModel {
    ...
    public static class GetDataServicePublishedApiResponseBodyDataRegistrationDetailsRegistrationRequestParameters extends TeaModel {
         ...
         * <li><p>9: FloatList</p>
         * </li>
         * <li><p>10: DoubleList</p>
         * </li>
         * <li><p>11: BooleanList</p>
         * </li>
         * </ul>
         * 
         * <strong>example:</strong>
    ...
    public static class GetDataServicePublishedApiResponseBodyDataRegistrationDetails extends TeaModel {
        ...
        /**
         * <p>The list of error codes for the registered API.</p>
         */
        ...
        /**
         * <p>The list of request parameters for the registered API.</p>
         */
    ...
    public static class GetDataServicePublishedApiResponseBodyDataScriptDetailsScriptRequestParameters extends TeaModel {
         ...
         * <ul>
         * <li><p>0: indicates that the parameter is in the URL path of the request.</p>
         * </li>
         * <li><p>1: indicates that the parameter is in the Query parameter of the request URL.</p>
         * </li>
         * <li><p>2: indicates that the parameter is in the request header.</p>
         * </li>
         * <li><p>3: indicates that the parameter is in the request body.</p>
         * </li>
         * </ul>
    ...
    public static class GetDataServicePublishedApiResponseBodyData extends TeaModel {
        ...
        /**
         * <p>Registered API details. Only returned for registered APIs.</p>
         */
        ...
        /**
         * <p>The SQL mode. 0: Basic SQL; 1: Advanced SQL.</p>
         * 
         * <strong>example:</strong>
         * <p>0</p>
         */
