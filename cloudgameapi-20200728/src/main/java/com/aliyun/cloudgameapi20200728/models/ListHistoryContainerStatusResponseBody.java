...
public class ListHistoryContainerStatusResponseBody extends TeaModel {
    ...
    public static class ListHistoryContainerStatusResponseBodyDataList extends TeaModel {
        ...
        public ListHistoryContainerStatusResponseBodyDataList setRegion(String region) {
            this.region = region;
            return this;
        }
        ...
        public ListHistoryContainerStatusResponseBodyDataList setResourceLevel(Integer resourceLevel) {
