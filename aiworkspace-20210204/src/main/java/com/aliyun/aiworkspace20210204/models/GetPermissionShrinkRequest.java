...
public class GetPermissionShrinkRequest extends TeaModel {
    ...
    public GetPermissionShrinkRequest setCallerAccessKeyId(String callerAccessKeyId) {
    ...
    public GetPermissionShrinkRequest setCallerSecurityToken(String callerSecurityToken) {
