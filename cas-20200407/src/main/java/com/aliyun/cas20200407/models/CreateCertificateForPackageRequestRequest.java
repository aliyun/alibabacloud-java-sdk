...
public class CreateCertificateForPackageRequestRequest extends TeaModel {
     ...
     * <ul>
     * <li><p>The domain name must be a single domain name or a wildcard domain name. Example: <code>*.aliyundoc.com</code>.</p>
     * </li>
     * <li><p>You can specify multiple domain names. Separate multiple domain names with commas (,). You can specify a maximum of five domain names.</p>
     * </li>
     * <li><p>If you specify multiple domain names, the domain names must be only single domain names or only wildcard domain names. You cannot specify both single domain names and wildcard domain names.</p>
     * </li>
     * </ul>
     * <blockquote>
     ...
     * <ul>
     * <li><p><strong>digicert-free-1-free</strong> (default): DigiCert single-domain domain validated (DV) certificate, which is free and valid for 3 months. This value is available only on the China site (aliyun.com).</p>
     * </li>
