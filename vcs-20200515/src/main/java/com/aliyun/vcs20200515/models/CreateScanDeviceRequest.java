...
public class CreateScanDeviceRequest extends TeaModel {
    ...
    public CreateScanDeviceRequest setCityCode(String cityCode) {
    ...
    public CreateScanDeviceRequest setCorpId(String corpId) {
        this.corpId = corpId;
        return this;
    }
    ...
    public CreateScanDeviceRequest setDeviceDirection(String deviceDirection) {
    ...
    public CreateScanDeviceRequest setDeviceRate(String deviceRate) {
    ...
    public CreateScanDeviceRequest setDeviceResolution(String deviceResolution) {
    ...
    public CreateScanDeviceRequest setDeviceSite(String deviceSite) {
    ...
    public CreateScanDeviceRequest setDeviceSn(String deviceSn) {
    ...
    public CreateScanDeviceRequest setDeviceType(String deviceType) {
    ...
    public CreateScanDeviceRequest setEncodeFormat(String encodeFormat) {
    ...
    public CreateScanDeviceRequest setFrameRate(String frameRate) {
    ...
    public CreateScanDeviceRequest setLongitude(String longitude) {
    ...
    public CreateScanDeviceRequest setOSDTimeEnable(String OSDTimeEnable) {
    ...
    public CreateScanDeviceRequest setOSDTimeType(String OSDTimeType) {
    ...
    public CreateScanDeviceRequest setOSDTimeX(String OSDTimeX) {
    ...
    public CreateScanDeviceRequest setOSDTimeY(String OSDTimeY) {
