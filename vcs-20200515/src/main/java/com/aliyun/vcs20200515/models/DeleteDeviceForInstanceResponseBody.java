...
public class DeleteDeviceForInstanceResponseBody extends TeaModel {
    ...
    public static DeleteDeviceForInstanceResponseBody build(java.util.Map<String, ?> map) throws Exception {
        DeleteDeviceForInstanceResponseBody self = new DeleteDeviceForInstanceResponseBody();
