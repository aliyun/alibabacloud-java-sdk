...
public class GetSmartHandleJobResponseBody extends TeaModel {
    /**
     * <p>The error code. This parameter is returned only if the job fails.</p>
     * 
     * <strong>example:</strong>
     * <p>SpeechTranslationNoValidVocal</p>
     */
    @NameInMap("ErrorCode")
    public String errorCode;

    /**
     * <p>The error message. This parameter is returned only if the job fails.</p>
     * 
     * <strong>example:</strong>
     * <p>The speech translation job failed due to lack of valid vocal voice data.</p>
     */
    ...
    public static class GetSmartHandleJobResponseBodyJobResult extends TeaModel {
        ...
        /**
         * <p>The URL of the output media file generated by the smart job.</p>
         * 
         * <strong>example:</strong>
        ...
        /**
         * <p>The token usage. This parameter is returned only for keyword expansion jobs.</p>
         * 
         * <strong>example:</strong>
    ...
    public static class GetSmartHandleJobResponseBodySmartJobInfoInputConfig extends TeaModel {
        /**
         * <p>The Object Storage Service (OSS) URL of the input file or the media ID.</p>
         * 
         * <strong>example:</strong>
         * <p>oss://example-bucket.oss-cn-shanghai.aliyuncs.com/example.mp4 or <strong><strong><strong>11-DB8D-4A9A-875B-275798</strong></strong></strong></p>
         */
        @NameInMap("InputFile")
