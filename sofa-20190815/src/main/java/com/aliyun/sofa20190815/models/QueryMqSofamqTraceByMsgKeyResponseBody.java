...
public class QueryMqSofamqTraceByMsgKeyResponseBody extends TeaModel {
    ...
    public QueryMqSofamqTraceByMsgKeyResponseBody setResultCode(String resultCode) {
    ...
    public QueryMqSofamqTraceByMsgKeyResponseBody setResultMessage(String resultMessage) {
