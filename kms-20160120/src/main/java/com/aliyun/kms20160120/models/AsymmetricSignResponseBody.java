...
public class AsymmetricSignResponseBody extends TeaModel {
     ...
     * <blockquote>
     * <p>If you use an alias of the CMK in the request, the ID of the CMK to which the alias is bound is returned.</p>
     * </blockquote>
     * 
    ...
    /**
     * <p>The ID of the key version. The ID is the GUID of the key version.</p>
     * 
     * <strong>example:</strong>
