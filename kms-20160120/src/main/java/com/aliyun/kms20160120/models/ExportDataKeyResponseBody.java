...
public class ExportDataKeyResponseBody extends TeaModel {
    /**
     * <p>The exported data key that is protected by public key encryption.</p>
     * 
    ...
    /**
     * <p>The ID of the CMK that is used to decrypt the ciphertext of the specified data key.<br> The globally unique identifier of the CMK.<br><br></p>
     * 
     * <strong>example:</strong>
    ...
    /**
     * <p>The ID of the key version that is used to decrypt the ciphertext of the specified data key.</p>
     * 
     * <strong>example:</strong>
