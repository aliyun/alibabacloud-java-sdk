...
public class GenerateDataKeyResponseBody extends TeaModel {
    /**
     * <p>The ciphertext of the data key encrypted by the primary version of the specified key.</p>
     * 
    ...
    /**
     * <p>The ID of the key. If you use a key alias or key ARN in the KeyId parameter of the request, the key ID is also returned in the response.</p>
     * 
     * <strong>example:</strong>
    ...
    /**
     * <p>The ID of the request, which is a unique identifier generated by Alibaba Cloud for the request. You can use the request ID to troubleshoot and locate issues.</p>
     * 
     * <strong>example:</strong>
    ...
    public GenerateDataKeyResponseBody setCiphertextForRecipient(String ciphertextForRecipient) {
