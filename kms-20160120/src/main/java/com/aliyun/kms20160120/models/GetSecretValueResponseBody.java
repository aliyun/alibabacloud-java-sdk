...
public class GetSecretValueResponseBody extends TeaModel {
    ...
    /**
     * <strong>example:</strong>
     * <p><em><strong>CipherForRecipient</strong></em></p>
     */
    ...
    /**
     * <p>The interval for automatic rotation of the secret.<br>The format is <code>integer[unit]</code>, where <code>integer</code> specifies the length of time and <code>unit</code> specifies the time unit. The value of <code>unit</code> is s (seconds). For example, a rotation interval of 7 days is 604800s.</p>
     * <blockquote>
     * <p>This parameter is returned only when automatic rotation is enabled.</p>
     * </blockquote>
     * 
     ...
     * <ul>
     * <li><p>For generic secrets, the secret value you specified is returned.</p>
     * </li>
     * <li><p>For ApsaraDB RDS secrets and Redis/Tair secrets, the secret value is returned in the format: <code>{&quot;AccountName&quot;:&quot;&quot;,&quot;AccountPassword&quot;:&quot;&quot;}</code>.</p>
     * </li>
     * <li><p>For RAM secrets, the secret value is returned in the format: <code>{&quot;AccessKeyId&quot;:&quot;Adfdsfd&quot;,&quot;AccessKeySecret&quot;:&quot;fdsfdsf&quot;,&quot;GenerateTimestamp&quot;: &quot;2023-03-25T10:42:40Z&quot;}</code>.  </p>
     * </li>
     * <li><p>For ECS secrets, the secret value is returned in the following formats:  </p>
     * <ul>
     * <li>Password-type secret: <code>{&quot;UserName&quot;:&quot;ecs-user&quot;,&quot;Password&quot;:&quot;H5asdasdsads****&quot;}</code>.  </li>
     * <li>Public-private key pair-type secret (private key in PEM format): <code>{&quot;UserName&quot;:&quot;ecs-user&quot;,&quot;PublicKey&quot;:&quot;ssh-rsa ****mKwnVix9YTFY9Rs= imported-openssh-key&quot;,&quot;PrivateKey&quot;: &quot;d6bee1cb-2e14-4277-ba6b-73786b21****&quot;}</code>.</li>
     * </ul>
     * </li>
     * <li><p>For PolarDB secrets, the secret value is returned in the format: <code>{&quot;AccountName&quot;:&quot;&quot;,&quot;AccountPassword&quot;:&quot;&quot;}</code>.</p>
     * </li>
     * </ul>
     * 
     * <strong>example:</strong>
    ...
    public GetSecretValueResponseBody setCiphertextForRecipient(String ciphertextForRecipient) {
