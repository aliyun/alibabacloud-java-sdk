...
public class EncryptResponseBody extends TeaModel {
    /**
     * <p>The ciphertext of the data that is encrypted using the primary version of the specified key.</p>
     * 
    ...
    /**
     * <p>The ID of the key. If you use an alias or an ARN of the key in the request, the ID of the key is returned.</p>
     * 
     * <strong>example:</strong>
    ...
    /**
     * <p>The ID of the key version that is used to encrypt the plaintext. It is the primary version of the specified key.</p>
     * 
     * <strong>example:</strong>
