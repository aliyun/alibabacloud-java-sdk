...
public class CertificatePublicKeyEncryptRequest extends TeaModel {
     ...
     * <br>
     * <p>*   RSAES_OAEP_SHA\_1: 214 bytes</p>
     * <p>*   RSAES_OAEP_SHA\_256: 190 bytes</p>
     * <p>*   SM2PKE: 6,047 bytes</p>
     * <br>
     * <p>If the size of data that you want to encrypt exceeds the preceding limits, you can call the [GenerateDataKey](~~28948~~) operation to generate a data key to encrypt the data. Then, call the CertificatePublicKeyEncrypt operation to encrypt the data key.</p>
     */
    @NameInMap("Plaintext")
