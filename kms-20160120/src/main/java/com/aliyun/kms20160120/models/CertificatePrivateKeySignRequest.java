...
public class CertificatePrivateKeySignRequest extends TeaModel {
     ...
     * <p>*   SM2DSA</p>
     * <br>
     * <p>>* The SM2DSA signature algorithm is supported only in regions where managed hardware security modules (HSMs) are used in mainland China. For more information, see [Managed HSM overview](~~125803~~).</p>
     */
    @NameInMap("Algorithm")
