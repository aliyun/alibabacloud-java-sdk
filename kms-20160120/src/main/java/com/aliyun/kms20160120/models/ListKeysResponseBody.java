...
public class ListKeysResponseBody extends TeaModel {
    ...
    /**
     * <p>The ID of the request. It is a globally unique identifier (GUID) generated by Alibaba Cloud. You can use the request ID to troubleshoot issues.</p>
     * 
     * <strong>example:</strong>
    ...
    /**
     * <p>The total number of master keys.</p>
     * 
     * <strong>example:</strong>
     * <p>3</p>
     */
