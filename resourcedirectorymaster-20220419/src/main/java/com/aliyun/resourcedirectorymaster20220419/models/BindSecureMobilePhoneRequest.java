...
public class BindSecureMobilePhoneRequest extends TeaModel {
     ...
     * <p>The mobile phone number you specify must be the same as the mobile phone number that you specify when you call the <a href="~~SendVerificationCodeForBindSecureMobilePhone~~">SendVerificationCodeForBindSecureMobilePhone</a> operation to obtain a verification code.</p>
     ...
     * <p>You can call the <a href="~~SendVerificationCodeForBindSecureMobilePhone~~">SendVerificationCodeForBindSecureMobilePhone</a> operation to obtain the verification code.</p>
     * <p>This parameter is required.</p>
     * 
     * <strong>example:</strong>
     * <p>123456</p>
