...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    public AddCodeupSourceToPipelineResponse addCodeupSourceToPipelineWithOptions(AddCodeupSourceToPipelineRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        OpenApiRequest req = OpenApiRequest.build(TeaConverter.buildMap(
            new TeaPair("body", com.aliyun.teautil.Common.toMap(request))
        ));
        return TeaModel.toModel(this.doRPCRequest("AddCodeupSourceToPipeline", "2020-03-03", "HTTPS", "POST", "AK", "json", req, runtime), new AddCodeupSourceToPipelineResponse());
    }

    public AddCodeupSourceToPipelineResponse addCodeupSourceToPipeline(AddCodeupSourceToPipelineRequest request) throws Exception {
        RuntimeOptions runtime = new RuntimeOptions();
    ...
    public UpdatePipelineEnvVarsResponse updatePipelineEnvVarsWithOptions(UpdatePipelineEnvVarsRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        OpenApiRequest req = OpenApiRequest.build(TeaConverter.buildMap(
            new TeaPair("body", com.aliyun.teautil.Common.toMap(request))
        ));
        return TeaModel.toModel(this.doRPCRequest("UpdatePipelineEnvVars", "2020-03-03", "HTTPS", "POST", "AK", "json", req, runtime), new UpdatePipelineEnvVarsResponse());
    }

    public UpdatePipelineEnvVarsResponse updatePipelineEnvVars(UpdatePipelineEnvVarsRequest request) throws Exception {
        RuntimeOptions runtime = new RuntimeOptions();
    ...
    public CreatePipelineFromTemplateResponse createPipelineFromTemplateWithOptions(CreatePipelineFromTemplateRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        OpenApiRequest req = OpenApiRequest.build(TeaConverter.buildMap(
            new TeaPair("body", com.aliyun.teautil.Common.toMap(request))
        ));
        return TeaModel.toModel(this.doRPCRequest("CreatePipelineFromTemplate", "2020-03-03", "HTTPS", "POST", "AK", "json", req, runtime), new CreatePipelineFromTemplateResponse());
    }

    public CreatePipelineFromTemplateResponse createPipelineFromTemplate(CreatePipelineFromTemplateRequest request) throws Exception {
        RuntimeOptions runtime = new RuntimeOptions();
    ...
    public ListPipelineTemplatesResponse listPipelineTemplatesWithOptions(ListPipelineTemplatesRequest request, RuntimeOptions runtime) throws Exception {
        ...
        return TeaModel.toModel(this.doRPCRequest("ListPipelineTemplates", "2020-03-03", "HTTPS", "GET", "AK", "json", req, runtime), new ListPipelineTemplatesResponse());
    }
