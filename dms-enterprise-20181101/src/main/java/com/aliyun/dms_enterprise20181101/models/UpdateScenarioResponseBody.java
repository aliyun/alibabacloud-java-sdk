...
public class UpdateScenarioResponseBody extends TeaModel {
    ...
    public UpdateScenarioResponseBody setErrorCode(String errorCode) {
    ...
    public UpdateScenarioResponseBody setErrorMessage(String errorMessage) {
    ...
    public UpdateScenarioResponseBody setSuccess(Boolean success) {
