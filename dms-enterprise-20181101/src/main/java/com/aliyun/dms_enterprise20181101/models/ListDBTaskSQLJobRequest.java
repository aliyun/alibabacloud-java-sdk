...
public class ListDBTaskSQLJobRequest extends TeaModel {
    /**
     * <p>The ID of the SQL task group. You can call the [GetStructSyncJobDetail](https://help.aliyun.com/document_detail/206160.html) operation to obtain this parameter.</p>
     * <br>
