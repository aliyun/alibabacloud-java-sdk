...
public class DescribeAvailableCrossRegionRequest extends TeaModel {
    ...
    public DescribeAvailableCrossRegionRequest setOwnerId(Long ownerId) {
    ...
    public DescribeAvailableCrossRegionRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public DescribeAvailableCrossRegionRequest setResourceOwnerId(Long resourceOwnerId) {
