...
public class DescribeHostAccountsRequest extends TeaModel {
    ...
    public DescribeHostAccountsRequest setOwnerId(Long ownerId) {
    ...
    public DescribeHostAccountsRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public DescribeHostAccountsRequest setResourceOwnerId(Long resourceOwnerId) {
