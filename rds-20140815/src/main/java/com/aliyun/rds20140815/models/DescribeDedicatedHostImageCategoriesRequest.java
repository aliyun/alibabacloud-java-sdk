...
public class DescribeDedicatedHostImageCategoriesRequest extends TeaModel {
    ...
    public DescribeDedicatedHostImageCategoriesRequest setOwnerId(Long ownerId) {
    ...
    public DescribeDedicatedHostImageCategoriesRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public DescribeDedicatedHostImageCategoriesRequest setResourceOwnerId(Long resourceOwnerId) {
