...
public class DescribeResourceUsageRequest extends TeaModel {
    ...
    public DescribeResourceUsageRequest setOwnerAccount(String ownerAccount) {
    ...
    public DescribeResourceUsageRequest setOwnerId(Long ownerId) {
    ...
    public DescribeResourceUsageRequest setResourceGroupId(String resourceGroupId) {
    ...
    public DescribeResourceUsageRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public DescribeResourceUsageRequest setResourceOwnerId(Long resourceOwnerId) {
