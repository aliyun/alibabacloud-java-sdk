...
public class ModifyDedicatedHostUserRequest extends TeaModel {
    ...
    public ModifyDedicatedHostUserRequest setOwnerId(Long ownerId) {
    ...
    public ModifyDedicatedHostUserRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public ModifyDedicatedHostUserRequest setResourceOwnerId(Long resourceOwnerId) {
