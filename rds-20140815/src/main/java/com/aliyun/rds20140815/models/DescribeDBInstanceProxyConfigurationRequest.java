...
public class DescribeDBInstanceProxyConfigurationRequest extends TeaModel {
    ...
    public DescribeDBInstanceProxyConfigurationRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public DescribeDBInstanceProxyConfigurationRequest setResourceOwnerId(Long resourceOwnerId) {
