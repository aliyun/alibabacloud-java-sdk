...
public class CheckDBNameAvailableRequest extends TeaModel {
    ...
    public CheckDBNameAvailableRequest setOwnerAccount(String ownerAccount) {
    ...
    public CheckDBNameAvailableRequest setOwnerId(Long ownerId) {
    ...
    public CheckDBNameAvailableRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public CheckDBNameAvailableRequest setResourceOwnerId(Long resourceOwnerId) {
