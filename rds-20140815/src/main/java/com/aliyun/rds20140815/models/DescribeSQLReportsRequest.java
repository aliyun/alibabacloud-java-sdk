...
public class DescribeSQLReportsRequest extends TeaModel {
    ...
    public DescribeSQLReportsRequest setOwnerId(Long ownerId) {
    ...
    public DescribeSQLReportsRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public DescribeSQLReportsRequest setResourceOwnerId(Long resourceOwnerId) {
    ...
    public DescribeSQLReportsRequest setOwnerAccount(String ownerAccount) {
