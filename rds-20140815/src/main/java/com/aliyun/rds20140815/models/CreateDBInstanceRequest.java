...
public class CreateDBInstanceRequest extends TeaModel {
    ...
    public static class CreateDBInstanceRequestServerlessConfig extends TeaModel {
         ...
         * <p>*   **false**: disables the feature. This is the default value.</p>
         * <br>
         * <p>> After the smart startup and suspension feature is enabled, if no connections to the instance are established within 10 minutes, the instance is suspended. After a connection to the instance is established, the instance is resumed.</p>
         */
        @NameInMap("AutoPause")
        public Boolean autoPause;

        /**
         * <p>The maximum number of RDS Capacity Units (RCUs). Valid values: **0.5 to 8**.</p>
         * <br>
         * <p>> The value of this parameter must be greater than or equal to the value of the **MinCapacity property** parameter.</p>
         */
        @NameInMap("MaxCapacity")
        public Double maxCapacity;

        /**
         * <p>The minimum number of RCUs. Valid values: **0.5 to 8**.</p>
         * <br>
         ...
         * <br>
         * <br>
         * <p>> *   If you set this parameter to true, a transient connection that lasts approximately 1 minute occurs during forced scaling. Process with caution.</p>
         * <br>
