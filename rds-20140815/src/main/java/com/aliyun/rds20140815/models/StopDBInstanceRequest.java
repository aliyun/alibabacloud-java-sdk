...
public class StopDBInstanceRequest extends TeaModel {
    ...
    public StopDBInstanceRequest setOwnerId(Long ownerId) {
    ...
    public StopDBInstanceRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public StopDBInstanceRequest setResourceOwnerId(Long resourceOwnerId) {
