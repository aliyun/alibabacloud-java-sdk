...
public class ResetHostAccountPasswordRequest extends TeaModel {
    ...
    public ResetHostAccountPasswordRequest setOwnerId(Long ownerId) {
    ...
    public ResetHostAccountPasswordRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public ResetHostAccountPasswordRequest setResourceOwnerId(Long resourceOwnerId) {
