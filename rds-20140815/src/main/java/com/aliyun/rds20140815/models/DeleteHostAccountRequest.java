...
public class DeleteHostAccountRequest extends TeaModel {
    ...
    public DeleteHostAccountRequest setOwnerId(Long ownerId) {
    ...
    public DeleteHostAccountRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public DeleteHostAccountRequest setResourceOwnerId(Long resourceOwnerId) {
