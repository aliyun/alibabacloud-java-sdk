...
public class PurgeDBInstanceLogRequest extends TeaModel {
    ...
    public PurgeDBInstanceLogRequest setOwnerAccount(String ownerAccount) {
    ...
    public PurgeDBInstanceLogRequest setOwnerId(Long ownerId) {
    ...
    public PurgeDBInstanceLogRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public PurgeDBInstanceLogRequest setResourceOwnerId(Long resourceOwnerId) {
