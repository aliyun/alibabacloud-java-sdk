...
public class CheckInstanceExistRequest extends TeaModel {
    ...
    public CheckInstanceExistRequest setOwnerId(Long ownerId) {
    ...
    public CheckInstanceExistRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public CheckInstanceExistRequest setResourceOwnerId(Long resourceOwnerId) {
