...
public class CreateHostAccountRequest extends TeaModel {
    ...
    public CreateHostAccountRequest setOwnerId(Long ownerId) {
    ...
    public CreateHostAccountRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public CreateHostAccountRequest setResourceOwnerId(Long resourceOwnerId) {
