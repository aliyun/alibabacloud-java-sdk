...
public class DescribeNextEventForSignRequest extends TeaModel {
    ...
    public DescribeNextEventForSignRequest setOwnerId(Long ownerId) {
    ...
    public DescribeNextEventForSignRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public DescribeNextEventForSignRequest setResourceOwnerId(Long resourceOwnerId) {
