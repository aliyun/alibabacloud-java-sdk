...
public class CalculateDBInstanceWeightRequest extends TeaModel {
    ...
    public CalculateDBInstanceWeightRequest setOwnerId(Long ownerId) {
    ...
    public CalculateDBInstanceWeightRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public CalculateDBInstanceWeightRequest setOwnerAccount(String ownerAccount) {
