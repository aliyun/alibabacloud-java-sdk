...
public class MigrateSecurityIPModeRequest extends TeaModel {
    ...
    public MigrateSecurityIPModeRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public MigrateSecurityIPModeRequest setResourceOwnerId(Long resourceOwnerId) {
