...
public class DescribeBackupTasksResponseBody extends TeaModel {
    /**
     * <p>An array that consists of the details of the backup task.</p>
     */
    @NameInMap("Items")
    ...
    public static class DescribeBackupTasksResponseBodyItemsBackupJob extends TeaModel {
         ...
         * <br>
         * <p>> If the return value of the **BackupStatus** parameter is **Finished**, you must specify the **BackupJobId** parameter to obtain the ID of the generated backup set.</p>
         */
        @NameInMap("BackupId")
