...
public class EnableResourceDirectoryRequest extends TeaModel {
     ...
     * <br>
     * <p>*   CurrentAccount: indicates that the current account is used to enable a resource directory.</p>
     * <p>*   NewManagementAccount: indicates that a newly created account is used to enable a resource directory. If you select this mode, you must configure the `MAName`, `MASecureMobilePhone`, and `VerificationCode` parameters.</p>
     */
     ...
     * <br>
     * <p>If you leave this parameter empty, the mobile phone number that is bound to the current account is used. The mobile phone number you specify must be the same as the mobile phone number that you specify when you call the [SendVerificationCodeForEnableRD](~~364248~~) operation to obtain a verification code.</p>
     * <br>
     ...
     * <br>
     * <p>You can call the [SendVerificationCodeForEnableRD](~~364248~~) operation to obtain the verification code.</p>
     */
