...
public class UpdateConnectorResponseBody extends TeaModel {
    ...
    public UpdateConnectorResponseBody setHttpStatusCode(Integer httpStatusCode) {
    ...
    public static class UpdateConnectorResponseBodyData extends TeaModel {
        ...
        public UpdateConnectorResponseBodyData setBoundAgentCount(Long boundAgentCount) {
        ...
        public UpdateConnectorResponseBodyData setEnabledAt(String enabledAt) {
        ...
        public UpdateConnectorResponseBodyData setMetadata(String metadata) {
        ...
        public UpdateConnectorResponseBodyData setName(String name) {
            this.name = name;
            return this;
        }
        ...
        public UpdateConnectorResponseBodyData setStatus(String status) {
            this.status = status;
            return this;
        }
