...
public class DescriberPython3ScriptLogsResponseBody extends TeaModel {
    /**
     * <p>The unique ID of the request. This ID is generated by Alibaba Cloud and can be used to troubleshoot and locate issues.</p>
     * 
    ...
    /**
     * <p>The operational logs of the Python 3 script.</p>
     * 
     * <strong>example:</strong>
     * <p>{
     *     &quot;logs&quot;: [
