...
public class DescribeOpenApiListResponseBody extends TeaModel {
    /**
     * <p>Returned result data.</p>
     */
    @NameInMap("Data")
    public DescribeOpenApiListResponseBodyData data;

    /**
     * <p>The ID of this request, a unique identifier generated by Alibaba Cloud for this request, used for troubleshooting and locating issues.</p>
     * 
    ...
    public static class DescribeOpenApiListResponseBodyData extends TeaModel {
        ...
        /**
         * <p>The returned API list content.</p>
         * 
         * <strong>example:</strong>
        ...
        /**
         * <p>List of supported versions.</p>
         * 
         * <strong>example:</strong>
         * <p>[&quot;2018-12-03&quot; ]</p>
         */
