...
public class ChangeResourceGroupResponse extends TeaModel {
    ...
    @NameInMap("body")
    public ChangeResourceGroupOutput body;
    ...
    public ChangeResourceGroupResponse setBody(ChangeResourceGroupOutput body) {
        this.body = body;
        return this;
    }
    public ChangeResourceGroupOutput getBody() {
        return this.body;
    }
