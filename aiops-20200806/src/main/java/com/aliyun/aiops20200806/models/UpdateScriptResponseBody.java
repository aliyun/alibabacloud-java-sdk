...
public class UpdateScriptResponseBody extends TeaModel {
    ...
    public UpdateScriptResponseBody setCode(Integer code) {
        this.code = code;
        return this;
    }
    ...
    public UpdateScriptResponseBody setData(java.util.Map<String, ?> data) {
        this.data = data;
        return this;
    }
    ...
    public UpdateScriptResponseBody setMsg(String msg) {
        this.msg = msg;
        return this;
    }
    ...
    public UpdateScriptResponseBody setStatus(String status) {
        this.status = status;
        return this;
    }
