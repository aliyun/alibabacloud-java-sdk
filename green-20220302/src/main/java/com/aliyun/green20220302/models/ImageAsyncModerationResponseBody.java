...
public class ImageAsyncModerationResponseBody extends TeaModel {
    ...
    /**
     * <p>The result of the asynchronous image moderation.</p>
     */
    @NameInMap("Data")
    ...
    /**
     * <p>The ID of the request. This ID is a unique identifier generated by Alibaba Cloud for the request. You can use this ID to troubleshoot and locate issues.</p>
     * 
     * <strong>example:</strong>
    ...
    public static class ImageAsyncModerationResponseBodyData extends TeaModel {
        ...
        /**
         * <p>The reqId field returned by the enhanced asynchronous image moderation API. You can use this field to query the detection results.</p>
         * 
         * <strong>example:</strong>
