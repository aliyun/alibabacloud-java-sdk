...
public class UploadIdentifyRecordRequest extends TeaModel {
    ...
    public UploadIdentifyRecordRequest setUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public UploadIdentifyRecordRequest setProductKey(String productKey) {
    ...
    public UploadIdentifyRecordRequest setDeviceSecret(String deviceSecret) {
    ...
    public UploadIdentifyRecordRequest setExt(String ext) {
        this.ext = ext;
        return this;
    }
