...
package com.aliyun.arms20181015;

import com.aliyun.tea.*;
import com.aliyun.arms20181015.models.*;
...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    public ARMSQueryDataSetResponse aRMSQueryDataSetWithOptions(ARMSQueryDataSetRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.hackerUserId)) {
            query.put("HackerUserId", request.hackerUserId);
        }
