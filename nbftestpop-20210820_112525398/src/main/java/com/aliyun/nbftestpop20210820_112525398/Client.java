...
package com.aliyun.nbftestpop20210820_112525398;

import com.aliyun.tea.*;
import com.aliyun.nbftestpop20210820_112525398.models.*;
...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    public PublishTestResponse publishTest(PublishTestRequest request) throws Exception {
        RuntimeOptions runtime = new RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
        return this.publishTestWithOptions(request, headers, runtime);
    }

    public PublishTestResponse publishTestWithOptions(PublishTestRequest request, java.util.Map<String, String> headers, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.x)) {
            query.put("x", request.x);
        ...
        return TeaModel.toModel(this.doROARequest("PublishTest", "2021-08-20_11-25-25-398", "HTTPS", "POST", "AK", "/publishTest", "json", req, runtime), new PublishTestResponse());
    }
}
