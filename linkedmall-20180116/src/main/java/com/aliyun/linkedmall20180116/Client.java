...
public class Client extends com.aliyun.tearpc.Client {
    ...
    public CreateSettleConfirmResponse createSettleConfirmWithOptions(CreateSettleConfirmRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("CreateSettleConfirm", "HTTPS", "POST", "2018-01-16", "AK,APP,PrivateKey", null, TeaModel.buildMap(request), runtime), new CreateSettleConfirmResponse());
    }
    ...
    public GetActivityGameInfoResponse getActivityGameInfoWithOptions(GetActivityGameInfoRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("GetActivityGameInfo", "HTTPS", "GET", "2018-01-16", "AK", TeaModel.buildMap(request), null, runtime), new GetActivityGameInfoResponse());
    }
    ...
    public GetUserTokenPageResponse getUserTokenPageWithOptions(GetUserTokenPageRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("GetUserTokenPage", "HTTPS", "GET", "2018-01-16", "AK", TeaModel.buildMap(request), null, runtime), new GetUserTokenPageResponse());
    }
    ...
    public GrantPromotionToUserResponse grantPromotionToUserWithOptions(GrantPromotionToUserRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("GrantPromotionToUser", "HTTPS", "POST", "2018-01-16", "AK", null, TeaModel.buildMap(request), runtime), new GrantPromotionToUserResponse());
    }
    ...
    public ListUserGameProcessResponse listUserGameProcessWithOptions(ListUserGameProcessRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("ListUserGameProcess", "HTTPS", "GET", "2018-01-16", "AK", TeaModel.buildMap(request), null, runtime), new ListUserGameProcessResponse());
    }
    ...
    public PushUserGameProcessResponse pushUserGameProcessWithOptions(PushUserGameProcessRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("PushUserGameProcess", "HTTPS", "POST", "2018-01-16", "AK", null, TeaModel.buildMap(request), runtime), new PushUserGameProcessResponse());
    }
    ...
    public QueryUserGameProcessResponse queryUserGameProcessWithOptions(QueryUserGameProcessRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("QueryUserGameProcess", "HTTPS", "GET", "2018-01-16", "AK", TeaModel.buildMap(request), null, runtime), new QueryUserGameProcessResponse());
    }
    ...
    public StartUserGameResponse startUserGameWithOptions(StartUserGameRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("StartUserGame", "HTTPS", "POST", "2018-01-16", "AK", null, TeaModel.buildMap(request), runtime), new StartUserGameResponse());
    }
