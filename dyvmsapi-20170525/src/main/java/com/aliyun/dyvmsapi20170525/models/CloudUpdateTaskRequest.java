...
public class CloudUpdateTaskRequest extends TeaModel {
    /**
    ...
    public static CloudUpdateTaskRequest build(java.util.Map<String, ?> map) throws Exception {
        CloudUpdateTaskRequest self = new CloudUpdateTaskRequest();
        return TeaModel.build(map, self);
    }

    public CloudUpdateTaskRequest setAgentGroup(String agentGroup) {
    ...
    public CloudUpdateTaskRequest setAgentTimeout(Long agentTimeout) {
    ...
    public CloudUpdateTaskRequest setAnswerRate(Long answerRate) {
    ...
    public CloudUpdateTaskRequest setAutoComplete(Long autoComplete) {
    ...
    public CloudUpdateTaskRequest setAutoStart(Long autoStart) {
    ...
    public CloudUpdateTaskRequest setAutoStartDay(String autoStartDay) {
    ...
    public CloudUpdateTaskRequest setAutoStartTime(String autoStartTime) {
    ...
    public CloudUpdateTaskRequest setAutoStop(Long autoStop) {
    ...
    public CloudUpdateTaskRequest setAutoStopDay(String autoStopDay) {
    ...
    public CloudUpdateTaskRequest setAutoStopTime(String autoStopTime) {
    ...
    public CloudUpdateTaskRequest setAutoTaskType(Long autoTaskType) {
    ...
    public CloudUpdateTaskRequest setAutoTriggerTimeStrategy(String autoTriggerTimeStrategy) {
    ...
    public CloudUpdateTaskRequest setCallLimitStrategy(String callLimitStrategy) {
    ...
    public CloudUpdateTaskRequest setCallPriorityStrategy(String callPriorityStrategy) {
    ...
    public CloudUpdateTaskRequest setCallRouteStrategy(Long callRouteStrategy) {
    ...
    public CloudUpdateTaskRequest setCallStrategy(String callStrategy) {
    ...
    public CloudUpdateTaskRequest setCallVariables(String callVariables) {
    ...
    public CloudUpdateTaskRequest setClidProperty(String clidProperty) {
    ...
    public CloudUpdateTaskRequest setCnos(String cnos) {
        this.cnos = cnos;
        return this;
    }
    ...
    public CloudUpdateTaskRequest setConcurrency(Long concurrency) {
    ...
    public CloudUpdateTaskRequest setCustomerClidType(Long customerClidType) {
    ...
    public CloudUpdateTaskRequest setCustomerClidWeight(String customerClidWeight) {
    ...
    public CloudUpdateTaskRequest setCustomerClidWeightFlag(Long customerClidWeightFlag) {
    ...
    public CloudUpdateTaskRequest setCustomerClids(String customerClids) {
    ...
    public CloudUpdateTaskRequest setCustomerClidsCategory(Long customerClidsCategory) {
    ...
    public CloudUpdateTaskRequest setCustomerClidsGroup(String customerClidsGroup) {
    ...
    public CloudUpdateTaskRequest setCustomerMoh(String customerMoh) {
    ...
    public CloudUpdateTaskRequest setCustomerTimeout(Long customerTimeout) {
    ...
    public CloudUpdateTaskRequest setCustomerVoice(String customerVoice) {
    ...
    public CloudUpdateTaskRequest setDescription(String description) {
    ...
    public CloudUpdateTaskRequest setEnterpriseId(Long enterpriseId) {
    ...
    public CloudUpdateTaskRequest setForceEndFlag(Long forceEndFlag) {
    ...
    public CloudUpdateTaskRequest setIsRewarm(Long isRewarm) {
    ...
    public CloudUpdateTaskRequest setIvrId(Long ivrId) {
        this.ivrId = ivrId;
        return this;
    }
    ...
    public CloudUpdateTaskRequest setIvrName(String ivrName) {
    ...
    public CloudUpdateTaskRequest setMaxWaitTime(Long maxWaitTime) {
    ...
    public CloudUpdateTaskRequest setMinAvailableAgentCount(Long minAvailableAgentCount) {
    ...
    public CloudUpdateTaskRequest setName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CloudUpdateTaskRequest setOwnerId(Long ownerId) {
    ...
    public CloudUpdateTaskRequest setPredictAdjust(Long predictAdjust) {
    ...
    public CloudUpdateTaskRequest setQuotiety(Double quotiety) {
    ...
    public CloudUpdateTaskRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public CloudUpdateTaskRequest setResourceOwnerId(Long resourceOwnerId) {
    ...
    public CloudUpdateTaskRequest setRetryStrategy(String retryStrategy) {
    ...
    public CloudUpdateTaskRequest setRetryStrategyOnlyToday(Long retryStrategyOnlyToday) {
    ...
    public CloudUpdateTaskRequest setRetryStrategyTimeType(Long retryStrategyTimeType) {
    ...
    public CloudUpdateTaskRequest setTaskId(String taskId) {
        this.taskId = taskId;
        return this;
    }
    ...
    public CloudUpdateTaskRequest setTimeStrategy(String timeStrategy) {
    ...
    public CloudUpdateTaskRequest setUserFields(String userFields) {
    ...
    public CloudUpdateTaskRequest setWarmUpDuration(Long warmUpDuration) {
    ...
    public CloudUpdateTaskRequest setWrapup(Long wrapup) {
        this.wrapup = wrapup;
        return this;
    }
