...
public class CloudBatchCreateAgentRequest extends TeaModel {
    /**
    ...
    public static CloudBatchCreateAgentRequest build(java.util.Map<String, ?> map) throws Exception {
        CloudBatchCreateAgentRequest self = new CloudBatchCreateAgentRequest();
        return TeaModel.build(map, self);
    }

    public CloudBatchCreateAgentRequest setActive(Long active) {
        this.active = active;
        return this;
    }
    ...
    public CloudBatchCreateAgentRequest setAreaCode(String areaCode) {
    ...
    public CloudBatchCreateAgentRequest setCallPower(Long callPower) {
    ...
    public CloudBatchCreateAgentRequest setCno(String cno) {
        this.cno = cno;
        return this;
    }
    ...
    public CloudBatchCreateAgentRequest setComment(String comment) {
    ...
    public CloudBatchCreateAgentRequest setEndCno(String endCno) {
        this.endCno = endCno;
        return this;
    }
    ...
    public CloudBatchCreateAgentRequest setEnterpriseId(Long enterpriseId) {
    ...
    public CloudBatchCreateAgentRequest setIbRecord(Long ibRecord) {
    ...
    public CloudBatchCreateAgentRequest setIsAsr(Long isAsr) {
        this.isAsr = isAsr;
        return this;
    }
    ...
    public CloudBatchCreateAgentRequest setIsOb(Long isOb) {
        this.isOb = isOb;
        return this;
    }
    public Long getIsOb() {
    ...
    public CloudBatchCreateAgentRequest setIsQualityCheck(Long isQualityCheck) {
    ...
    public CloudBatchCreateAgentRequest setName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CloudBatchCreateAgentRequest setObClid(String obClid) {
        this.obClid = obClid;
        return this;
    }
    ...
    public CloudBatchCreateAgentRequest setObClidProperty(String obClidProperty) {
    ...
    public CloudBatchCreateAgentRequest setObClidType(Long obClidType) {
    ...
    public CloudBatchCreateAgentRequest setObRecord(Long obRecord) {
    ...
    public CloudBatchCreateAgentRequest setOwnerId(Long ownerId) {
    ...
    public CloudBatchCreateAgentRequest setPower(Long power) {
        this.power = power;
        return this;
    }
    ...
    public CloudBatchCreateAgentRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public CloudBatchCreateAgentRequest setResourceOwnerId(Long resourceOwnerId) {
    ...
    public CloudBatchCreateAgentRequest setSkillIds(String skillIds) {
    ...
    public CloudBatchCreateAgentRequest setSkillLevels(String skillLevels) {
    ...
    public CloudBatchCreateAgentRequest setWebrtcUrlType(Long webrtcUrlType) {
    ...
    public CloudBatchCreateAgentRequest setWrapup(Long wrapup) {
        this.wrapup = wrapup;
        return this;
    }
