...
public class CloudBatchUpdateAgentRequest extends TeaModel {
    /**
    ...
    public static CloudBatchUpdateAgentRequest build(java.util.Map<String, ?> map) throws Exception {
        CloudBatchUpdateAgentRequest self = new CloudBatchUpdateAgentRequest();
        return TeaModel.build(map, self);
    }

    public CloudBatchUpdateAgentRequest setActive(Long active) {
        this.active = active;
        return this;
    }
    ...
    public CloudBatchUpdateAgentRequest setAgentType(Long agentType) {
    ...
    public CloudBatchUpdateAgentRequest setAreaCode(String areaCode) {
    ...
    public CloudBatchUpdateAgentRequest setCallPower(Long callPower) {
    ...
    public CloudBatchUpdateAgentRequest setCnos(String cnos) {
        this.cnos = cnos;
        return this;
    }
    ...
    public CloudBatchUpdateAgentRequest setComment(String comment) {
    ...
    public CloudBatchUpdateAgentRequest setEnterpriseId(Long enterpriseId) {
    ...
    public CloudBatchUpdateAgentRequest setIbRecord(Long ibRecord) {
    ...
    public CloudBatchUpdateAgentRequest setIsAsr(Long isAsr) {
        this.isAsr = isAsr;
        return this;
    }
    ...
    public CloudBatchUpdateAgentRequest setIsOb(Long isOb) {
        this.isOb = isOb;
        return this;
    }
    public Long getIsOb() {
    ...
    public CloudBatchUpdateAgentRequest setIsObRemember(String isObRemember) {
    ...
    public CloudBatchUpdateAgentRequest setIsQualityCheck(Long isQualityCheck) {
    ...
    public CloudBatchUpdateAgentRequest setIsRandom(String isRandom) {
    ...
    public CloudBatchUpdateAgentRequest setName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CloudBatchUpdateAgentRequest setObClid(String obClid) {
        this.obClid = obClid;
        return this;
    }
    ...
    public CloudBatchUpdateAgentRequest setObClidProperty(String obClidProperty) {
    ...
    public CloudBatchUpdateAgentRequest setObClidType(Long obClidType) {
    ...
    public CloudBatchUpdateAgentRequest setObRecord(Long obRecord) {
    ...
    public CloudBatchUpdateAgentRequest setOwnerId(Long ownerId) {
    ...
    public CloudBatchUpdateAgentRequest setPermitObPreviewTime(String permitObPreviewTime) {
    ...
    public CloudBatchUpdateAgentRequest setPower(Long power) {
        this.power = power;
        return this;
    }
    ...
    public CloudBatchUpdateAgentRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public CloudBatchUpdateAgentRequest setResourceOwnerId(Long resourceOwnerId) {
    ...
    public CloudBatchUpdateAgentRequest setWebrtcUrlType(Long webrtcUrlType) {
    ...
    public CloudBatchUpdateAgentRequest setWrapup(Long wrapup) {
        this.wrapup = wrapup;
        return this;
    }
