...
public class CloudUpdateAgentRequest extends TeaModel {
    /**
    ...
    /**
     * <p>所选的技能id；可选择多个，多个之间使用英文标点逗号间隔.例如:&quot;1,2,3&quot;；skillIds为&quot;0&quot;时代表清空座席所有技能，不为&quot;0&quot;时需要同时传入skillLevels</p>
     * 
     * <strong>example:</strong>
     * <p>1,2,3</p>
     */
    ...
    public static CloudUpdateAgentRequest build(java.util.Map<String, ?> map) throws Exception {
        CloudUpdateAgentRequest self = new CloudUpdateAgentRequest();
        return TeaModel.build(map, self);
    }

    public CloudUpdateAgentRequest setActive(Long active) {
        this.active = active;
        return this;
    }
    ...
    public CloudUpdateAgentRequest setAgentType(Long agentType) {
    ...
    public CloudUpdateAgentRequest setAreaCode(String areaCode) {
    ...
    public CloudUpdateAgentRequest setCallPower(Long callPower) {
    ...
    public CloudUpdateAgentRequest setCno(String cno) {
        this.cno = cno;
        return this;
    }
    ...
    public CloudUpdateAgentRequest setComment(String comment) {
    ...
    public CloudUpdateAgentRequest setEnterpriseId(Long enterpriseId) {
    ...
    public CloudUpdateAgentRequest setIbRecord(Long ibRecord) {
    ...
    public CloudUpdateAgentRequest setIsAsr(Long isAsr) {
        this.isAsr = isAsr;
        return this;
    }
    ...
    public CloudUpdateAgentRequest setIsOb(Long isOb) {
        this.isOb = isOb;
        return this;
    }
    public Long getIsOb() {
    ...
    public CloudUpdateAgentRequest setIsObRemember(String isObRemember) {
    ...
    public CloudUpdateAgentRequest setIsQualityCheck(Long isQualityCheck) {
    ...
    public CloudUpdateAgentRequest setIsRandom(String isRandom) {
    ...
    public CloudUpdateAgentRequest setName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CloudUpdateAgentRequest setObClid(String obClid) {
        this.obClid = obClid;
        return this;
    }
    ...
    public CloudUpdateAgentRequest setObClidProperty(String obClidProperty) {
    ...
    public CloudUpdateAgentRequest setObClidType(Long obClidType) {
    ...
    public CloudUpdateAgentRequest setObRecord(Long obRecord) {
    ...
    public CloudUpdateAgentRequest setOwnerId(Long ownerId) {
    ...
    public CloudUpdateAgentRequest setPermitObPreviewTime(String permitObPreviewTime) {
    ...
    public CloudUpdateAgentRequest setPower(Long power) {
        this.power = power;
        return this;
    }
    ...
    public CloudUpdateAgentRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public CloudUpdateAgentRequest setResourceOwnerId(Long resourceOwnerId) {
    ...
    public CloudUpdateAgentRequest setSkillIds(String skillIds) {
    ...
    public CloudUpdateAgentRequest setSkillLevels(String skillLevels) {
    ...
    public CloudUpdateAgentRequest setWebrtcUrlType(Long webrtcUrlType) {
    ...
    public CloudUpdateAgentRequest setWrapup(Long wrapup) {
        this.wrapup = wrapup;
        return this;
    }
