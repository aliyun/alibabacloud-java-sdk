...
public class ClinkCreateQueueShrinkRequest extends TeaModel {
    /**
    ...
    public String queueMembersShrink;
    ...
    public static ClinkCreateQueueShrinkRequest build(java.util.Map<String, ?> map) throws Exception {
        ClinkCreateQueueShrinkRequest self = new ClinkCreateQueueShrinkRequest();
        return TeaModel.build(map, self);
    }

    public ClinkCreateQueueShrinkRequest setChatLocation(Long chatLocation) {
    ...
    public ClinkCreateQueueShrinkRequest setChatMaxWait(Long chatMaxWait) {
    ...
    public ClinkCreateQueueShrinkRequest setChatStrategy(Long chatStrategy) {
    ...
    public ClinkCreateQueueShrinkRequest setEnterpriseId(Long enterpriseId) {
    ...
    public ClinkCreateQueueShrinkRequest setIbAllowed(Long ibAllowed) {
    ...
    public ClinkCreateQueueShrinkRequest setJoinEmpty(Long joinEmpty) {
    ...
    public ClinkCreateQueueShrinkRequest setMaxPauseClientFlag(Long maxPauseClientFlag) {
    ...
    public ClinkCreateQueueShrinkRequest setMaxPauseClientType(Long maxPauseClientType) {
    ...
    public ClinkCreateQueueShrinkRequest setMaxPauseClientValue(Long maxPauseClientValue) {
    ...
    public ClinkCreateQueueShrinkRequest setMaxWait(Long maxWait) {
    ...
    public ClinkCreateQueueShrinkRequest setMemberTimeout(Long memberTimeout) {
    ...
    public ClinkCreateQueueShrinkRequest setName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ClinkCreateQueueShrinkRequest setOwnerId(Long ownerId) {
    ...
    public ClinkCreateQueueShrinkRequest setQno(String qno) {
        this.qno = qno;
        return this;
    }
    ...
    public ClinkCreateQueueShrinkRequest setQueueMembersShrink(String queueMembersShrink) {
        this.queueMembersShrink = queueMembersShrink;
        return this;
    }
    public String getQueueMembersShrink() {
        return this.queueMembersShrink;
    }

    public ClinkCreateQueueShrinkRequest setQueueTimeout(Long queueTimeout) {
    ...
    public ClinkCreateQueueShrinkRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public ClinkCreateQueueShrinkRequest setResourceOwnerId(Long resourceOwnerId) {
    ...
    public ClinkCreateQueueShrinkRequest setSayCno(Long sayCno) {
        this.sayCno = sayCno;
        return this;
    }
    ...
    public ClinkCreateQueueShrinkRequest setServiceLevel(Long serviceLevel) {
    ...
    public ClinkCreateQueueShrinkRequest setStrategy(Long strategy) {
    ...
    public ClinkCreateQueueShrinkRequest setVipSupport(Long vipSupport) {
    ...
    public ClinkCreateQueueShrinkRequest setWeight(Long weight) {
        this.weight = weight;
        return this;
    }
    ...
    public ClinkCreateQueueShrinkRequest setWrapupTime(Long wrapupTime) {
