...
public class StopScannerTaskRequest extends TeaModel {
    /**
    ...
    public static StopScannerTaskRequest build(java.util.Map<String, ?> map) throws Exception {
        StopScannerTaskRequest self = new StopScannerTaskRequest();
        return TeaModel.build(map, self);
    }

    public StopScannerTaskRequest setScannerTaskId(String scannerTaskId) {
