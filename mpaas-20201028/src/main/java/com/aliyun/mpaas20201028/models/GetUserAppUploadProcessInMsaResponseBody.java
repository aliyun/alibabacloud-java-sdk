...
public class GetUserAppUploadProcessInMsaResponseBody extends TeaModel {
    ...
    public static class GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo extends TeaModel {
        ...
        public GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo setAssetsFileList(java.util.List<String> assetsFileList) {
        ...
        public GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo setEnhancedAssetsFiles(java.util.List<String> enhancedAssetsFiles) {
        ...
        public GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo setEnhancedSoFiles(java.util.List<String> enhancedSoFiles) {
        ...
        public GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo setSoFileList(java.util.List<String> soFileList) {
