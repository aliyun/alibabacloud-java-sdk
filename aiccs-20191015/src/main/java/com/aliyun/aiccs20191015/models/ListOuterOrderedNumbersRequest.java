...
public class ListOuterOrderedNumbersRequest extends TeaModel {
    @NameInMap("OwnerId")
    public Long ownerId;
    ...
    public ListOuterOrderedNumbersRequest setOwnerId(Long ownerId) {
    ...
    public ListOuterOrderedNumbersRequest setResourceOwnerId(Long resourceOwnerId) {
