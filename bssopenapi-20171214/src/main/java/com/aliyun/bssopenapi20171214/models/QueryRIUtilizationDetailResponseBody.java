...
public class QueryRIUtilizationDetailResponseBody extends TeaModel {
    ...
    public static class QueryRIUtilizationDetailResponseBodyDataDetailListDetailList extends TeaModel {
        ...
        /**
         * <p>The duration that is deducted by using the RI. Unit: hours.</p>
         * <br>
         * <p>This parameter is returned only if the RICommodityCode parameter is set to ecsRi. If the RICommodityCode parameter is set to scu_bag, this parameter is not returned.</p>
         */
