...
public class UpgradePostPayOrderRequest extends TeaModel {
    ...
    public static class UpgradePostPayOrderRequestServerlessConfig extends TeaModel {
        /**
         * <p>The traffic reserved for message publishing. Unit: MB/s. Valid values: 1 to 31457280. You can specify only integers for this parameter.</p>
         */
        @NameInMap("ReservedPublishCapacity")
        public Long reservedPublishCapacity;

        /**
         * <p>The traffic reserved for message subscription. Unit: MB/s. Valid values: 1 to 31457280. You can specify only integers for this parameter.</p>
         */
