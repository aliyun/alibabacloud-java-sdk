...
public class QueryResponseBody extends TeaModel {
    ...
    public QueryResponseBody setCode(Integer code) {
        this.code = code;
        return this;
    }
    ...
    public QueryResponseBody setData(String data) {
        this.data = data;
        return this;
    }
    ...
    public QueryResponseBody setMessage(String message) {
    ...
    public QueryResponseBody setRequestId(String requestId) {
