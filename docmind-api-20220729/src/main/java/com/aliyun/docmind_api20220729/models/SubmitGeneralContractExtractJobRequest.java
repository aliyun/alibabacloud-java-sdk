...
public class SubmitGeneralContractExtractJobRequest extends TeaModel {
    ...
    public SubmitGeneralContractExtractJobRequest setFileNameExtension(String fileNameExtension) {
    ...
    public SubmitGeneralContractExtractJobRequest setFileUrl(String fileUrl) {
