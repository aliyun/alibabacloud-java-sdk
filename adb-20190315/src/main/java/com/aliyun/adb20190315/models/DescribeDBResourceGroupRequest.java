...
public class DescribeDBResourceGroupRequest extends TeaModel {
    ...
    public DescribeDBResourceGroupRequest setOwnerAccount(String ownerAccount) {
    ...
    public DescribeDBResourceGroupRequest setResourceOwnerId(Long resourceOwnerId) {
