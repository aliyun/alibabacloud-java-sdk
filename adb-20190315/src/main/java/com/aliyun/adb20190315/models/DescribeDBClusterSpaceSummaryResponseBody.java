...
public class DescribeDBClusterSpaceSummaryResponseBody extends TeaModel {
    ...
    public static class DescribeDBClusterSpaceSummaryResponseBodyDataColdData extends TeaModel {
        ...
        /**
         * <p>The other data size. Unit: bytes.</p>
         * 
         * <strong>example:</strong>
         * <p>1048576</p>
         */
         ...
         * <blockquote>
         * <p> Formula: Cold data size = Data size of table records + Data size of regular indexes + Data size of primary key indexes + Other data size.</p>
         * </blockquote>
         * 
         * <strong>example:</strong>
         * <p>4194304</p>
    ...
    public static class DescribeDBClusterSpaceSummaryResponseBodyDataDataGrowth extends TeaModel {
         ...
         * <blockquote>
         * <p> Formula: Data growth within the last day = Current data size - Data size of one day ago.</p>
         * </blockquote>
         * 
         * <strong>example:</strong>
         * <p>1048576</p>
         ...
         * <blockquote>
         * <p> Formula: Daily data growth within the last seven days = (Current data size - Data size of seven days ago)/7.</p>
         * </blockquote>
         * 
         * <strong>example:</strong>
         * <p>1048576</p>
    ...
    public static class DescribeDBClusterSpaceSummaryResponseBodyDataHotData extends TeaModel {
         ...
         * <blockquote>
         * <p> Formula: Hot data size = Data size of table records + Data size of regular indexes + Data size of primary key indexes + Other data size.</p>
         * </blockquote>
         * 
         * <strong>example:</strong>
         * <p>4194304</p>
