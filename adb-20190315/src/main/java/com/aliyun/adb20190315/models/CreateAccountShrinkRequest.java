...
public class CreateAccountShrinkRequest extends TeaModel {
    ...
    public CreateAccountShrinkRequest setOwnerAccount(String ownerAccount) {
    ...
    public CreateAccountShrinkRequest setOwnerId(Long ownerId) {
    ...
    public CreateAccountShrinkRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public CreateAccountShrinkRequest setResourceOwnerId(Long resourceOwnerId) {
    ...
    public CreateAccountShrinkRequest setTagShrink(String tagShrink) {
