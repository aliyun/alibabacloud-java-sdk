...
public class DescribeDataObjectColumnDetailV2ResponseBody extends TeaModel {
    /**
     * <p>The page number in the paging query. Default value: 1.</p>
     * 
    ...
    /**
     * <p>The list of column detection results for the data table.</p>
     */
    @NameInMap("Items")
    ...
    public static class DescribeDataObjectColumnDetailV2ResponseBodyItems extends TeaModel {
        ...
        /**
         * <p>The instance name of the data asset table.</p>
         * 
         * <strong>example:</strong>
        ...
        /**
         * <p>The risk level ID. Valid values:</p>
         * <ul>
        ...
        /**
         * <p>The ID of the sensitive data detection rule that is hit.</p>
         * 
         * <strong>example:</strong>
         * <p>51</p>
         */
