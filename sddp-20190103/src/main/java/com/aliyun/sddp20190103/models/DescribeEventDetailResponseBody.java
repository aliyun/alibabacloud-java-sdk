...
public class DescribeEventDetailResponseBody extends TeaModel {
    ...
    public static class DescribeEventDetailResponseBodyEventDetailChartData extends TeaModel {
        /**
         * <p>The value of the X-axis data item.</p>
         * 
         * <strong>example:</strong>
         * <p>[test1,test2,...]</p>
         */
        ...
        /**
         * <p>The value of the Y-axis data item.</p>
         * 
         * <strong>example:</strong>
         * <p>[1,2,3,...]</p>
         */
        ...
        /**
         * <p>The value of the Z-axis data item.</p>
         */
        @NameInMap("Z")
    ...
    public static class DescribeEventDetailResponseBodyEventDetailChart extends TeaModel {
        /**
         * <p>The chart display type. Valid values:</p>
         * <ul>
         * <li><strong>1</strong>: bar chart.</li>
         * <li><strong>2</strong>: line chart.</li>
         * </ul>
         * <blockquote>
         * <p>This field is returned only when NewAlarm is set to true.</p>
         * </blockquote>
         * 
         * <strong>example:</strong>
         * <p>1</p>
        ...
        /**
         * <p>The data items of the baseline behavior profile of the anomalous activity.</p>
         */
        @NameInMap("Data")
        public DescribeEventDetailResponseBodyEventDetailChartData data;

        /**
         * <p>The name of the baseline behavior profile of the anomalous activity.</p>
         * 
         * <strong>example:</strong>
        ...
        /**
         * <p>The label description of the X-axis data items.</p>
         * 
         * <strong>example:</strong>
         * <p>Number of days</p>
         */
        ...
        /**
         * <p>The label description of the Y-axis data items.</p>
         * 
         * <strong>example:</strong>
         * <p>Value</p>
         */
        ...
        /**
         * <p>The label description of the Z-axis data items.</p>
         * <blockquote>
         * <p>This field is returned only when NewAlarm is set to true.</p>
         * </blockquote>
         * 
    ...
    public static class DescribeEventDetailResponseBodyEventDetailResourceInfo extends TeaModel {
        /**
         * <p>The title of the anomalous activity source.</p>
         * 
         * <strong>example:</strong>
         * <p>Risk</p>
         */
        ...
        /**
         * <p>The description of the anomalous activity source.</p>
         * 
         * <strong>example:</strong>
    ...
    public static class DescribeEventDetailResponseBodyEventDetail extends TeaModel {
        /**
         * <p>The baseline behavior profile of the anomalous activity.</p>
         */
        @NameInMap("Chart")
        ...
        /**
         * <p>The source information of the anomalous activity.</p>
         */
    ...
    public static class DescribeEventDetailResponseBodyEventHandleInfoList extends TeaModel {
        /**
         * <p>The account used for handling.</p>
         * 
         * <strong>example:</strong>
         * <p>sddp-test2</p>
         */
        ...
        /**
         * <p>The time when the blocking was performed. Format: UNIX timestamp. Unit: milliseconds.</p>
         * 
         * <strong>example:</strong>
         * <p>1611139155000</p>
         */
        ...
        /**
         * <p>The time when the unblocking was performed. Format: UNIX timestamp. Unit: milliseconds.</p>
         * 
         * <strong>example:</strong>
         * <p>1611139155000</p>
         */
        ...
        /**
         * <p>The handling duration. If this parameter is empty, the handling is permanent. Unit: minutes.</p>
         * 
         * <strong>example:</strong>
         * <p>10</p>
         */
        ...
        /**
         * <p>The unblocking status. Valid values:</p>
         * <ul>
         * <li><strong>0</strong>: blocked.</li>
         * <li><strong>1</strong>: unblocked.</li>
         * <li><strong>-1</strong>: blocking failed.</li>
         * <li><strong>-2</strong>: unblocking failed.</li>
         * </ul>
         * 
         * <strong>example:</strong>
         * <p>1</p>
    ...
    public static class DescribeEventDetailResponseBodyEvent extends TeaModel {
        /**
         * <p>The time when the alert was triggered for the anomalous activity. Format: UNIX timestamp. Unit: milliseconds.</p>
         * 
         * <strong>example:</strong>
         * <p>1545829129000</p>
         */
        ...
        /**
         * <p>Indicates whether detection enhancement is enabled for the anomalous activity. Valid values:</p>
         * <ul>
         * <li><strong>true</strong>: Enabled.</li>
         * <li><strong>false</strong>: Disabled.</li>
         * </ul>
         * <blockquote>
         * <p>Enhancing the detection capability for anomalous activities can improve detection accuracy and increase the event alerting rate for anomalous activities.</p>
         * </blockquote>
         * 
         * <strong>example:</strong>
         * <p>false</p>
        ...
        /**
         * <p>The name of the asset instance of the product to which the anomalous activity belongs.</p>
         * 
         * <strong>example:</strong>
         * <p>in-222***</p>
         */
        ...
        /**
         * <p>The time when the anomalous activity was handled. Format: UNIX timestamp. Unit: milliseconds.</p>
         * 
         * <strong>example:</strong>
         * <p>1611139155000</p>
         */
        ...
        /**
         * <p>The specific content in the anomalous activity details.</p>
         */
        @NameInMap("Detail")
        public DescribeEventDetailResponseBodyEventDetail detail;

        /**
         * <p>The display name of the account that triggered the anomalous activity.</p>
         * 
         * <strong>example:</strong>
         * <p>yundunsr</p>
         */
        ...
        /**
         * <p>The time when the anomalous activity occurred. Format: UNIX timestamp. Unit: milliseconds.</p>
         * 
         * <strong>example:</strong>
         * <p>1545829129000</p>
         */
        ...
        /**
         * <p>The unique ID of the anomalous activity recorded by Data Security Center.</p>
         * 
         * <strong>example:</strong>
         * <p>52234</p>
         */
        ...
        /**
         * <p>The logon name of the account that triggered the anomalous activity.</p>
         * 
         * <strong>example:</strong>
         * <p>det1111</p>
         */
        ...
        /**
         * <p>The name of the product to which the anomalous activity belongs. Valid values: <strong>MaxCompute, OSS, ADS, OTS, RDS</strong>, and others.</p>
         * 
         * <strong>example:</strong>
         * <p>MaxCompute</p>
         */
        ...
        /**
         * <p>The handling status of the anomalous activity. Valid values:</p>
         * <ul>
         * <li><strong>0</strong>: unhandled. </li>
         * <li><strong>1</strong>: confirmed as a violation. </li>
         * <li><strong>2</strong>: marked as a false positive.</li>
         * </ul>
         * 
         * <strong>example:</strong>
         * <p>0</p>
        ...
        /**
         * <p>The name of the handling status of the anomalous activity.</p>
         * 
         * <strong>example:</strong>
         * <p>Pending</p>
         */
        ...
        /**
         * <p>The code of the subtype of the anomalous activity.</p>
         * 
         * <strong>example:</strong>
         * <p>020008</p>
         */
        ...
        /**
         * <p>The name of the subtype of the anomalous activity.</p>
         * 
         * <strong>example:</strong>
        ...
        /**
         * <p>The name of the parent type of the anomalous activity. Valid values:</p>
         * <ul>
         * <li><strong>01</strong>: anomalous permission access.</li>
        ...
        /**
         * <p>The ID of the account that triggered the anomalous activity.</p>
         * 
         * <strong>example:</strong>
         * <p>229157443385014***</p>
         */
