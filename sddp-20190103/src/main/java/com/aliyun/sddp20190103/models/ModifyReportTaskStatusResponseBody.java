...
public class ModifyReportTaskStatusResponseBody extends TeaModel {
    /**
     * <p>The ID of the request. This unique identifier is generated by Alibaba Cloud for each request. If you have an issue, provide this ID for troubleshooting.</p>
     * 
