...
public class DescribeParentInstanceRequest extends TeaModel {
    ...
    /**
     * <p>The database connection status of the instance or the database under the instance. Valid values:</p>
     * <ul>
     * <li><strong>-3</strong>: The database is not created.</li>
     ...
     * <li><strong>DatabaseNotCreated</strong>: The database is not created.</li>
     * </ul>
     * 
     * <strong>example:</strong>
     * <p>Running</p>
    ...
    /**
     * <p>The page number when paging is used. Default value: <strong>1</strong>.</p>
     * 
     * <strong>example:</strong>
     * <p>1</p>
     */
    ...
    /**
     * <p>The number of entries per page when paging is used. Default value: 10.</p>
     * 
     * <strong>example:</strong>
     * <p>10</p>
     */
    ...
    /**
     * <p>Required. The product type. Valid values:</p>
     * <ul>
