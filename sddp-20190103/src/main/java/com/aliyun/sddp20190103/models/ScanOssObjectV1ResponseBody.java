...
public class ScanOssObjectV1ResponseBody extends TeaModel {
    /**
     * <p>The ID of the scan task. This is returned after the task is successfully created.</p>
     * 
    ...
    /**
     * <p>The ID of the request. This is a unique identifier generated by Alibaba Cloud for the request. You can use it to troubleshoot and locate issues.</p>
     * 
     * <strong>example:</strong>
