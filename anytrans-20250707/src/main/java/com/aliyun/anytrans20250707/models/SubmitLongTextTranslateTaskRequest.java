...
public class SubmitLongTextTranslateTaskRequest extends TeaModel {
    ...
    public static class SubmitLongTextTranslateTaskRequestExtConfig extends TeaModel {
        /**
         * <p>Specifies whether to skip the Content Moderation check. (To skip the check, you must first complete the process to disable Content Moderation and then call the operation.)</p>
         * 
         * <strong>example:</strong>
         * <p>false</p>
         */
    ...
    public static class SubmitLongTextTranslateTaskRequestExtTerminologies extends TeaModel {
        /**
         * <p>The source text of the term pair.</p>
         * 
         * <strong>example:</strong>
         * <p>机器学习</p>
         */
    ...
    public static class SubmitLongTextTranslateTaskRequestExtTextTransform extends TeaModel {
        /**
         * <p>Specifies whether to convert the target text to lowercase.</p>
         * 
         * <strong>example:</strong>
         * <p>false</p>
         */
        ...
        /**
         * <p>Specifies whether to convert the target text to title case.</p>
         * 
         * <strong>example:</strong>
         * <p>false</p>
         */
        ...
        /**
         * <p>Specifies whether to convert the target text to uppercase.</p>
         * 
         * <strong>example:</strong>
         * <p>false</p>
         */
    ...
    public static class SubmitLongTextTranslateTaskRequestExt extends TeaModel {
        ...
        /**
         * <p>A natural language string in English that guides the model toward a specific translation style.</p>
         * 
         * <strong>example:</strong>
        ...
        /**
         * <p>A list of translation examples to provide context to the model.</p>
         */
        @NameInMap("examples")
        public java.util.List<SubmitLongTextTranslateTaskRequestExtExamples> examples;

        /**
         * <p>Extended parameter configuration (bizUserId: A user ID at the business level, used to differentiate between business users and apply terminology interventions that are isolated on a per-user basis. bizType: A business scenario type or identifier, used to differentiate between scenarios and apply terminology interventions that are isolated on a per-scenario basis.)</p>
         * 
         * <strong>example:</strong>
        ...
        /**
         * <p>A list of sensitive words to filter from the translation result.</p>
         */
        @NameInMap("sensitives")
        public java.util.List<String> sensitives;

        /**
         * <p>A list of term pairs to customize the translation.</p>
         */
        @NameInMap("terminologies")
        public java.util.List<SubmitLongTextTranslateTaskRequestExtTerminologies> terminologies;

        /**
         * <p>Specifies case conversion rules for the target text.</p>
         */
        @NameInMap("textTransform")
        public SubmitLongTextTranslateTaskRequestExtTextTransform textTransform;

        /**
         * <p>User-defined passthrough data is not processed by the translation service and is returned as is for use in scenarios such as tracking.</p>
         * 
         * <strong>example:</strong>
