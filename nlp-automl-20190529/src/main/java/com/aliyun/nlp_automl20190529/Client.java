...
package com.aliyun.nlp_automl20190529;

import com.aliyun.tea.*;
import com.aliyun.nlp_automl20190529.models.*;
...
public class Client extends com.aliyun.teaopenapi.Client {
     ...
     */
    public PredictModelResponse predictModelWithOptions(PredictModelRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            ...
            new TeaPair("version", "2019-05-29"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/api/automl/predict"),
    ...
    public PredictModelResponse predictModel(PredictModelRequest request) throws Exception {
        ...
        return this.predictModelWithOptions(request, headers, runtime);
    }
}
