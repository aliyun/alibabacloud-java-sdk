...
public class DeleteFaceUserGroupAndDeviceGroupRelationRequest extends TeaModel {
    ...
    public DeleteFaceUserGroupAndDeviceGroupRelationRequest setApiProduct(String apiProduct) {
    ...
    public DeleteFaceUserGroupAndDeviceGroupRelationRequest setApiRevision(String apiRevision) {
