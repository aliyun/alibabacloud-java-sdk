...
public class DeleteAlgorithmResponseBody extends TeaModel {
    ...
    public DeleteAlgorithmResponseBody setErrorMessage(String errorMessage) {
    ...
    public DeleteAlgorithmResponseBody setCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public DeleteAlgorithmResponseBody setSuccess(Boolean success) {
