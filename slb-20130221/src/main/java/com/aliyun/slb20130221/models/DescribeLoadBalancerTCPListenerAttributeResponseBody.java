...
public class DescribeLoadBalancerTCPListenerAttributeResponseBody extends TeaModel {
    ...
    public DescribeLoadBalancerTCPListenerAttributeResponseBody setConnectPort(Integer connectPort) {
    ...
    public DescribeLoadBalancerTCPListenerAttributeResponseBody setConnectTimeout(Integer connectTimeout) {
    ...
    public DescribeLoadBalancerTCPListenerAttributeResponseBody setInterval(Integer interval) {
    ...
    public DescribeLoadBalancerTCPListenerAttributeResponseBody setMaxConnection(Integer maxConnection) {
