...
package com.aliyun.imagesearch20200212;

import com.aliyun.tea.*;
import com.aliyun.imagesearch20200212.models.*;
...
public class Client extends com.aliyun.tearpc.Client {
    ...
    public SearchImageByNameResponse searchImageByName(SearchImageByNameRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        return TeaModel.toModel(this.doRequest("SearchImageByName", "HTTPS", "POST", "2020-02-12", "AK", null, TeaModel.buildMap(request), runtime), new SearchImageByNameResponse());
    }
    ...
    public SearchImageByPicResponse searchImageByPic(SearchImageByPicRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("SearchImageByPic", "HTTPS", "POST", "2020-02-12", "AK", null, TeaModel.buildMap(request), runtime), new SearchImageByPicResponse());
    }
    ...
    public DeleteImageResponse deleteImage(DeleteImageRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("DeleteImage", "HTTPS", "POST", "2020-02-12", "AK", null, TeaModel.buildMap(request), runtime), new DeleteImageResponse());
    }
    ...
    public AddImageResponse addImage(AddImageRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("AddImage", "HTTPS", "POST", "2020-02-12", "AK", null, TeaModel.buildMap(request), runtime), new AddImageResponse());
    }
