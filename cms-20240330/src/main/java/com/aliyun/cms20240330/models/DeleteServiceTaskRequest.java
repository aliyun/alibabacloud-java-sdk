...
public class DeleteServiceTaskRequest extends TeaModel {
    /**
    ...
    public static DeleteServiceTaskRequest build(java.util.Map<String, ?> map) throws Exception {
        DeleteServiceTaskRequest self = new DeleteServiceTaskRequest();
        return TeaModel.build(map, self);
    }

    public DeleteServiceTaskRequest setType(String type) {
        this.type = type;
        return this;
    }
