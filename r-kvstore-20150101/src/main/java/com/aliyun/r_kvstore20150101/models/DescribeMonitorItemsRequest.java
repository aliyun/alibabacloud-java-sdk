...
public class DescribeMonitorItemsRequest extends TeaModel {
    ...
    public DescribeMonitorItemsRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public DescribeMonitorItemsRequest setResourceOwnerId(Long resourceOwnerId) {
