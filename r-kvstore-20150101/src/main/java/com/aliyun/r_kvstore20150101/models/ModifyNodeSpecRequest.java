...
public class ModifyNodeSpecRequest extends TeaModel {
    ...
    public ModifyNodeSpecRequest setInstanceClass(String instanceClass) {
    ...
    public ModifyNodeSpecRequest setInstanceId(String instanceId) {
    ...
    public ModifyNodeSpecRequest setSwitchTimeMode(String switchTimeMode) {
