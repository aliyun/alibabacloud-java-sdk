...
public class DescribeInstanceConfigRequest extends TeaModel {
    /**
     * <p>The instance ID. You can call the <a href="https://help.aliyun.com/document_detail/473778.html">DescribeInstances</a> operation to obtain this ID.</p>
    ...
    public DescribeInstanceConfigRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public DescribeInstanceConfigRequest setResourceOwnerId(Long resourceOwnerId) {
