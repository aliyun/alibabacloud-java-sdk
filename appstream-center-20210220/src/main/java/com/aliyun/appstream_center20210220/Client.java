...
package com.aliyun.appstream_center20210220;

import com.aliyun.tea.*;
import com.aliyun.appstream_center20210220.models.*;
...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    public FindIdpListByLoginIdentifierResponse findIdpListByLoginIdentifierWithOptions(FindIdpListByLoginIdentifierRequest tmpReq, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.loginIdentifier)) {
            body.put("LoginIdentifier", request.loginIdentifier);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.supportTypes)) {
            body.put("SupportTypes", request.supportTypes);
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "FindIdpListByLoginIdentifier"),
        ...
        return TeaModel.toModel(this.doRPCRequest(params.action, params.version, params.protocol, params.method, params.authType, params.bodyType, req, runtime), new FindIdpListByLoginIdentifierResponse());
    }
     ...
     * @return FindIdpListByLoginIdentifierResponse
     */
    public FindIdpListByLoginIdentifierResponse findIdpListByLoginIdentifier(FindIdpListByLoginIdentifierRequest request) throws Exception {
    ...
    public GetStsTokenResponse getStsTokenWithOptions(GetStsTokenRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        return TeaModel.toModel(this.doRPCRequest(params.action, params.version, params.protocol, params.method, params.authType, params.bodyType, req, runtime), new GetStsTokenResponse());
    }
