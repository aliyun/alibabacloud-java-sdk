...
public class UpdateOIDCProviderRequest extends TeaModel {
     ...
     * <p>A client ID can contain letters, digits, and special characters and cannot start with the special characters. The special characters are <code>periods (.), hyphens (-), underscores (_), colons (:), and forward slashes (/)</code>.\<code>\\</code></p>
