...
public class ModifyInstanceConfigResponseBody extends TeaModel {
    ...
    public ModifyInstanceConfigResponseBody setAccessDeniedDetail(String accessDeniedDetail) {
    ...
    public ModifyInstanceConfigResponseBody setData(Boolean data) {
        this.data = data;
        return this;
    }
    ...
    public ModifyInstanceConfigResponseBody setErrCode(String errCode) {
    ...
    public ModifyInstanceConfigResponseBody setErrMessage(String errMessage) {
    ...
    public ModifyInstanceConfigResponseBody setHttpStatusCode(Integer httpStatusCode) {
    ...
    public ModifyInstanceConfigResponseBody setSuccess(Boolean success) {
