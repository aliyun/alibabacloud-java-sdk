...
public class GetApInfoFromPoolResponseBody extends TeaModel {
    @NameInMap("Data")
    ...
    public GetApInfoFromPoolResponseBody setData(java.util.Map<String, ?> data) {
        this.data = data;
        return this;
    }
    ...
    public GetApInfoFromPoolResponseBody setIsSuccess(Boolean isSuccess) {
