...
public class ListTopicsResponseBody extends TeaModel {
    ...
    /**
     * <p>The pagination token for the next query. If NextToken is empty, no more results are available. If NextToken is returned, the value indicates the token for the next query.</p>
     * 
     * <strong>example:</strong>
