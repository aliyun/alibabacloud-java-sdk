...
public class ListSubscriptionsResponseBody extends TeaModel {
    ...
    /**
     * <p>The pagination token for the next query. If NextToken is empty, no more results are available. If NextToken has a value, it indicates the token for the next query.</p>
     * 
     * <strong>example:</strong>
