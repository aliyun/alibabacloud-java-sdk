...
package com.aliyun.edas20170405;

import com.aliyun.tea.*;
import com.aliyun.edas20170405.models.*;
...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    public EdasProduceResponse edasProduceWithOptions(EdasProduceRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.sourceFlag)) {
            query.put("sourceFlag", request.sourceFlag);
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "EdasProduce"),
            new TeaPair("version", "2017-04-05"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new EdasProduceResponse());
    }

    public EdasProduceResponse edasProduce(EdasProduceRequest request) throws Exception {
