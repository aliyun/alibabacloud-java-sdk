...
public class CreateKnowLedgeResponseBody extends TeaModel {
    ...
    public CreateKnowLedgeResponseBody setCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public CreateKnowLedgeResponseBody setData(Boolean data) {
        this.data = data;
        return this;
    }
    ...
    public CreateKnowLedgeResponseBody setMsg(String msg) {
        this.msg = msg;
        return this;
    }
    ...
    public CreateKnowLedgeResponseBody setSuccess(Boolean success) {
