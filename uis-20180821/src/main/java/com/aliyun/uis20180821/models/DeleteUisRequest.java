...
public class DeleteUisRequest extends TeaModel {
    ...
    public DeleteUisRequest setOwnerAccount(String ownerAccount) {
    ...
    public DeleteUisRequest setOwnerId(Long ownerId) {
    ...
    public DeleteUisRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public DeleteUisRequest setResourceOwnerId(Long resourceOwnerId) {
