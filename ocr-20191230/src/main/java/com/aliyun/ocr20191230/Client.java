...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    public RecognizeBankCardResponse recognizeBankCardAdvance(RecognizeBankCardAdvanceRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.imageURLObject)) {
            ...
            recognizeBankCardReq.imageURL = "http://" + authResponseBody.get("Bucket") + "." + authResponseBody.get("Endpoint") + "/" + authResponseBody.get("ObjectKey") + "";
        }
    ...
    public RecognizeBusinessLicenseResponse recognizeBusinessLicenseAdvance(RecognizeBusinessLicenseAdvanceRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.imageURLObject)) {
            ...
            this._postOSSObject(authResponseBody.get("Bucket"), ossHeader);
            recognizeBusinessLicenseReq.imageURL = "http://" + authResponseBody.get("Bucket") + "." + authResponseBody.get("Endpoint") + "/" + authResponseBody.get("ObjectKey") + "";
        }
    ...
    public RecognizeCharacterResponse recognizeCharacterAdvance(RecognizeCharacterAdvanceRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.imageURLObject)) {
            ...
            this._postOSSObject(authResponseBody.get("Bucket"), ossHeader);
            recognizeCharacterReq.imageURL = "http://" + authResponseBody.get("Bucket") + "." + authResponseBody.get("Endpoint") + "/" + authResponseBody.get("ObjectKey") + "";
        }
    ...
    public RecognizeDriverLicenseResponse recognizeDriverLicenseAdvance(RecognizeDriverLicenseAdvanceRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.imageURLObject)) {
            ...
            this._postOSSObject(authResponseBody.get("Bucket"), ossHeader);
            recognizeDriverLicenseReq.imageURL = "http://" + authResponseBody.get("Bucket") + "." + authResponseBody.get("Endpoint") + "/" + authResponseBody.get("ObjectKey") + "";
        }
    ...
    public RecognizeDrivingLicenseResponse recognizeDrivingLicenseAdvance(RecognizeDrivingLicenseAdvanceRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.imageURLObject)) {
            ...
            this._postOSSObject(authResponseBody.get("Bucket"), ossHeader);
            recognizeDrivingLicenseReq.imageURL = "http://" + authResponseBody.get("Bucket") + "." + authResponseBody.get("Endpoint") + "/" + authResponseBody.get("ObjectKey") + "";
        }
    ...
    public RecognizeIdentityCardResponse recognizeIdentityCardAdvance(RecognizeIdentityCardAdvanceRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.imageURLObject)) {
            ...
            this._postOSSObject(authResponseBody.get("Bucket"), ossHeader);
            recognizeIdentityCardReq.imageURL = "http://" + authResponseBody.get("Bucket") + "." + authResponseBody.get("Endpoint") + "/" + authResponseBody.get("ObjectKey") + "";
        }
    ...
    public RecognizeLicensePlateResponse recognizeLicensePlateAdvance(RecognizeLicensePlateAdvanceRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.imageURLObject)) {
            ...
            this._postOSSObject(authResponseBody.get("Bucket"), ossHeader);
            recognizeLicensePlateReq.imageURL = "http://" + authResponseBody.get("Bucket") + "." + authResponseBody.get("Endpoint") + "/" + authResponseBody.get("ObjectKey") + "";
        }
    ...
    public RecognizePdfResponse recognizePdfAdvance(RecognizePdfAdvanceRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.fileURLObject)) {
            ...
            this._postOSSObject(authResponseBody.get("Bucket"), ossHeader);
            recognizePdfReq.fileURL = "http://" + authResponseBody.get("Bucket") + "." + authResponseBody.get("Endpoint") + "/" + authResponseBody.get("ObjectKey") + "";
        }
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.tasks)) {
            ...
            for (RecognizeQrCodeAdvanceRequest.RecognizeQrCodeAdvanceRequestTasks item0 : request.tasks) {
                if (!com.aliyun.teautil.Common.isUnset(item0.imageURLObject)) {
                    ...
                    this._postOSSObject(authResponseBody.get("Bucket"), ossHeader);
                    RecognizeQrCodeRequest.RecognizeQrCodeRequestTasks tmp = recognizeQrCodeReq.tasks.get(i0);
    ...
    public RecognizeQuotaInvoiceResponse recognizeQuotaInvoiceAdvance(RecognizeQuotaInvoiceAdvanceRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.imageURLObject)) {
            ...
            this._postOSSObject(authResponseBody.get("Bucket"), ossHeader);
            recognizeQuotaInvoiceReq.imageURL = "http://" + authResponseBody.get("Bucket") + "." + authResponseBody.get("Endpoint") + "/" + authResponseBody.get("ObjectKey") + "";
        }
    ...
    public RecognizeTableResponse recognizeTableAdvance(RecognizeTableAdvanceRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.imageURLObject)) {
            ...
            this._postOSSObject(authResponseBody.get("Bucket"), ossHeader);
            recognizeTableReq.imageURL = "http://" + authResponseBody.get("Bucket") + "." + authResponseBody.get("Endpoint") + "/" + authResponseBody.get("ObjectKey") + "";
        }
    ...
    public RecognizeTaxiInvoiceResponse recognizeTaxiInvoiceAdvance(RecognizeTaxiInvoiceAdvanceRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.imageURLObject)) {
            ...
            this._postOSSObject(authResponseBody.get("Bucket"), ossHeader);
            recognizeTaxiInvoiceReq.imageURL = "http://" + authResponseBody.get("Bucket") + "." + authResponseBody.get("Endpoint") + "/" + authResponseBody.get("ObjectKey") + "";
        }
    ...
    public RecognizeTicketInvoiceResponse recognizeTicketInvoiceAdvance(RecognizeTicketInvoiceAdvanceRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.imageURLObject)) {
            ...
            this._postOSSObject(authResponseBody.get("Bucket"), ossHeader);
            recognizeTicketInvoiceReq.imageURL = "http://" + authResponseBody.get("Bucket") + "." + authResponseBody.get("Endpoint") + "/" + authResponseBody.get("ObjectKey") + "";
        }
    ...
    public RecognizeTrainTicketResponse recognizeTrainTicketAdvance(RecognizeTrainTicketAdvanceRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.imageURLObject)) {
            ...
            this._postOSSObject(authResponseBody.get("Bucket"), ossHeader);
            recognizeTrainTicketReq.imageURL = "http://" + authResponseBody.get("Bucket") + "." + authResponseBody.get("Endpoint") + "/" + authResponseBody.get("ObjectKey") + "";
        }
    ...
    public RecognizeVATInvoiceResponse recognizeVATInvoiceAdvance(RecognizeVATInvoiceAdvanceRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.fileURLObject)) {
            ...
            this._postOSSObject(authResponseBody.get("Bucket"), ossHeader);
            recognizeVATInvoiceReq.fileURL = "http://" + authResponseBody.get("Bucket") + "." + authResponseBody.get("Endpoint") + "/" + authResponseBody.get("ObjectKey") + "";
        }
    ...
    public RecognizeVINCodeResponse recognizeVINCodeAdvance(RecognizeVINCodeAdvanceRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.imageURLObject)) {
            ...
            this._postOSSObject(authResponseBody.get("Bucket"), ossHeader);
            recognizeVINCodeReq.imageURL = "http://" + authResponseBody.get("Bucket") + "." + authResponseBody.get("Endpoint") + "/" + authResponseBody.get("ObjectKey") + "";
        }
    ...
    public RecognizeVideoCharacterResponse recognizeVideoCharacterAdvance(RecognizeVideoCharacterAdvanceRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        // Step 0: init client
        com.aliyun.credentials.models.CredentialModel credentialModel = null;
        if (com.aliyun.teautil.Common.isUnset(_credential)) {
            throw new TeaException(TeaConverter.buildMap(
        ...
        com.aliyun.openapiutil.Client.convert(request, recognizeVideoCharacterReq);
        if (!com.aliyun.teautil.Common.isUnset(request.videoURLObject)) {
            ...
            this._postOSSObject(authResponseBody.get("Bucket"), ossHeader);
            recognizeVideoCharacterReq.videoURL = "http://" + authResponseBody.get("Bucket") + "." + authResponseBody.get("Endpoint") + "/" + authResponseBody.get("ObjectKey") + "";
        }

        RecognizeVideoCharacterResponse recognizeVideoCharacterResp = this.recognizeVideoCharacterWithOptions(recognizeVideoCharacterReq, runtime);
