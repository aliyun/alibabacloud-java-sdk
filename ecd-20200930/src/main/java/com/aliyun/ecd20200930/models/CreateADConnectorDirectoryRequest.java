...
public class CreateADConnectorDirectoryRequest extends TeaModel {
     ...
     * <br>
     * <p>Valid values:</p>
     * <p>- VPC (Only connect through VPC)</p>
     * <p>- Internet (Only connect through the Internet [Default])</p>
     * <p>- Any (Both VPC and Internet are supported)</p>
     */
     ...
     * <br>
     * <p>Valid values:</p>
     * <p>- true (To grant the local administrator permission [Default])</p>
     * <p>- false (Not to grant the local administrator permission)</p>
     */
     ...
     * <br>
     * <p>Valid values:</p>
     * <p>- true (To enable MFA)</p>
     * <p>- false (To disable MFA [Default])</p>
     */
