...
public class UnlockVirtualMFADeviceRequest extends TeaModel {
     ...
     * <br>
     * <p>You can call the [DescribeVirtualMFADevices](~~206210~~) operation to query the serial number of the virtual MFA device bound to Active Directory (AD) users.</p>
     */
