...
public class PullRpaModelRequest extends TeaModel {
    ...
    public PullRpaModelRequest setAliyunKpLong(Long aliyunKpLong) {
    ...
    public PullRpaModelRequest setCallerParentId(Long callerParentId) {
    ...
    public PullRpaModelRequest setCallerSecurityTransport(Boolean callerSecurityTransport) {
    ...
    public PullRpaModelRequest setCallerType(String callerType) {
    ...
    public PullRpaModelRequest setClientIp(String clientIp) {
    ...
    public PullRpaModelRequest setMfaPresent(Boolean mfaPresent) {
    ...
    public PullRpaModelRequest setPopAction(String popAction) {
    ...
    public PullRpaModelRequest setProxyCallerIp(String proxyCallerIp) {
    ...
    public PullRpaModelRequest setProxyCallerSecurityTransport(Boolean proxyCallerSecurityTransport) {
    ...
    public PullRpaModelRequest setProxyTrustTransportInfo(Boolean proxyTrustTransportInfo) {
    ...
    public PullRpaModelRequest setRequestId(String requestId) {
    ...
    public PullRpaModelRequest setSecurityToken(String securityToken) {
    ...
    public PullRpaModelRequest setStsTokenCallerBid(Long stsTokenCallerBid) {
    ...
    public PullRpaModelRequest setStsTokenCallerUid(Long stsTokenCallerUid) {
    ...
    public PullRpaModelRequest setUserCallerSecurityTransport(Boolean userCallerSecurityTransport) {
