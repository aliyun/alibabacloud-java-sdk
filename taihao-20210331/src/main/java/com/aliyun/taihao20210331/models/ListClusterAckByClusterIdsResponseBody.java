...
public class ListClusterAckByClusterIdsResponseBody extends TeaModel {
    @NameInMap("code")
    public String code;
    ...
    public static ListClusterAckByClusterIdsResponseBody build(java.util.Map<String, ?> map) throws Exception {
        ListClusterAckByClusterIdsResponseBody self = new ListClusterAckByClusterIdsResponseBody();
        return TeaModel.build(map, self);
    }

    public ListClusterAckByClusterIdsResponseBody setCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public ListClusterAckByClusterIdsResponseBody setData(java.util.List<Data> data) {
        this.data = data;
        return this;
    }
    ...
    public ListClusterAckByClusterIdsResponseBody setMessage(String message) {
    ...
    public ListClusterAckByClusterIdsResponseBody setRequestId(String requestId) {
    ...
    public ListClusterAckByClusterIdsResponseBody setSuccess(Boolean success) {
