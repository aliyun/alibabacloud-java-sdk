...
public class ListClusterOperationNodesResponseBody extends TeaModel {
    @NameInMap("code")
    public String code;
    ...
    public static ListClusterOperationNodesResponseBody build(java.util.Map<String, ?> map) throws Exception {
        ListClusterOperationNodesResponseBody self = new ListClusterOperationNodesResponseBody();
        return TeaModel.build(map, self);
    }

    public ListClusterOperationNodesResponseBody setCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public ListClusterOperationNodesResponseBody setData(java.util.List<Data> data) {
        this.data = data;
        return this;
    }
    ...
    public ListClusterOperationNodesResponseBody setMessage(String message) {
    ...
    public ListClusterOperationNodesResponseBody setRequestId(String requestId) {
    ...
    public ListClusterOperationNodesResponseBody setSuccess(Boolean success) {
