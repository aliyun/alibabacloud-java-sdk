...
public class ListUserPublicKeysResponseBody extends TeaModel {
    /**
     * <p>The list of public keys of the user.</p>
     */
    @NameInMap("PublicKeys")
    public java.util.List<ListUserPublicKeysResponseBodyPublicKeys> publicKeys;

    /**
     * <p>The ID of the request, which is a unique identifier generated by Alibaba Cloud for the request. You can use this ID to troubleshoot and locate issues.</p>
     * 
    ...
    public static class ListUserPublicKeysResponseBodyPublicKeys extends TeaModel {
        /**
         * <p>The comment on the public key.</p>
         * 
         * <strong>example:</strong>
         * <p>comment</p>
         */
        ...
        /**
         * <p>The ID of the user to whom the public key belongs.</p>
         * 
         * <strong>example:</strong>
         * <p>1</p>
         */
