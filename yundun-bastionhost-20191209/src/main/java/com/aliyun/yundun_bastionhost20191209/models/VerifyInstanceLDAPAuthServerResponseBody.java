...
public class VerifyInstanceLDAPAuthServerResponseBody extends TeaModel {
    /**
     * <p>The ID of the request, which is a unique identifier generated by Alibaba Cloud for the request. This parameter can be used for troubleshooting and issue locating.</p>
     * 
