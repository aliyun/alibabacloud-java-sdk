...
public class EnableInstancePublicAccessResponseBody extends TeaModel {
    /**
     * <p>The ID of the Bastionhost instance for which the public access switch has been enabled.</p>
     * 
    ...
    /**
     * <p>The request ID, which is a unique identifier generated by Alibaba Cloud for the request. You can use the ID for troubleshooting.</p>
     * 
     * <strong>example:</strong>
