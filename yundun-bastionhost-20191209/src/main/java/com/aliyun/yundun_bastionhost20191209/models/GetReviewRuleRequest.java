...
public class GetReviewRuleRequest extends TeaModel {
    /**
    ...
    public static GetReviewRuleRequest build(java.util.Map<String, ?> map) throws Exception {
        GetReviewRuleRequest self = new GetReviewRuleRequest();
        return TeaModel.build(map, self);
    }

    public GetReviewRuleRequest setInstanceId(String instanceId) {
    ...
    public GetReviewRuleRequest setRegionId(String regionId) {
    ...
    public GetReviewRuleRequest setReviewRuleId(Long reviewRuleId) {
