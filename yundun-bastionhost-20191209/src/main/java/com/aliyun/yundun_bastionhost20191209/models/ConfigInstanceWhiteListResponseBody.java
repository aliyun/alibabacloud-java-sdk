...
public class ConfigInstanceWhiteListResponseBody extends TeaModel {
    /**
     * <p>The ID of the Bastionhost instance whose whitelist was configured.</p>
     * 
    ...
    /**
     * <p>A unique request ID generated by Alibaba Cloud. Use this ID to troubleshoot issues.</p>
     * 
     * <strong>example:</strong>
