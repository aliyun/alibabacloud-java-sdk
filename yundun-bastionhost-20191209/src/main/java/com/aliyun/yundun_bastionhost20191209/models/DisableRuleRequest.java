...
public class DisableRuleRequest extends TeaModel {
    ...
    public DisableRuleRequest setInstanceId(String instanceId) {
    ...
    public DisableRuleRequest setProjectId(Long projectId) {
    ...
    public DisableRuleRequest setRegionId(String regionId) {
    ...
    public DisableRuleRequest setRuleId(String ruleId) {
        this.ruleId = ruleId;
        return this;
    }
