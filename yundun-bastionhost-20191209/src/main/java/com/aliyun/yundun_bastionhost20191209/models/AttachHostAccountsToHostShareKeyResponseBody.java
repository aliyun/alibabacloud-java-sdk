...
public class AttachHostAccountsToHostShareKeyResponseBody extends TeaModel {
    ...
    /**
     * <p>The results of the operation.</p>
     */
    @NameInMap("Results")
    ...
    public static class AttachHostAccountsToHostShareKeyResponseBodyResults extends TeaModel {
        /**
         * <p>The error code. A value of <strong>OK</strong> indicates that the association was successful. Other error codes indicate that the association failed.</p>
         * 
         * <strong>example:</strong>
         * <p>OK</p>
         */
