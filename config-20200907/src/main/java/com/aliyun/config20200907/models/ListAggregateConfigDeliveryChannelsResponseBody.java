...
public class ListAggregateConfigDeliveryChannelsResponseBody extends TeaModel {
    ...
    public static class ListAggregateConfigDeliveryChannelsResponseBodyDeliveryChannels extends TeaModel {
        ...
        public ListAggregateConfigDeliveryChannelsResponseBodyDeliveryChannels setCompliantSnapshot(Boolean compliantSnapshot) {
        ...
        public ListAggregateConfigDeliveryChannelsResponseBodyDeliveryChannels setDeliverySnapshotTime(String deliverySnapshotTime) {
