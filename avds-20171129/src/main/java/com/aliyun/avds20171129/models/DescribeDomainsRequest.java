...
public class DescribeDomainsRequest extends TeaModel {
    ...
    public DescribeDomainsRequest setTaskId(Integer taskId) {
        this.taskId = taskId;
        return this;
    }
    ...
    public DescribeDomainsRequest setAsset(String asset) {
        this.asset = asset;
        return this;
    }
    ...
    public DescribeDomainsRequest setCurrentPage(Integer currentPage) {
    ...
    public DescribeDomainsRequest setPageSize(Integer pageSize) {
