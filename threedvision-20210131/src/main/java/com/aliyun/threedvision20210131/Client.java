...
package com.aliyun.threedvision20210131;

import com.aliyun.tea.*;
import com.aliyun.threedvision20210131.models.*;
...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    public Client(com.aliyun.teaopenapi.models.Config config) throws Exception {
        ...
        this._endpoint = this.getEndpoint("threedvision", _regionId, _endpointRule, _network, _suffix, _endpointMap, _endpoint);
    }
    ...
    public EstimateMonocularImageDepthResponse estimateMonocularImageDepthWithOptions(EstimateMonocularImageDepthRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "EstimateMonocularImageDepth"),
            new TeaPair("version", "2021-01-31"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new EstimateMonocularImageDepthResponse());
    }

    public EstimateMonocularImageDepthResponse estimateMonocularImageDepth(EstimateMonocularImageDepthRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        return this.estimateMonocularImageDepthWithOptions(request, runtime);
    }

    public EstimateMonocularImageDepthResponse estimateMonocularImageDepthAdvance(EstimateMonocularImageDepthAdvanceRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        // Step 0: init client
        ...
        com.aliyun.openplatform20191219.models.AuthorizeFileUploadRequest authRequest = com.aliyun.openplatform20191219.models.AuthorizeFileUploadRequest.build(TeaConverter.buildMap(
            new TeaPair("product", "threedvision"),
            new TeaPair("regionId", _regionId)
        ));
    ...
    public EstimateMonocularVideoDepthResponse estimateMonocularVideoDepthWithOptions(EstimateMonocularVideoDepthRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "EstimateMonocularVideoDepth"),
            new TeaPair("version", "2021-01-31"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new EstimateMonocularVideoDepthResponse());
    }
    ...
    public EstimateStereoImageDepthResponse estimateStereoImageDepthWithOptions(EstimateStereoImageDepthRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> body = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.leftImageURL)) {
            body.put("LeftImageURL", request.leftImageURL);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.rightImageURL)) {
            body.put("RightImageURL", request.rightImageURL);
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "EstimateStereoImageDepth"),
            new TeaPair("version", "2021-01-31"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new EstimateStereoImageDepthResponse());
    }
    ...
    public EstimateStereoImageDepthResponse estimateStereoImageDepthAdvance(EstimateStereoImageDepthAdvanceRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        // Step 0: init client
        String accessKeyId = _credential.getAccessKeyId();
        String accessKeySecret = _credential.getAccessKeySecret();
        String securityToken = _credential.getSecurityToken();
        ...
        com.aliyun.ossutil.models.RuntimeOptions ossRuntime = new com.aliyun.ossutil.models.RuntimeOptions();
        com.aliyun.openapiutil.Client.convert(runtime, ossRuntime);
        EstimateStereoImageDepthRequest estimateStereoImageDepthReq = new EstimateStereoImageDepthRequest();
        com.aliyun.openapiutil.Client.convert(request, estimateStereoImageDepthReq);
        if (!com.aliyun.teautil.Common.isUnset(request.leftImageURLObject)) {
            authResponse = authClient.authorizeFileUploadWithOptions(authRequest, runtime);
            ossConfig.accessKeyId = authResponse.body.accessKeyId;
            ossConfig.endpoint = com.aliyun.openapiutil.Client.getEndpoint(authResponse.body.endpoint, authResponse.body.useAccelerate, _endpointType);
            ossClient = new com.aliyun.oss.Client(ossConfig);
            fileObj = com.aliyun.fileform.models.FileField.build(TeaConverter.buildMap(
                new TeaPair("filename", authResponse.body.objectKey),
                new TeaPair("content", request.leftImageURLObject),
                new TeaPair("contentType", "")
            ));
            ossHeader = com.aliyun.oss.models.PostObjectRequest.PostObjectRequestHeader.build(TeaConverter.buildMap(
                new TeaPair("accessKeyId", authResponse.body.accessKeyId),
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.rightImageURLObject)) {
            authResponse = authClient.authorizeFileUploadWithOptions(authRequest, runtime);
            ossConfig.accessKeyId = authResponse.body.accessKeyId;
            ossConfig.endpoint = com.aliyun.openapiutil.Client.getEndpoint(authResponse.body.endpoint, authResponse.body.useAccelerate, _endpointType);
            ossClient = new com.aliyun.oss.Client(ossConfig);
            fileObj = com.aliyun.fileform.models.FileField.build(TeaConverter.buildMap(
                new TeaPair("filename", authResponse.body.objectKey),
                new TeaPair("content", request.rightImageURLObject),
                new TeaPair("contentType", "")
            ));
            ossHeader = com.aliyun.oss.models.PostObjectRequest.PostObjectRequestHeader.build(TeaConverter.buildMap(
                new TeaPair("accessKeyId", authResponse.body.accessKeyId),
        ...
        EstimateStereoImageDepthResponse estimateStereoImageDepthResp = this.estimateStereoImageDepthWithOptions(estimateStereoImageDepthReq, runtime);
    ...
    public ReconstructBodyBySingleImageResponse reconstructBodyBySingleImageWithOptions(ReconstructBodyBySingleImageRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> body = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.imageURL)) {
            body.put("ImageURL", request.imageURL);
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "ReconstructBodyBySingleImage"),
            new TeaPair("version", "2021-01-31"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new ReconstructBodyBySingleImageResponse());
    }

    public ReconstructBodyBySingleImageResponse reconstructBodyBySingleImage(ReconstructBodyBySingleImageRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        return this.reconstructBodyBySingleImageWithOptions(request, runtime);
    }

    public ReconstructBodyBySingleImageResponse reconstructBodyBySingleImageAdvance(ReconstructBodyBySingleImageAdvanceRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        // Step 0: init client
        String accessKeyId = _credential.getAccessKeyId();
        String accessKeySecret = _credential.getAccessKeySecret();
        String securityToken = _credential.getSecurityToken();
    ...
    public ReconstructThreeDMultiViewResponse reconstructThreeDMultiViewWithOptions(ReconstructThreeDMultiViewRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> body = new java.util.HashMap<>();
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.zipFileUrl)) {
            body.put("ZipFileUrl", request.zipFileUrl);
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "ReconstructThreeDMultiView"),
            new TeaPair("version", "2021-01-31"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new ReconstructThreeDMultiViewResponse());
    }

    public ReconstructThreeDMultiViewResponse reconstructThreeDMultiView(ReconstructThreeDMultiViewRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        return this.reconstructThreeDMultiViewWithOptions(request, runtime);
    }

    public ReconstructThreeDMultiViewResponse reconstructThreeDMultiViewAdvance(ReconstructThreeDMultiViewAdvanceRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        // Step 0: init client
        String accessKeyId = _credential.getAccessKeyId();
        String accessKeySecret = _credential.getAccessKeySecret();
        String securityToken = _credential.getSecurityToken();
