...
public class TagResourcesRequest extends TeaModel {
    ...
    public static class Tag extends TeaModel {
        /**
         * <p>The key of the tag. You must enter at least one tag key and at most 20 tag keys. The tag key cannot be an empty string.</p>
         * <br>
        ...
        /**
         * <p>The value of the tag. You must enter at least one tag value and at most 20 tag values. It can be an empty string.</p>
         * <br>
