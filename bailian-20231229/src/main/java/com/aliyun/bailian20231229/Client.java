...
public class Client extends com.aliyun.teaopenapi.Client {
     ...
     * <b>description</b> :
     * <ul>
     * <li>This operation adds chunk content to a specified knowledge base of the document search (document), data query (table), or image Q&amp;A (image) type. Related operations on multimedia search (multimedia) knowledge bases are not supported. For data query and image Q&amp;A knowledge bases, this operation takes effect only when the data source is a spreadsheet connector (excel).</li>
     ...
     * 
     * <b>summary</b> : 
     * <p>Adds chunks to a document search (document), data query (table), or image Q&amp;A (image) knowledge base.</p>
     * 
     ...
     */
    public AddChunkResponse addChunkWithOptions(String WorkspaceId, AddChunkRequest tmpReq, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(tmpReq);
        AddChunkShrinkRequest request = new AddChunkShrinkRequest();
        com.aliyun.openapiutil.Client.convert(tmpReq, request);
        if (!com.aliyun.teautil.Common.isUnset(tmpReq.field)) {
            request.fieldShrink = com.aliyun.openapiutil.Client.arrayToStringWithSpecifiedStyle(tmpReq.field, "field", "json");
        }
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.fieldShrink)) {
            query.put("field", request.fieldShrink);
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "AddChunk"),
            new TeaPair("version", "2023-12-29"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/" + com.aliyun.openapiutil.Client.getEncodeParam(WorkspaceId) + "/chunk/create"),
            new TeaPair("method", "POST"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new AddChunkResponse());
    }
     ...
     * @return AddChunkResponse
     */
    public AddChunkResponse addChunk(String WorkspaceId, AddChunkRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
     ...
     * <b>description</b> :
     * <ul>
     * <li>RAM users must first obtain <a href="https://help.aliyun.com/document_detail/2848578.html">API permissions</a> for Alibaba Cloud Model Studio (requires <code>AliyunBailianDataFullAccess</code>, which includes the sfm:AddFile permission) and <a href="https://help.aliyun.com/document_detail/2851098.html">join a workspace</a> before calling this operation. Alibaba Cloud accounts can call this operation directly without authorization. Call this operation by using the latest &lt;props=&quot;china&quot;&gt;<a href="https://api.aliyun.com/api-tools/sdk/bailian?version=2023-12-29">Alibaba Cloud Model Studio SDK</a>&lt;props=&quot;intl&quot;&gt;<a href="https://api.alibabacloud.com/api-tools/sdk/bailian?version=2023-12-29">Alibaba Cloud Model Studio SDK</a>.</li>
     * <li>This operation is not idempotent.
     * <strong>Rate limiting:</strong>
     * This operation is rate-limited. Do not exceed 10 calls per second. If you are throttled, retry later.</li>
     * </ul>
     * 
     * <b>summary</b> : 
     * <p>Imports a file from the temporary storage of Alibaba Cloud Model Studio into an Alibaba Cloud Model Studio data connection (formerly known as application data).</p>
     * 
     ...
     * <b>description</b> :
     * <ul>
     * <li><p>Make sure the OSS bucket belongs to the same Alibaba Cloud account as Model Studio and that authorization has been completed as described in <a href="https://help.aliyun.com/document_detail/2782155.html">Importing data from OSS configuration instructions</a>.</p>
     * <ul>
     * <li>Supported bucket storage types do not include Archive, Cold Archive, or Deep Cold Archive. Buckets with content encryption enabled are supported. Buckets with public read/write, public read, or private access are supported.</li>
     * <li>To use a bucket with <a href="https://help.aliyun.com/document_detail/2636937.html">Referer-based hotlink protection</a> enabled, add the domain name <code>*.console.aliyun.com</code> to the Referer whitelist as described in <a href="https://help.aliyun.com/document_detail/2636937.html">Allow access only from trusted websites</a>.</li>
     * </ul>
     * </li>
     * <li><p>Resource Access Management (RAM) users must first obtain <a href="https://help.aliyun.com/document_detail/2848578.html">API permissions</a> for Model Studio (the <code>AliyunBailianDataFullAccess</code> permission is required, which includes the sfm:AddFilesFromAuthorizedOss permission) and <a href="https://help.aliyun.com/document_detail/2851098.html">join a workspace</a> before invoking this operation. Alibaba Cloud accounts can invoke this operation directly without authorization. Call this operation by using the latest &lt;props=&quot;china&quot;&gt;<a href="https://api.aliyun.com/api-tools/sdk/bailian?version=2023-12-29">Model Studio SDK</a>&lt;props=&quot;intl&quot;&gt;<a href="https://api.alibabacloud.com/api-tools/sdk/bailian?version=2023-12-29">Model Studio SDK</a>.</p>
     * </li>
     * <li><p>This operation does not have idempotence.
     * <strong>Rate limit:</strong>
     * This operation is throttled if called too frequently. Do not exceed 5 calls per second. If throttled, retry later.</p>
     * </li>
     * </ul>
     * 
     * <b>summary</b> : 
     * <p>Imports files from an authorized OSS bucket into Alibaba Cloud Model Studio application data.</p>
     * 
    ...
    /**
     * <b>summary</b> : 
     * <p>Batch updates document tags in a data connection.</p>
     * 
     ...
     * 
     * <b>summary</b> : 
     * <p>Configures the parsing method for specific file types. For example, specifies large model document parsing for .pdf files or Qwen VL parsing for .jpg files.</p>
     * 
     ...
     * <li><strong>Resource Access Management (RAM) user</strong>: Before invoking this operation, obtain <a href="https://help.aliyun.com/document_detail/2848578.html">API permissions</a> for Alibaba Cloud Model Studio (you can use the <code>AliyunBailianDataFullAccess</code> policy, which includes the sfm:CreateIndex permission required by this operation), and <a href="https://help.aliyun.com/document_detail/2851098.html">join a workspace</a>.</li>
     * <li><strong>Alibaba Cloud account</strong>: Has permissions by default and can invoke this operation directly.</li>
     * </ul>
     * </li>
     * <li><strong>Calling method</strong>: Use the latest &lt;props=&quot;china&quot;&gt;<a href="https://api.aliyun.com/api-tools/sdk/bailian?version=2023-12-29">Alibaba Cloud Model Studio SDK</a>&lt;props=&quot;intl&quot;&gt;<a href="https://api.alibabacloud.com/api-tools/sdk/bailian?version=2023-12-29">Alibaba Cloud Model Studio SDK</a>. The SDK provides encapsulation of complex signature calculation logic and simplifies the invocation procedure.</li>
     * <li><strong>What to do next</strong>: This operation only performs initialization of the knowledge base creation job. After invoking this operation, you must invoke the <strong>SubmitIndexJob</strong> operation to complete the creation (otherwise, you will get an empty knowledge base). For code examples, see <a href="https://help.aliyun.com/document_detail/2852772.html">Knowledge Base API Guide</a>.</li>
     * <li><strong>Idempotence</strong>: This operation is not idempotent. Repeated invocations may create multiple knowledge bases with the same name. Implement idempotent calls by using a &quot;query first, then create&quot; approach.
     * <strong>Rate limiting:</strong>
     * This operation is subject to rate limiting. Do not exceed 10 calls per second. If you are rate-limited, retry later.</li>
     * </ul>
     * 
     * <b>summary</b> : 
     * <p>Creates a knowledge base of either type: an unstructured knowledge base based on documents or audio/video, or a structured knowledge base for data queries or image-based Q&amp;A.</p>
     * 
     ...
     * 
     * <b>summary</b> : 
     * <p>Queries the basic information of a file in application data, including the file name, type, and status.</p>
     * 
     ...
     * <li>You must have a knowledge base job that is in progress. You can create a knowledge base creation task by invoking the <strong>SubmitIndexJob</strong> operation, or create a knowledge base document append task by invoking the <strong>SubmitIndexAddDocumentsJob</strong> operation. Obtain the corresponding <code>JobId</code>.</li>
     * <li>Invoke this operation at intervals of 5 seconds or more.</li>
     * <li>This operation supports idempotence.</li>
     * </ul>
     * 
     * <b>summary</b> : 
     * <p>Queries the current status of a specified knowledge base creation task or knowledge base document append task.</p>
     * 
     ...
     * 
     * <b>summary</b> : 
     * <p>Retrieves files and their summary information from a specified knowledge base.</p>
     * 
     ...
     * <li>Before invoking this operation, make sure your knowledge base has been created and has not been deleted (that is, the knowledge base ID <code>IndexId</code> is valid).</li>
     * <li>This operation has idempotence.</li>
     * </ul>
     * 
     * <b>summary</b> : 
     * <p>Retrieves files and their details from a specified knowledge base.</p>
     * 
     ...
     * <p>&lt;props=&quot;china&quot;&gt;</p>
     * <ul>
     * <li>This operation does not support data query or image Q&amp;A knowledge bases. For information about how to update data query or image Q&amp;A knowledge bases, see the knowledge base update instructions in <a href="https://help.aliyun.com/document_detail/2807740.html">Knowledge base</a>.
     * &lt;props=&quot;intl&quot;&gt;</li>
     * <li>This operation does not support data query or image Q&amp;A knowledge bases. For information about how to update data query or image Q&amp;A knowledge bases, see the knowledge base update instructions in <a href="https://help.aliyun.com/document_detail/2807740.html">Knowledge base</a>.</li>
     ...
     * <li>Before invoking this operation, make sure that your knowledge base has been created and has not been deleted (that is, the knowledge base ID <code>IndexId</code> is valid).</li>
     * <li>Before invoking this operation, invoke the <strong>AddFile</strong> operation to upload the files you want to append to Model Studio.</li>
     * <li>After invoking this operation, the node requires time to execute and may take several hours during peak periods. Do not submit duplicate requests before the node is complete. To query the node execution status, invoke the <strong>GetIndexJobStatus</strong> operation. The <code>Documents</code> file list returned by this operation contains all files in this append job (uniquely identified by the <code>job_id</code> you provide), and you can check whether each file was imported (parsed) successfully. Note that invoking GetIndexJobStatus too frequently will trigger rate limiting. Do not exceed a frequency of 20 times per minute.</li>
     * <li>After this operation is invoked successfully, it takes some time to execute. Do not submit duplicate requests before the response is returned. This operation does not have idempotence.
     * <strong>Rate limit:</strong>
     * Frequent calls to this operation will be throttled. Do not exceed 10 calls per second. If throttled, retry later.</li>
     * </ul>
     * 
     * <b>summary</b> : 
     * <p>Appends parsed files to a specified knowledge base.</p>
     * 
     ...
     * <strong>Rate limiting:</strong>
     * This operation is rate-limited. Do not exceed 5 calls per second. If you are throttled, retry later.</li>
     * </ul>
     * 
     * <b>summary</b> : 
     * <p>Updates the tags of a specified file.</p>
     * 
