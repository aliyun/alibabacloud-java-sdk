...
public class AddChunkRequest extends TeaModel {
    /**
     ...
     */
    @NameInMap("field")
    public java.util.Map<String, ?> field;

    public static AddChunkRequest build(java.util.Map<String, ?> map) throws Exception {
        AddChunkRequest self = new AddChunkRequest();
        return TeaModel.build(map, self);
    }

    public AddChunkRequest setPipelineId(String pipelineId) {
    ...
    public AddChunkRequest setDataId(String dataId) {
        this.dataId = dataId;
        return this;
    }
    ...
    public AddChunkRequest setField(java.util.Map<String, ?> field) {
        this.field = field;
        return this;
    }
