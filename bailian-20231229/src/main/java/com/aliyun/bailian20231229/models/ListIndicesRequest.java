...
public class ListIndicesRequest extends TeaModel {
    /**
     * <p>The name of the knowledge base. You can use this parameter to search for a knowledge base by name. The name must be 1 to 20 characters in length and can contain characters in the Unicode letter category (including letters, Chinese characters, and digits). The name can also contain colons (:), underscores (_), periods (.), or hyphens (-).</p>
    ...
    /**
     * <p>The number of knowledge bases to display per page. No maximum limit.
     * Default value: 10.</p>
     * 
     * <strong>example:</strong>
     * <p>10</p>
