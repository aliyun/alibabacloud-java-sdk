...
public class CloneExperimentResponseBody extends TeaModel {
    ...
    public CloneExperimentResponseBody setCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public CloneExperimentResponseBody setData(String data) {
        this.data = data;
        return this;
    }
    ...
    public CloneExperimentResponseBody setMessage(String message) {
    ...
    public CloneExperimentResponseBody setSuccess(Boolean success) {
