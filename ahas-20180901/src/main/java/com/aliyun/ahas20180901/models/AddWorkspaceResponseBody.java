...
public class AddWorkspaceResponseBody extends TeaModel {
    ...
    public AddWorkspaceResponseBody setCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public AddWorkspaceResponseBody setData(String data) {
        this.data = data;
        return this;
    }
    ...
    public AddWorkspaceResponseBody setMessage(String message) {
    ...
    public AddWorkspaceResponseBody setSuccess(Boolean success) {
