...
public class DeleteWorkspaceMemberResponseBody extends TeaModel {
    ...
    public DeleteWorkspaceMemberResponseBody setCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public DeleteWorkspaceMemberResponseBody setData(String data) {
        this.data = data;
        return this;
    }
    ...
    public DeleteWorkspaceMemberResponseBody setMessage(String message) {
