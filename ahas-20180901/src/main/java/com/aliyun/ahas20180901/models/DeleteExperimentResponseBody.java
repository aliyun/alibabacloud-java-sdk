...
public class DeleteExperimentResponseBody extends TeaModel {
    ...
    public DeleteExperimentResponseBody setCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public DeleteExperimentResponseBody setData(String data) {
        this.data = data;
        return this;
    }
    ...
    public DeleteExperimentResponseBody setMessage(String message) {
    ...
    public DeleteExperimentResponseBody setSuccess(Boolean success) {
