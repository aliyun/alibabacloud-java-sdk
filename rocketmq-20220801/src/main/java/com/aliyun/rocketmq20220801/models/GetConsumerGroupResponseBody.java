...
public class GetConsumerGroupResponseBody extends TeaModel {
    ...
    public static class GetConsumerGroupResponseBodyDataConsumeRetryPolicy extends TeaModel {
        ...
        public GetConsumerGroupResponseBodyDataConsumeRetryPolicy setFixedIntervalRetryTime(Integer fixedIntervalRetryTime) {
    ...
    public static class GetConsumerGroupResponseBodyData extends TeaModel {
        ...
        public GetConsumerGroupResponseBodyData setMessageModel(String messageModel) {
        ...
        public GetConsumerGroupResponseBodyData setTopicName(String topicName) {
