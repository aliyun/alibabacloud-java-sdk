...
public class DescribeImageCachesRequest extends TeaModel {
    ...
    public DescribeImageCachesRequest setClientToken(String clientToken) {
    ...
    public DescribeImageCachesRequest setImageId(String imageId) {
    ...
    public DescribeImageCachesRequest setMaxResults(Long maxResults) {
    ...
    public DescribeImageCachesRequest setZoneId(String zoneId) {
        this.zoneId = zoneId;
        return this;
    }
