...
public class DescribeDedicatedHostsRequest extends TeaModel {
    ...
    public DescribeDedicatedHostsRequest setSchedulerOptions(SchedulerOptions schedulerOptions) {
    ...
    public DescribeDedicatedHostsRequest setTag(java.util.List<Tag> tag) {
        this.tag = tag;
        return this;
    }
