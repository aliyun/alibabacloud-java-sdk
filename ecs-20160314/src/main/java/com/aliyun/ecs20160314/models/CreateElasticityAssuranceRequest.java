...
public class CreateElasticityAssuranceRequest extends TeaModel {
    ...
    public CreateElasticityAssuranceRequest setPrivatePoolOptions(PrivatePoolOptions privatePoolOptions) {
    ...
    public CreateElasticityAssuranceRequest setTag(java.util.List<Tag> tag) {
        this.tag = tag;
        return this;
    }
