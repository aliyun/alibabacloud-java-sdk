...
public class UpdateAiModelProviderResponseBody extends TeaModel {
    ...
    public static class UpdateAiModelProviderResponseBodyDataModelCardsAvailablePaths extends TeaModel {
        /**
         * <p>The model invocation path. The path can be up to 2048 characters in length.</p>
         * 
         * <strong>example:</strong>
    ...
    public static class UpdateAiModelProviderResponseBodyData extends TeaModel {
        /**
         * <p>The list of AI service summaries currently bound to the model provider.</p>
         */
        @NameInMap("boundServices")
        public java.util.List<ServiceInfo> boundServices;

        /**
         * <p>The display name of the model provider. The name can be up to 128 characters in length.</p>
         * 
         * <strong>example:</strong>
        ...
        /**
         * <p>The list of model cards currently associated with the model provider.</p>
         */
        @NameInMap("modelCards")
        public java.util.List<UpdateAiModelProviderResponseBodyDataModelCards> modelCards;

        /**
         * <p>The number of model cards currently associated with the model provider.</p>
         * 
         * <strong>example:</strong>
         * <p>2</p>
         */
        ...
        /**
         * <p>The model provider ID. The ID is generated by the system and starts with mp-.</p>
         * 
         * <strong>example:</strong>
         * <p>mp-8c13d2b4f8a1</p>
         */
        ...
        /**
         * <p>The stable identifier of the model provider. The identifier can be up to 128 characters in length.</p>
         * 
         * <strong>example:</strong>
         * <p>qwen</p>
         */
