...
public class SubmitCampaignResponseBody extends TeaModel {
    ...
    public SubmitCampaignResponseBody setData(Boolean data) {
        this.data = data;
        return this;
    }
    ...
    public SubmitCampaignResponseBody setHttpStatusCode(Integer httpStatusCode) {
    ...
    public SubmitCampaignResponseBody setParams(java.util.List<String> params) {
        this.params = params;
        return this;
    }
    ...
    public SubmitCampaignResponseBody setSuccess(Boolean success) {
