...
public class ListHistoricalAgentSkillGroupReportResponseBody extends TeaModel {
    ...
    public static class ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound extends TeaModel {
        ...
        public ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound setSatisfactionCount(Long satisfactionCount) {
    ...
    public static class ListHistoricalAgentSkillGroupReportResponseBodyDataListOutbound extends TeaModel {
        ...
        public ListHistoricalAgentSkillGroupReportResponseBodyDataListOutbound setSatisfactionCount(Long satisfactionCount) {
            this.satisfactionCount = satisfactionCount;
            return this;
        }
        public Long getSatisfactionCount() {
    ...
    public static class ListHistoricalAgentSkillGroupReportResponseBodyDataListOverall extends TeaModel {
        ...
        public ListHistoricalAgentSkillGroupReportResponseBodyDataListOverall setSatisfactionCount(Long satisfactionCount) {
            this.satisfactionCount = satisfactionCount;
            return this;
        }
        public Long getSatisfactionCount() {
