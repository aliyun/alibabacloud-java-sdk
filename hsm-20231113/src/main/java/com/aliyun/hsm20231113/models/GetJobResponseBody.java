...
public class GetJobResponseBody extends TeaModel {
    ...
    public static class GetJobResponseBodyJob extends TeaModel {
        ...
        public GetJobResponseBodyJob setCompleted(Boolean completed) {
        ...
        public GetJobResponseBodyJob setError(String error) {
            this.error = error;
            return this;
        }
        ...
        public GetJobResponseBodyJob setProgress(Long progress) {
        ...
        public GetJobResponseBodyJob setResponse(String response) {
        ...
        public GetJobResponseBodyJob setType(String type) {
            this.type = type;
            return this;
        }
