...
public class CreateCdnSubTaskRequest extends TeaModel {
     ...
     * <p>*   **9**: frequently requested URLs that are redirected to the origin (ranked by the number of requests)</p>
     * <p>*   **11**: frequently requested URLs that are redirected to the origin (ranked by the amount of network traffic)</p>
