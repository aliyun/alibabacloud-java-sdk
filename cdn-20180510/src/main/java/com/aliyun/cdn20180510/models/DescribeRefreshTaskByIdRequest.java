...
public class DescribeRefreshTaskByIdRequest extends TeaModel {
     ...
     * <br>
     * <p>You can call the [RefreshObjectCaches](https://help.aliyun.com/document_detail/91164.html) operation to query task IDs. Then, you can use the task IDs to query task status.</p>
     * <br>
