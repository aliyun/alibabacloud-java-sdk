...
public class BatchSetCdnDomainConfigRequest extends TeaModel {
     ...
     * <br>
     * <p>*   **functionName**: the name of the feature. This parameter is required. Separate multiple values with commas (,). For more information, see [A list of features](~~388460~~).</p>
     ...
     * <br>
     * <p>If you set **parentId** to **-1**, the existing rule conditions in the configurations are deleted.</p>
     * <br>
     * <p>    [{</p>
     * <p>       "functionArgs": [{</p>
     ...
     * <p>     "parentId": "Optional, which corresponds to configid of the referenced rule condition"</p>
     * <p>    }]</p>
     * <br>
     * <p>The following code shows a sample configuration if **parentId** is not used.</p>
     * <br>
     * <p>In this example, the **origin_request_header** feature is used to add back-to-origin HTTP headers, and the rule condition whose configuration ID is **222728944812032** is referenced.</p>
     * <br>
     * <p>    [{</p>
     * <p>            "functionArgs": [{</p>
     ...
     * <p>    }]</p>
     * <br>
     * <p>The following code shows a sample configuration if **parentId** is used.</p>
     * <br>
     * <p>In this example, the **origin_request_header** feature is used to add back-to-origin HTTP headers, and the rule condition whose configuration ID is **222728944812032** is referenced.</p>
     * <br>
     * <p>    [{</p>
