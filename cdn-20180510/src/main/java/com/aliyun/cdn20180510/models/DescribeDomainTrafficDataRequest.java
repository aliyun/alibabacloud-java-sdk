...
public class DescribeDomainTrafficDataRequest extends TeaModel {
    ...
    /**
     * <p>The name of the Internet service provider (ISP). You can call the [DescribeCdnRegionAndIsp](~~DescribeCdnRegionAndIsp~~) operation to query ISPs.</p>
     * <br>
    ...
    /**
     * <p>The name of the region. You can call the [DescribeCdnRegionAndIsp](~~DescribeCdnRegionAndIsp~~) operation to query regions.</p>
     * <br>
