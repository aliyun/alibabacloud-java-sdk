...
public class DescribeDomainReqHitRateDataRequest extends TeaModel {
     ...
     * <br>
     * <p>By default, this operation queries the bandwidth values of back-to-origin requests for all accelerated domain names that belong to your Alibaba Cloud account.</p>
     */
