...
public class CreateServiceInstanceRequest extends TeaModel {
    ...
    public CreateServiceInstanceRequest setServiceInstanceId(String serviceInstanceId) {
    ...
    public static class CreateServiceInstanceRequestCommodity extends TeaModel {
        ...
        public CreateServiceInstanceRequestCommodity setQuotationId(String quotationId) {
