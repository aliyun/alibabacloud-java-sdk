...
public class ListServiceInstanceLogsRequest extends TeaModel {
    ...
    /**
     * <p>The log source. When this field is empty, query logs with the source set to computeNest and ros. Valid values:</p>
     * <p>computeNest : logs of the deployment and upgrade of the service instance.
     ...
     * meteringData：Logs originating from the pay-as-you-go model.</p>
     * 
