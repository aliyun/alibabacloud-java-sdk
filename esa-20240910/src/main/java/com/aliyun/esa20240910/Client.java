...
public class Client extends com.aliyun.teaopenapi.Client {
     ...
     * 
     * <b>summary</b> : 
     * <p>Configures one or more feature settings for a website.</p>
     * 
     * @param tmpReq CreateSiteFunctionRequest
     * @param runtime runtime options for this request RuntimeOptions
     * @return CreateSiteFunctionResponse
     */
    public CreateSiteFunctionResponse createSiteFunctionWithOptions(CreateSiteFunctionRequest tmpReq, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(tmpReq);
        CreateSiteFunctionShrinkRequest request = new CreateSiteFunctionShrinkRequest();
        com.aliyun.openapiutil.Client.convert(tmpReq, request);
        if (!com.aliyun.teautil.Common.isUnset(tmpReq.cacheReserve)) {
            request.cacheReserveShrink = com.aliyun.openapiutil.Client.arrayToStringWithSpecifiedStyle(tmpReq.cacheReserve, "CacheReserve", "json");
        }

        if (!com.aliyun.teautil.Common.isUnset(tmpReq.cacheRules)) {
            request.cacheRulesShrink = com.aliyun.openapiutil.Client.arrayToStringWithSpecifiedStyle(tmpReq.cacheRules, "CacheRules", "json");
        }

        if (!com.aliyun.teautil.Common.isUnset(tmpReq.cacheTags)) {
            request.cacheTagsShrink = com.aliyun.openapiutil.Client.arrayToStringWithSpecifiedStyle(tmpReq.cacheTags, "CacheTags", "json");
        }

        if (!com.aliyun.teautil.Common.isUnset(tmpReq.cnameFlattening)) {
            request.cnameFlatteningShrink = com.aliyun.openapiutil.Client.arrayToStringWithSpecifiedStyle(tmpReq.cnameFlattening, "CnameFlattening", "json");
        }

        if (!com.aliyun.teautil.Common.isUnset(tmpReq.compressionRules)) {
            request.compressionRulesShrink = com.aliyun.openapiutil.Client.arrayToStringWithSpecifiedStyle(tmpReq.compressionRules, "CompressionRules", "json");
        }

        if (!com.aliyun.teautil.Common.isUnset(tmpReq.crossBorderOptimization)) {
            request.crossBorderOptimizationShrink = com.aliyun.openapiutil.Client.arrayToStringWithSpecifiedStyle(tmpReq.crossBorderOptimization, "CrossBorderOptimization", "json");
        }

        if (!com.aliyun.teautil.Common.isUnset(tmpReq.developmentMode)) {
            request.developmentModeShrink = com.aliyun.openapiutil.Client.arrayToStringWithSpecifiedStyle(tmpReq.developmentMode, "DevelopmentMode", "json");
        }

        if (!com.aliyun.teautil.Common.isUnset(tmpReq.httpRequestHeaderModificationRules)) {
            request.httpRequestHeaderModificationRulesShrink = com.aliyun.openapiutil.Client.arrayToStringWithSpecifiedStyle(tmpReq.httpRequestHeaderModificationRules, "HttpRequestHeaderModificationRules", "json");
        }

        if (!com.aliyun.teautil.Common.isUnset(tmpReq.httpResponseHeaderModificationRules)) {
            request.httpResponseHeaderModificationRulesShrink = com.aliyun.openapiutil.Client.arrayToStringWithSpecifiedStyle(tmpReq.httpResponseHeaderModificationRules, "HttpResponseHeaderModificationRules", "json");
        }

        if (!com.aliyun.teautil.Common.isUnset(tmpReq.httpsApplicationConfiguration)) {
            request.httpsApplicationConfigurationShrink = com.aliyun.openapiutil.Client.arrayToStringWithSpecifiedStyle(tmpReq.httpsApplicationConfiguration, "HttpsApplicationConfiguration", "json");
        }

        if (!com.aliyun.teautil.Common.isUnset(tmpReq.httpsBasicConfiguration)) {
            request.httpsBasicConfigurationShrink = com.aliyun.openapiutil.Client.arrayToStringWithSpecifiedStyle(tmpReq.httpsBasicConfiguration, "HttpsBasicConfiguration", "json");
        }

        if (!com.aliyun.teautil.Common.isUnset(tmpReq.imageTransform)) {
            request.imageTransformShrink = com.aliyun.openapiutil.Client.arrayToStringWithSpecifiedStyle(tmpReq.imageTransform, "ImageTransform", "json");
        }

        if (!com.aliyun.teautil.Common.isUnset(tmpReq.ipv6)) {
            request.ipv6Shrink = com.aliyun.openapiutil.Client.arrayToStringWithSpecifiedStyle(tmpReq.ipv6, "Ipv6", "json");
        }

        if (!com.aliyun.teautil.Common.isUnset(tmpReq.managedTransforms)) {
            request.managedTransformsShrink = com.aliyun.openapiutil.Client.arrayToStringWithSpecifiedStyle(tmpReq.managedTransforms, "ManagedTransforms", "json");
        }

        if (!com.aliyun.teautil.Common.isUnset(tmpReq.networkOptimization)) {
            request.networkOptimizationShrink = com.aliyun.openapiutil.Client.arrayToStringWithSpecifiedStyle(tmpReq.networkOptimization, "NetworkOptimization", "json");
        }

        if (!com.aliyun.teautil.Common.isUnset(tmpReq.originProtection)) {
            request.originProtectionShrink = com.aliyun.openapiutil.Client.arrayToStringWithSpecifiedStyle(tmpReq.originProtection, "OriginProtection", "json");
        }

        if (!com.aliyun.teautil.Common.isUnset(tmpReq.originRules)) {
            request.originRulesShrink = com.aliyun.openapiutil.Client.arrayToStringWithSpecifiedStyle(tmpReq.originRules, "OriginRules", "json");
        }

        if (!com.aliyun.teautil.Common.isUnset(tmpReq.redirectRules)) {
            request.redirectRulesShrink = com.aliyun.openapiutil.Client.arrayToStringWithSpecifiedStyle(tmpReq.redirectRules, "RedirectRules", "json");
        }

        if (!com.aliyun.teautil.Common.isUnset(tmpReq.rewriteUrlRules)) {
            request.rewriteUrlRulesShrink = com.aliyun.openapiutil.Client.arrayToStringWithSpecifiedStyle(tmpReq.rewriteUrlRules, "RewriteUrlRules", "json");
        }

        if (!com.aliyun.teautil.Common.isUnset(tmpReq.seoBypass)) {
            request.seoBypassShrink = com.aliyun.openapiutil.Client.arrayToStringWithSpecifiedStyle(tmpReq.seoBypass, "SeoBypass", "json");
        }

        if (!com.aliyun.teautil.Common.isUnset(tmpReq.siteNameExclusive)) {
            request.siteNameExclusiveShrink = com.aliyun.openapiutil.Client.arrayToStringWithSpecifiedStyle(tmpReq.siteNameExclusive, "SiteNameExclusive", "json");
        }

        if (!com.aliyun.teautil.Common.isUnset(tmpReq.sitePause)) {
            request.sitePauseShrink = com.aliyun.openapiutil.Client.arrayToStringWithSpecifiedStyle(tmpReq.sitePause, "SitePause", "json");
        }

        if (!com.aliyun.teautil.Common.isUnset(tmpReq.tieredCache)) {
            request.tieredCacheShrink = com.aliyun.openapiutil.Client.arrayToStringWithSpecifiedStyle(tmpReq.tieredCache, "TieredCache", "json");
        }

        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.cacheReserveShrink)) {
            query.put("CacheReserve", request.cacheReserveShrink);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.cacheRulesShrink)) {
            query.put("CacheRules", request.cacheRulesShrink);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.cacheTagsShrink)) {
            query.put("CacheTags", request.cacheTagsShrink);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.cnameFlatteningShrink)) {
            query.put("CnameFlattening", request.cnameFlatteningShrink);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.compressionRulesShrink)) {
            query.put("CompressionRules", request.compressionRulesShrink);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.crossBorderOptimizationShrink)) {
            query.put("CrossBorderOptimization", request.crossBorderOptimizationShrink);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.developmentModeShrink)) {
            query.put("DevelopmentMode", request.developmentModeShrink);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.httpRequestHeaderModificationRulesShrink)) {
            query.put("HttpRequestHeaderModificationRules", request.httpRequestHeaderModificationRulesShrink);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.httpResponseHeaderModificationRulesShrink)) {
            query.put("HttpResponseHeaderModificationRules", request.httpResponseHeaderModificationRulesShrink);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.httpsApplicationConfigurationShrink)) {
            query.put("HttpsApplicationConfiguration", request.httpsApplicationConfigurationShrink);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.httpsBasicConfigurationShrink)) {
            query.put("HttpsBasicConfiguration", request.httpsBasicConfigurationShrink);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.imageTransformShrink)) {
            query.put("ImageTransform", request.imageTransformShrink);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.ipv6Shrink)) {
            query.put("Ipv6", request.ipv6Shrink);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.managedTransformsShrink)) {
            query.put("ManagedTransforms", request.managedTransformsShrink);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.networkOptimizationShrink)) {
            query.put("NetworkOptimization", request.networkOptimizationShrink);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.originProtectionShrink)) {
            query.put("OriginProtection", request.originProtectionShrink);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.originRulesShrink)) {
            query.put("OriginRules", request.originRulesShrink);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.redirectRulesShrink)) {
            query.put("RedirectRules", request.redirectRulesShrink);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.rewriteUrlRulesShrink)) {
            query.put("RewriteUrlRules", request.rewriteUrlRulesShrink);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.seoBypassShrink)) {
            query.put("SeoBypass", request.seoBypassShrink);
        }
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.siteNameExclusiveShrink)) {
            query.put("SiteNameExclusive", request.siteNameExclusiveShrink);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.sitePauseShrink)) {
            query.put("SitePause", request.sitePauseShrink);
        }
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.tieredCacheShrink)) {
            query.put("TieredCache", request.tieredCacheShrink);
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "CreateSiteFunction"),
            new TeaPair("version", "2024-09-10"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new CreateSiteFunctionResponse());
    }
     ...
     * @return CreateSiteFunctionResponse
     */
    public CreateSiteFunctionResponse createSiteFunction(CreateSiteFunctionRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
     ...
     */
    public DeleteSiteFunctionResponse deleteSiteFunctionWithOptions(DeleteSiteFunctionRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> query = new java.util.HashMap<>();
        if (!com.aliyun.teautil.Common.isUnset(request.configIds)) {
            query.put("ConfigIds", request.configIds);
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "DeleteSiteFunction"),
            new TeaPair("version", "2024-09-10"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new DeleteSiteFunctionResponse());
    }
     ...
     * @return DeleteSiteFunctionResponse
     */
    public DeleteSiteFunctionResponse deleteSiteFunction(DeleteSiteFunctionRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
     ...
     */
    public UpdateSiteFunctionResponse updateSiteFunctionWithOptions(UpdateSiteFunctionRequest tmpReq, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(tmpReq);
        UpdateSiteFunctionShrinkRequest request = new UpdateSiteFunctionShrinkRequest();
        com.aliyun.openapiutil.Client.convert(tmpReq, request);
        if (!com.aliyun.teautil.Common.isUnset(tmpReq.cacheReserve)) {
            request.cacheReserveShrink = com.aliyun.openapiutil.Client.arrayToStringWithSpecifiedStyle(tmpReq.cacheReserve, "CacheReserve", "json");
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "UpdateSiteFunction"),
            new TeaPair("version", "2024-09-10"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new UpdateSiteFunctionResponse());
    }
     ...
     * @return UpdateSiteFunctionResponse
     */
    public UpdateSiteFunctionResponse updateSiteFunction(UpdateSiteFunctionRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
