...
public class CreatePageShrinkRequest extends TeaModel {
    ...
    public static CreatePageShrinkRequest build(java.util.Map<String, ?> map) throws Exception {
        CreatePageShrinkRequest self = new CreatePageShrinkRequest();
        return TeaModel.build(map, self);
    }

    public CreatePageShrinkRequest setContent(String content) {
    ...
    public CreatePageShrinkRequest setContentType(String contentType) {
    ...
    public CreatePageShrinkRequest setDescription(String description) {
    ...
    public CreatePageShrinkRequest setName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CreatePageShrinkRequest setSiteIdsShrink(String siteIdsShrink) {
