...
public class CreateRoutineBuildConfigurationShrinkRequest extends TeaModel {
    /**
    ...
    public static CreateRoutineBuildConfigurationShrinkRequest build(java.util.Map<String, ?> map) throws Exception {
        CreateRoutineBuildConfigurationShrinkRequest self = new CreateRoutineBuildConfigurationShrinkRequest();
        return TeaModel.build(map, self);
    }

    public CreateRoutineBuildConfigurationShrinkRequest setAssetsDirectory(String assetsDirectory) {
    ...
    public CreateRoutineBuildConfigurationShrinkRequest setBuildBranches(String buildBranches) {
    ...
    public CreateRoutineBuildConfigurationShrinkRequest setBuildCommand(String buildCommand) {
    ...
    public CreateRoutineBuildConfigurationShrinkRequest setEnvironmentVariablesShrink(String environmentVariablesShrink) {
    ...
    public CreateRoutineBuildConfigurationShrinkRequest setGitAccountId(Long gitAccountId) {
    ...
    public CreateRoutineBuildConfigurationShrinkRequest setGitPlatform(String gitPlatform) {
    ...
    public CreateRoutineBuildConfigurationShrinkRequest setInstallCommand(String installCommand) {
    ...
    public CreateRoutineBuildConfigurationShrinkRequest setIsPrivate(Boolean isPrivate) {
    ...
    public CreateRoutineBuildConfigurationShrinkRequest setNodeVersion(String nodeVersion) {
    ...
    public CreateRoutineBuildConfigurationShrinkRequest setProductionBranch(String productionBranch) {
    ...
    public CreateRoutineBuildConfigurationShrinkRequest setRepository(String repository) {
    ...
    public CreateRoutineBuildConfigurationShrinkRequest setRootDirectory(String rootDirectory) {
    ...
    public CreateRoutineBuildConfigurationShrinkRequest setRoutineEntry(String routineEntry) {
    ...
    public CreateRoutineBuildConfigurationShrinkRequest setRoutineName(String routineName) {
    ...
    public CreateRoutineBuildConfigurationShrinkRequest setTemplateName(String templateName) {
