...
public class DescribeTraceDiagnoseReportResponseBody extends TeaModel {
    /**
     * <p>IP address of the local DNS server.</p>
     * 
    ...
    /**
     * <p>Expiration time. Timestamp in seconds.</p>
     * 
     * <strong>example:</strong>
     * <p>1678701915</p>
     */
    ...
    /**
     * <p>Status of the diagnostic link.</p>
     * <p>1: Active.
     * 0: Expired.</p>
     * 
     * <strong>example:</strong>
    ...
    /**
     * <p>Time consumed for report generation, in seconds.</p>
     * 
     * <strong>example:</strong>
     * <p>10</p>
     */
    ...
    public static class DescribeTraceDiagnoseReportResponseBodyReport extends TeaModel {
        ...
        /**
         * <p>Client request response header.</p>
         * 
         * <strong>example:</strong>
