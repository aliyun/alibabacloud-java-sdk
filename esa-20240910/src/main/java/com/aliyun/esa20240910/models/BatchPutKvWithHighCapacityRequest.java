...
public class BatchPutKvWithHighCapacityRequest extends TeaModel {
    ...
    public static BatchPutKvWithHighCapacityRequest build(java.util.Map<String, ?> map) throws Exception {
        BatchPutKvWithHighCapacityRequest self = new BatchPutKvWithHighCapacityRequest();
        return TeaModel.build(map, self);
    }

    public BatchPutKvWithHighCapacityRequest setNamespace(String namespace) {
    ...
    public BatchPutKvWithHighCapacityRequest setUrl(String url) {
        this.url = url;
        return this;
    }
