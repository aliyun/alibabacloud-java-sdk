...
public class BatchDeleteKvWithHighCapacityRequest extends TeaModel {
    ...
    /**
     * <p>The download URL that stores the key-value pairs to be batch deleted, such as an OSS download URL with read permissions.</p>
     * <ul>
     * <li><p>When calling this operation by using the SDK, the SDK automatically uploads the submitted content to OSS and passes the corresponding URL.</p>
     * </li>
     * <li><p>When calling this operation directly, upload the JSON payload (in the same format as the BatchDeleteKv body: {&quot;Namespace&quot;:&quot;...&quot;,&quot;Keys&quot;:[...]}) to an OSS bucket and generate a signed HTTPS GET URL.</p>
     * </li>
     * </ul>
     * <p>This parameter is required.</p>
     * 
