...
public class UpdateGatewayServiceResponseBody extends TeaModel {
    ...
    public UpdateGatewayServiceResponseBody setCode(Integer code) {
        this.code = code;
        return this;
    }
    ...
    public UpdateGatewayServiceResponseBody setData(Long data) {
        this.data = data;
        return this;
    }
    public Long getData() {
    ...
    public UpdateGatewayServiceResponseBody setHttpStatusCode(Integer httpStatusCode) {
    ...
    public UpdateGatewayServiceResponseBody setSuccess(Boolean success) {
