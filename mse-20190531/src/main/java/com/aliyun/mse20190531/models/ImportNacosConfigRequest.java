...
public class ImportNacosConfigRequest extends TeaModel {
    ...
    /**
     * <p>The URL of the file, which must be the URL generated by MSE. If the URL is not generated by MSE, a message stating that the required permissions on the API are not obtained is displayed. Perform the following steps to obtain the URL:</p>
     * <br>
     * <p>1\. Call the GetImportFileUrl operation to obtain the URL.</p>
     * <br>
     * <p>2\. Upload the file to the OSS address returned by the GetImportFileUrl operation.</p>
     * <br>
     * <p>3\. Call the ImportNacosConfig operation to import the file.</p>
     */
    @NameInMap("FileUrl")
