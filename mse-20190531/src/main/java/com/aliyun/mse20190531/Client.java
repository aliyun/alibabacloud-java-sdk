...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    public Client(Config config) throws Exception {
        ...
        this._endpointMap = TeaConverter.buildMap(
            new TeaPair("cn-chengdu", "mse.cn-chegndu.aliyuncs.com"),
            new TeaPair("ap-northeast-1", "mse. ap-northeast-1.aliyuncs.com"),
            new TeaPair("cn-shanghai-finance-1", "msefinance-share.cn-shanghai-finance-1.aliyuncs.com"),
            new TeaPair("cn-shenzhen-finance-1", "msefinance-share.cn-shenzhen-finance-1.aliyuncs.com")
        );
