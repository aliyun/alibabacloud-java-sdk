...
package com.aliyun.speechfiletranscriberlite20211221;

import com.aliyun.tea.*;
import com.aliyun.speechfiletranscriberlite20211221.models.*;
...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    public Client(Config config) throws Exception {
        ...
        this._endpoint = this.getEndpoint("speechfiletranscriberlite", _regionId, _endpointRule, _network, _suffix, _endpointMap, _endpoint);
    }
    ...
    public SubmitTaskResponse submitTaskWithOptions(SubmitTaskRequest request, RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new SubmitTaskResponse());
    }
