...
public class DescribeWebRulesResponseBody extends TeaModel {
    ...
    public static class DescribeWebRulesResponseBodyWebRules extends TeaModel {
         ...
         */
        @NameInMap("WafProtectionEnable")
        public Boolean wafProtectionEnable;
        ...
        public DescribeWebRulesResponseBodyWebRules setWafProtectionEnable(Boolean wafProtectionEnable) {
