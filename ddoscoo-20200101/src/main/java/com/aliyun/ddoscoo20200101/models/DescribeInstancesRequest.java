...
public class DescribeInstancesRequest extends TeaModel {
    ...
    /**
     * <p>The end of the time range to query. Instances whose expiration time is earlier than the point in time are queried.**** The value is a UNIX timestamp. Unit: milliseconds.</p>
     */
    @NameInMap("ExpireEndTime")
    public Long expireEndTime;

    /**
     * <p>The beginning of the time range to query. Instances whose expiration time is later than the point in time are queried.**** The value is a UNIX timestamp. Unit: milliseconds.</p>
     */
    ...
    /**
     * <p>The description of the instance to query. Fuzzy match is supported.</p>
     */
    @NameInMap("Remark")
    ...
    /**
     * <p>An array that consists of the states of the instances to query.</p>
     */
    @NameInMap("Status")
    public java.util.List<Integer> status;

    /**
     * <p>An array consisting of the tags that are added to the instance to query.</p>
     */
    @NameInMap("Tag")
