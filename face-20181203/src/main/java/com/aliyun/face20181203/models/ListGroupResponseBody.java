...
public class ListGroupResponseBody extends TeaModel {
    ...
    public ListGroupResponseBody setMessage(String message) {
    ...
    public ListGroupResponseBody setData(String data) {
        this.data = data;
        return this;
    }
    ...
    public ListGroupResponseBody setCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public ListGroupResponseBody setSuccess(Boolean success) {
