...
public class CreateAclPolicyResponseBody extends TeaModel {
    ...
    public static CreateAclPolicyResponseBody build(java.util.Map<String, ?> map) throws Exception {
        CreateAclPolicyResponseBody self = new CreateAclPolicyResponseBody();
        return TeaModel.build(map, self);
    }

    public CreateAclPolicyResponseBody setGatewayId(String gatewayId) {
