...
public class CreateRecycleBinDeleteJobRequest extends TeaModel {
     ...
     * <br>
     * <p>You can use the client to generate the token, but you must make sure that the token is unique among different requests. The token can contain only ASCII characters and cannot exceed 64 characters in length. For more information, see [How do I ensure the idempotence?](~~25693~~)</p>
     * <br>
     ...
     * <br>
     * <p>You can call the [ListRecycledDirectoriesAndFiles](~~264193~~) operation to query the value of the FileId parameter.</p>
     */
    @NameInMap("FileId")
