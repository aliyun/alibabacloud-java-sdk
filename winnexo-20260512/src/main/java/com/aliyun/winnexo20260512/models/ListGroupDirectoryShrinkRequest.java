...
public class ListGroupDirectoryShrinkRequest extends TeaModel {
    /**
    ...
    public static ListGroupDirectoryShrinkRequest build(java.util.Map<String, ?> map) throws Exception {
        ListGroupDirectoryShrinkRequest self = new ListGroupDirectoryShrinkRequest();
        return TeaModel.build(map, self);
    }

    public ListGroupDirectoryShrinkRequest setDirectoryId(String directoryId) {
    ...
    public ListGroupDirectoryShrinkRequest setGroupId(String groupId) {
    ...
    public ListGroupDirectoryShrinkRequest setPage(Long page) {
        this.page = page;
        return this;
    }
    public Long getPage() {
    ...
    public ListGroupDirectoryShrinkRequest setPageSize(Long pageSize) {
    ...
    public ListGroupDirectoryShrinkRequest setSortField(String sortField) {
    ...
    public ListGroupDirectoryShrinkRequest setSortOrder(String sortOrder) {
    ...
    public ListGroupDirectoryShrinkRequest setSourceStatus(String sourceStatus) {
    ...
    public ListGroupDirectoryShrinkRequest setSourceTypesShrink(String sourceTypesShrink) {
    ...
    public ListGroupDirectoryShrinkRequest setTenantId(String tenantId) {
