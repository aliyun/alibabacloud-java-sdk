...
public class ListScheduledTasksShrinkRequest extends TeaModel {
    /**
    ...
    public String visibilitiesShrink;

    public static ListScheduledTasksShrinkRequest build(java.util.Map<String, ?> map) throws Exception {
        ListScheduledTasksShrinkRequest self = new ListScheduledTasksShrinkRequest();
        return TeaModel.build(map, self);
    }

    public ListScheduledTasksShrinkRequest setCollaborationGroupId(String collaborationGroupId) {
    ...
    public ListScheduledTasksShrinkRequest setCreatorOnly(Boolean creatorOnly) {
    ...
    public ListScheduledTasksShrinkRequest setKeyword(String keyword) {
    ...
    public ListScheduledTasksShrinkRequest setMaxResults(Integer maxResults) {
    ...
    public ListScheduledTasksShrinkRequest setNextToken(String nextToken) {
    ...
    public ListScheduledTasksShrinkRequest setPage(Long page) {
        this.page = page;
        return this;
    }
    public Long getPage() {
    ...
    public ListScheduledTasksShrinkRequest setPageSize(Long pageSize) {
    ...
    public ListScheduledTasksShrinkRequest setTenantId(String tenantId) {
    ...
    public ListScheduledTasksShrinkRequest setVisibilitiesShrink(String visibilitiesShrink) {
        this.visibilitiesShrink = visibilitiesShrink;
        return this;
    }
    public String getVisibilitiesShrink() {
        return this.visibilitiesShrink;
    }
