...
public class MultiComplexResponseBody extends TeaModel {
    ...
    public MultiComplexResponseBody setStringValue(java.io.InputStream stringValue) {
    ...
    public static class MultiComplexResponseBodySecondOutputThirdList extends TeaModel {
        ...
        public MultiComplexResponseBodySecondOutputThirdList setThirdString(java.io.InputStream thirdString) {
    ...
    public static class MultiComplexResponseBodySecondOutput extends TeaModel {
        ...
        public MultiComplexResponseBodySecondOutput setSecondString(java.io.InputStream secondString) {
