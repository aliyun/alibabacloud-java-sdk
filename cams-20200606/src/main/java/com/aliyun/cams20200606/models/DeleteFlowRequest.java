...
public class DeleteFlowRequest extends TeaModel {
    ...
    public DeleteFlowRequest setOwnerId(Long ownerId) {
    ...
    public DeleteFlowRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public DeleteFlowRequest setResourceOwnerId(Long resourceOwnerId) {
