...
public class TriggerChatFlowRequest extends TeaModel {
    /**
    ...
    public static TriggerChatFlowRequest build(java.util.Map<String, ?> map) throws Exception {
        TriggerChatFlowRequest self = new TriggerChatFlowRequest();
        return TeaModel.build(map, self);
    }

    public TriggerChatFlowRequest setClaimTimeMillis(Long claimTimeMillis) {
    ...
    public TriggerChatFlowRequest setData(java.util.Map<String, ?> data) {
        this.data = data;
        return this;
    }
    ...
    public TriggerChatFlowRequest setDiscardTimeMillis(Long discardTimeMillis) {
    ...
    public TriggerChatFlowRequest setFlowCode(String flowCode) {
    ...
    public TriggerChatFlowRequest setOutId(String outId) {
        this.outId = outId;
        return this;
    }
    ...
    public TriggerChatFlowRequest setOwnerId(Long ownerId) {
    ...
    public TriggerChatFlowRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public TriggerChatFlowRequest setResourceOwnerId(Long resourceOwnerId) {
    ...
    public TriggerChatFlowRequest setUuid(String uuid) {
        this.uuid = uuid;
        return this;
    }
