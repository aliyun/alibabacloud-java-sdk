...
public class ListChatFlowShrinkRequest extends TeaModel {
    ...
    public ListChatFlowShrinkRequest setFlowCode(String flowCode) {
    ...
    public ListChatFlowShrinkRequest setFlowStatus(String flowStatus) {
    ...
    public ListChatFlowShrinkRequest setPhoneNumber(String phoneNumber) {
    ...
    public ListChatFlowShrinkRequest setTitle(String title) {
        this.title = title;
        return this;
    }
