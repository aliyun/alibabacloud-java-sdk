...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    /**
     * <b>summary</b> : 
     * <p>Retrieves the details of a session. You can only query sessions generated by your own account.</p>
     * 
     ...
     */
    public GetSessionContentResponse getSessionContentWithOptions(GetSessionContentRequest request, java.util.Map<String, String> headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "GetSessionContent"),
            new TeaPair("version", "2026-06-22"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/api/oss/agent/get_session_content.json"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new GetSessionContentResponse());
    }
     ...
     * @return GetSessionContentResponse
     */
    public GetSessionContentResponse getSessionContent(GetSessionContentRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        java.util.Map<String, String> headers = new java.util.HashMap<>();
