...
package com.aliyun.captcha20230305;
...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    public Client(com.aliyun.teaopenapi.models.Config config) throws Exception {
        ...
        this._endpoint = this.getEndpoint("captcha", _regionId, _endpointRule, _network, _suffix, _endpointMap, _endpoint);
    }
    ...
    public VerifyCaptchaResponse verifyCaptchaWithOptions(VerifyCaptchaRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.captchaVerifyParam)) {
            query.put("CaptchaVerifyParam", request.captchaVerifyParam);
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "VerifyCaptcha"),
            new TeaPair("version", "2023-03-05"),
    ...
    public VerifyIntelligentCaptchaResponse verifyIntelligentCaptchaWithOptions(VerifyIntelligentCaptchaRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "VerifyIntelligentCaptcha"),
            new TeaPair("version", "2023-03-05"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
