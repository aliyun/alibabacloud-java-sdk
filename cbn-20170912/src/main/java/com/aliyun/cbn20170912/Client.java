...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    public Client(Config config) throws Exception {
        ...
        this._endpointMap = TeaConverter.buildMap(
            ...
            new TeaPair("me-east-1", "cbn.aliyuncs.com"),
            ...
            new TeaPair("ap-northeast-2-pop", "cbn.aliyuncs.com"),
            new TeaPair("cn-beijing-finance-1", "cbn.aliyuncs.com"),
            new TeaPair("cn-beijing-finance-pop", "cbn.aliyuncs.com"),
            new TeaPair("cn-beijing-gov-1", "cbn.aliyuncs.com"),
            new TeaPair("cn-beijing-nu16-b01", "cbn.aliyuncs.com"),
            new TeaPair("cn-edge-1", "cbn.aliyuncs.com"),
            new TeaPair("cn-fujian", "cbn.aliyuncs.com"),
            new TeaPair("cn-haidian-cm12-c01", "cbn.aliyuncs.com"),
            new TeaPair("cn-hangzhou-bj-b01", "cbn.aliyuncs.com"),
            new TeaPair("cn-hangzhou-finance", "cbn.aliyuncs.com"),
            new TeaPair("cn-hangzhou-internal-prod-1", "cbn.aliyuncs.com"),
            new TeaPair("cn-hangzhou-internal-test-1", "cbn.aliyuncs.com"),
            new TeaPair("cn-hangzhou-internal-test-2", "cbn.aliyuncs.com"),
            new TeaPair("cn-hangzhou-internal-test-3", "cbn.aliyuncs.com"),
            new TeaPair("cn-hangzhou-test-306", "cbn.aliyuncs.com"),
            new TeaPair("cn-hongkong-finance-pop", "cbn.aliyuncs.com"),
            new TeaPair("cn-huhehaote-nebula-1", "cbn.aliyuncs.com"),
            new TeaPair("cn-qingdao-nebula", "cbn.aliyuncs.com"),
            new TeaPair("cn-shanghai-et15-b01", "cbn.aliyuncs.com"),
            new TeaPair("cn-shanghai-et2-b01", "cbn.aliyuncs.com"),
            new TeaPair("cn-shanghai-inner", "cbn.aliyuncs.com"),
            new TeaPair("cn-shanghai-internal-test-1", "cbn.aliyuncs.com"),
            new TeaPair("cn-shenzhen-inner", "cbn.aliyuncs.com"),
            new TeaPair("cn-shenzhen-st4-d01", "cbn.aliyuncs.com"),
            new TeaPair("cn-shenzhen-su18-b01", "cbn.aliyuncs.com"),
            new TeaPair("cn-wuhan", "cbn.aliyuncs.com"),
            new TeaPair("cn-yushanfang", "cbn.aliyuncs.com"),
            new TeaPair("cn-zhangbei", "cbn.aliyuncs.com"),
            new TeaPair("cn-zhangbei-na61-b01", "cbn.aliyuncs.com"),
            new TeaPair("cn-zhangjiakou-na62-a01", "cbn.aliyuncs.com"),
            new TeaPair("cn-zhengzhou-nebula-1", "cbn.aliyuncs.com"),
            new TeaPair("eu-west-1-oxs", "cbn.aliyuncs.com"),
            new TeaPair("rus-west-1-pop", "cbn-share.aliyuncs.com")
        );
