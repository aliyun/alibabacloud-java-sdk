...
public class DeleteTransitRouterEcrAttachmentRequest extends TeaModel {
     ...
     * <ul>
     * <li><strong>false</strong> (default): Sends a normal request. If the request passes the check, the configuration of the inter-region connection is directly modified.</li>
     * <li><strong>true</strong>: Sends a check request. Only the verification is performed, and the configuration of the inter-region connection is not modified. The check items include whether required parameters are specified and the request format. If the check fails, the corresponding error is returned. If the check passes, the corresponding request ID is returned.</li>
     * </ul>
     * 
     * <strong>example:</strong>
     * <p>false</p>
    ...
    /**
     * <p>Specifies whether to forcefully delete the ECR connection. Valid values:</p>
     * <ul>
     * <li><strong>false</strong> (default): Before the ECR connection is deleted, the system checks whether related resource dependencies exist, such as associated forwarding and route learning. If related dependencies exist, the ECR connection cannot be deleted and the corresponding error is returned.</li>
     * <li><strong>true</strong>: When the ECR connection is deleted, all related dependencies are deleted by default.</li>
     * </ul>
     * 
     * <strong>example:</strong>
     * <p>false</p>
