...
public class AssociateTransitRouterAttachmentWithRouteTableRequest extends TeaModel {
     ...
     * <br>
     * <p>*   **false** (default): sends the request. If the request passes the precheck, the associated forwarding correlation is created.</p>
     * <p>*   **true**: sends a request for precheck only. The associated forwarding correlation is not created after the request passes the precheck. If you use this value, the system checks the required parameters and the request syntax. If the request fails to pass the precheck, an error message is returned. If the request passes the check, the system returns the ID of the request.</p>
     */
    @NameInMap("DryRun")
