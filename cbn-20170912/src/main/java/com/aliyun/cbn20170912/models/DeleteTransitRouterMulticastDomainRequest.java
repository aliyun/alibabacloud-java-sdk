...
public class DeleteTransitRouterMulticastDomainRequest extends TeaModel {
     ...
     * <p>Generate a token on your client to make sure that it is unique among different requests. The token can contain only ASCII characters.</p>
     * 
     ...
     * </li>
     * <li><p><strong>false</strong> (default): performs a normal request. If the request passes the check, the multicast domain is deleted.</p>
     * </li>
     * </ul>
     * 
     * <strong>example:</strong>
