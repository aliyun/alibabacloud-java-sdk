...
public class DeleteIpamPoolRequest extends TeaModel {
    /**
    ...
    public static DeleteIpamPoolRequest build(java.util.Map<String, ?> map) throws Exception {
        DeleteIpamPoolRequest self = new DeleteIpamPoolRequest();
        return TeaModel.build(map, self);
    }

    public DeleteIpamPoolRequest setClientToken(String clientToken) {
    ...
    public DeleteIpamPoolRequest setDryRun(Boolean dryRun) {
        this.dryRun = dryRun;
        return this;
    }
    ...
    public DeleteIpamPoolRequest setIpamPoolId(String ipamPoolId) {
    ...
    public DeleteIpamPoolRequest setOwnerAccount(String ownerAccount) {
    ...
    public DeleteIpamPoolRequest setOwnerId(Long ownerId) {
    ...
    public DeleteIpamPoolRequest setRegionId(String regionId) {
    ...
    public DeleteIpamPoolRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public DeleteIpamPoolRequest setResourceOwnerId(Long resourceOwnerId) {
