...
public class DataSolutionSegmentBaggageMappingListPassengerBaggageAllowanceMappingValue extends TeaModel {
    ...
    public DataSolutionSegmentBaggageMappingListPassengerBaggageAllowanceMappingValue setCarryLength(Integer carryLength) {
    ...
    public DataSolutionSegmentBaggageMappingListPassengerBaggageAllowanceMappingValue setCarryWidth(Integer carryWidth) {
    ...
    public DataSolutionSegmentBaggageMappingListPassengerBaggageAllowanceMappingValue setCarryHeight(Integer carryHeight) {
    ...
    public DataSolutionSegmentBaggageMappingListPassengerBaggageAllowanceMappingValue setCarrySumOfLengthWidthHeight(Integer carrySumOfLengthWidthHeight) {
    ...
    public DataSolutionSegmentBaggageMappingListPassengerBaggageAllowanceMappingValue setLength(Integer length) {
        this.length = length;
        return this;
    }
    ...
    public DataSolutionSegmentBaggageMappingListPassengerBaggageAllowanceMappingValue setWidth(Integer width) {
        this.width = width;
        return this;
    }
    ...
    public DataSolutionSegmentBaggageMappingListPassengerBaggageAllowanceMappingValue setHeight(Integer height) {
        this.height = height;
        return this;
    }
    ...
    public DataSolutionSegmentBaggageMappingListPassengerBaggageAllowanceMappingValue setSumOfLengthWidthHeight(Integer sumOfLengthWidthHeight) {
