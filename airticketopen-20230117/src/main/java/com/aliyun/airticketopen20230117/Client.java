...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    public ChangeReShopResponse changeReShopWithOptions(ChangeReShopRequest tmpReq, ChangeReShopHeaders headers, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(tmpReq);
        ChangeReShopShrinkRequest request = new ChangeReShopShrinkRequest();
        com.aliyun.openapiutil.Client.convert(tmpReq, request);
        ...
        if (!com.aliyun.teautil.Common.isUnset(tmpReq.passengers)) {
            request.passengersShrink = com.aliyun.openapiutil.Client.arrayToStringWithSpecifiedStyle(tmpReq.passengers, "passengers", "json");
        }
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.passengersShrink)) {
            body.put("passengers", request.passengersShrink);
        }
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "ChangeReShop"),
            new TeaPair("version", "2023-01-17"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/airticket/v1/change/action-reshop"),
            new TeaPair("method", "POST"),
            new TeaPair("authType", "AK"),
            new TeaPair("style", "ROA"),
            new TeaPair("reqBodyType", "formData"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new ChangeReShopResponse());
    }

    public ChangeReShopResponse changeReShop(ChangeReShopRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        ChangeReShopHeaders headers = new ChangeReShopHeaders();
        return this.changeReShopWithOptions(request, headers, runtime);
    }
