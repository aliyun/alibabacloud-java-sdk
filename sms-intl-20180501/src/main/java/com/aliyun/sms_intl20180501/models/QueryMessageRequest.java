...
public class QueryMessageRequest extends TeaModel {
    ...
    public QueryMessageRequest setOwnerId(Long ownerId) {
    ...
    public QueryMessageRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public QueryMessageRequest setResourceOwnerId(Long resourceOwnerId) {
