...
public class DescribeClusterAddonUpgradeStatusResponse extends TeaModel {
    ...
    public DescribeClusterAddonUpgradeStatusResponse setStatusCode(Integer statusCode) {
    ...
    public DescribeClusterAddonUpgradeStatusResponse setBody(java.util.Map<String, ?> body) {
        this.body = body;
        return this;
    }
