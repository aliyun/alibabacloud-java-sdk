...
public class RunAbbreviationContentResponseBody extends TeaModel {
    /**
     * <p>Indicates whether the output is complete. True means it is complete.</p>
     */
    @NameInMap("End")
    public Boolean end;

    /**
     * <p>The streaming output header, which contains general return information.</p>
     */
    @NameInMap("Header")
    public RunAbbreviationContentResponseBodyHeader header;

    /**
     * <p>Result payload, JSON structure</p>
     */
    @NameInMap("Payload")
    ...
    public static class RunAbbreviationContentResponseBodyHeader extends TeaModel {
        ...
        /**
         * <p>The session ID for a single session.</p>
         * 
         * <strong>example:</strong>
        ...
        /**
         * <p>The task ID for a single generation task.</p>
         * 
         * <strong>example:</strong>
         * <p>d3be9981-ca2d-4e17-bf31-1c0a628e9f99</p>
         */
        ...
        /**
         * <p>Trace ID for the request chain.</p>
         * 
         * <strong>example:</strong>
