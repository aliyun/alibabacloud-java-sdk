...
public class RunExpandContentResponseBody extends TeaModel {
    ...
    /**
     * <p>Streaming output header, containing general return information.</p>
     */
    @NameInMap("Header")
    public RunExpandContentResponseBodyHeader header;

    /**
     * <p>Payload of the returned result, JSON structure.</p>
     */
    @NameInMap("Payload")
    ...
    public static class RunExpandContentResponseBodyHeader extends TeaModel {
        ...
        /**
         * <p>Error message for exceptions.</p>
         * 
         * <strong>example:</strong>
        ...
        /**
         * <p>Session ID for a single session.</p>
         * 
         * <strong>example:</strong>
        ...
        /**
         * <p>Task ID for a single generation task.</p>
         * 
         * <strong>example:</strong>
         * <p>d3be9981-ca2d-4e17-bf31-1c0a628e9f99</p>
         */
