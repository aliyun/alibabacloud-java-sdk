...
public class RunExpandContentRequest extends TeaModel {
    ...
    public static RunExpandContentRequest build(java.util.Map<String, ?> map) throws Exception {
        RunExpandContentRequest self = new RunExpandContentRequest();
        return TeaModel.build(map, self);
    }

    public RunExpandContentRequest setContent(String content) {
