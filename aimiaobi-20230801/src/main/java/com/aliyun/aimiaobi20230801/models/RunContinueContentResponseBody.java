...
public class RunContinueContentResponseBody extends TeaModel {
    /**
     * <p>Is output complete? True indicates completion.</p>
     */
    @NameInMap("End")
    public Boolean end;

    /**
     * <p>Streaming output header, contains general return information.</p>
     */
    @NameInMap("Header")
