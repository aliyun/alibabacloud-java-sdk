...
public class OperateRerunJobResponseBody extends TeaModel {
    /**
     * <p>The response code. A value of <code>200</code> indicates that the request succeeded.</p>
     * 
    ...
    /**
     * <p>A unique identifier for the request, generated by Alibaba Cloud. Use this ID for troubleshooting.</p>
     * 
     * <strong>example:</strong>
