...
public class GetProjectRequest extends TeaModel {
    ...
    public GetProjectRequest setOperatorId(String operatorId) {
    ...
    public GetProjectRequest setOperatorType(String operatorType) {
    ...
    public GetProjectRequest setProjectId(String projectId) {
