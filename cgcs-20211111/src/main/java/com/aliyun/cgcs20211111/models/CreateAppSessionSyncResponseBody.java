...
public class CreateAppSessionSyncResponseBody extends TeaModel {
    ...
    public static class CreateAppSessionSyncResponseBodyBizInfoBiz extends TeaModel {
        @NameInMap("Key")
        public String key;
        ...
        public static CreateAppSessionSyncResponseBodyBizInfoBiz build(java.util.Map<String, ?> map) throws Exception {
            CreateAppSessionSyncResponseBodyBizInfoBiz self = new CreateAppSessionSyncResponseBodyBizInfoBiz();
            return TeaModel.build(map, self);
        }

        public CreateAppSessionSyncResponseBodyBizInfoBiz setKey(String key) {
            this.key = key;
            return this;
        }
        ...
        public CreateAppSessionSyncResponseBodyBizInfoBiz setValue(String value) {
            this.value = value;
            return this;
        }
    ...
    public static class CreateAppSessionSyncResponseBodyBizInfo extends TeaModel {
        @NameInMap("Biz")
        public java.util.List<CreateAppSessionSyncResponseBodyBizInfoBiz> biz;
        ...
        public CreateAppSessionSyncResponseBodyBizInfo setBiz(java.util.List<CreateAppSessionSyncResponseBodyBizInfoBiz> biz) {
            this.biz = biz;
            return this;
        }
        public java.util.List<CreateAppSessionSyncResponseBodyBizInfoBiz> getBiz() {
            return this.biz;
        }
