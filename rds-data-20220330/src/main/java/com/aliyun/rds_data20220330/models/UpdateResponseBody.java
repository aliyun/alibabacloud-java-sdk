...
public class UpdateResponseBody extends TeaModel {
    ...
    public UpdateResponseBody setCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public UpdateResponseBody setData(UpdateResult data) {
        this.data = data;
        return this;
    }
    ...
    public UpdateResponseBody setMessage(String message) {
    ...
    public UpdateResponseBody setRequestId(String requestId) {
    ...
    public UpdateResponseBody setSuccess(Boolean success) {
