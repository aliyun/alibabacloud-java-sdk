...
public class RunInstancesShrinkRequest extends TeaModel {
    ...
    public RunInstancesShrinkRequest setIpv6AddressCount(Long ipv6AddressCount) {
    ...
    public RunInstancesShrinkRequest setLaunchTemplateId(String launchTemplateId) {
    ...
    public RunInstancesShrinkRequest setLaunchTemplateName(String launchTemplateName) {
    ...
    public RunInstancesShrinkRequest setLaunchTemplateVersion(Integer launchTemplateVersion) {
