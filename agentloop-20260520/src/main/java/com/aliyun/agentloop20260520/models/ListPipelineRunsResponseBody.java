...
public class ListPipelineRunsResponseBody extends TeaModel {
     ...
     */
    @NameInMap("runs")
    public java.util.List<ListPipelineRunsResponseBodyRuns> runs;
    ...
    public ListPipelineRunsResponseBody setMaxResults(Integer maxResults) {
    ...
    public ListPipelineRunsResponseBody setRuns(java.util.List<ListPipelineRunsResponseBodyRuns> runs) {
        this.runs = runs;
        return this;
    }
    public java.util.List<ListPipelineRunsResponseBodyRuns> getRuns() {
        return this.runs;
    }

    public ListPipelineRunsResponseBody setTotalCount(Integer totalCount) {
    ...
    public static class ListPipelineRunsResponseBodyRuns extends TeaModel {
        /**
        ...
        public static ListPipelineRunsResponseBodyRuns build(java.util.Map<String, ?> map) throws Exception {
            ListPipelineRunsResponseBodyRuns self = new ListPipelineRunsResponseBodyRuns();
            return TeaModel.build(map, self);
        }

        public ListPipelineRunsResponseBodyRuns setAgentSpaceName(String agentSpaceName) {
        ...
        public ListPipelineRunsResponseBodyRuns setAttempt(Integer attempt) {
        ...
        public ListPipelineRunsResponseBodyRuns setErrorCode(String errorCode) {
        ...
        public ListPipelineRunsResponseBodyRuns setErrorMessage(String errorMessage) {
        ...
        public ListPipelineRunsResponseBodyRuns setFinishTime(String finishTime) {
        ...
        public ListPipelineRunsResponseBodyRuns setFromTime(Long fromTime) {
        ...
        public ListPipelineRunsResponseBodyRuns setMaxAttempts(Integer maxAttempts) {
        ...
        public ListPipelineRunsResponseBodyRuns setNextRetryTime(String nextRetryTime) {
        ...
        public ListPipelineRunsResponseBodyRuns setPipelineName(String pipelineName) {
        ...
        public ListPipelineRunsResponseBodyRuns setRunId(String runId) {
            this.runId = runId;
            return this;
        }
        ...
        public ListPipelineRunsResponseBodyRuns setStartTime(String startTime) {
        ...
        public ListPipelineRunsResponseBodyRuns setStats(java.util.Map<String, ?> stats) {
            this.stats = stats;
            return this;
        }
        ...
        public ListPipelineRunsResponseBodyRuns setStatus(String status) {
            this.status = status;
            return this;
        }
        ...
        public ListPipelineRunsResponseBodyRuns setToTime(Long toTime) {
            this.toTime = toTime;
            return this;
        }
        ...
        public ListPipelineRunsResponseBodyRuns setTriggerTime(String triggerTime) {
        ...
        public ListPipelineRunsResponseBodyRuns setTriggerType(String triggerType) {
