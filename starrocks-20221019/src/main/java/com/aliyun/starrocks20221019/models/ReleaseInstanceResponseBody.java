...
public class ReleaseInstanceResponseBody extends TeaModel {
    ...
    public ReleaseInstanceResponseBody setAccessDeniedDetail(String accessDeniedDetail) {
    ...
    public ReleaseInstanceResponseBody setData(Boolean data) {
        this.data = data;
        return this;
    }
    ...
    public ReleaseInstanceResponseBody setErrCode(String errCode) {
    ...
    public ReleaseInstanceResponseBody setErrMessage(String errMessage) {
    ...
    public ReleaseInstanceResponseBody setHttpStatusCode(Integer httpStatusCode) {
