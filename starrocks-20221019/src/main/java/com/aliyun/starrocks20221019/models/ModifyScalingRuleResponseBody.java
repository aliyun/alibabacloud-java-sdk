...
public class ModifyScalingRuleResponseBody extends TeaModel {
    ...
    public ModifyScalingRuleResponseBody setAccessDeniedDetail(String accessDeniedDetail) {
    ...
    public ModifyScalingRuleResponseBody setData(Boolean data) {
        this.data = data;
        return this;
    }
    ...
    public ModifyScalingRuleResponseBody setErrCode(String errCode) {
    ...
    public ModifyScalingRuleResponseBody setErrMessage(String errMessage) {
    ...
    public ModifyScalingRuleResponseBody setHttpStatusCode(Integer httpStatusCode) {
    ...
    public ModifyScalingRuleResponseBody setSuccess(Boolean success) {
