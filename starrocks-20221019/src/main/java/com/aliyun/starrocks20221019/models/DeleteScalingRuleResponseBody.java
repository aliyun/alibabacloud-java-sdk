...
public class DeleteScalingRuleResponseBody extends TeaModel {
    ...
    public DeleteScalingRuleResponseBody setAccessDeniedDetail(String accessDeniedDetail) {
    ...
    public DeleteScalingRuleResponseBody setErrCode(String errCode) {
    ...
    public DeleteScalingRuleResponseBody setErrMessage(String errMessage) {
    ...
    public DeleteScalingRuleResponseBody setHttpStatusCode(Integer httpStatusCode) {
    ...
    public DeleteScalingRuleResponseBody setSuccess(Boolean success) {
