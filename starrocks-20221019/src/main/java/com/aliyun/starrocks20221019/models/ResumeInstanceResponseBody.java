...
public class ResumeInstanceResponseBody extends TeaModel {
    ...
    public ResumeInstanceResponseBody setAccessDeniedDetail(String accessDeniedDetail) {
    ...
    public ResumeInstanceResponseBody setErrCode(String errCode) {
    ...
    public ResumeInstanceResponseBody setErrMessage(String errMessage) {
