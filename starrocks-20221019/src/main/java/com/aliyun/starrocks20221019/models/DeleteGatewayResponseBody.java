...
public class DeleteGatewayResponseBody extends TeaModel {
    ...
    public DeleteGatewayResponseBody setData(Boolean data) {
        this.data = data;
        return this;
    }
    ...
    public DeleteGatewayResponseBody setErrCode(String errCode) {
    ...
    public DeleteGatewayResponseBody setErrMessage(String errMessage) {
