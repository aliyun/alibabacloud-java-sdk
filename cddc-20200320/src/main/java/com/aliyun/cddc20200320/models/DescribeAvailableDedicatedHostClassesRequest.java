...
public class DescribeAvailableDedicatedHostClassesRequest extends TeaModel {
    ...
    public DescribeAvailableDedicatedHostClassesRequest setOwnerId(Long ownerId) {
    ...
    public DescribeAvailableDedicatedHostClassesRequest setResourceOwnerId(Long resourceOwnerId) {
    ...
    public DescribeAvailableDedicatedHostClassesRequest setDbType(String dbType) {
        this.dbType = dbType;
        return this;
    }
