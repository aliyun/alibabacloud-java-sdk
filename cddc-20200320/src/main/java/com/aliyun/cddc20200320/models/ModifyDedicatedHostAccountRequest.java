...
public class ModifyDedicatedHostAccountRequest extends TeaModel {
    ...
    public ModifyDedicatedHostAccountRequest setOwnerId(Long ownerId) {
    ...
    public ModifyDedicatedHostAccountRequest setResourceOwnerAccount(String resourceOwnerAccount) {
    ...
    public ModifyDedicatedHostAccountRequest setResourceOwnerId(Long resourceOwnerId) {
