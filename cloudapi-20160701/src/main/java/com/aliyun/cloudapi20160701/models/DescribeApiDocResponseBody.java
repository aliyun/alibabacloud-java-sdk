...
public class DescribeApiDocResponseBody extends TeaModel {
    ...
    public static class DescribeApiDocResponseBodyRequestBodyRequestParam extends TeaModel {
        ...
        public DescribeApiDocResponseBodyRequestBodyRequestParam setArrayItemsType(String arrayItemsType) {
    ...
    public static class DescribeApiDocResponseBodyRequestHeadersRequestParam extends TeaModel {
        ...
        public DescribeApiDocResponseBodyRequestHeadersRequestParam setArrayItemsType(String arrayItemsType) {
            this.arrayItemsType = arrayItemsType;
            return this;
        }
        public String getArrayItemsType() {
    ...
    public static class DescribeApiDocResponseBodyRequestQueriesRequestParam extends TeaModel {
        ...
        public DescribeApiDocResponseBodyRequestQueriesRequestParam setArrayItemsType(String arrayItemsType) {
            this.arrayItemsType = arrayItemsType;
            return this;
        }
        public String getArrayItemsType() {
