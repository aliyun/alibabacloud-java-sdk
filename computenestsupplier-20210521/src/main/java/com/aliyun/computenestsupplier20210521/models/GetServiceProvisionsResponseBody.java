...
public class GetServiceProvisionsResponseBody extends TeaModel {
    ...
    public static class GetServiceProvisionsResponseBodyServiceProvisionsRoleProvisionRolesApiForCreation extends TeaModel {
        ...
        /**
         * <p>The parameters of the API operation. ${Variable name} indicates a dynamic parameter.</p>
         * 
         * <strong>example:</strong>
    ...
    public static class GetServiceProvisionsResponseBodyServiceProvisions extends TeaModel {
        ...
        /**
         * <p>The information about the RAM roles of the cloud service. If this parameter is empty, no RAM roles is associated with the service.</p>
         */
        ...
        /**
         * <p>The activation status of the cloud service. Valid values:</p>
         * <ul>
         * <li>Enabled: The cloud service is activated.</li>
         * <li>EnabledByDefault: The cloud service is activated by default.</li>
         * <li>Disabled: The cloud service is not activated.</li>
         * <li>Unknown: The activation status of the cloud service is unknown.</li>
         * </ul>
         * 
         * <strong>example:</strong>
         * <p>Enabled</p>
         ...
         * 
         * <strong>example:</strong>
         * <p>resource(Eip) import info missing</p>
         */
