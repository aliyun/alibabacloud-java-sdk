...
public class ListSecretsRequest extends TeaModel {
    ...
    public ListSecretsRequest setDBInstanceId(String DBInstanceId) {
    ...
    public ListSecretsRequest setOwnerId(Long ownerId) {
    ...
    public ListSecretsRequest setRegionId(String regionId) {
    ...
    public ListSecretsRequest setWorkspaceId(String workspaceId) {
