...
public class ListDatabasesRequest extends TeaModel {
    ...
    public ListDatabasesRequest setDBInstanceId(String DBInstanceId) {
    ...
    public ListDatabasesRequest setDatabase(String database) {
    ...
    public ListDatabasesRequest setNextToken(String nextToken) {
    ...
    public ListDatabasesRequest setOwnerId(Long ownerId) {
    ...
    public ListDatabasesRequest setSecretArn(String secretArn) {
