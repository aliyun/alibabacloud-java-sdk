...
public class CreateDocumentCollectionRequest extends TeaModel {
    ...
    public static class CreateDocumentCollectionRequestSparseVectorIndexConfig extends TeaModel {
        ...
        /**
         * <p>The size of the candidate set (<code>ef_construction</code>) for HNSW index construction. Valid values: 4 to 1,000. The default value is 64.</p>
         * <blockquote>
         * <p>This parameter is applicable only to AnalyticDB for PostgreSQL V7.0 instances, and its value must be greater than or equal to <code>2 * HnswM</code>.</p>
         * </blockquote>
         * 
         * <strong>example:</strong>
         * <p>128</p>
    ...
    public static class CreateDocumentCollectionRequestVectorIndexConfig extends TeaModel {
        /**
         * <p>The number of lists (partitions) for the novad algorithm. Valid values: [2, 1073741824]. The default value is 256.</p>
         * 
         * <strong>example:</strong>
         * <p>256</p>
         */
        ...
        /**
         * <p>The number of bits used for rabitq compression. Valid values: [1, 8]. The default value is 3.</p>
         * 
         * <strong>example:</strong>
         * <p>3</p>
         */
