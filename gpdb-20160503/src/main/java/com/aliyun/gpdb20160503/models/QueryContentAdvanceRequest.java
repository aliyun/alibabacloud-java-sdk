...
public class QueryContentAdvanceRequest extends TeaModel {
    ...
    public QueryContentAdvanceRequest setUrlExpiration(String urlExpiration) {
    ...
    public static class QueryContentAdvanceRequestGraphSearchArgs extends TeaModel {
        /**
         * <p>The number of top entities and relationship edges to return. The default value is <code>60</code>.</p>
         * 
         * <strong>example:</strong>
         * <p>60</p>
         */
    ...
    public static class QueryContentAdvanceRequestRerankModel extends TeaModel {
        /**
         * <p>This parameter is available only when <code>RerankModel.Name</code> is set to <code>qwen3-rerank</code>.
         * You can add a custom task description to guide the model\&quot;s sorting strategy.</p>
         * 
         * <strong>example:</strong>
        ...
        /**
         * <p>The name of the reranking model. Valid values: <code>qwen3-rerank</code>, <code>gte-rerank-v2</code>.</p>
         * 
         * <strong>example:</strong>
         * <p>qwen3-rerank</p>
         */
