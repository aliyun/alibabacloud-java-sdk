...
public class QueryContentAdvanceRequest extends TeaModel {
    ...
    public static class QueryContentAdvanceRequestRerankModel extends TeaModel {
        /**
         * <p>This parameter can be set when RerankModel.Name is qwen3-rerank. Specifies a custom sorting task type description that guides the model to adopt different sorting strategies.</p>
         * 
         * <strong>example:</strong>
        ...
        /**
         * <p>The rerank model name. Valid values: qwen3-rerank, gte-rerank-v2.</p>
         * 
         * <strong>example:</strong>
         * <p>qwen3-rerank</p>
         */
        ...
        public QueryContentAdvanceRequestRerankModel setRerankMetadataFields(String rerankMetadataFields) {
