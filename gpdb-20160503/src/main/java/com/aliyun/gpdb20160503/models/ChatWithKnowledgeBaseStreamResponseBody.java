...
public class ChatWithKnowledgeBaseStreamResponseBody extends TeaModel {
    ...
    /**
     * <p>The retrieval results from multiple knowledge bases.</p>
     */
    ...
    public static class ChatWithKnowledgeBaseStreamResponseBodyChatCompletionChoicesMessageToolCallsFunction extends TeaModel {
        /**
         * <p>The arguments for the function call, generated by the model in JSON format.</p>
         * 
         * <strong>example:</strong>
         * <p>{&quot;city&quot;:&quot;hangzhou&quot;}</p>
         */
    ...
    public static class ChatWithKnowledgeBaseStreamResponseBodyChatCompletionChoicesMessageToolCalls extends TeaModel {
        /**
         * <p>Details of the function that the model wants to call.</p>
         */
        @NameInMap("Function")
        ...
        /**
         * <p>The index of the tool in the <code>Input</code> parameter of the request, starting from 0.</p>
         * 
         * <strong>example:</strong>
         * <p>1</p>
         */
    ...
    public static class ChatWithKnowledgeBaseStreamResponseBodyChatCompletionChoicesMessage extends TeaModel {
        ...
        /**
         * <p>The model\&quot;s chain of thought (CoT) content.</p>
         * 
         * <strong>example:</strong>
    ...
    public static class ChatWithKnowledgeBaseStreamResponseBodyChatCompletionChoices extends TeaModel {
        /**
         * <p>The reason the model stopped generating output.</p>
         * 
         * <strong>example:</strong>
         * <p>finish</p>
         */
        ...
        /**
         * <p>The response from the large language model (LLM).</p>
         */
        @NameInMap("Message")
    ...
    public static class ChatWithKnowledgeBaseStreamResponseBodyChatCompletionUsagePromptTokensDetails extends TeaModel {
        /**
         * <p>The number of prompt tokens served from the cache.</p>
         * 
         * <strong>example:</strong>
         * <p>24</p>
         */
    ...
    public static class ChatWithKnowledgeBaseStreamResponseBodyChatCompletionUsage extends TeaModel {
        ...
        /**
         * <p>Details about the prompt token usage.</p>
         */
    ...
    public static class ChatWithKnowledgeBaseStreamResponseBodyChatCompletion extends TeaModel {
        ...
        /**
         * <p>The token usage statistics for the completion.</p>
         */
        @NameInMap("Usage")
    ...
    public static class ChatWithKnowledgeBaseStreamResponseBodyMultiCollectionRecallResultMatches extends TeaModel {
        ...
        /**
         * <p>The public URL of the retrieved image. By default, the URL is valid for 2 hours.</p>
         * <p>You can use the <code>UrlExpiration</code> parameter to specify a custom validity period.</p>
         * 
         * <strong>example:</strong>
        ...
        /**
         * <p>The unique ID of the vector record.</p>
         * <blockquote>
         * <p>If this parameter is left empty, the database automatically generates a UUID. If you provide an ID that conflicts with an existing one, the existing record is updated with the data from the request.</p>
         * </blockquote>
         * 
         * <strong>example:</strong>
         * <p>273e3fc7-8f56-4167-a1bb-d35d2f3b9043</p>
        ...
        /**
         * <p>Metadata from the document loader, captured during document ingestion.</p>
         * 
         * <strong>example:</strong>
         * <p>{&quot;page&quot;:1}</p>
         */
        ...
        /**
         * <p>The source of the match. <code>1</code> indicates vector search, <code>2</code> indicates full-text search, and <code>3</code> indicates hybrid recall.</p>
         * 
         * <strong>example:</strong>
         * <p>0.12</p>
         */
        ...
        /**
         * <p>The similarity score. The score is calculated based on the distance metric specified when the index was created (<code>l2/ip/cosine</code>).</p>
         * 
         * <strong>example:</strong>
         * <p>10</p>
         */
    ...
    public static class ChatWithKnowledgeBaseStreamResponseBodyMultiCollectionRecallResultUsage extends TeaModel {
        /**
         * <p>The number of tokens used for embedding.</p>
         * <blockquote>
         * <p>A token is the smallest unit created by splitting the input text. A token can be a unit such as a word, a phrase, a punctuation mark, or a character.</p>
         * </blockquote>
         * 
         * <strong>example:</strong>
         * <p>158</p>
    ...
    public static class ChatWithKnowledgeBaseStreamResponseBodyMultiCollectionRecallResult extends TeaModel {
        ...
        /**
         * <p>The status of the API call. Valid values:</p>
         * <ul>
         * <li><p><strong>success</strong>: The call succeeded.</p>
         * </li>
         * <li><p><strong>fail</strong>: The call failed.</p>
         * </li>
         * </ul>
         * 
         * <strong>example:</strong>
        ...
        /**
         * <p>The number of tokens consumed for embedding.</p>
         */
        @NameInMap("Usage")
