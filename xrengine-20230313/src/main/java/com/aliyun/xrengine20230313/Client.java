...
public class Client extends com.aliyun.teaopenapi.Client {
    ...
    public LoginHuggingFaceResponse loginHuggingFaceWithOptions(LoginHuggingFaceRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        java.util.Map<String, Object> body = new java.util.HashMap<>();
        ...
        com.aliyun.teaopenapi.models.Params params = com.aliyun.teaopenapi.models.Params.build(TeaConverter.buildMap(
            new TeaPair("action", "LoginHuggingFace"),
            new TeaPair("version", "2023-03-13"),
            new TeaPair("protocol", "HTTPS"),
            new TeaPair("pathname", "/"),
            new TeaPair("method", "POST"),
        ...
        return TeaModel.toModel(this.callApi(params, req, runtime), new LoginHuggingFaceResponse());
    }

    public LoginHuggingFaceResponse loginHuggingFace(LoginHuggingFaceRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
