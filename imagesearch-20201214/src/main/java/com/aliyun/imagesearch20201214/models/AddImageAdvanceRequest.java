...
public class AddImageAdvanceRequest extends TeaModel {
    ...
    public AddImageAdvanceRequest setIntAttr3(Integer intAttr3) {
    ...
    public AddImageAdvanceRequest setIntAttr4(Integer intAttr4) {
    ...
    public AddImageAdvanceRequest setStrAttr3(String strAttr3) {
    ...
    public AddImageAdvanceRequest setStrAttr4(String strAttr4) {
