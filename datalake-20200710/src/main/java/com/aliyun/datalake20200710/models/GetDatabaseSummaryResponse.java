...
public class GetDatabaseSummaryResponse extends TeaModel {
    ...
    @NameInMap("body")
    @Validation(required = true)
    public GetDatabaseSummaryResponseBody body;
    ...
    public GetDatabaseSummaryResponse setBody(GetDatabaseSummaryResponseBody body) {
        this.body = body;
        return this;
    }
    public GetDatabaseSummaryResponseBody getBody() {
        return this.body;
    }
