...
public class DeleteModelResponseBody extends TeaModel {
    ...
    /**
     * <p>Result of the operation, indicating whether it was successful:</p>
     * <ul>
     * <li>true: Success</li>
     * <li>false: Failure</li>
     * </ul>
    ...
    public DeleteModelResponseBody setCode(Long code) {
        this.code = code;
        return this;
    }
    public Long getCode() {
    ...
    public DeleteModelResponseBody setHttpStatusCode(Long httpStatusCode) {
    ...
    public DeleteModelResponseBody setResultObject(Boolean resultObject) {
