...
public class CreateProcessDefinitionResponseBody extends TeaModel {
    ...
    public CreateProcessDefinitionResponseBody setData(Boolean data) {
        this.data = data;
        return this;
    }
    ...
    public CreateProcessDefinitionResponseBody setMessage(String message) {
    ...
    public CreateProcessDefinitionResponseBody setSuccess(Boolean success) {
