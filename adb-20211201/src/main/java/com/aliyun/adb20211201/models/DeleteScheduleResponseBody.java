...
public class DeleteScheduleResponseBody extends TeaModel {
    ...
    public DeleteScheduleResponseBody setData(Boolean data) {
        this.data = data;
        return this;
    }
    ...
    public DeleteScheduleResponseBody setMessage(String message) {
    ...
    public DeleteScheduleResponseBody setSuccess(Boolean success) {
