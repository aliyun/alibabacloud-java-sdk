...
public class Client extends com.aliyun.teaopenapi.Client {
     ...
     */
    public BatchSendMailResponse batchSendMailWithOptions(BatchSendMailRequest tmpReq, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(tmpReq);
        BatchSendMailShrinkRequest request = new BatchSendMailShrinkRequest();
        com.aliyun.openapiutil.Client.convert(tmpReq, request);
        if (!com.aliyun.teautil.Common.isUnset(tmpReq.receivers)) {
            request.receiversShrink = com.aliyun.openapiutil.Client.arrayToStringWithSpecifiedStyle(tmpReq.receivers, "Receivers", "json");
        }

        if (!com.aliyun.teautil.Common.isUnset(tmpReq.templateContent)) {
            request.templateContentShrink = com.aliyun.openapiutil.Client.arrayToStringWithSpecifiedStyle(tmpReq.templateContent, "TemplateContent", "json");
        }
        ...
        if (!com.aliyun.teautil.Common.isUnset(request.receiversShrink)) {
            body.put("Receivers", request.receiversShrink);
        }

        if (!com.aliyun.teautil.Common.isUnset(request.templateContentShrink)) {
            body.put("TemplateContent", request.templateContentShrink);
        }
     ...
     * <h2>Description</h2>
     * <ul>
     * <li>Set the <strong>templateType</strong> parameter to <code>0</code> to create a mail template.</li>
     * <li>For a mail template, specify <code>templateSubject</code> (email subject), <code>templateNickName</code> (sender name), and <code>templateText</code> (email HTML body).</li>
     * <li>The template name (<code>templateName</code>) must be unique within an account.</li>
     * <li>Newly created templates have a default status of <code>pending approval</code>.</li>
     * </ul>
     * 
     * <b>summary</b> : 
     * <p>Creates a new mail template in DirectMail.</p>
     * 
    ...
    /**
     * <b>summary</b> : 
     * <p>Retrieves the status of a file validation task.</p>
     * 
    ...
    /**
     * <b>summary</b> : 
     * <p>Sends a test email using a template.</p>
     * 
