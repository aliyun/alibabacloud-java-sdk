...
public class ModifyHostAvailabilityRequest extends TeaModel {
    ...
    public static class ModifyHostAvailabilityRequestTaskOption extends TeaModel {
         ...
         * <p>*   HEAD</p>
         * <br>
         * <p>> This parameter must be specified when TaskType is set to HTTP. For more information about how to configure the TaskType parameter, see [CreateHostAvailability](~~115317~~).</p>
         */
         ...
         * <br>
         * <p>> This parameter must be specified when TaskType is set to PING or TELNET. For more information about how to configure the TaskType parameter, see [CreateHostAvailability](~~115317~~).</p>
         */
