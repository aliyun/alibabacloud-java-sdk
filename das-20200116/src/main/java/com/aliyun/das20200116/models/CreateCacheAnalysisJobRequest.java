...
public class CreateCacheAnalysisJobRequest extends TeaModel {
     ...
     * <ul>
     * <li><p>If you need to specify multiple backup file IDs, separate them with commas (,). For example, you can set this parameter to <code>12345,67890</code>.</p>
     * </li>
     * <li><p>If you do not specify this parameter, the system automatically backs up the task and performs cache analysis on the backup file.</p>
     * </li>
     * </ul>
     * 
