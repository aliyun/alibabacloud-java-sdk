...
public class GetPfsSqlSummariesResponseBody extends TeaModel {
    ...
    public static class GetPfsSqlSummariesResponseBodyDataList extends TeaModel {
        ...
        @NameInMap("NoIndexUsedAvg")
        public Double noIndexUsedAvg;
        ...
        public GetPfsSqlSummariesResponseBodyDataList setNoIndexUsedAvg(Double noIndexUsedAvg) {
            this.noIndexUsedAvg = noIndexUsedAvg;
            return this;
        }
        public Double getNoIndexUsedAvg() {
            return this.noIndexUsedAvg;
        }
        ...
        public GetPfsSqlSummariesResponseBodyDataList setSqlFeature(String sqlFeature) {
