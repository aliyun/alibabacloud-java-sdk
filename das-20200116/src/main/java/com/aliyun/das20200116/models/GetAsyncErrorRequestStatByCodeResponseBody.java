...
public class GetAsyncErrorRequestStatByCodeResponseBody extends TeaModel {
    ...
    public GetAsyncErrorRequestStatByCodeResponseBody setCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public GetAsyncErrorRequestStatByCodeResponseBody setData(String data) {
        this.data = data;
        return this;
    }
    ...
    public GetAsyncErrorRequestStatByCodeResponseBody setSuccess(String success) {
